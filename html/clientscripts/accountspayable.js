...
function addLineItem()
{
        ...
        newdivtablebody.appendChild(newdivcurrent_row);
            ...
            newdivcurrent_row.className = "bluenocur";
                ...
                var innHtmlline =  "<B>Invoice - PO Item Matching</B>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<INPUT TYPE=\"button\" CLASS=\"SUBMIT\" onmouseover=\"className='SUBMITHOVER'\" onMouseout=\"className='SUBMIT'\" name='addIdnvoiceLine' id='addIdnvoiceLine' OnClick=addinvoiceLine('"+rownum+"') value=\"Add Line\"> ";
                innHtmlline += "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<INPUT TYPE=\"button\" CLASS=\"SUBMIT\" onmouseover=\"className='SUBMITHOVER'\" onMouseout=\"className='SUBMIT'\" name='addCreditCorrection' id='addCreditCorrection' OnClick=addcreditcorrectionline('"+rownum+"') value=\"Add Correction\"> ";
                innHtmlline += "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<INPUT TYPE=\"button\" CLASS=\"SUBMIT\" onmouseover=\"className='SUBMITHOVER'\" onMouseout=\"className='SUBMIT'\" name='addmaterialrma"+rownum+"' id='addmaterialrma"+rownum+"' OnClick=addrmaline('"+rownum+"') value=\"Add RMA (Credit)\"> ";
                innHtmlline += "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<INPUT TYPE=\"button\" CLASS=\"SUBMIT\" onmouseover=\"className='SUBMITHOVER'\" onMouseout=\"className='SUBMIT'\" name='addadchrgreturn"+rownum+"' id='addadchrgreturn"+rownum+"' OnClick=addaddchgrtn('"+rownum+"') value=\"Additional Charge (RMA Credit)\"> ";
...
newdivcurrent_row=document.createElement("TR");
            ...
            newdivcurrent_row.className = "whitenocur";
                ...
                var innHtmlline2 =  "<INPUT TYPE=\"button\" CLASS=\"SUBMIT\" onmouseover=\"className='SUBMITHOVER'\" onMouseout=\"className='SUBMIT'\" name='showallInvLines"+rownum+"' id='showallInvLines"+rownum+"' OnClick=showallinvlines('"+rownum+"') value=\"Show All\">";
					 innHtmlline2 +=  "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<INPUT TYPE=\"button\" CLASS=\"SUBMIT\" onmouseover=\"className='SUBMITHOVER'\" onMouseout=\"className='SUBMIT'\" name='showunMatchedInv"+rownum+"' id='showunMatchedInv"+rownum+"' OnClick=showunmatchedinv('"+rownum+"') value=\"Show Only Open Invoices\"> ";
...
newdivcurrent_row=document.createElement("TR");
        ...
        newdivcurrent_row=document.createElement("TR");
            ...
            newdivcurrent_row.className = "bluenocur";
                ...
                newdivcurrent_cell.setAttribute("width",'10%');
                newdivcurrent_cell.setAttribute("align",'left');
					 var innHtmlline1 =  "<B>Invoice - Receipt Matching</B>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<INPUT TYPE=\"button\" CLASS=\"SUBMIT\" onmouseover=\"className='SUBMITHOVER'\" onMouseout=\"className='SUBMIT'\" name='shwallreceiptMatching"+rownum+"' id='shwallreceiptMatching"+rownum+"' OnClick=showallreceiptlines('"+rownum+"') value=\"Show All\">";
					 innHtmlline1 +=  "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<INPUT TYPE=\"button\" CLASS=\"SUBMIT\" onmouseover=\"className='SUBMITHOVER'\" onMouseout=\"className='SUBMIT'\" name='showunMatchedReceipts"+rownum+"' id='showunMatchedReceipts"+rownum+"' OnClick=showunmatchedrecipts('"+rownum+"') value=\"Show Only Receipts to Match\"> ";
        ...
        newdivcurrent_row=document.createElement("TR");
            ...
            newdivcurrent_row.className = "whitenocur";
                ...
                var invisibleElements = "<INPUT TYPE=\"hidden\" NAME=\"linestatus"+rownum+"\" ID=\"linestatus"+rownum+"\" VALUE=\"Draft\">";
                invisibleElements += "<INPUT TYPE=\"hidden\" NAME=\"row"+rownum+"linenumber\" ID=\"row"+rownum+"linenumber\" VALUE=\""+lineNumberc+"\">";
                invisibleElements += "<INPUT TYPE=\"hidden\" NAME=\"row"+rownum+"row\" ID=\"row"+rownum+"row\" VALUE=\""+rownum+"\">";
                invisibleElements += "<INPUT TYPE=\"hidden\" NAME=\"itemnotestatus"+rownum+"\" ID=\"itemnotestatus"+rownum+"\" VALUE=\"No\">";
                invisibleElements += "<INPUT TYPE=\"hidden\" NAME=\"linechange"+rownum+"\" ID=\"linechange"+rownum+"\" VALUE=\"Yes\">";
                invisibleElements += "<INPUT TYPE=\"hidden\" NAME=\"originallinestatus"+rownum+"\" ID=\"originallinestatus"+rownum+"\" VALUE=\"Draft\">";
                invisibleElements += "<INPUT TYPE=\"hidden\" NAME=\"ammendment"+rownum+"\" ID=\"ammendment"+rownum+"\" VALUE=\"0\">";
                invisibleElements += "<INPUT TYPE=\"hidden\" NAME=\"ammendmentcomments"+rownum+"\" ID=\"ammendmentcomments"+rownum+"\" VALUE=\"\">";
                invisibleElements += "<INPUT TYPE=\"hidden\" NAME=\"itemtype"+rownum+"\" ID=\"itemtype"+rownum+"\" VALUE=\"\">";
                invisibleElements += "<INPUT TYPE=\"hidden\" NAME=\"associatedprsstatus"+rownum+"\" ID=\"associatedprsstatus"+rownum+"\" VALUE=\"No\">";
                invisibleElements += "<INPUT TYPE=\"hidden\" NAME=\"nofassociatedprs"+rownum+"\" ID=\"nofassociatedprs"+rownum+"\" VALUE=\"0\">";
                invisibleElements += "<INPUT TYPE=\"hidden\" NAME=\"specstatus"+rownum+"\" ID=\"specstatus"+rownum+"\" VALUE=\"No\">";
                invisibleElements += "<INPUT TYPE=\"hidden\" NAME=\"msdsstatus"+rownum+"\" ID=\"msdsstatus"+rownum+"\" VALUE=\"No\">";
                invisibleElements += "<INPUT TYPE=\"hidden\" NAME=\"validspec"+rownum+"\" ID=\"validspec"+rownum+"\" VALUE=\"No\">";
                invisibleElements += "<INPUT TYPE=\"hidden\" NAME=\"flowdownstatus"+rownum+"\" ID=\"flowdownstatus"+rownum+"\" VALUE=\"No\">";
                invisibleElements += "<INPUT TYPE=\"hidden\" NAME=\"validflowdown"+rownum+"\" ID=\"validflowdown"+rownum+"\" VALUE=\"No\">";
                invisibleElements += "<INPUT TYPE=\"hidden\" NAME=\"tcmbuystatus"+rownum+"\" ID=\"tcmbuystatus"+rownum+"\" VALUE=\"No\">";
                invisibleElements += "<INPUT TYPE=\"hidden\" NAME=\"clientbuystatus"+rownum+"\" ID=\"clientbuystatus"+rownum+"\" VALUE=\"No\">";
                invisibleElements += "<INPUT TYPE=\"hidden\" NAME=\"validitem"+rownum+"\" ID=\"validitem"+rownum+"\" VALUE=\"No\">";
                invisibleElements += "<INPUT TYPE=\"hidden\" NAME=\"qtyreceived"+rownum+"\" ID=\"qtyreceived"+rownum+"\" VALUE=\"0\">";
                invisibleElements += "<INPUT TYPE=\"hidden\" NAME=\"linetotalprice"+rownum+"\" ID=\"linetotalprice"+rownum+"\" VALUE=\"0\">";
                invisibleElements += "<INPUT TYPE=\"hidden\" NAME=\"polineunitprice"+rownum+"\" ID=\"polineunitprice"+rownum+"\" VALUE=\"0\">";
                invisibleElements += "<INPUT TYPE=\"hidden\" NAME=\"prshipto"+rownum+"\" ID=\"prshipto"+rownum+"\" VALUE=\"\">";
                invisibleElements += "<INPUT TYPE=\"hidden\" NAME=\"noofmatchingitem"+rownum+"\" ID=\"noofmatchingitem"+rownum+"\" VALUE=\"0\">";
                invisibleElements += "<INPUT TYPE=\"hidden\" NAME=\"noofreceiptmatching"+rownum+"\" ID=\"noofreceiptmatching"+rownum+"\" VALUE=\"0\">";
                invisibleElements += "<INPUT TYPE=\"hidden\" NAME=\"nooflinesinaddcharge"+rownum+"\" ID=\"nooflinesinaddcharge"+rownum+"\" VALUE=\"0\">";
