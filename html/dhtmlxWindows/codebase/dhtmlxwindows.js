...
//#}	
	...
	*/
	...
	this._createViewport = function() {
		...
		if (_isIE) {
			this._carcass.innerHTML = "<iframe src='javascript:false;' border=0 frameborder=0 style='filter: alpha(opacity=0); width: 100%; height:100%; position: absolute; top: 0px; left: 0px; width: 100%; height: 100%;'></iframe><div style='position: absolute; top: 0px; left: 0px; width: 100%; height: 100%;'></div>";
		}
	...
	this._autoResizeViewport = function() {
		for (var a in this.wins) {
			if (this.wins[a]._isFullScreened) {
				this.wins[a]._content.style.width = document.body.offsetWidth+"px";
				// doctype fix
				if (document.body.offsetHeight == 0) {
					...
					this.wins[a]._content.style.height = document.body.offsetHeight+"px";
				}
				// this.wins[a]._content.style.height = document.body.offsetHeight-(_isIE?4:0)+"px";
				// this.wins[a]._content.style.backgroundColor = "#909090";
		...
		win.innerHTML = "<table border='0' cellspacing='0' cellpadding='0' width='100%' height='"+win.h+"' class='dhtmlx_wins_"+this.skin+"'>"+
					...
					"<tr><td class='dhtmlx_wins_td_header_full' clearonselect='yes'>"+
						"<table border='0' cellspacing='0' cellpadding='0' width='100%' class='dhtmlx_wins_header' clearonselect='yes'>"+
							...
							"</tr>"+
						"</table>"+
						(_isIE?"<iframe frameborder='0' src='javascript:false;' class='dhx_ie6_wincover_forsel' onload='this.contentWindow.document.body.style.overflow=\"hidden\";'></iframe>":"")+
					"</td></tr>"+
					// body
					"<tr><td class='dhtmlx_wins_td_body_full' height='"+(win.h-skin["header_height"])+"'>"+
						"<table border='0' cellspacing='0' cellpadding='0' width='100%' height='"+(win.h-skin["header_height"])+"' class='dhtmlx_wins_body'>"+
							...
							"</tr>"+
						"</table>"+
						(this._isIE6?"<iframe frameborder='0' src='javascript:false;' style='top:"+skin["header_height"]+"px;' class='dhx_ie6_wincover_forsel' onload='this.contentWindow.document.body.style.overflow=\"hidden\";'></iframe>":"")+
					"</td></tr>"+
				"</table>"+
				// window icon
...
//#}
	...
	this._maximizeWindow = function(win) {
		if (win._allowResizeGlobal == false && true != win._allowMaxMin) { return; }
