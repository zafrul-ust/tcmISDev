...
function dhtmlXLayoutObject(base, view, skin) {
	...
	if (!base._skipChecksOnStartUp) {
		...
		if (base._isWindow == true) {
			...
			//console.log(this.parentDhxWins.imagePath)
	...
	*/
	...
	this.skinParams = { "standard"		: {"hor_sep_height": 6, "cpanel_height": 31, "cpanel_collapsed_width": 20, "cpanel_collapsed_height": (_isFF?20:22)},
			    ...
			    "dhx_blue"		: {"hor_sep_height": 5, "cpanel_height": (_isOpera?10:10), "cpanel_collapsed_width":  10, "cpanel_collapsed_height": 10}
	};
	// ff - 34,18
	// ie - 34,18
	// safari - 34,18
	...
	this._buildSurface = function() {
		...
		for (var a in p) {
			...
			try{
				...
				this.polyObj[a].style.width = "100px";
			}
	...
	*/
	this.setSizes = function(winObj) {
		...
		var wh = (winObj._isFullScreened?winObj._content.offsetHeight:winObj._content.childNodes[2].offsetHeight);
