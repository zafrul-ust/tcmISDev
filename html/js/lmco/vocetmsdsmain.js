...
function showOrHideMsdsNoSpan() {
	if($v("searchField") == 'material_id' || $v("searchField") == 'customer_msds_or_mixture_no')
		$("matchType").value = '=';
	else
...
function facilityChanged() {
	    ...
	    var arr = null;
	   	arr =  vocetStatusArr[selectedFacility];
	    buildDropDown(arr,defaults,"vocetStatus");
	    arr =  vocetCoatCategoryArr[selectedFacility];
