...
function eXcell_calck(cell){
 ...
 this.obj = new calcX(arPos[0]-this.grid.objBox.scrollLeft,arPos[1]+this.cell.offsetHeight-this.grid.objBox.scrollTop,this,this.val);
 ...
 this.detach = function(x,val){
 if(x)
 this.setValue(val);
 else if(this.obj)this.obj.removeSelf();
 this.obj=null;
