 ...
 if(!_isOpera)
{
 ...
 if((!this.dynScroll || this.dynScroll=='false' || ind<this.obj.childNodes.length)&&((ind)||(ind==0)))
{
 if(_isKHTML)
...
(e?e.target:event.srcElement).title='';
 ...
 if(ced)
(e?e.target:event.srcElement).title = ced.getTitle?ced.getTitle():(ced.getValue()||"").replace(/<[^>]*>/gi,"");
