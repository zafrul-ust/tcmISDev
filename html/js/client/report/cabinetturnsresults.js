...
function resultOnLoad()
{
	...
	if (totalLines > 0)
	{
		document.getElementById("inventoryTurnReportBean").style["display"] = "";
		
		initializeGrid();
	}  
	else
	{
		document.getElementById("inventoryTurnReportBean").style["display"] = "none";   
	}
...
function initializeGrid(){
   totalLines = document.getElementById("totalLines").value;
	if (totalLines > 0)
	{
		beangrid = new dhtmlXGridObject('inventoryTurnReportBean');
