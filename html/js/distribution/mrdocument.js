...
function resultOnLoad()
{
	...
	if (totalLines > 0)
	{
		document.getElementById("mrDocumentViewBean").style["display"] = "";

		initializeGrid();  
	}  
	else
	{
		document.getElementById("mrDocumentViewBean").style["display"] = "none";   
	}
...
function initializeGrid(){
	beangrid = new dhtmlXGridObject('mrDocumentViewBean');
...
function addNewMrDocument()
{
	
  var prNumber = document.getElementById("prNumber").value;
  var companyId = document.getElementById("companyId").value;
  var loc = "/tcmIS/distribution/addmrdocument.do?prNumber="+prNumber+"";
  try {
