...
function printLabels() {
  ...
  document.genericForm.action='/tcmIS/doe/label.do?action=printLabels';
  document.genericForm.submit();
  //var a = window.setTimeout("document.genericForm.submit();",500);
}

function generateExcel() {
  openWinGenericViewFile('/tcmIS/common/loadingpleasewait.jsp','_newgenerateExcel','650','600','yes');
  document.genericForm.target='_newgenerateExcel';
  document.genericForm.action='/tcmIS/doe/catalog.do?createExcel=createExcel';
  document.genericForm.submit();
  //var a = window.setTimeout("document.genericForm.submit();",500);
}
