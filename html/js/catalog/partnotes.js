...
if( !validateForm() ) return false;
    ...
    /*This is to keep the part notes page working for POLCHEM hubs*/
    var catalogId = document.getElementById("catalogId");
    if (catalogId.value == 'NSN')
    {
     var companyId = document.getElementById("companyId");
     companyId.value = 'USGOV';
     var catalogCompanyId = document.getElementById("catalogCompanyId");
     catalogCompanyId.value = 'USGOV';
    }
