...
var returnSelectedManufacturerName=null;
var returnSelectedManufacturerId=null;
...
{ 
  	try 
  	{
  		...
  		openervalueElementId.value = returnSelectedManufacturerId;
  		var openerdisplayElementId = opener.document.getElementById(displayElementId);
  		openerdisplayElementId.value = returnSelectedManufacturerName;
  		//reset valiable
  		returnSelectedManufacturerName = null;
  		returnSelectedManufacturerId=null;
  		valueElementId=null;
  	...
  	try 
  	{
  		if( window.opener.manufacturerChanged ) 
  		{
  			window.opener.manufacturerChanged(returnSelectedManufacturerId);
  		}
  	} 
  	catch(exx) 
  	{ 
