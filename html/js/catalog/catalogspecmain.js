...
legendWin = new YAHOO.widget.Panel("showLegendArea", { width:"300px", fixedcenter: true, constraintoviewport: true, underlay:"none", close:true, visible:false,
...
function submitUpdate() {
    ...
    window.frames["resultFrame"].document.genericForm.target='';
