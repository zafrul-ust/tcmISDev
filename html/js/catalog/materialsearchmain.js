...
var returnSelectedMaterialName=null;
var returnSelectedMaterialId=null;
...
{ 
  	try 
  	{
  		...
  		openervalueElementId.value = returnSelectedMaterialId;
  		var openerdisplayElementId = opener.document.getElementById(displayElementId);
  		openerdisplayElementId.value = returnSelectedMaterialName;
  		//reset valiable
  		returnSelectedMaterialName = null;
  		returnSelectedMaterialId=null;
  		valueElementId=null;
  	...
  	try 
  	{
  		...
  		{
  			window.opener.personnelChanged(returnSelectedMaterialId);
  		}
  	} 
  	catch(exx) 
  	{ 
