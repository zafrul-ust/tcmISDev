...
function validateSearchForm() {
    ...
    if ($v("searchText").length > 0) {
        if ($v("searchWhat") == 'i.item_id' && isNaN($v("searchText"))) {
            result = false;
...
function addUserToEmailList() {
	loc = "addusertoemaillistmain.do?userGroupId=ItemStorageDataNotification&levelOfControl=company&company=Radian";
