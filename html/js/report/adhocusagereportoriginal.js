...
function facilityHasReportingEntity(selectedFacility) {
	...
	if (selectedFacility.length == 0 || selectedFacility == 'All') {
...
function saveTemplateAudit() {
   ...
   if(reportFieldList.length <= 0) {
    ...
    document.adHocUsageReportForm.target='';
  openWinGeneric("savetemplate.do?reportType=usage&templateId="+$v("templateId"),"savetemplate","600","370","yes","80","80");
}
