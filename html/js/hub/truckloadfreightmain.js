...
function createXls() {
 	...
 	if(flag) {
		...
		openWinGenericViewFile('/tcmIS/common/loadingfile.jsp','_TruckLoadFreightGenerateExcel','650','600','yes');
    	document.genericForm.target='_TruckLoadFreightGenerateExcel';
...
function showHazmatInfo(tmpConsolidationNumber) {
	viewHazmatInfo(tmpConsolidationNumber);	
}