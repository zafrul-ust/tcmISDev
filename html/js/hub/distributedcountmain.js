...
{
  if (window.frames["resultFrame"].checkUsageTotals())
  {
    /*Set any variables you want to send to the server*/
    var submitUpdate = window.frames["resultFrame"].document.getElementById("submitUpdate");
...
{
    /*Set any variables you want to send to the server*/
    var submitSave = window.frames["resultFrame"].document.getElementById("submitSave");
    submitSave.value = 'submitSave';
    showPleaseWait();
    /*Submit the form in the result frame*/
    window.frames["resultFrame"].document.genericForm.submit();
}