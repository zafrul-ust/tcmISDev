...
function resultOnLoad()
{
 ...
 if (totalLines > 0)
 {
  document.getElementById("supplierPurchaseHistoryViewBean").style["display"] = "";
  initializeGrid();  
 }  
 else
 {
   document.getElementById("supplierPurchaseHistoryViewBean").style["display"] = "none";   
 }
...
function initializeGrid(){
	 beangrid = new dhtmlXGridObject('supplierPurchaseHistoryViewBean');
