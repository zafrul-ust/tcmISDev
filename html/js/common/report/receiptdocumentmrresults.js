...
{		  	
	...
	if (totalLines > 0)
	{
		document.getElementById("receiptDocumentMrBean").style["display"] = "";
		initializeGrid();
	}
	else
		document.getElementById("receiptDocumentMrBean").style["display"] = "none";
