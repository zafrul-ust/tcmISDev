...
{
	alert(messagesData.savingsMatch);
}
...
{
 loc = "/tcmIS/haas/searchpersonnelmain.do?displayArea=customerContactManager&valueElementId=customerContactId";
...
function clearClientContact()
{
    ...
    document.getElementById("customerContactManager").value = "";
}