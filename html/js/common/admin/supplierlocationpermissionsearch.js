...
function generateExcel() {
  ...
  if(flag) {
    ...
    openWinGenericViewFile('/tcmIS/common/loadingfile.jsp','_SupplierLocationPermissionGenerateExcel','800','600','yes');
    document.genericForm.target='_SupplierLocationPermissionGenerateExcel';
