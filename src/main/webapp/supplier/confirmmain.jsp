...
<!-- action=start is there to decide in the action to query the database for the drop down in the search section.
 ...
 -->
 <iframe id="searchFrame" name="searchFrame" width="100%" height="150" frameborder="0" marginwidth="0" style="" src="confirmsearch.do?userAction=display"></iframe>
</div>
<!-- Search Frame Ends -->
...
<%--	   <span id="createLink" style="display:none">
	   	<a href="#" onclick="call('create'); return false;"><fmt:message key="label.createshipment"/></a> |
	   </span>--%>
<%--  <span id="updateResultLink" style="display:none">
       <tcmis:permission indicator="true" userGroupId="suppliershipping"> --%>     
	   <a href="#" onclick="call('update'); return false;"><fmt:message key="label.updateshipment"/></a> |
	   <a href="#" onclick="call('confirm'); return false;"><fmt:message key="label.confirmshipment"/></a>
