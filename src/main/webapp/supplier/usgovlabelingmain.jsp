...
<!-- action=start is there to decide in the action to query the database for the drop down in the search section.
 ...
 -->
 <iframe id="searchFrame" name="searchFrame" width="100%" height="160" frameborder="0" marginwidth="0" style="" src="usgovlabelingsearch.do?action=${action}&supplier=${supplier}&shipFromLocationId=${shipFromLocationId}&picklistId=${picklistId}"></iframe>
</div>
<!-- Search Frame Ends -->
...
--%>
 <a href="#" onclick="call('printLabels'); return false;"><fmt:message key="label.printlabels"/></a>
<%--
         </tcmis:permission>
--%>      </span>
      &nbsp;
