	...
	<script language="JavaScript" type="text/javascript">
		...
		function initializeData() {
			try {
				...
				var obj = opener.getInitialEditPOPopupData(window.name, $v("callFromResultFrame"));
		...
		function submitPopup() {
			opener.submitEditPOPopup(window, isWhitespace($v("transactionId")) ? null : $v("transactionId"), $v("supplierId"), $v("locationId"), $v("catPartNo"), $v("poNumber"), $v("quantity"), $("isBlanketPO").checked ? "Y" : "N", $v("notes"));
		}
									...
									<div class="roundContent" id="searchTableDiv">
										...
										<table id="searchTable" width="100%" border="0" cellpadding="0"	cellspacing="0" class="tableSearch">
											...
											<tr>
												...
												<td class="optionTitleLeft">
													<input class="inputBox" type="text" name="poNumber" id="poNumber" value="" size="20"/>
												</td>
											</tr>
											<tr>
												<td class="optionTitleBoldRight"><fmt:message key="label.quantity" />:*</td>
												<td class="optionTitleLeft">
													<input class="inputBox" type="text" name="quantity" id="quantity" value="" size="20"/>
												</td>
											</tr>
											<tr>
											...
											<tr>
												<td colspan="2" nowrap="nowrap">
													<input type="checkbox" name="isBlanketPO" id="isBlanketPO" /><span class="optionTitleBoldLeft"><fmt:message key="label.blanketpo" /></span>
													&nbsp;
												</td>
											</tr>
											<tr>
