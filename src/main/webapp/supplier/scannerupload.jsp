...
<script src="/js/supplier/scannerupload.js" language="JavaScript"></script>
...
<title>
<fmt:message key="scannerupload.title"/>
</title>
...
<tcmis:form action="/scannerupload.do" onsubmit="return submitOnlyOnce();" enctype="multipart/form-data">
   ...
   <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableSearch">
    <tr>
     ...
     <td width="85%" class="optionTitleBoldLeft">
      <html:file property="theFile" styleId="theFile" value="c:\scannerdownload\shippingcount.csv" size="50" styleClass="HEADER"/>
     </td>
    </tr>
    <tr>
     <td width="5%" colspan="2" class="optionTitleBoldLeft"><fmt:message key="scannerupload.shippingcountfilepath"/></td>
    </tr>
    <tr>
