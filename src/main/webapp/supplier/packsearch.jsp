...
<script type="text/javascript" src="/js/supplier/packsearch.js"></script>
...
<body bgcolor="#ffffff" onload="onLoadSearchCheck();">

<!--Uncomment for production-->
<tcmis:form action="/packresults.do" onsubmit="return submitFrameOnlyOnce();" target="resultFrame">
        ...
        <c:choose>
          ...
          <c:otherwise>
            ...
            <c:forEach items="${suppLocationIdArray}" varStatus="status1">
              ...
              <c:choose>
	              <c:when test="${param.shipFromLocationId != '' && param.shipFromLocationId == currentLocation}">
    ...
    <td width="5%" class="optionTitleBoldRight">
 	  ...
 	  <tr class="alignLeft">
        <td colspan="6" class="optionTitleLeft">
		  <input type="button" name="search" id="search" value="<fmt:message key="label.search"/>" class="inputBtns" onmouseover="this.className='inputBtns inputBtnsOver'" onmouseout="this.className='inputBtns'" onclick="$('picklistId').value='';dosearch()"/>
...
<input type="hidden" id="pageDo" value="<tcmis:jsReplace value="${param.pageDo}"/>"/>    
</div>
<!-- Hidden elements end -->
