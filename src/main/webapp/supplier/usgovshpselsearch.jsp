...
errorInteger:"<fmt:message key="label.positiveinteger"/>"};
// -->
</script>
</head>
...
<tcmis:form action="/usgovshpselresults.do" onsubmit="return submitFrameOnlyOnce();" target="resultFrame">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableSearch">
      <tr>
		...
		<td width="20%" class="optionTitleLeft">
 			<input type="hidden" name="oldsupplier" id="oldsupplier" value=""/>
       ...
       <c:forEach var="SupplierLocationOvBean" items="${supplierLocationOvBean}" varStatus="status">
        ...
        <option  value="radianPo"><fmt:message key="label.haaspo"/></option>
				...
				<option  value="cityCommaState"><fmt:message key="label.shittocitycommastate"/></option>
				<option  value="zip"><fmt:message key="label.shiptozip"/></option>
      ...
      <c:set var="selectedsuppLocationIdArray" value='${paramValues.suppLocationIdArray}'/>
        ...
        <td width="10%" class="optionTitleBoldRight">
 		...
 		<td width="5%" class="optionTitleBoldLeft" colspan="5">
 			<select name="sort" id="sort" class="selectBox">
				<option value="shipToLocationId,deliveryPoint"><fmt:message key="label.shiptodelto"/></option>
				<%--<option value="itemId"><fmt:message key="label.itemid"/></option>
				<option value="mrNumber"><fmt:message key="label.mr"/></option>
				<option value="customerPo"><fmt:message key="label.po"/></option>--%>
  			</select>
 	  ...
 	  <tr>
		...
		<td class="optionTitleBoldLeft" colspan="3" nowrap="nowrap">
			<input name="orderStatuses" type="radio" class="radioBtns" value="all" id="allStatus"/><fmt:message key="label.all"/>
			<input name="orderStatuses" type="radio" class="radioBtns" value="allocatedOnly" id="allocatedOnlyStatus" checked="checked"/><fmt:message key="label.allocatedordersonly"/>
			<input name="orderStatuses" type="radio" class="radioBtns" value="unallocatedOnly" id="unallocatedOnlyStatus" /><fmt:message key="label.unallocatedordersonly"/>
		</td>
 	  </tr>
 	  <tr><td>&nbsp;</td></tr>
 	  <tr class="alignLeft">
        <td width="10%" colspan="4" class="optionTitleLeft">
		  <input type="button" name="search" id="search" value="<fmt:message key="label.search"/>" class="inputBtns" onmouseover="this.className='inputBtns inputBtnsOver'" onmouseout="this.className='inputBtns'" onclick="submitSearchForm()"/>
...
<input type="hidden" name="_action" id="_action" value="search"/>
<input type="hidden" name="startSearchTime" id="startSearchTime" value=""/>
<input type="hidden" name="orderStatus" id="orderStatus" value="<tcmis:jsReplace value="${param.orderStatus}"/>" />
</div>
<!-- Hidden elements end -->
