...
<script type="text/javascript" src="/js/supplier/vendorpaymentmain.js"></script>
...
<!-- action=start is there to decide in the action to query the database for the drop down in the search section.
 ...
 -->
 <iframe id="searchFrame" name="searchFrame" width="600" height="150" frameborder="0" marginwidth="0" style="" src="/tcmIS/supplier/vendorpaymentsearch.do"></iframe>
</div>
<!-- Search Frame Ends -->
