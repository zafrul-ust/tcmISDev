...
<!-- action=start is there to decide in the action to query the database for the drop down in the search section.
 ...
 -->
 <iframe id="searchFrame" name="searchFrame" width="100%" height="150" frameborder="0" marginwidth="0" style="" src="packsearch.do?userAction=display&pageDo=<tcmis:jsReplace value="${param.pageDo}"/>&supplier=<tcmis:jsReplace value="${param.supplier}"/>&shipFromLocationId=<tcmis:jsReplace value="${param.shipFromLocationId}"/>&picklistId=<tcmis:jsReplace value="${param.picklistId}"/>"></iframe>
</div>
<!-- Search Frame Ends -->
...
<div class="roundright">
  ...
  <div class="roundContent">
    <div class="boxhead"> <%-- boxhead Begins --%>
     ...
     <span id="requestorigininsLink">
      | <a href="#" onclick="getResultFrame().requestWAWFReport(); return false;"><fmt:message key="label.requestorigininspection"/></a>
     </span>
      | <a href="#" onclick="getResultFrame().printInventoryPicklist();"><fmt:message key="picklistreprint.printpicklist"/></a>
      </span>
      &nbsp;
