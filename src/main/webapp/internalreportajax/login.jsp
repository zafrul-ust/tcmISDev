...
<%--Don't need these as I started to use dbuser.properties to login to the correct schema.
This page was authenticating the user by loging into TCM_OPS
but running the page logging in as INTERNALREPORT.
Now it uses INTERNALREPORT for both user authentication and the page queries. - Nawaz 07-14-08
--%>
<%--<html:hidden property="client" value="TCM_OPS"/>
<html:hidden property="companyId" value="Radian"/>--%>
