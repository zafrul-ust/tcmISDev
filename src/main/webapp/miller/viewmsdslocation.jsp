...
<title>
<fmt:message key="viewmsdslocation.title"/>
</title>
...
<B><fmt:message key="viewmsdslocation.title"/></B>
</TD>
...
<TD WIDTH="25%" HEIGHT="35" ALIGN="LEFT" CLASS="announce">
<c:out value="${requestScope.currentMsdsLoadViewBeanCollection[0].status}"/>
</TD>
...
<TD WIDTH="25%" HEIGHT="35" ALIGN="LEFT" CLASS="announce">
<c:out value="${requestScope.currentMsdsLoadViewBeanCollection[0].tradeName}"/>
</TD>
<TD WIDTH="25%" HEIGHT="35" ALIGN="LEFT" CLASS="announce">
&nbsp;
</TD>
...
<TD WIDTH="25%" HEIGHT="35" ALIGN="LEFT" CLASS="announce">
<c:out value="${requestScope.currentMsdsLoadViewBeanCollection[0].manufacturerName}"/>
</TD>
<TD WIDTH="25%" HEIGHT="35" ALIGN="LEFT" CLASS="announce">
&nbsp;
</TD>
...
<fmt:formatDate pattern="MM/dd/yyyy" value="${requestScope.currentMsdsLoadViewBeanCollection[0].revisionDate}"/>
</TD>
...
<A HREF="<c:out value="${requestScope.currentMsdsLoadViewBeanCollection[0].content}"/>" TARGET="NEW">
 <fmt:message key="processmsds.link.imagefile"/>
</A>
</c:when>
<c:otherwise>
...
<B><fmt:message key="processmsds.label.currentlocations"/></B>
</TD>
</TR>
</TABLE>
