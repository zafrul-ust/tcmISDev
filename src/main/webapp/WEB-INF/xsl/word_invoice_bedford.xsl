...
<xsl:call-template name="invoiceSum">
 <xsl:with-param name="pNodes" select="InvoiceFormatViewBedfordBean"/>
</xsl:call-template>
</xsl:variable>
...
<w:tc><w:tcPr><w:tcW w:w="2520" w:type="dxa"/><w:gridSpan w:val="2"/><w:tcMar><w:left w:w="72" w:type="dxa"/></w:tcMar></w:tcPr><w:p><w:pPr><w:rPr><w:rFonts w:ascii="Arial" w:h-ansi="Arial" w:cs="Arial"/><wx:font wx:val="Arial"/><w:sz w:val="20"/><w:sz-cs w:val="20"/></w:rPr></w:pPr><w:r><w:rPr><w:rFonts w:ascii="Arial" w:h-ansi="Arial" w:cs="Arial"/><wx:font wx:val="Arial"/><w:sz w:val="20"/><w:sz-cs w:val="20"/></w:rPr>
<w:t><xsl:value-of select="InvoiceFormatViewBedfordBean/poNumber"/></w:t>
</w:r></w:p></w:tc></w:tr>
...
-->
<xsl:for-each select="InvoiceFormatViewBedfordBean">
<w:tr><w:tblPrEx><w:tblCellMar><w:top w:w="0" w:type="dxa"/><w:bottom w:w="0" w:type="dxa"/></w:tblCellMar></w:tblPrEx><w:trPr><w:trHeight w:val="341"/></w:trPr>
