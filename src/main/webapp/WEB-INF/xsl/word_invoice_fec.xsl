...
<w:tr><w:tblPrEx><w:tblCellMar><w:top w:w="0" w:type="dxa"/><w:bottom w:w="0" w:type="dxa"/></w:tblCellMar></w:tblPrEx><w:trPr><w:trHeight w:val="341"/></w:trPr>
<w:tc><w:tcPr><w:tcW w:w="1602" w:type="dxa"/></w:tcPr><w:p><w:pPr><w:jc w:val="left"/><w:rPr><w:rFonts w:ascii="Arial" w:h-ansi="Arial" w:cs="Arial"/><wx:font wx:val="Arial"/><w:sz w:val="20"/><w:sz-cs w:val="20"/></w:rPr></w:pPr><w:r><w:rPr><w:rFonts w:ascii="Arial" w:h-ansi="Arial" w:cs="Arial"/><wx:font wx:val="Arial"/><w:sz w:val="20"/><w:sz-cs w:val="20"/></w:rPr>
<xsl:variable name="catalogPrice" select="catalogPrice"/>
<w:t><xsl:value-of select="quantity"/> at <xsl:value-of select='format-number($catalogPrice, "$0.00;-$0.00")'/></w:t>
</w:r></w:p></w:tc>
...
<xsl:variable name="totalCost" select="quantity * catalogPrice"/>
<w:t><xsl:value-of select='format-number($totalCost, "$0.00;-$0.00")'/></w:t>
</w:r></w:p></w:tc></w:tr>
