...
<w:t>GKN Westland Aerospace Inc.</w:t>
</w:r></w:p></w:tc>
...
<w:t>3951 Alabama Hwy 229 South</w:t>
</w:r></w:p></w:tc>
...
<w:t>Invoice Inquiries: Coryelle Smith</w:t>
</w:r></w:p></w:tc></w:tr>
...
<w:tc><w:tcPr><w:tcW w:w="10162" w:type="dxa"/><w:gridSpan w:val="5"/></w:tcPr><w:p><w:pPr><w:rPr><w:rFonts w:ascii="Arial" w:h-ansi="Arial" w:cs="Arial"/><wx:font wx:val="Arial"/><w:sz w:val="20"/><w:sz-cs w:val="20"/></w:rPr></w:pPr><w:r><w:rPr><w:rFonts w:ascii="Arial" w:h-ansi="Arial" w:cs="Arial"/><wx:font wx:val="Arial"/><w:sz w:val="20"/><w:sz-cs w:val="20"/></w:rPr>
<w:t>Contact Phone: 512-519-3948</w:t>
</w:r></w:p></w:tc></w:tr>
...
<w:tc><w:tcPr><w:tcW w:w="10162" w:type="dxa"/><w:gridSpan w:val="5"/></w:tcPr><w:p><w:pPr><w:rPr><w:rFonts w:ascii="Arial" w:h-ansi="Arial" w:cs="Arial"/><wx:font wx:val="Arial"/><w:sz w:val="20"/><w:sz-cs w:val="20"/></w:rPr></w:pPr><w:r><w:rPr><w:rFonts w:ascii="Arial" w:h-ansi="Arial" w:cs="Arial"/><wx:font wx:val="Arial"/><w:sz w:val="20"/><w:sz-cs w:val="20"/></w:rPr>
<w:t>coryelle.smith@haastcm.com</w:t>
</w:r></w:p></w:tc></w:tr>
...
<w:tc><w:tcPr><w:tcW w:w="5081" w:type="dxa"/><w:gridSpan w:val="4"/><w:vAlign w:val="center"/></w:tcPr><w:p><w:pPr><w:jc w:val="center"/><w:rPr><w:rFonts w:ascii="Arial" w:h-ansi="Arial" w:cs="Arial"/><wx:font wx:val="Arial"/><w:sz w:val="20"/><w:sz-cs w:val="20"/></w:rPr></w:pPr></w:p><w:p><w:pPr><w:jc w:val="right"/><w:rPr><w:rFonts w:ascii="Arial" w:h-ansi="Arial" w:cs="Arial"/><wx:font wx:val="Arial"/><w:sz w:val="20"/><w:sz-cs w:val="20"/></w:rPr></w:pPr><w:r><w:rPr><w:rFonts w:ascii="Arial" w:h-ansi="Arial" w:cs="Arial"/><wx:font wx:val="Arial"/><w:sz w:val="20"/><w:sz-cs w:val="20"/></w:rPr>
<w:t>
 Services Provided for 
 <xsl:variable name="invoiceDate" select="invoiceDate"/>
 <xsl:call-template name="format-date">
 <xsl:with-param name="date" select="$invoiceDate" />
 <xsl:with-param name="format" select="9" />
</xsl:call-template> 18, <xsl:call-template name="format-date">
 <xsl:with-param name="date" select="$invoiceDate" />
 <xsl:with-param name="format" select="11" />
</xsl:call-template> - <xsl:call-template name="format-date">
 <xsl:with-param name="date" select="$invoiceDate" />
 <xsl:with-param name="format" select="8" />
 </xsl:call-template> 17, <xsl:call-template name="format-date">
 <xsl:with-param name="date" select="$invoiceDate" />
 <xsl:with-param name="format" select="10" />
</xsl:call-template>
</w:t>
</w:r></w:p></w:tc>
</w:tr>
...
<w:t>Total Material Invoice Amount:</w:t>
</w:r></w:p></w:tc>
...
<xsl:variable name="invoiceAmount" select="invoiceAmount"/>
<w:t>USD <xsl:value-of select='format-number($invoiceAmount, "$0.00;-$0.00")'/></w:t>
</w:r></w:p></w:tc>
...
<xsl:variable name="PreviousMonthName">
  <xsl:choose>
    <xsl:when test="$monthName = 'Feb'">Jan</xsl:when>
    <xsl:when test="$monthName = 'Mar'">Feb</xsl:when>
    <xsl:when test="$monthName = 'Apr'">Mar</xsl:when>
    <xsl:when test="$monthName = 'May'">Apr</xsl:when>
    <xsl:when test="$monthName = 'Jun'">May</xsl:when>
    <xsl:when test="$monthName = 'Jul'">Jun</xsl:when>
    <xsl:when test="$monthName = 'Aug'">Jul</xsl:when>
    <xsl:when test="$monthName = 'Sep'">Aug</xsl:when>
    <xsl:when test="$monthName = 'Oct'">Sep</xsl:when>
    <xsl:when test="$monthName = 'Nov'">Oct</xsl:when>
    <xsl:when test="$monthName = 'Dec'">Nov</xsl:when>
...
<xsl:value-of select="$PreviousMonthName" />
    </xsl:when>
    <xsl:when test="$format = 10">
<xsl:value-of select="$year" />
    </xsl:when>
    <xsl:when test="$format = 11">
