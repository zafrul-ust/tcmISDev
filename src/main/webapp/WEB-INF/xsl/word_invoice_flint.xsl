...
<w:tbl>
<w:tblPr><w:tblW w:w="10162" w:type="dxa"/><w:tblInd w:w="1" w:type="dxa"/><w:tblLayout w:type="Fixed"/><w:tblCellMar><w:left w:w="10" w:type="dxa"/><w:right w:w="10" w:type="dxa"/></w:tblCellMar><w:tblLook w:val="01E0"/></w:tblPr>
<w:tblGrid>
<w:gridCol w:w="2602"/>
<w:gridCol w:w="1080"/>
<w:gridCol w:w="1080"/>
...
<w:t>NAO Disbursements- Warrant Cntr.</w:t>
    </xsl:when>
    <xsl:otherwise>
...
<xsl:for-each select="invoiceDetailCollection">
<xsl:for-each select="InvoiceDetailBean">
...
<w:t><xsl:value-of select="catPartNo"/> - <xsl:value-of select="partDescription"/></w:t>
</w:r></w:p></w:tc>
...
<xsl:variable name="extPrice" select="netAmount"/>
