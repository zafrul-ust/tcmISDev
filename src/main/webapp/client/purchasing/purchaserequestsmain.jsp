...
<script type="text/javascript" src="/js/client/purchasing/purchaserequestsmain.js"></script>
...
missingdata:"<fmt:message key="label.customerpurchase.missingdata"/>",
norowselected:"<fmt:message key="label.customerpurchase.norowselected"/>",
...
<!-- action=start is there to decide in the action to query the database for the drop down in the search section.
 ...
 -->
 <iframe id="searchFrame" name="searchFrame" width="100%" height="110" frameborder="0" marginwidth="0" style="" src="purchaserequestssearch.do"></iframe>
</div>
<!-- Search Frame Ends -->
    ...
    <div class="boxhead"> <%-- boxhead Begins --%>
     <%-- Place all update links in divs that can be turned on or off depending on the search criteria that is selected
      ...
      <span id="updateResultLink" style="display: none">
        | <a href="#" onclick="submitUpdate(); return false;"><fmt:message key="label.process"/></a>
	      <span id="convertPurchaseLink" style="display: none">
	      | <a href="#" onclick="submitConvert(); return false;"><fmt:message key="label.awardbidtowesco"/></a>
	      </span>
      </span>
      &nbsp;
