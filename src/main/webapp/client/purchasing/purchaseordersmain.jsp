...
<script type="text/javascript" src="/js/client/purchasing/purchaseordersmain.js"></script>
...
<!-- action=start is there to decide in the action to query the database for the drop down in the search section.
 ...
 -->
 <iframe id="searchFrame" name="searchFrame" width="100%" height="110" frameborder="0" marginwidth="0" style="" src="purchaseorderssearch.do?action=<c:out value="${action}"/>&customerPoNumber=<c:out value="${customerPoNumber}"/>"></iframe>
</div>
<!-- Search Frame Ends -->
