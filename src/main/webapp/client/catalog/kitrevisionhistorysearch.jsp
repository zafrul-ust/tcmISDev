...
<title>
<fmt:message key="label.kitrevisions"/>: ${param.customerMixtureNumber}
</title>
...
var gridConfig = {
		divName:'kitRevHistViewBean', // the div id to contain the grid.this is also the dynabean form that will be sent back to the server
...
<div id="kitRevHistViewBean" style="width:100%;height:500px;" style="display: none;"></div>
