...
<script type="text/javascript" src="/js/client/catalog/newshipto.js"></script>
...
<tcmis:form action="/newshipto.do" onsubmit="return submitFrameOnlyOnce();">
...
<table>
<tr>
	<td width="8%" class="optionTitleBoldRight" nowrap><fmt:message key="label.fulladdress"/>:<span style='font-size:12.0pt;color:red'>*</span>
	</td>
	...
	<td width="8%" class="optionTitleBoldRight"><fmt:message key="label.country"/>:<span style='font-size:12.0pt;color:red'>*</span>
	</td>
    <td width="15%" class="optionTitle">
...
<tr>
	...
	<td width="8%" class="optionTitleBoldRight" nowrap><fmt:message key="label.state"/>/<fmt:message key="label.region"/>:<span style='font-size:12.0pt;color:red'>*</span>
	</td>
	<td width="15%" class="optionTitle">
...
<tr>
	...
	<td width="8%" class="optionTitleBoldRight"><fmt:message key="label.city"/>:<span style='font-size:12.0pt;color:red'>*</span>
	</td>
	<td width="15%" class="optionTitleBoldLeft" nowrap>
		...
		<fmt:message key="label.postalcode"/>:<span style='font-size:12.0pt;color:red'>*</span>
...
<input type="hidden" name="country" id="country" value="${param.country}">
