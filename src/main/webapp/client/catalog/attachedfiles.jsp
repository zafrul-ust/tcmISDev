...
<title>
<fmt:message key="label.viewattachedfile"/>-${param.requestId}
</title>
...
function openDoc(URL){
	winId = "doc"+count;
	openWinGeneric(URL,winId,"700","750","yes","50","50","20","20","no");
	count++;
}
...
<!--
 var gridConfig = {
	divName:'fileBean', // the div id to contain the grid.
...
<div id="fileBean" style="height:400px;display: none;" ></div>
...
<c:if test="${!empty fileList}" >
    ...
    <!--
        ...
        var jsonMainData = {
        rows:[
        <c:forEach var="fileBean" items="${fileList}" varStatus="status">
   		
   		<c:set var="url"><a href="#" onclick="openDoc(\'${status.current}\');"><tcmis:jsReplace  value='${status.current}'/></a></c:set>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableNoData" id="resultsPageTable">
 <tr>
  <td>
   <fmt:message key="label.noattachedfile"/>
  </td>
 </tr>
</table>
</c:if>
