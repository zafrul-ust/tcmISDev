...
companyrequired:"<fmt:message key="errors.required"><fmt:param><fmt:message key="label.company"/></fmt:param></fmt:message>",		
...
function validateForm() {
   if ($v("msdsSearchCompanyId").length < 1) {
		alert(messagesData.companyrequired);
		return false;
	}
...
<tcmis:form action="/msdssearchresults.do" onsubmit="return submitSearchOnlyOnce();" target="resultFrame">
    ...
    <table>
      <tr><!--
            <td width="10%" class="optionTitleBoldLeft"nowrap>&nbsp;
                ...
                <select name="msdsSearchCompanyId" id="msdsSearchCompanyId" class="selectBox" >
                	<c:forEach var="msdsSearchBean" items="${msdsSearchCompanyColl}" varStatus="status">
                		<option value="${msdsSearchBean.msdsSearchCompanyId}"><tcmis:jsReplace value="${msdsSearchBean.companyName}"/></option>
                	</c:forEach>
                </select>
            </td>
	        ...
	        <td width="50%" id="simpleSearchTd2" class="optionTitleBoldLeft" nowrap>
		        &nbsp;         
	            <input name="searchText" id="searchText" type="text" class="inputBox"  size="45" value="">&nbsp;
	        </td>
	        <td width="10%">
	            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	        </td>
...
<input name="msdsSearchCompanyId" id="msdsSearchCompanyId" value="HAAS" type="hidden"/>
</div>
<!-- Hidden elements end -->
