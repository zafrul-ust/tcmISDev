...
<body bgcolor="#ffffff" onload="loadLayoutWin('','substrateManagement');myOnLoad();" onunload="closeAllchildren();" onresize="resizeFrames()">
...
<tcmis:form action="/substratemanagementresults.do" onsubmit="return submitSearchOnlyOnce();" target="resultFrame">
