...
<head>
	...
	<script type="text/javascript" src="/js/client/het/hetcontainerentrymain.js"></script>
	...
	var altFacilityId = new Array(
		...
		messagesData = 
			...
			containerprefix:"<fmt:message key="label.containerprefix" />",
...
<body bgcolor="#ffffff" onload="loadLayoutWin('','containerEntry');myOnLoad();" onresize="resizeFrames()" onunload="closeAllchildren()">
	...
	<div class="interface" id="mainPage" style="">
		...
		<div id="searchFrameDiv">
			<div class="contentArea">
				<tcmis:form action="/hetcontainerentryresults.do" onsubmit="return submitSearchOnlyOnce();" target="resultFrame">
										...
										<div class="roundContent">
											<table  class="tableSearch" width="800" border="0" cellpadding="0" cellspacing="0">
												<tr>
													...
													<%--		<option value="RECEIPT_ID"><fmt:message key="label.containerprefix" /></option>
												...
												<tr>
													...
													<td  class="optionTitleBoldLeft">
													   ...
													   <td width="10%" class="optionTitleBoldRight">
												       	  <input type="checkbox" name="nonHaasPurchased" value="Y" id="nonHaasPurchased" checked onchange="nonHaasPurchasedChange(this)"/>
													    </td>  
													     <td width="10%" class="optionTitleBoldLeft">
													      <fmt:message key="label.nonhaaspurchased"/>&nbsp;
													   	</td>  
												</tr>
												<tr>
