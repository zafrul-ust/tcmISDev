...
<script type="text/javascript" src="/js/client/het/searchmsdsmfgmain.js"></script>
...
<title>  
<fmt:message key="label.msdssearch"/> 
</title>
...
function selectedMSDS()
{ 	
//  try {
    	var m = new msdsInfo(); 
  		window.opener.${param.callback}(m);
//  } catch(exx) {}
...
<body bgcolor="#ffffff" onload="loadLayoutWin('','searchMsdsMfg');" onunload="try{opener.parent.closeTransitWin();}catch(ex){}" onresize="resizeFrames()">
...
<tcmis:form action="/searchmsdsmfgresults.do" onsubmit="return submitSearchOnlyOnce();" target="resultFrame">
   ...
   <div class="roundContent">
    ...
    <table width="200" id="searchTable" border="0" cellpadding="0" cellspacing="0" class="tableSearch">
              ...
              <%--      	   <option value="catPartNo"> <fmt:message key="label.partno"/>  </option>   --%>
		                   ...
		                   <option value="customerMsdsNumber"><fmt:message key="label.msds"/> </option>
		            </select>
		            ...
		            <input name="searchArgument" id="searchArgument" type="text" class="inputBox" onkeypress="" size="40" value="">&nbsp;
		        </td>		
			</tr>
			<tr>
...
<input type="text" name="uAction" id="uAction" value="${param.uAction}"/>
<input type="text" name="facilityId" id="facilityId" value="${param.facilityId}"/>
<input type="text" name="startSearchTime" id="startSearchTime" value=""/>
</div>
<!-- Hidden elements end -->
