...
<head>
	...
	<script type="text/javascript" src="/js/client/het/usageloggingmain.js"></script>
	...
	<title>
		<fmt:message key="label.usagelogging"/>	
	</title>
...
<body bgcolor="#ffffff" onload="loadLayoutWin('','usageLogging');myOnLoad();" onresize="resizeFrames()">
	...
	<div class="interface" id="mainPage" style="">
		...
		<div id="searchFrameDiv">
			<div class="contentArea">
				<tcmis:form action="/usageloggingresults.do" onsubmit="return submitSearchOnlyOnce();" target="resultFrame">
												...
												<tr>
													...
													<td width="50%" class="optionTitleLeft">
														<select name="searchField" class="selectBox" id="searchField">
															<option value="CONTAINER_ID"><fmt:message key="label.containerid" /></option>
															...
															<option value="CART_NAME"><fmt:message key="label.cartname" /></option>
														</select>
					  				...
					  				<div class="roundContent">
											...
											<div id="mainUpdateLinks" style="display: none"> <%-- mainUpdateLinks Begins --%>
												<div id="updateResultLink" style="display: none">
													<a href="#" onclick="call('submitMainUpdate'); return false;"><fmt:message key="label.save"/></a>
												</div>     
											</div>
											</div> <%-- boxhead Ends --%>
