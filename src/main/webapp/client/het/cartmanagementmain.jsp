...
<head>
	...
	<script type="text/javascript" src="/js/client/het/cartmanagementmain.js"></script>
	...
	<title>
		<fmt:message key="label.cartmanagement"/>	
	</title>
...
<body bgcolor="#ffffff" onload="loadLayoutWin('','cartManagement');myOnLoad();"  onunload="closeAllchildren();" onresize="resizeFrames()">
	...
	<div class="interface" id="mainPage" style="">
		...
		<div id="searchFrameDiv">
			<div class="contentArea">
				<tcmis:form action="/cartmanagementresults.do" onsubmit="return submitSearchOnlyOnce();" target="resultFrame">
												...
												<tr>
													...
													<td width="50%" class="optionTitleLeft">
														<select name="searchField" class="selectBox" id="searchField">
															<option value="cartName"><fmt:message key="label.cartname" /></option>
									...
									<div class="roundtop">
					  				...
					  				<div class="roundContent">
											...
											<div id="mainUpdateLinks" > <%-- mainUpdateLinks Begins --%>
												...
												<a href="#" onclick="call('newCart'); return false;"><fmt:message key="label.newcart"/></a> |
