...
<head>
	...
	<script type="text/javascript" src="/js/client/het/shipmentreceivingmain.js"></script>
	...
	<script language="JavaScript" type="text/javascript">
		...
		messagesData = 
			...
			integer:"<fmt:message key="errors.integer"/>",	
...
<body bgcolor="#ffffff" onload="loadLayoutWin('','shipmentReceiving');myOnLoad();" onresize="resizeFrames()">
	...
	<div class="interface" id="mainPage" style="">
		...
		<div id="searchFrameDiv">
			<div class="contentArea">
				<tcmis:form action="/shipmentreceivingresults.do" onsubmit="return submitSearchOnlyOnce();" target="resultFrame">
											...
											<table  class="tableSearch" width="800" border="0" cellpadding="0" cellspacing="0">
												<tr>
													...
													<td width="50%" class="optionTitleLeft">
														<select name="searchField" class="selectBox" id="searchField" onchange="displayDays();">
															<option value="shipmentId" selected><fmt:message key="label.shipmentid" /></option>
															<option value="withinDays"><fmt:message key="label.deliveredwithin" /></option>
														</select>&nbsp;
														<input class="inputBox" type="text" name="searchArgument" id="searchArgument" value='' size="25" />
														&nbsp;<span id="daysSpan" style="display:none;"><fmt:message key="label.days" /></span>
													</td>
					  				...
					  				<div class="roundContent">
											...
											<div id="mainUpdateLinks" style="display: none"> <%-- mainUpdateLinks Begins --%> 
												<span id="updateResultLink" style="display: none">
													<a href="#" onclick="resultFrame.save();"><fmt:message key="label.save" /></a>
												</span>
											</div>
											</div> <%-- boxhead Ends --%>
