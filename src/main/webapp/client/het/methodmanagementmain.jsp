...
<script type="text/javascript" src="/js/client/het/methodmanagementmain.js"></script>
...
<title>
   <fmt:message key="label.methodmanagement"/>
</title>
...
<body bgcolor="#ffffff" onload="loadLayoutWin('','methodManagement');myOnLoad();" onunload="closeAllchildren();" onresize="resizeFrames()">
...
<tcmis:form action="/methodmanagementresults.do" onsubmit="return submitSearchOnlyOnce();" target="resultFrame">
								...
								<div class="roundright">
									...
									<div class="roundContent">
										<div class="boxhead">
											...
											<a href="#" onclick="resultFrame.newMethod();"><fmt:message key="label.addnewmethod" /></a> | 
