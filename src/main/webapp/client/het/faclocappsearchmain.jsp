...
<title>
   <fmt:message key="label.faclocappsearch"/>
</title>
...
var altFacilityId = new Array(
		...
		<c:forEach var="facility" items="${personnelBean.userFacilityWorkAreaGroupWorkAreaOvBeanCollection}" varStatus="status">
			<c:forEach var="workAreaGroupBean" items="${facility.workAreaGroupColl}" varStatus="status1">
                ...
                var selectedFacIndex = ${param.facilityIdIndex};
                var selectedWagIndex = ${param.wagIdIndex};
// -->
</script> 	

</head>

<body bgcolor="#ffffff" onload="loadLayoutWin('','facLocAppSearch');myOnLoad();" onresize="resizeFrames()" onunload="try{opener.parent.closeTransitWin();}catch(ex){}">
...
<tcmis:form action="/faclocappsearchresults.do" onsubmit="return submitSearchOnlyOnce();" target="resultFrame">
   ...
   <div class="roundContent">
		<table width="450" id="searchTable" border="0" cellpadding="0" cellspacing="0" class="tableSearch">
			...
			<td width="40%" class="optionTitleBoldLeft">
				...
				<script>document.write(altFacilityName[${param.facilityIdIndex}]);</script>
			</td>
			</tr>
			<tr>
				...
				<td width="40%" class="optionTitleBoldLeft">
					<select name="application" id="application" class="selectBox" onchange="workAreaGroupChanged()">			
					</select>
				</td>
			</tr>
			<tr>
			<td width="10%" class="optionTitleBoldRight" nowrap>
				...
				<td width="40%" class="optionTitleBoldLeft">
					<select name="cabinetIdArray" id="cabinetIdArray" class="selectBox">
					</select>
				</td>		
			</tr>
			<tr></tr>
								...
								<div class="roundright">
									...
									<div class="roundContent">
										<div class="boxhead">
											...
											--%>
											<div id="mainUpdateLinks" style="display: none"><span id="showlegendLink"> 
											<a href="#" id ="selectedRow" onclick="resultFrame.returnWA();"></a>
											</div>
										</div>
