...
<head>
	...
	<script language="JavaScript" type="text/javascript">
		...
		var config = [
			{ columnId:"areaId"},
			{ columnId:"areaName", columnName:'<fmt:message key="label.area"/>', width:10, tooltip: true },
			{ columnId:"areaDescription", columnName:'<fmt:message key="label.description"/>', width:20, tooltip: true },
			{ columnId:"companyId"},
			{ columnId:"facilityId"}
		];
		...
		function selectRow(rowId, cellId) {
			selectedRowId = rowId;
			var area = gridCellValue(mygrid, rowId, "areaName");
			$("selectedRow").innerHTML = messagesData.returnselected + " : " + area;
		}

		function returnSelectedRow () {
			opener.insertArea(gridCellValue(mygrid, selectedRowId, "areaId"), gridCellValue(mygrid, selectedRowId, "areaName"));
			window.close();
		}
		// -->
	</script>
								...
								<div class="roundright">
									...
									<div class="roundContent">
										...
										<div class="dataContent">
											<tcmis:form action="/areasearch.do">
												...
												<div class="interface" id="resultsPage">
													<div class="backGroundContent">
														...
														var jsonMainData =  {
															rows:[<c:forEach var="bean" items="${areas}" varStatus="status">
																{id:${status.count},
																data:[
																  '${bean.areaId}',
																  '<tcmis:jsReplace value="${bean.areaName}"/>',
																  '<tcmis:jsReplace value="${bean.areaDescription}"/>',
																  '${bean.companyId}',
																  '${bean.facilityId}'
														...
														<div id="hiddenElements" style="display: none;">    		
															...
															<input name="totalLines" id="totalLines" value="${fn:length(areas)}" type="hidden"/>
