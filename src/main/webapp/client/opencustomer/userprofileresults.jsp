...
<table width="100%" class="tableResults" id="resultsPageTable" border="0" cellpadding="0" cellspacing="0">
   ...
   <tr class="${colorClass}">
      <td width="5%" class="alignRight">
		  <input type="button" name="customersPage" id="customersPage" value="<fmt:message key="label.customers"/>" class="inputBtns" onmouseover="this.className='inputBtns inputBtnsOver'" onmouseout="this.className='inputBtns'" onClick="openCustomersPages()" ${disableButton}/>
	  </td>
	  <td width="85%" class="alignLeft">
		<fmt:message key="label.customersMessage"/>
	  </td>
   </tr>
   ...
   <tr class="${colorClass}">
      <td width="5%" class="alignRight">
        <input type="button" name="shiptoPage" id="shiptoPage" value="<fmt:message key="label.shipto"/>" class="inputBtns" onmouseover="this.className='inputBtns inputBtnsOver'" onmouseout="this.className='inputBtns'" onClick="openShiptoPages()" ${disableButton}/>
      </td>
      <td width="85%" class="alignLeft">
      	<fmt:message key="label.shiptoMessage"/>
      </td>
   </tr>
...
<input name="showResultFrame" id="showResultFrame" value="${showThisFrame}" type="hidden">	
