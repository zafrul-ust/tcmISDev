...
<script type="text/javascript" src="/js/client/opencustomer/userprofile.js"></script>
...
var requiredFTitle = new Array( "<fmt:message key="label.firstname"/>",
				...
				"<fmt:message key="label.defaultcustomer"/>",
...
<div class="contentArea" id="contentArea"> <!-- Start of contentArea-->
...
<!--  didn't user box head.... -->
 ...
 <tr>
 	<td width="10%" class="optionTitleBoldRight" nowrap>
 		<fmt:message key="label.logonid"/><span style='font-size:12.0pt;color:red'>*</span>:
 	</td>
 	<td width="23%" class="optionTitleLeft" nowrap>
 		...
 		<table>
 			...
 			<td>
 				...
 				<input type="button" class="lookupBtn" onmouseover="this.className='lookupBtn lookupBtnOver'" onmouseout="this.className='lookupBtn'" name="searchShipTo" value="..." align="right" onClick="changePersonnel()"/>
	     		<input type="button" class="smallBtns" onmouseover="this.className='smallBtns smallBtnsOver'" onmouseout="this.className='smallBtns'" value="<fmt:message key="label.newuser"/>" onclick="newUser()" />
	     		</c:if>
 				</div>
 			</td>	
 			</tr>
  ...
  <tr>
   	<td width="10%" class="optionTitleBoldRight" nowrap>
	 	<span><fmt:message key="label.firstname"/></span><span style='font-size:12.0pt;color:red'>*</span>:
	</td>
 	<td width="23%" class="optionTitleLeft">
 		<c:if test="${userId == personnelBean.personnelId || createNewUserCount > 0}">
   	...
   	<td width="10%" class="optionTitleBoldRight" nowrap>
	 	<span><fmt:message key="label.lastname"/></span><span style='font-size:12.0pt;color:red'>*</span>:
	</td>
 	<td width="23%" class="optionTitleLeft">
 		<c:if test="${userId == personnelBean.personnelId || createNewUserCount > 0}">
  ...
  <tr>
   	<td width="10%" class="optionTitleBoldRight" nowrap="nowrap">
	 	<fmt:message key="label.email"/><span style='font-size:12.0pt;color:red'>*</span>:
	</td>
 	<td width="23%" class="optionTitleLeft">
 		<c:if test="${userId == personnelBean.personnelId || createNewUserCount > 0}">
 	...
 	<td id="defaultcustomer1" style="display:none" width="10%" class="optionTitleBoldRight" nowrap>
	 	<fmt:message key="label.defaultcustomer"/><span style='font-size:12.0pt;color:red'>*</span>:
	</td>
 	<td id="defaultcustomer2" style="display:none" width="23%" class="optionTitleLeft" nowrap>
 		<input type="text" name="defaultCustomerName" id="defaultCustomerName" value="" size="20"  onkeypress="onKeySearch(event,lookupCustomer);" class="invGreyInputText" readonly/>
      	<input name="defaultCustomer" id="defaultCustomer" type="hidden" value=""/>  
 		<input type="button" class="lookupBtn" onmouseover="this.className='lookupBtn lookupBtnOver'" onmouseout="this.className='lookupBtn'" name="searchShipTo" value="..." align="right" onClick="chooseDefaultCustomer();"/>
 	</td>
  </tr>
  <tr>
