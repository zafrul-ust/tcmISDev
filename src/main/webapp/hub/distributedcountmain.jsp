...
<script type="text/javascript" src="/js/hub/distributedcountmain.js"></script>
...
<!-- action=start is there to decide in the action to query the database for the drop down in the search section.
 ...
 -->
 <iframe id="searchFrame" name="searchFrame" width="100%" height="115" frameborder="0" marginwidth="0" style="" src="/tcmIS/hub/distributedcountsearch.do"></iframe>
</div>
<!-- Search Frame Ends -->
     ...
     <%-- Place all update links in divs that can be turned on or off depending on the search criteria that is selected
      ...
      <span id="updateResultLink" style="display: none">
        <tcmis:inventoryGroupPermission indicator="true" userGroupId="Hub ItemCount">
         <a id="submitSaveButton" style="" href="javascript:submitSave()"><fmt:message key="label.save"/></a>
         |
         <a id="submitUpdateButton" style="" href="javascript:submitUpdate()"><fmt:message key="label.process"/></a>
