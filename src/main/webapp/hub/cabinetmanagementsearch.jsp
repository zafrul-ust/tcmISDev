...
<tcmis:form action="/cabinetmanagementresult.do" onsubmit="return submitFrameOnlyOnce();" target="resultFrame">
...
<div class="roundcont filterContainer">
 <div class="roundright">
   ...
   <div class="roundContent">
    ...
    <table border="0" width="750" border="0" cellpadding="0" cellspacing="0" class="tableSearch">
      <tr >
