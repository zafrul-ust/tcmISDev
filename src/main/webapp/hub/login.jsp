...
<script type="text/javascript" src="/js/common/sessiontimeout.js"></script>

<title><fmt:message key="login.title"/></title>
</head>

<BODY BGCOLOR="#FFFFFF" onload="sessionLogout()" TEXT="#000000">
...
<html:hidden property="companyId" value="Radian"/>
 <c:set var="home" value="${home}"/>
  <c:if test="${empty home}">
    <c:set var="home" value="hubhome"/>
 </c:if>
<html:hidden property="home" value="${home}"/>
