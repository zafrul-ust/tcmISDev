...
<script type="text/javascript" src="/js/hub/companyfacilities.js"></script>
...
selectedRowMsg:"<fmt:message key="label.facility"/>",itemInteger:"<fmt:message key="error.item.integer"/>"};
...
<tcmis:form action="/companyfacilitiesresults.do" onsubmit="return submitFrameOnlyOnce();">
