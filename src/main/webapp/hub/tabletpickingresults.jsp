...
<script type="text/javascript" src="/js/hub/tabletpickingresults.js"></script>
...
<tcmis:form action="/tabletpickingresults.do" onsubmit="return submitFrameOnlyOnce();">
...
{ id:${dataCount+1},
 ...
 data:['${hasPermission}',
  ...
  '${picklistItem.room}', '${picklistItem.roomDescription}',
  '${facilityName}',
  <c:choose>
 ...
 '${catPartNo}','${picklistItem.stockingMethod}', '${picklistItem.pickQty}',
...
<c:if test="${empty picklistColl}">
 ...
 <!-- Search results end --> 
    ...
    <div id="hiddenElements" style="display: none;">    			
		...
		<input name="companyId" id="companyId" type="hidden" value='${sessionScope.personnelBean.companyId}'/>
    </div>
    <!-- Hidden elements end -->
