...
<tr>
	<td width="5%" class="optionTitleBoldRight">
		<fmt:message key="label.program"/>:
	</td>
	<td width="10%" colspan="3" class="optionTitleBoldLeft">
		<select class="selectBox" name="hubC" id="hubC">
		</select>
	</td>
</tr>
<tr>
	...
	<td width="10%" colspan="3" class="optionTitleBoldLeft">
		<select class="selectBox" name="facility" id="facility">
		</select>
	</td>
</tr>
<tr>
	...
	<td width="10%" colspan="3" class="optionTitleBoldLeft">
		<select class="selectBox" name="workarea" id="workarea">
		</select>
	</td>
</tr>
<tr>
	...
	<td width="10%" class="optionTitleBoldLeft">
		<select class="selectBox" name="invenGrp" id="invenGrp">
		</select>
	</td>
...
<tr>
	...
	<td width="10%" class="optionTitleBoldLeft">
		<select class="selectbox" name="like" id="like">
			<html:option value="CAT_PART_NO" key="label.partnumber"/>
			<html:option value="ITEM_ID" key="label.itemid"/>
		</select>
	</td>
	<td width="10%" class="optionTitleBoldLeft">
		<input class="inputBox" type="text" name="searchText" id="searchText" value="" size="8">
	...
	<td width="10%" class="optionTitleBoldLeft">
		<input type="checkbox" name="minMaxOnly" id="minMaxOnly" value="Yes" checked="checked"/>
		&nbsp;&nbsp;
		<fmt:message key="label.showminmaxonly"/>
	</td>
</tr>
	<td colspan="4" class="optionTitleLeft">
		<input type="submit" class="inputBtns" onmouseover="this.className='inputBtns inputBtnsOver'" onmouseout="this.className='inputBtns'" value="<fmt:message key="label.search"/>" name="search">
		<input type="submit" class="inputBtns" onmouseover="this.className='inputBtns inputBtnsOver'" onmouseout="this.className='inputBtns'" value="<fmt:message key="label.update"/>" name="update" id="update"/>
		<input type="button" class="inputBtns" onmouseover="this.className='inputBtns inputBtnsOver'" onmouseout="this.className='inputBtns'" value="<fmt:message key="label.otb"/>" name="otb" id="otb"/>
	</td>
<tr>
</tr>
