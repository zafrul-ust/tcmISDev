...
<!-- Add any other javascript you need for the page here -->
<script type="text/javascript" src="/js/hub/dotshippingnamemain.js"></script>

<title>
<fmt:message key="label.dotshippingnames"/>
</title>
...
<body bgcolor="#ffffff" onload="loadLayoutWin('','dotShippingInfo');mainOnload();try{document.getElementById('searchArgument').focus()}catch(ex){}" onunload="try{opener.closeTransitWin();}catch(ex){}"  onresize="resizeFrames()">
...
<tcmis:form action="/dotshippingnameresults.do" onsubmit="return submitFrameOnlyOnce();" target="resultFrame">
