...
invalidmilstripcode:"<fmt:message key="label.invalidmilstripcode"/>",futuredatenotallowed:"<fmt:message key="label.futuredatenotallowed"/>"};
// -->
...
<c:out value="${custPoAddressChangeViewBeanCollection[0].originalTransactionType}"/>
        ...
        <td>
            <input name="oldMilstripCode" id="oldMilstripCode" type="hidden" value="<c:out value="${custPoAddressChangeViewBeanCollection[0].milstripCode}"/>">
            <c:if test="${custPoAddressChangeViewBeanCollection[0].milstripCode == null}">
                <input name="milstripCode" id="milstripCode" type="text" maxlength="17">
            </c:if>
            <c:if test="${custPoAddressChangeViewBeanCollection[0].milstripCode != null}">
...
<input name="portOfEmbarkation" id="portOfEmbarkation" type="hidden" value="<c:out value="${custPoAddressChangeViewBeanCollection[0].portOfEmbarkation}"/>">
        ...
        <td class="optionTitleBoldLeft"><fmt:message key="label.portofdebarkation"/>:</td>
        <td>
<input name="portOfDebarkation" id="portOfDebarkation" type="text" class="inputBox" value="<c:out 
value="${custPoAddressChangeViewBeanCollection[0].portOfDebarkation}"/>" maxlength="3">
       </td>
      </tr>
             <tr>
...
<c:out value="${custPoAddressChangeViewBeanCollection[0].docIdCode}"/>
       ...
       <td class="optionTitleBoldLeft"><fmt:message key="label.quantity"/>:</td>
        <td>
<c:out value="${custPoAddressChangeViewBeanCollection[0].quantity}"/>
       </td>
...
<c:out value="${custPoAddressChangeViewBeanCollection[0].shippingNotes}"/>
        ...
        <td class="optionTitleBoldLeft"><fmt:message key="label.uom"/>:</td>
        <td>
         <c:out value="${custPoAddressChangeViewBeanCollection[0].uom}"/>
       </td>
      </tr>
      <tr>
        <td class="optionTitleBoldLeft"><fmt:message key="label.shiptododaac"/>:<c:out value="${addressChangeRequestId}"/></td>
        <td>
<input name="addressChangeRequestId" id="addressChangeRequestId" value="<c:out value="${addressChangeRequestId}"/>" type="hidden" >
          <input name="dodaac" id="dodaac" type="text" class="inputBox" value="<c:out value="${custPoAddressChangeViewBeanCollection[0].origShipToDodaac}"/>" onfocus="blur();">
<input name="dodaacType" id="dodaacType" value="" type="hidden" >
       </td>
        <td class="optionTitleBoldLeft"><fmt:message key="label.markfordodaac"/>:</td>
        <td>
          <input name="mfDodaac" id="mfdodaac" type="text" class="inputBox" value="<c:out value="${custPoAddressChangeViewBeanCollection[0].origMarkForDodaac}"/>" onfocus="blur();">
       </td>
      </tr>
      <tr>
        <td class="optionTitleBoldLeft"><fmt:message key="label.shiptolocationid"/>:</td>
        <td><input name="locationId" id="locationId" type="text" class="inputBox" value="<c:out value="${custPoAddressChangeViewBeanCollection[0].origShipToLocationId}"/>" onfocus="blur();"></td>
          <td class="optionTitleBoldLeft"><fmt:message key="label.markforlocationid"/>:</td>
          <td><input name="mfLocationId" id="mfLocationId" type="text" class="inputBox" value="<c:out value="${custPoAddressChangeViewBeanCollection[0].origMarkForLocationId}"/>" onfocus="blur();"></td>
...
<c:out value="${custPoAddressChangeViewBeanCollection[0].mfAddressLine4Display}"/>
      ...
      <tr>
      <td>
<input name="submitSearch" id="submitSearch" type="submit" value="<fmt:message key="label.search"/>" class="inputBtns" onmouseover="this.className='inputBtns inputBtnsOver'" onmouseout="this.className='inputBtns'" onclick="submitSearchForm('dpms'); return false;">
...
<input name="submitUpdate" id="submitUpdate" type="submit" value="<fmt:message key="label.update"/>" class="inputBtns" onmouseover="this.className='inputBtns inputBtnsOver'" onmouseout="this.className='inputBtns'" onclick="return submitUpdateForm();">
                ...
                <td>
<input name="submitNew" id="submitNew" type="submit" value="<fmt:message key="label.newaddress"/>" class="inputBtns" onmouseover="this.className='inputBtns inputBtnsOver'" onmouseout="this.className='inputBtns'" onclick="submitNewForm('dpms'); return false;">
