...
<!-- Add any other javascript you need for the page here -->
<script type="text/javascript" src="/js/hub/adrshippingnamemain.js"></script>

<title>
<fmt:message key="label.adrshippingnames"/>
</title>
...
<body bgcolor="#ffffff" onload="loadLayoutWin('','adrShippingInfo');mainOnload();try{document.getElementById('searchArgument').focus()}catch(ex){}" onunload="try{opener.closeTransitWin();}catch(ex){}"  onresize="resizeFrames()">
...
<tcmis:form action="/adrshippingnameresults.do" onsubmit="return submitFrameOnlyOnce();" target="resultFrame">
