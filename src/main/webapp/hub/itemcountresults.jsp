...
<head>
	...
	<script type="text/javascript" src="/js/hub/itemcountresults.js"></script>
	...
	<script language="JavaScript" type="text/javascript">
		...
		<%-- See webroot/dhtmlxgrid/codebase/dhtmlxcommon_haas.js for option explanations of config & gridconfig --%>
	       ...
	       var config = [ 
			...
			{columnId: "inPurchasing", columnName:'<tcmis:jsReplace value="${inpurchasing}"/>',attachHeader:'<fmt:message key="label.inpurchasing"/>', sort:"int", align:"right"},
			{columnId: "packaging", columnName:'#cspan', attachHeader:'<fmt:message key="inventory.label.inventoryuom"/>', tooltip:true},       		
	       ...
	       var gridConfig = {
		       ...
		       //noSmartRender:false // Turn off smart rendering
