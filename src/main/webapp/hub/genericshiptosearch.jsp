...
<title>
<fmt:message key="label.genericshipto"/>
</title>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableSearch">
	<tr>
		<td width="20%" class="optionTitleBoldRigth">
	...
	<tr>
		<td width="20%" class="optionTitleBoldRight">
			<fmt:message key="label.shipto"/> <fmt:message key="label.id"/>
		</td>
		<td width="70%">
			<input class="inputBox" type="text" name="shipToId" id="supplierId" value="" size="25" readonly="readonly"/>
		</td>
	</tr>
	<tr>
		<td>
