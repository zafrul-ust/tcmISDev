...
<body bgcolor="#ffffff" onload="searchOnLoad();parent.closeAllchildren();" onunload="parent.closeAllchildren();">

<tcmis:form action="/showchemreceivedreceiptsresults.do" onsubmit="return submitFrameOnlyOnce();" target="resultFrame">
	...
	<table id="searchMaskTable" width="100%" border="0" cellpadding="0" cellspacing="0">
		<tr>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableSearch">
				...
				<tr>
					<td width="6%" class="optionTitle">
						<input id="option1" type="radio" name="paperSizeRadio" onClick="assignpaperSize('31')" value="31" checked="checked" class="radioBtns"> <fmt:message key="labels.label.size35" />
					</td>
					<td width="8%" class="optionTitle">
						<input id="option2" type="radio" name="paperSizeRadio" onClick="assignpaperSize('811')" value="811" class="radioBtns"> <fmt:message key="labels.label.size811" />
					</td>
					...
					<td width="5%" class="alignLeft">
						<html:button property="containerlabels" styleClass="inputBtns" onmouseover="this.className='inputBtns inputBtnsOver'" onmouseout="this.className='inputBtns'" onclick="printReceiptDetailLabels()">
							<fmt:message key="label.receiptdetaillables" />
   						</html:button>
   					</td>
					...
					<%--  <td width="5%" class="alignLeft">
  <html:button property="printthispage" styleClass="inputBtns" onmouseover="this.className='inputBtns inputBtnsOver'" onmouseout="this.className='inputBtns'" onclick="printResults()">
     <fmt:message key="label.printthispage"/>
   </html:button>
  </td>--%>

					<%--  <td width="5%" colspan="6" class="alignLeft">
  <html:button property="containerlabels" styleClass="inputBtns" onmouseover="this.className='inputBtns inputBtnsOver'" onmouseout="this.className='inputBtns'" onclick= "parent.closeWindow()">
   <fmt:message key="label.close"/>
				...
				<tr>
					<td width="5%" colspan="6" class="alignLeft"><input type="checkbox" name="skipKitLabels" id="skipKitLabels" value="Yes">&nbsp;<fmt:message key="receivedreceipts.label.skipkitlabels" /></td>
				</tr>
			</table>
...
--> <c:if test="${requestScope['org.apache.struts.action.ERROR'] != null}">
	...
	<div id="hiddenElements" style="display: none;">
		<input type="hidden" name="labelReceipts" id="labelReceipts" value="<c:out value="${param.labelReceipts}"/>"> 
		<input type="hidden" name="paperSize" id="paperSize" value="31"> 
		<input type="hidden" name="hubNumber" id="hubNumber" value="<c:out value="${param.sourceHub}"/>"> 
		<input type="hidden" name="justReceived" id="justReceived" value="${param.justReceived}"> 
		<input type="hidden" name="receivedReceipts" id="receivedReceipts" value="${param.receivedReceipts}"> 
		...
		<input type="hidden" name="userAction" id="userAction" value="${param.userAction}">
	</div>
