...
<script type="text/javascript" src="/js/hub/shelflifeexpforcast.js"></script>
...
<body bgcolor="#ffffff" onload="loadLayoutWin('','shelfLifeForcast');setOps();" onresize="resizeFrames()">
...
<tcmis:form action="/shelflifeexpforcastresults.do" onsubmit="return submitSearchOnlyOnce();" target="resultFrame">
 ...
 <div class="roundright">
   ...
   <div class="roundContent">
    ...
    <tr>
	 ...
	 <select class="selectBox" name="lotStatus" id="lotStatus" size="5" multiple>
    ...
    <tr>
      <td width="5%" class="optionTitleBoldRight" nowrap><fmt:message key="label.inventorygroup"/>:&nbsp;</td>
      <td width="10%">
...
<input name="searchHeight" id="searchHeight" type="hidden" value="164">
</div>
<!-- Hidden elements end -->
