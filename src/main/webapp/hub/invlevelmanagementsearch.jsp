...
<script type="text/javascript" src="/js/hub/invlevelmanagementsearch.js"></script>
...
daysSinceIssuedLimitInteger:"<fmt:message key="label.dayssinceissued"/> <fmt:message key="label.mustbeaninteger"/>",
...
<tcmis:form action="/invlevelmanagementresults.do" onsubmit="return submitFrameOnlyOnce();" target="resultFrame">
 ...
 <select name="sourceHub" id="sourceHub" onchange="hubchanged()" class="selectBox">
  ...
  <c:if test="${invenGroupCount == 0}">
   <option value=""><fmt:message key="label.all"/></option>
		...
		<td width="75%" class="optionTitleBoldLeft" >
 	  ...
 	  <tr class="alignLeft">   
        ...
        <td width="90%" class="optionTitleLeft" colspan="3"> 		
			<input name="createExcel" id="createExcel" type="button" value="<fmt:message key="label.createxls"/>" class="inputBtns" onmouseover="this.className='inputBtns inputBtnsOver'" onmouseout="this.className='inputBtns'"
