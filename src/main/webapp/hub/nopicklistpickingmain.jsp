...
<script src="/js/hub/nopicklistpickingmain.js" language="JavaScript"></script>
...
<div id="searchFrameDiv">
 <iframe id="searchFrame" name="searchFrame" width="100%" height="140" frameborder="0" marginwidth="0" style="" src="/tcmIS/hub/nopicklistpickingsearch.do"></iframe>
</div>
<!-- Search Frame Ends -->
    ...
    <div class="boxhead">
     <%-- Place all update links in divs that can be turned on or off depending on the search criteria that is selected--%>
      ...
      <%--<span id="showlegendLink">
        <a href="javascript:showPickingLegend()"><fmt:message key="label.showlegend"/></a>
      </span>--%>
      <span id="updateResultLink" style="display: none">
        <tcmis:permission indicator="true" userGroupId="Issuing">
            <a href="#" onclick="doConfirm(); return false;"><fmt:message key="button.confirm"/></a>
        </tcmis:permission>
      </span>
      <span id="pickedResultLink" style="display: none">
        | <a href="#" onclick="printBols(); return false;"><fmt:message key="label.generateBOL"/></a>
        | <a href="#" onclick="printboxLabels(); return false;"><fmt:message key="picklistreprint.printboxlabels"/></a>
        | <a href="#" onclick="printPackingList(); return false;"><fmt:message key="label.printpackinglist"/></a>        
      </span>
     </div>
    </div>
...
<div id="showLegendAreaTitle" class="hd"><fmt:message key="label.legend"/></div>
<div id="showLegendAreaBody" class="bd">
  <table width="100%" class="tableResults" border="0" cellpadding="0" cellspacing="0">
   <tr><td width="100px" class="pink legendText">&nbsp;</td><td class="legendText">AOG/Super Critical MR</td></tr>
   <tr><td width="100px" class="red legendText">&nbsp;</td><td class="legendText">Critical MR</td></tr>
   <tr><td width="100px" class="yellow legendText">&nbsp;</td><td class="legendText">This Receipt Is Not Pickable.</td></tr>
   <%--<tr><td width="100px" class="red legendText">&nbsp;</td><td class="legendText">There was an error in processing this Pick.</td></tr>--%>
  </table>
</div>
</div>
