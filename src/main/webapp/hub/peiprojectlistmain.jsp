...
<!-- action=start is there to decide in the action to query the database for the drop down in the search section.
 ...
 -->
 <iframe id="searchFrame" name="searchFrame" width="100%" height="180" frameborder="0" marginwidth="0" style="" src="/tcmIS/hub/peiprojectlistsearch.do"></iframe>
</div>
<!-- Search Frame Ends -->
  ...
  <div class="roundContent">
    <div class="boxhead"> <%-- boxhead Begins --%>
     <%-- Place all update links in divs that can be turned on or off depending on the search criteria that is selected
      ...
      <a href="#" onclick="getSearchFrame().printprojectlist();return false;"><fmt:message key="label.print"/></a>
<!-- 
		  <html:button property="submitPrint" styleId="submitPrint" styleClass="inputBtns" onmouseover="this.className='inputBtns inputBtnsOver'" onmouseout="this.className='inputBtns'" onclick="getSearchFrame().printprojectlist();return false;">
