...
<script type="text/javascript" src="/js/hub/addnewroom.js"></script>
...
<title>
<fmt:message key="label.new"/>&nbsp;<fmt:message key="label.room"/>
</title>
...
var closeNewRoomWin = false;
<c:if test="${closeNewRoomWin eq 'Y'}" >
closeNewRoomWin = true;
</c:if>
...
<body bgcolor="#ffffff"  onload="newRoomWinClose();" onresize="resizeFrames()">
<div class="interface" id="mainPage" style="">

<!-- Search Frame Begins -->
<div id="searchFrameDiv">
<tcmis:form action="/addnewroom.do" onsubmit="return submitSearchOnlyOnce();" target="resultFrame">
...
<table width="400" border="0" cellpadding="0" cellspacing="0" class="tableSearch">
	...
	<tr>
      ...
      <td   width="6%" class="optionTitleBoldLeft" >
         <input name="room" id="room" type="text" class="inputBox" size="20" maxlength="30" value="${roomBean.room}"/>
       </td>
       <td   width="6%" class="optionTitleBoldLeft" >
         &nbsp;
       </td>      
    ...
    <tr>
		<td width="6%" class="optionTitleBoldRight">
		<fmt:message key="label.room"/>&nbsp;<fmt:message key="label.description"/>:
		</td> 
      <td   width="6%" class="optionTitleBoldLeft" >
         <input name="roomDescription" id="roomDescription" type="text" class="inputBox" size="40" maxlength="100" value="${roomBean.roomDescription}"/>
       </td>
       <td   width="6%" class="optionTitleBoldLeft" >
         &nbsp;
       </td>      
...
<input name="hub" id="hub" type="hidden" value="${param.branchPlant}"/>
<input name="sourceHub" id="sourceHub" type="hidden" value="${param.branchPlant}"/>
<input name="sourceHubName" id="sourceHubName" type="hidden" value="${param.sourceHubName}"/>
<input name="branchPlant" id="branchPlant" type="hidden" value="${branchPlant}"/>
</div>
<!-- Hidden elements end -->
</tcmis:form>
</div>
