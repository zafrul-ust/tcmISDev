...
<script type="text/javascript" src="/js/hub/truckloadfreightmain.js"></script>
<script type="text/javascript" src="/js/hub/showhazmatdetail.js"></script>
...
-->
<body bgcolor="#ffffff" onload="loadLayoutWin('','truckloadFreight');showHub()" onresize="resizeFrames()">
...
<tcmis:form action="/truckloadfreightresults.do" onsubmit="return submitSearchOnlyOnce();" target="resultFrame">
     ...
     <%-- Place all update links in divs that can be turned on or off depending on the search criteria that is selected
      ...
      <div id="mainUpdateLinks" style="display: none"> <%-- mainUpdateLinks Begins --%>
      	<div id="updateResultLink" style="display: none">
			...
			| <a href="#" onclick="call('submitCancel'); return false;"><fmt:message key="label.canceltl"/></a>
		</div>
