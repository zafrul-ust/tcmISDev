...
<script type="text/javascript" src="/js/hub/companyfacilitiesmain.js"></script>
...
<tcmis:form action="/companyfacilitiesresults.do" onsubmit="return submitSearchOnlyOnce();" target="resultFrame">
...
<table width="80%" border="0" cellpadding="0" cellspacing="0" class="tableSearch">
      ...
      <tr>
      	...
      	<td colspan="2">
			...
			<input type="submit" id="cancel" value="<fmt:message key="label.cancel"/>" class="inputBtns" onmouseover="this.className='inputBtns inputBtnsOver'" onmouseout="this.className='inputBtns'" onClick="parent.window.close()"/>
		</td>
      </tr>
    </table>
