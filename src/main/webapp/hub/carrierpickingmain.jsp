...
<!-- action=start is there to decide in the action to query the database for the drop down in the search section.
 ...
 -->
 <iframe id="searchFrame" name="searchFrame" width="100%" height="170" frameborder="0" marginwidth="0" style="" src="carrierpickingsearch.do?action=display"></iframe>
</div>
<!-- Search Frame Ends -->
  ...
  <div class="roundContent">
    <div class="boxhead"> <%-- boxhead Begins --%>
      ...
      <span id="showlegendLink">
	      <a href="#" onclick="call('showpickingpagelegend'); return false;"><fmt:message key="label.showlegend"/></a> 
      </span>
      <span id="updateResultLink" style="display: none">
       | <a href="#" onclick="call('genPicklist');"><fmt:message key="picklistpicking.generatepicklist"/></a>
      </span>
