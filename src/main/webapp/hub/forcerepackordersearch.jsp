...
<%--<tcmis:form action="/forcerepackorder.do" onsubmit="return submitFrameOnlyOnce();" target="resultFrame">--%>
...
<table id="searchMaskTable" width="900" border="1" cellpadding="0" cellspacing="0">
<tr><td>
    ...
    <table width="100%" border="1" cellpadding="0" cellspacing="0" class="tableSearch">
      <tr>
 	  <tr >      
 		...
 		<td width="15%" class="invisibleClass" type="text" name="inventoryGrp" id="inventoryGrp" value="<c:out value="${status.current.invGroup}"/>" >
		</td>
 	  ...
 	  <tr class="alignLeft">   
        ...
        <td width="85%" class="optionTitleLeft" colspan="6"> 		
