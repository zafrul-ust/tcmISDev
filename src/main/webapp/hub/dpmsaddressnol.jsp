...
<c:out value="${custPoAddressChangeViewBeanCollection[0].originalTransactionType}"/>
        ...
        <td>
            <c:if test="${custPoAddressChangeViewBeanCollection[0].milstripCode == null}">
                <input name="milstripCode" id="milstripCode" class="inputBox" size="14" type="text">
            </c:if>
            <c:if test="${custPoAddressChangeViewBeanCollection[0].milstripCode != null}">
...
<c:out value="${custPoAddressChangeViewBeanCollection[0].shippingNotes}"/>
        ...
        <input name="addressChangeRequestId" id="addressChangeRequestId" value="<c:out value="${addressChangeRequestId}"/>" type="hidden" >
          <input name="dodaac" id="dodaac" type="hidden" value="<c:out value="${custPoAddressChangeViewBeanCollection[0].origShipToDodaac}"/>">
...
<c:out value="${custPoAddressChangeViewBeanCollection[0].mfAddressLine4Display}"/>
      ...
      <tr>
      <td>
<input name="submitSearch" id="submitSearch" type="submit" value="<fmt:message key="label.search"/>" class="inputBtns" onmouseover="this.className='inputBtns inputBtnsOver'" onmouseout="this.className='inputBtns'" onclick="submitSearchForm('nol'); return false;">

</td>
     <td>
<input name="submitUpdate" id="submitUpdate" type="submit" value="<fmt:message key="label.update"/>" class="inputBtns" onmouseover="this.className='inputBtns inputBtnsOver'" onmouseout="this.className='inputBtns'" onclick="submitUpdateForm();">

</td>
      <td>
<input name="submitNew" id="submitNew" type="submit" value="<fmt:message key="label.newaddress"/>" class="inputBtns" onmouseover="this.className='inputBtns inputBtnsOver'" onmouseout="this.className='inputBtns'" onclick="submitNewForm('nol'); return false;">
