...
<title>
<fmt:message key="label.itemweights"/>
</title>
...
<!-- action=start is there to decide in the action to query the database for the drop down in the search section.
 ...
 -->
 <iframe id="searchFrame" name="searchFrame" width="300" height="100" frameborder="0" marginwidth="0" style="" src="itemweightsearch.do"></iframe>
</div>
<!-- Search Frame Ends -->
