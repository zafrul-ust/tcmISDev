...
{		
	var loc = "/tcmIS/hub/printlabelpdf.do?packingGroupId="+$v('packingGroupId');
	openWinGeneric(loc,"printlabelpdf","600","500","yes","50","50");
...
<body bgcolor="#ffffff" onload="document.getElementById('packingGroupId').focus();" >
...
<tcmis:form action="/printlabelpdf.do" onsubmit="return submitSearchOnlyOnce();" target="resultFrame">
 ...
 <div class="roundright">
   ...
   <div class="roundContent">
    ...
    <tr>        
	  ...
	  <td  class="optionTitleBoldRight">Packing Group Id:</td>
        <td nowrap class="optionTitleBoldLeft">         
            <input name="packingGroupId" id="packingGroupId" type="text" class="inputBox" size="15" onkeypress="return onKeyPress();"/>
    </td>          
    </tr>
    <tr>
     <td colspan="4"  class="optionTitleBoldLeft" nowrap>
          <input name="submitSearch" type="button" class="inputBtns" value="Show PDF" id="submitSearch" onmouseover="this.className='inputBtns inputBtnsOver'" onMouseout="this.className='inputBtns'"
          		 onclick= "openNewSpecWin();"/>&nbsp;
      </td>
       </tr>      
    </table>
...
<input type="hidden" name="uAction" id="uAction" value="init"/>
...
<div id="showLegendArea" style="display: none;overflow: auto;">
  <table width=100% class="tableResults" border="0" cellpadding="0" cellspacing="0">
    <tr><td width="50px" class=""></td><td width="50px" class="alt"></td></td><td class="legendText"><fmt:message key="label.knowspecsassociatedwithitem"/></td></tr>
    <tr><td width="100px" class="yellow legendText" colspan="2"><td class="legendText"><fmt:message key="label.knowspecsnotassociatedwithitem"/></td></tr>
  </table>
</div>
<%-- show legend Ends --%>
</body>
