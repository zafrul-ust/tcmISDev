...
<title>
<fmt:message key="shipmenthistory.title"/>
</title>
...
<!-- action=start is there to decide in the action to query the database for the drop down in the search section.
 ...
 -->
 <iframe id="searchFrame" name="searchFrame" width="900" height="170" frameborder="0" marginwidth="0" style="" src="shipmenthistorysearch.do?pageid=${param.pageid}"></iframe>
</div>
<!-- Search Frame Ends -->
    ...
    <div class="boxhead"> <%-- boxhead Begins --%>
     <%-- Place all update links in divs that can be turned on or off depending on the search criteria that is selected
      ...
      <span id="updateResultLink" style="display:">
        ...
        | <a href="#" onclick="call('consolidate'); return false;"><fmt:message key="label.printpackinglist"/></a>
        | <a href="#" onclick="call('consolidateBol'); return false;"><fmt:message key="shipmenthistory.button.consolidatedbol"/></a>
      </span>
      <span id="updateInvoiceLink" style="display:none">
        |  <a href="#" onclick="call('printInvoice'); return false;"><fmt:message key="label.printinvoice"/></a>        
      </span>
