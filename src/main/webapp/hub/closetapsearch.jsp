...
<%--<tcmis:form action="/closetap.do" onsubmit="return submitFrameOnlyOnce();" target="resultFrame">--%>
   ...
   <div class="roundContent">
    ...
    <table width="100%" border="1" cellpadding="0" cellspacing="0" class="tableSearch">
      <tr>
    	 ...
    	 <td width="80%" class="optionTitleBoldLeft" colspan="2"><c:out value="${status.current.tapId}"/></td>		
 	  </tr>  
 	  ...
 	  <tr class="alignLeft">     
        ...
        <td width="20%" class="optionTitleLeft"> 		
			<input name="closeTap" id="closeTap" type="button" value="<fmt:message key="label.closetap"/>" class="inputBtns" onmouseover="this.className='inputBtns inputBtnsOver'" onmouseout="this.className='inputBtns'">
 		</td>      
