...
<%--<tcmis:form action="/reversetap.do" onsubmit="return submitFrameOnlyOnce();" target="resultFrame">--%>
...
<table id="searchMaskTable" width="800" border="1" cellpadding="0" cellspacing="0">
<tr><td>
   ...
   <div class="roundContent">
    ...
    <table width="100%" border="1" cellpadding="0" cellspacing="0" class="tableSearch">
      <tr>
		...
		<td width="45%" class="optionTitleLeft" colspan="2">       		
   			<input class="inputBox" type="text" name="searchArgument" id="searchArgument" size="20">
 		</td>
 	  </tr>  
 	  <tr class="alignLeft">   
 		<td width="20%" class="optionTitleBoldRight">
  			<fmt:message key="label.tapid"/>
 		</td>	     
 		<td width="20%" class="invisibleClass" type="text" name="undotapid" value="" readonly>
 	  ...
 	  <tr class="alignLeft">      
        ...
        <td width="20%" class="optionTitleLeft"> 		
			<input name="reverseTap" id="reverseTap" type="button" value="<fmt:message key="label.reverseselectedtap"/>" class="inputBtns" onmouseover="this.className='inputBtns inputBtnsOver'" onmouseout="this.className='inputBtns'">
 		</td>      
