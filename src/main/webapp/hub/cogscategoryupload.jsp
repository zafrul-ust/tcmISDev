...
date:"<fmt:message key="label.date"/>",pleaseuploadcsvfile:"<fmt:message key="label.pleaseuploadcsvfile"/>",type:"<fmt:message key="label.type"/>",submitOnlyOnce:"<fmt:message key="label.submitOnlyOnce"/>"};
...
function validateFileExtension() {
    var documentName = $v("theFile");
    var splitResults = documentName.split(".");

    if(documentName != null && splitResults[splitResults.length-1] != "csv") {
        alert(messagesData.pleaseuploadcsvfile);
...
<title>
 <fmt:message key="label.cogscategoryuploadfile"/>
</title>
</head>
...
<tcmis:form action="/cogscategoryupload.do" onsubmit="return submitOnlyOnce();" enctype="multipart/form-data">
