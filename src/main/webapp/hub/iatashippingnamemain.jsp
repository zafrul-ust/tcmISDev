...
<!-- Add any other javascript you need for the page here -->
<script type="text/javascript" src="/js/hub/iatashippingnamemain.js"></script>

<title>
<fmt:message key="label.iatashippingnames"/>
</title>
...
var technicalNameRequired=null;
var shippingNameCount = null;
var cOnlyComment = null;
var cOnlyG	= null;
var	cOnlyMaxNetQtyPerPkg = null;
var cOnlyMaxNetUnitPerPkg = null;
var cOnlyMaxNetValPerPkg = null;
var cOnlyPkgInstr = null;
var	ergCode = null;
var hazardLabel = null;		
var pCComment = null;
var pCG	= null;
var pCLtdQtyG = null;
var	pCLtdQtyMazNetQtyPerPkg = null;
var	pCLtdQtyMaxNetUntPerPkg = null;
var pCLtdQtyMaxNetValPerPkg	 = null;
var pCLtdQtyPkgInstr = null;
var	pCMaxNetQtyPerPkg = null;
var pCMaxNetUnitPerPkg = null;
var	pCMaxNetValPerPkg = null;
var pCPkgInstr = null;
var pickable = null;
var	properShippingNameDesc = null;
...
<body bgcolor="#ffffff" onload="loadLayoutWin('','iataShippingInfo');mainOnload();try{document.getElementById('searchArgument').focus()}catch(ex){}" onunload="try{opener.closeTransitWin();}catch(ex){}"  onresize="resizeFrames()">
...
<tcmis:form action="/iatashippingnameresults.do" onsubmit="return submitFrameOnlyOnce();" target="resultFrame">
