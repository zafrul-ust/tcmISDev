...
<script type="text/javascript" src="/js/hub/picklistpickingmain.js"></script>
...
<body bgcolor="#ffffff"    onload="loadLayoutWin('','${param.pageid}');setDropDowns();" onresize="resizeFrames()">
...
<tcmis:form action="/picklistpickingresults.do" onsubmit="return submitSearchOnlyOnce();" target="resultFrame">
     ...
     <td width="5%" class="optionTitleBoldRight">&nbsp;</td>
       ...
       &nbsp;
        ...
        <td width="5%" class="optionTitleBoldLeft" nowrap>
          ...
          <html:select property="sortBy" styleId="sortBy" styleClass="selectBox" value="prNumber">            
  ...
  <div class="roundContent">
    <div class="boxhead"> <%-- boxhead Begins --%>
     <%-- Place all update links in divs that can be turned on or off depending on the search criteria that is selected
      ...
      <span id="showlegendLink"> <a href="#" onclick="showpickingpagelegend(); return false;"><fmt:message key="label.showlegend"/></a> </a></span>
      <span id="updateResultLink" style="display:none">| 
      <a href="#" onclick="call('genPicklist');"><fmt:message key="picklistpicking.generatepicklist"/></a></span>
      </div>
    </div> <%-- boxhead Ends --%>
