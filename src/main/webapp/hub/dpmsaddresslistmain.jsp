...
<script type="text/javascript" src="/js/hub/dpmsaddresslistmain.js"></script>
...
<!-- action=start is there to decide in the action to query the database for the drop down in the search section.
 ...
 -->
 <iframe id="searchFrame" name="searchFrame" width="100%" height="120" frameborder="0" marginwidth="0" style="" src="dpmsaddresslistsearch.do?locationType=${param.locationType}&dodaac=${param.dodaac}&dodaacType=${param.dodaacType}"></iframe>
</div>
<!-- Search Frame Ends -->
...
<div class="roundright">
  ...
  <div class="roundContent">
    <div class="boxhead"> <%-- boxhead Begins --%>
     <%-- Place all update links in divs that can be turned on or off depending on the search criteria that is selected
      ...
      <span id="updateResultLink" style="display: none">        
            ...
            <a href="#" onclick="selectAddress('<c:out value="${param.locationType}"/>'); return false;"><fmt:message key="label.ok"/></a>
    ...
    <div class="dataContent">
     <iframe id="resultFrame" name="resultFrame" width="100%" height="250" frameborder="0" marginwidth="0" src="dpmsaddresslistresults.do?submitSearch=search&locationType=${param.locationType}&dodaacType=${param.dodaacType}&dodaac=${param.dodaac}"></iframe>
   </div>
