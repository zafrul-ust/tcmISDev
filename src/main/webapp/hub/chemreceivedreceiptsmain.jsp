...
<title>
<c:choose>
  <c:when test="${empty param.receivedReceipts}" >
...
<body bgcolor="#ffffff" onresize="resizeFrames()" onunload="closeAllchildren();">
...
<!-- action=start is there to decide in the action to query the database for the drop down in the search section.
 ...
 -->  
 <iframe id="searchFrame" name="searchFrame" width="100%" height="90" frameborder="0" marginwidth="0" style="" src="showchemreceivedreceiptssearch.do?userAction=search&justReceived=${param.justReceived}&receivedReceipts=${param.receivedReceipts}&sourceHub=${param.sourceHub}&inventoryGroup=${param.inventoryGroup}"></iframe>
</div>
<!-- Search Frame Ends -->
  ...
  <div class="roundContent">
    <div class="boxhead"> <%-- boxhead Begins --%>
     <%-- Place all update links in divs that can be turned on or off depending on the search criteria that is selected
      ...
      <span id="legendLink" style="">
         <a href="#" onclick="openWinGeneric('/tcmIS/help/receivingpagelegend.html','receivingpagelegend','290','310','no','50','50'); return false;"><fmt:message key="label.Legend"/></a> |
      </span>
      <span id="updateResultLink" style="display: none">
        <tcmis:inventoryGroupPermission indicator="true" userGroupId="ReceivingQC">
         <a href="#" onclick="call('changeItem'); return false;"><fmt:message key="label.changeitem"/></a> |
        </tcmis:inventoryGroupPermission>
      </span>
      <span id="printLink" style="">
         <a href="#" onclick="call('printResults'); return false;"><fmt:message key="label.print"/></a> |
      </span>
