...
<title>
<fmt:message key="label.uploadminmaxdata"/>
</title>
...
function showExample() {
    openWinGeneric("/template/ManualMinMaxTemplate.xls","uploadMinMaxExample","250","150","yes","80","80");
}
...
function submitRequest() {
    ...
    else if($("documentName") != null && (splitResults[splitResults.length-1] != "xls" && splitResults[splitResults.length-1] != "XLS") ) {
...
<body bgcolor="#ffffff"  onload="newListWinClose();" onunload="try{opener.stopPleaseWait();}catch(ex){}">

<tcmis:form action="/uploadminmaxlevel.do" onsubmit="return submitSearchOnlyOnce();" enctype="multipart/form-data">
...
<fieldset>
<legend><fmt:message key="label.uploadminmaxdata"/>:</legend>
<table id="searchTable" width="100%" border="0" cellpadding="0" cellspacing="0" class="tableSearch">
   <tr>
     ...
     <td width="85%" class="optionTitleBoldLeft">
      <html:file property="theFile" styleId="theFile" value="c:\uploadminmaxlevel.xls" size="40" styleClass="HEADER"/>
