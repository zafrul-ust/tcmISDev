...
<script type="text/javascript" src="/js/hub/dodaacupdatemain.js"></script>
...
<!-- action=start is there to decide in the action to query the database for the drop down in the search section.
 ...
 -->
 <iframe id="searchFrame" name="searchFrame" width="100%" height="120" frameborder="0" marginwidth="0" style="" src="dodaacupdatesearch.do"></iframe>
</div>
<!-- Search Frame Ends -->
...
<div class="roundright">
  ...
  <div class="roundContent">
    ...
    <a href="#" onclick="updateLocation()"><fmt:message key="label.update"/></a>
    ...
    <div class="dataContent">
     <iframe id="resultFrame" name="resultFrame" width="100%" height="250" frameborder="0" marginwidth="0" src="dodaacupdateresults.do"></iframe>
   </div>
