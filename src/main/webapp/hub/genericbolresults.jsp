...
<th width="2%"><fmt:message key="label.noofunits"/></th>

<th width="2%"><fmt:message key="label.rq"/></th>

<th width="2%"><fmt:message key="label.hazardous"/></th>

<th width="15%"><fmt:message key="label.dot"/></th>
...
<tr class="<c:out value="${colorClass}"/>" id="rowId<c:out value="${status.index}"/>">
	<td width="5%">
		<input type="text" class="inputBox" name="itemId<c:out value="${status.index}"/>" name="itemId<c:out value="${status.index}"/>" value="<c:out value="${status.current.itemId}"/>" size="10"/>
	</td>
	<td width="2%">
		<input type="text" class="inputBox" name="totalQty<c:out value="${status.index}"/>" id="totalQty<c:out value="${status.index}"/>" value="<c:out value="${status.current.totalQty}"/>" size="5"/>
	</td>
	<td width="2%">
		<input type="checkbox" name="rqValue<c:out value="${status.index}"/>" id="rqValue<c:out value="${status.index}"/>" value="<c:out value="${status.current.rqValue}"/>"/>
	</td>
	<td width="2%">
		<input type="checkbox" name="hazardous<c:out value="${status.index}"/>" id="hazardous<c:out value="${status.index}"/>" value="<c:out value="${status.current.hazardous}"/>"/>
	</td>
	<td width="15%">
		<input type="text" class="inputBox" name="dot<c:out value="${status.index}"/>" id="dot<c:out value="${status.index}"/>" value="<c:out value="${status.current.dot}"/>" size="40"/>
	</td>
</tr>
