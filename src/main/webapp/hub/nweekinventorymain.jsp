...
<script type="text/javascript" src="/js/hub/nweekinventorymain.js"></script>
...
<body bgcolor="#ffffff"  onload="loadLayoutWin('','nWeekInv');setOps();" onresize="resizeFrames()">
...
<tcmis:form action="/nweekinventoryresults.do" onsubmit="return submitSearchOnlyOnce();" target="resultFrame">
                ...
                <div class="roundright">
                    ...
                    <div class="roundContent">
                        ...
                        <table width="600" border="0" cellpadding="0" cellspacing="0" class="tableSearch">
                            ...
                            <tr>  <td width="6%" class="optionTitleBoldRight"><fmt:message key="label.hub"/>:</td>
							      <td width="10%">
							         <select name="hub" id="hub" class="selectBox">
							         </select>
							       </td> 
							         
							       <td nowrap colspan="2"  width="6%" class="optionTitleBoldLeft">&nbsp;<fmt:message key="label.onhandlessthan"/>:
							       <input name="searchArgument" id="searchArgument" type="text" value="30" class="inputBox" size="2">
							        &nbsp;
                                  <fmt:message key="label.daysofinventory"/>
                                  </td>
