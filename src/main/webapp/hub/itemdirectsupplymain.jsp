...
<body bgcolor="#ffffff"  onload="loadLayoutWin('<fmt:message key="label.itemdirectsupply"/>','itemDirectSupply');setOps();" onresize="resizeFrames()">
...
<tcmis:form action="/itemdirectsupplyresults.do" onsubmit="return submitSearchOnlyOnce();" target="resultFrame">
                        ...
                        <table width="300" border="0" cellpadding="0" cellspacing="0" class="tableSearch">
                            ...
                            <tr>  <td nowrap width="6%" class="optionTitleBoldRight"><fmt:message key="label.hub"/>:</td>
							      <td  width="5%" class="optionTitleBoldLeft">
							         <select name="hub" id="hub" class="selectBox" onchange="">
							         </select>
							       </td> 
  ...
  <div class="roundContent">
    <div class="boxhead"> <%-- boxhead Begins --%>
     ...
     <div id="mainUpdateLinks" style="display: none"> <%-- mainUpdateLinks Begins --%>
         <span id="additemSpan" style="display: none"> <a href="javascript:addItem()"><fmt:message key="label.additem"/></a></span>
         <span id="deleteitemSpan" style="display: none"><a href="#" onclick="call('doDelete');return false;">|&nbsp<fmt:message key="label.delete"/></a></span>
