...
<title>
<fmt:message key="label.inventorydetails"/> <fmt:message key="label.foritem"/>: <c:out value="${param.itemId}"/>
</title>
...
<!-- action=start is there to decide in the action to query the database for the drop down in the search section.
 ...
 -->
 <iframe id="searchFrame" name="searchFrame" style="display: none" width="100%" height="50" frameborder="0" marginwidth="0" style="" src="/blank.html"></iframe>
</div>
<!-- Search Frame Ends -->
...
<%--      <span id="showlegendLink">
    ...
    <div class="dataContent">
     <iframe id="resultFrame" name="resultFrame" width="100%" height="250" frameborder="0" marginwidth="0" 
 		 	 src="/tcmIS/hub/inventorydetailsresults.do?itemId=<c:out value="${param.itemId}"/>&hub=<c:out value="${param.hub}"/>"></iframe>
    </div>
