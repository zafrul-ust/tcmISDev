...
<%--<tcmis:form action="/mrallocation.do" onsubmit="return submitFrameOnlyOnce();" target="resultFrame">--%>
    ...
    <table width="100%" border="1" cellpadding="0" cellspacing="0" class="tableSearch">
      <tr>
 		<td width="15%" class="optionTitleBoldRight">
  			<fmt:message key="label.mrnumbers"/>:
 		</td>
		<td width="85%" class="optionTitleLeft" colspan="2">       		
   			<input class="inputBox" type="text" name="mrNumbers" id="mrNumbers" size="80">
 		</td>
 	  <tr>  
 	  <tr class="alignLeft">      
 		<td width="15%" >
        ...
        <td width="85%" class="optionTitleLeft" > 		
  			<fmt:message key="label.youcanentermultipleetcmsg"/>.
 		</td>       
 	  </tr>  
