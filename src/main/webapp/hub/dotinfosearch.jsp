...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableSearch">
	<tr>
		...
		<td width="20%" class="optionTitleLeft">
			<input type="text" name="itemId" id="itemId" value="" size="19" class="inputBox"/>
		</td>
		<td width="5%"/>
	</tr>
	<tr>
	...
	<tr>
		<td class="optionTitleBoldRight" width="5%">
			<fmt:message key="label.final"/> <fmt:message key="label.shipping"/> <fmt:message key="label.name"/>:
		</td>
		<td colspan="3" width="20%"/>
	</tr>
	<tr>
		<td width="5%" class="optionTitleRigth">
			<input class="inputBtns" onmouseover="this.className='inputBtns inputBtnsOver'" onmouseout="this.className='inputBtns'" type="submit" value="<fmt:message key="label.search"/>" name="search"/>
		</td>
		<td width="5%" class="optionTitleBoldRight">
			<input type="button" class="inputBtns" onmouseover="this.className='inputBtns inputBtnsOver'" onmouseout="this.className='inputBtns'" name="showFinalShip" value="<fmt:message key="label.ship"/> <fmt:message key="label.name"/>"/>
		</td>
		<td width="20%"/>
	</tr>
</table>
