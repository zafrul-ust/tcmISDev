...
<script type="text/javascript" src="/js/hub/packshipconfirmmain.js"></script>
...
messagesData={alert:"<fmt:message key="label.alert"/>",
	...
	missingdata:"<fmt:message key="label.packshipconfirm.missingdata"/>",
...
<!-- action=start is there to decide in the action to query the database for the drop down in the search section.
 ...
 -->
 <iframe id="searchFrame" name="searchFrame" width="100%" height="120" frameborder="0" marginwidth="0" style="" src="packshipconfirmsearch.do"></iframe>
</div>
<!-- Search Frame Ends -->
    ...
    <div class="boxhead"> <%-- boxhead Begins --%>
     <%-- Place all update links in divs that can be turned on or off depending on the search criteria that is selected
      ...
      <div id="mainUpdateLinks" style="display: none"> <%-- mainUpdateLinks Begins --%>
        <span id="updateResultLink" style="display: none"><a href="#" onclick="submitUpdate(); return false;"><fmt:message key="label.updateshipment"/></a></span>
	      <span id="shipConfirmResultLink" style="display: none"> | <a href="#" onclick="confirmShipment(); return false;"><fmt:message key="label.confirmshipment"/></a> </span>
        <span id="reprintPalletMslResultLink" style="display: none"> | <a href="#" onclick="reprintPalletMsl(); return false;"><fmt:message key="label.reprintpalletmsl"/></a></span>
        <span id="WAWFInsRequestLink" style="display: none"> | <a href="#" onclick="requestWAWFInsRequest(); return false;"><fmt:message key="label.requestorigininspection"/></a></span>
        <span id="printHazardousLink" style="display: none"> | <a href="#" onclick="printHazardousGoodsManifest(); return false;"><fmt:message key="label.printhazardousgoodsmanifest"/></a></span>
