...
<tcmis:form action="/itemweightresults.do" onsubmit="return submitFrameOnlyOnce();" target="resultFrame">
 ...
 <div class="roundright">
   ...
   <div class="roundContent">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableSearch">
				<tr>
					<td width="5%" class="optionTitleBoldRight"><fmt:message key="label.partnsn" />:</td>
					<td width="3%" class="optionTitleBoldLeft"><input class="inputBox" type="text" name="nsn"
						id="nsn" size="20" onkeypress="return onKeyPress()">
					</td>
				</tr>
				<tr>
					<td width="5%" class="optionTitleBoldRight"><input name="submitSearch" id="submitSearch" type="button"
