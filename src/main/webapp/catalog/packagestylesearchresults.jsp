...
<script type="text/javascript" src="/js/catalog/packagestylesearch.js"></script>
...
selectedPackageStyle:"<fmt:message key="label.selectedpackagestyle"/>",
selectedRowMsg:"<fmt:message key="label.returnselecteddata"/>"};

var config = [
  {
  	columnId:"pkgStyle",
  	columnName:'<fmt:message key="label.packagestyle"/>',
  	width:35
  }
  ];
...
<tcmis:form action="/packagestylesearchresults.do" onsubmit="return submitFrameOnlyOnce();">

<div class="interface" id="resultsPage">
<div class="backGroundContent">
<c:set var="dataCount" value='${0}'/>

<c:if test="${!empty packageStyleBeanCollection}" >
...
var jsonData = {
rows:[
<c:forEach var="bean" items="${packageStyleBeanCollection}" varStatus="status">
