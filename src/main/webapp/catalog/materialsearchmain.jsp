...
<body bgcolor="#ffffff" onload="loadLayoutWin('','materialSearch');myInit()" onunload="opener.stopShowingWait();"  onresize="resizeFrames()">
			...
			<div class="contentArea">
				<tcmis:form action="/materialsearchresults.do" onsubmit="return submitSearchOnlyOnce();" target="resultFrame">
					...
					<div id="hiddenElements" style="display: none;">
						...
						<input type="hidden" name="excludeMaterialIds" id="excludeMaterialIds" value='<tcmis:jsReplace value="${param.excludeMaterialIds}"/>'/>
					</div>
				</tcmis:form>
			</div> 
		</div>
