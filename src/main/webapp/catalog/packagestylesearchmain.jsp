...
<body bgcolor="#ffffff" onload="loadLayoutWin('','packStyleSearch');document.getElementById('searchArgument').focus();" onresize="resizeFrames()">
...
<tcmis:form action="/packagestylesearchresults.do" onsubmit="return submitSearchOnlyOnce();" target="resultFrame">
