...
<body bgcolor="#ffffff" onload="loadLayoutWin('','replacementPartSearch');" onresize="resizeFrames()" onunload="try{opener.closeTransitWin();}catch(ex){}">
...
<tcmis:form action="/replacementpartsearchresults.do" onsubmit="return submitSearchOnlyOnce();" target="resultFrame">
...
<table width="100%" id="searchTable" border="0" cellpadding="0" cellspacing="0" class="tableSearch">
	...
	<tr>
		...
		<td>
          <input name="createExcel" type="button" class="inputBtns" value="<fmt:message key="label.createexcel"/>" id="createExcel" onmouseover="this.className='inputBtns inputBtnsOver'" onMouseout="this.className='inputBtns'"
