...
<body bgcolor="#ffffff" onload="loadLayoutWin('','flowdownSearch');" onresize="resizeFrames()" onunload="checkClose()">
...
<tcmis:form action="/flowdownsearchresults.do" onsubmit="return submitSearchOnlyOnce();" target="resultFrame">
