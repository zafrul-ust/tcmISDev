...
<c:if test="${!empty param.fileNames}">
	<meta http-equiv="Refresh" content="0; url=<c:out value="haasdocsmain.do?type=${param.type}&fileNames=${param.fileNames}" />">
</c:if>
<c:if test="${!empty param.prNumber || !empty param.shipmentId}">
	<meta http-equiv="Refresh" content="0; url=<c:out value="haasdocsmain.do?type=${param.type}&prNumber=${param.prNumber}&shipmentId=${param.shipmentId}" />">
</c:if>
</head>
...
<body bgcolor="#ffffff">
  ...
  <c:choose>
   <c:when test="${empty param.fileNames  && empty param.prNumber  && empty param.shipmentId}">
