...
<title><fmt:message key="dana.hub.home"/></title>
</head>
...
<%--
    <TR>
     <TD width="10%" align="CENTER">
       <input CLASS="SUBMIT" onmouseover="className='SUBMITHOVER'" onMouseout="className='SUBMIT'" type="submit" value="Log Out" name="Login">
     </TD>
    </TR>
    <TR>
     <TD width="10%" HEIGHT="50" align="CENTER" valign="BOTTOM">
       <A HREF="/tcmIS/Invoice/ChangePassword?whichHome=Hub" STYLE="color:#e86915">Change Password</A>
     </TD>
    </TR>
--%>
    <TR><TD>&nbsp;</TD></TR>
...
<html:link style="color:#e86915" forward="showmonthlyinventorydetail">
 Dana&nbsp;<fmt:message key="monthlyinventorydetail.title"/>
</html:link>
</TD>

<TD ALIGN="CENTER" onmouseover="className='menuh1'" onMouseout="className='menu1'" width="33%" height="30">
<html:link style="color:#e86915" forward="showusagetrend">
