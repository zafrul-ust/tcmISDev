...
<logic:present name="personnelBean">
  <logic:present name="StatusBean">
    <table width='100%'>
    <tr>
       <logic:iterate id="header" name="StatusBean" property="headersIter" type="HeaderBean">
       <td class="heading"><bean:write name="header" property="header"/></td>
       </logic:iterate>
    </tr>

    <logic:iterate id="row" name="StatusBean" property="rowsIter" type="RowViewBean">
    <tr>
