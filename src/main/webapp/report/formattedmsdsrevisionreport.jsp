...
<tcmis:form action="/formattedmsdsrevisionreport.do" onsubmit="return submitOnlyOnce();">
...
<html:hidden property="submitValue" styleId="submitValue" value=""/>
   <td class="optionTitleLeft" colspan="2">
      <html:button property="submitReport" styleClass="inputBtns" onmouseover="this.className='inputBtns inputBtnsOver'" onmouseout="this.className='inputBtns'"  onclick="generateMsdsReportAudit();">
