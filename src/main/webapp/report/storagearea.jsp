...
<script type="text/javascript" src="/js/report/storagearea.js"></script>
...
<title>
<fmt:message key="label.storagearea"/>
</title>
...
returnselectedvalues:"<fmt:message key="label.returnselectedvalues"/>",
...
<!--
 var gridConfig = {
	divName:'storageAreaBean', // the div id to contain the grid.
...
{ columnId:"storageAreaDesc",
  columnName:'<fmt:message key="label.storagearea"/>',
  tooltip:true,
  width:16
},
{ columnId:"storageAreaId"
},
{ columnId:"order"
},
{columnId:"facilityId"
    ...
    <div class="boxhead"> <%-- boxhead Begins --%>
     <%-- Place all update links in divs that can be turned on or off depending on the search criteria that is selected
      ...
      <div id="mainUpdateLinks"> 
      	<span id='selectedStorageAreaSpan'></span>
...
<div id="storageAreaBean" style="height:400px;display: none;" ></div>
<c:if test="${storageAreaCollection != null}" >

<%--NEW - storing the data to be displayed in the grid in a JSON.--%>
<c:set var="dataCount" value='${0}'/>
<c:if test="${!empty storageAreaCollection}" >
    <script type="text/javascript">
    <!--
        ...
        { id:${status.index +1},
         data:[
         'Y','',
  		 '<tcmis:jsReplace value="${bean.storageAreaDesc}" processMultiLines="true"/>',
  		 '${bean.storageAreaId}','',
  		 '${bean.facilityId}',
  		 '${bean.areaId}',
  		 '${bean.buildingId}',
...
<input name="StorageAreaIdString" id="StorageAreaIdString" value="${param.StorageAreaIdString}" type="hidden"/>
