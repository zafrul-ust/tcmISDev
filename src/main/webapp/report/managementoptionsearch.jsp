...
<script src="/js/report/managementsearch.js" language="JavaScript"></script>
...
<title>
<fmt:message key="managementoptionsearch.title"/>
</title>
...
selectvalue:"<fmt:message key="label.selectvalue"/>",
...
<tcmis:form action="/managementoptionsearch.do" onsubmit="return submitOnlyOnce();">
...
<tr><td class="optionTitleBoldCenter" colspan="3"><fmt:message key="managementoptionsearch.title"/></td></tr>
<tr>
...
<tr>
   <td  class="optionTitleBoldRight"><fmt:message key="managementoptionsearch.label.selectedmanagementoption"/></td>
...
<c:if test="${vvWasteManagementOptionBeanCollection != null}" >
...
<div class="roundright">
  ...
  <div class="roundContent">
    ...
    <c:forEach var="vvWasteManagementOptionBean" items="${vvWasteManagementOptionBeanCollection}" varStatus="status">
   ...
   <tr>
      <th width="5%" height="25"><fmt:message key="managementoptionsearch.label.managementoption"/></th>
   ...
   <tr onclick="selectValue('<c:out value="${status.current.managementOption}"/>', '<c:out value="${status.current.managementOptionDesc}"/>')"
       class="<c:out value="${colorClass}"/>" id="rowId<c:out value="${status.index}"/>">
     <td width="5%"><c:out value="${status.current.managementOption}"/></td>
     <td width="5%"><c:out value="${status.current.managementOptionDesc}"/></td>
   </tr>
...
<c:if test="${empty vvWasteManagementOptionBeanCollection}" >
<c:if test="${vvWasteManagementOptionBeanCollection != null}" >
