...
<script type="text/javascript" src="/js/report/openpicksmain.js"></script>
...
<body bgcolor="#ffffff"  onload="loadLayoutWin('<fmt:message key="openpicks.title"/>','openPicks');setOps();" onresize="resizeFrames()">
...
<tcmis:form action="/openpicksresults.do" onsubmit="return submitSearchOnlyOnce();" target="resultFrame">
...
<table id="searchMaskTable" width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
        <td>
			...
			<%-- 				         
							       <td nowrap width="2%" class="optionTitleBoldRight">&nbsp;
							       <fmt:message key="label.picklistid"/>:   
							        </td>
							        <td width="5%" colspan="2"  class="optionTitleBoldLeft">							       
							         <select name="picklistId" id="picklistId" class="selectBox">
							         </select>							         
							      </td>	
							       <td width="5%" class="optionTitleLeft"></td>
							       <td width="5%" class="optionTitleLeft"></td>   --%>
