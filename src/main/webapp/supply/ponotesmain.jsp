...
<script type="text/javascript" src="/js/supply/ponotesmain.js"></script>
...
<!-- action=start is there to decide in the action to query the database for the drop down in the search section.
 ...
 -->
 <iframe id="searchFrame" name="searchFrame" width="100%" height="200" frameborder="0" marginwidth="0" style="" 
 		 src="ponotessearch.do?phase=<c:out value="${param.phase}"/>&pONumber=<c:out value="${param.pONumber}"/>"> 
 </iframe>
</div>
<!-- Search Frame Ends -->
...
<%--      <span id="showlegendLink">
    ...
    <div class="dataContent">
     <iframe id="resultFrame" name="resultFrame" width="100%" height="100%" frameborder="0" marginwidth="0" 
     	src="ponotesresults.do?phase=<c:out value="${param.phase}"/>&pONumber=<c:out value="${param.pONumber}"/>"></iframe>
   </div>
