...
<tcmis:form action="/ponotesresults.do" onsubmit="return submitFrameOnlyOnce();" target="resultFrame">
...
<div class="roundcont filterContainer">
 <div class="roundright">
   <div class="roundtop">
     <div class="roundtopright"> <img src="/images/rndBoxes/borderTL_filter.gif" alt="" width="10" class="corner_filter" style="display: none" /></div>
   </div>
   <div class="roundContent">
	...
	<tr>
		...
		<td width="95%" colspan="2" class="optionTitleLeft">
		  <c:out value="${param.pONumber}"/></td>		
	</tr>
	<tr>
		<td width="5%" class="optionTitleBoldRight" valign="top">
			<fmt:message key="label.note"/>:
		</td>
		<td width="95%" colspan="2">
			<textarea name="note" id="note" rows="6" cols="100" class="inputBox"></textarea>
		</td>
	</tr>
	<tr>
	    <td width="5%">&nbsp;</td>
		<td class="optionTitleLeft" width="95%">
