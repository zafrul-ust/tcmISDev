...
<title>
<fmt:message key="label.emailpad"/>
</title>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableSearch">
	<tr>
		<td width="5%" class="optionTitleBoldRigth">
			<fmt:message key="label.email"/> <fmt:message key="label.notes"/>:
		</td>
		<td width="50%" colspan="2">
			<textarea name="comment" id="comment" rows="12" cols="100" class="inputBox"></textarea>
		</td>
	</tr>
	<tr>
		<td class="optionTitleLeft">
			<input class="inputBtns" onmouseover="this.className='inputBtns inputBtnsOver'" onmouseout="this.className='inputBtns'" type="submit" value="<fmt:message key="label.addemailnotes"/>" name="create"/>
		</td>
		<td>
