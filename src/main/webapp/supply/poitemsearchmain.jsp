...
<body bgcolor="#ffffff" onload="loadLayoutWin('','itemSearch');document.genericForm.searchArgument_1.focus();" onunload="closeAllchildren();try{opener.closeTransitWin();}catch(ex){}" >
...
<tcmis:form action="/poitemsearchresults.do" onsubmit="return submitSearchOnlyOnce();" target="resultFrame">
...
<table width="100%" id="searchTable" border="0" cellpadding="0" cellspacing="0" class="tableSearch">
	...
	<tr>
		...
		<td width="5%" colspan="2" class="optionTitleBoldRight" nowrap>
...
<input type="hidden" name="shipToId" id="shipToId" value="${param.shipToId}"/>
<input type="hidden" name="validBPO" id="validBPO" value="${param.validBPO}"/>
