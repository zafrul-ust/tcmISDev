...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableSearch">
	...
	<tr>
		<td width="20%" class="optionTitleBoldRight">
			<fmt:message key="label.searchtext"/> <fmt:message key="label.2"/>:
		</td>
		<td width="40%" class="optionTitleLeft">
			<input class="inputBox" type="text" name="searchText2" id="searchText2" value="" size="40"/>
		</td>
	...
	<tr>	
		...
		<td width="70%" colspan="3">
			<input class="inputBox" type="text" name="itemId" id="itemId" value="" size="10" readonly="readonly"/>
		</td>
	</tr>
	<tr>
		<td>
			<input type="button" class="inputBtns" onmouseover="this.className='inputBtns inputBtnsOver'" onmouseout="this.className='inputBtns'" name="search" value="<fmt:message key="label.search"/>"/>
		</td>
	</tr>
</table>
