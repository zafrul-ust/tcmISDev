...
<script type="text/javascript" src="/js/supply/potextbe.js"></script>
...
<tcmis:form action="/potextberesults.do" onsubmit="return submitFrameOnlyOnce();" target="resultFrame">
   ...
   <div class="roundContent">
	...
	<tr>
		...
		<td width="92%" colspan="2">
					<textarea name="email" id="email" rows="12" cols="100" class="inputBox">
			</textarea>
		</td>
	</tr>
	<tr>
