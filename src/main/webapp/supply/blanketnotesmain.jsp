...
<script type="text/javascript" src="/js/supply/blanketnotesmain.js"></script>
...
<!-- action=start is there to decide in the action to query the database for the drop down in the search section.
 ...
 <iframe id="searchFrame" name="searchFrame" width="100%" height="150" frameborder="0" marginwidth="0" style="" 
 		 src="blanketnotessearch.do?phase=<c:out value="${param.phase}"/>&pONumber=<c:out value="${param.pONumber}"/>"> 
 </iframe>
</div>
<!-- Search Frame Ends -->
...
<%--      <span id="showlegendLink">
    ...
    <div class="dataContent">
     <iframe id="resultFrame" name="resultFrame" width="100%" height="600" frameborder="0" marginwidth="0" 
     	src="blanketnotesresults.do?phase=<c:out value="${param.phase}"/>&pONumber=<c:out value="${param.pONumber}"/>"></iframe>
   </div>
