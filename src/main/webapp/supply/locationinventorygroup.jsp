...
<script type="text/javascript" src="/js/supply/locationinventorygroup.js"></script>
...
<body bgcolor="#ffffff"  onload="loadLayoutWin('<fmt:message key="label.inventorygroup"/>','inventoryGroup');" onresize="resizeFrames()">
   ...
   <div class="roundContent">
	...
	<tr>
		...
		<td width="85%" class="optionTitleLeft">
                   ...
                   <html:select property="igArray" styleClass="selectBox" styleId="igArray" multiple="false" size="4">
                      <html:options collection="locationIGViewBeanCollection" property="inventoryGroup"/>
                   </html:select>
	...
	<tr>
		<td width="15%" class="optionTitleBoldRight">
			<input type="button" class="inputBtns" name="okButton" id="okButton" onmouseover="this.className='inputBtns inputBtnsOver'" onmouseout="this.className='inputBtns'" value="<fmt:message key="label.ok"/>" 
				   onclick="selectIG();" />
		</td>
		<td width="85%"/>
	</tr>
