...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableSearch">
	<tr>
		...
		<td width="40%" class="optionTitleLeft">
			<input class="inputBox" type="text" name="searchText" id="searchText" value="hub" size="40"/>
		</td>
	<tr>
		<td width="20%" class="optionTitleBoldRight">
		...
		<td width="70%">
			<input class="inputBox" type="text" name="shipToId" id="shipToId" value="" size="25" readonly="readonly"/>
		</td>
	</tr>
	<tr>
		<td>
