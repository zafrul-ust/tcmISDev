...
<html:html lang="true">
	<head>
		...
		<script type="text/javascript" src="/js/supply/mrcancellationmain.js"></script> 
	...
	-->
	<body bgcolor="#ffffff" onload="loadLayoutWin('','mrcancellation');setOps();" onresize="resizeFrames()">
		<div class="interface" id="mainPage" style="">
			<!-- Search div Begins -->
			<div id="searchFrameDiv">
				<!-- start of contentArea -->
				<div class="contentArea">
					<tcmis:form action="/mrcancellationresults.do" onsubmit="return submitSearchOnlyOnce();" target="resultFrame">
											...
											<div class="roundContent">
												...
												<table width="100%" id="tableSearch" border="0" cellpadding="0" cellspacing="0" class="tableSearch">
												    ...
												    <tr>  	
														...
														<td colspan="4">
															<html:checkbox name="genericForm" styleId="genericForm" property="checkBuyerId" /> &nbsp;&nbsp;<fmt:message key="label.requestneedingmyapproval" />
														</td>
													</tr>
													<tr>
