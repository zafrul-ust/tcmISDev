...
<tcmis:form action="/poemailresults.do" onsubmit="return submitFrameOnlyOnce();" target="resultFrame">
   ...
   <div class="roundContent">
	...
	<tr>
		<td width="5%" class="optionTitleBoldRight" valign="top">
			<fmt:message key="label.emailnote"/>:
		</td>
		<td width="95%" colspan="2">
					<textarea name="email" id="email" rows="12" cols="100" class="inputBox"></textarea>
		</td>
	</tr>
	<tr>
	    <td width="5%" >&nbsp;</td>
		<td class="optionTitleLeft" width="92%">
			<input type="submit" name="submitAddNote" id="submitAddNote" class="inputBtns" onmouseover="this.className='inputBtns inputBtnsOver'" onmouseout="this.className='inputBtns'" 
						value="<fmt:message key="label.addemailnote"/>"  
