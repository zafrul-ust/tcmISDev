...
<title>
<fmt:message key="label.shiptosearch"/>
</title>
...
<th width="15%"><fmt:message key="label.shipto"/> <fmt:message key="label.id"/></th>

<th width="35%"><fmt:message key="label.shipto"/> <fmt:message key="label.description"/></th>

<th width="10%"><fmt:message key="label.facilityid"/></th>

<th width="10%"><fmt:message key="label.company"/> <fmt:message key="label.id"/></th>

<th width="20%"><fmt:message key="label.address"/></th>
...
<td width="15%"><c:out value="${status.current.id}"/></td>

<td width="35%"><c:out value="${status.current.description}"/></td>

<td width="10%"><c:out value="${status.current.facilityId}"/></td>

<td width="10%"><c:out value="${status.current.companyId}"/></td>

<td width="20%"><c:out value="${status.current.address}"/></td>
