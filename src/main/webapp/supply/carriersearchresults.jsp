...
<c:set var="dataCount" value='${0}'/>
 ...
 <%--<c:if test="${!empty pageNameViewBeanCollection}" >--%>
 			<fmt:message key="label.shipper"/> <fmt:message key="label.code"/>:
			<input type="text" class="inputBox" name="shipperCode" id="shipperCode" value="" size="25" readonly="readonly"/>
	</table>
...
<th width="15%"><fmt:message key="label.code"/></th>

<th width="35%"><fmt:message key="label.carrier"/> <fmt:message key="label.name"/></th>

<th width="15%"><fmt:message key="label.company"/>(<fmt:message key="label.hub"/>)</th>

<th width="10%"><fmt:message key="label.shipto"/></th>

<th width="20%"><fmt:message key="label.notes"/></th>
...
<td width="15%"><c:out value="${status.current.code}"/></td>

<td width="35%"><c:out value="${status.current.name}"/></td>

<td width="15%"><c:out value="${status.current.company}"/>(<c:out value="${status.current.hub}"/>)</td>

<td width="10%"><c:out value="${status.current.shipTo}"/></td>

<td width="20%"><c:out value="${status.current.notes}"/></td>
