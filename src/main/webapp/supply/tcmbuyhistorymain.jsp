...
<script type="text/javascript" src="/js/supply/tcmbuyhistorymain.js"></script>
...
<body bgcolor="#ffffff" onload="myMainBodyOnLoad();" onresize="resizeFrames()">
...
<!-- action=start is there to decide in the action to query the database for the drop down in the search section.
 ...
 -->
 <iframe id="searchFrame" name="searchFrame" style="display: none" width="100%" height="50" frameborder="0" marginwidth="0" style="" 
 		 src="/blanksearch.html"></iframe>
</div>
<!-- Search Frame Ends -->
...
<%--      <span id="showlegendLink">
    ...
    <div class="dataContent">
     <iframe id="resultFrame" name="resultFrame" width="100%" height="600" frameborder="0" marginwidth="0" 
     	src="tcmbuyhistoryresults.do?itemId=<c:out value="${param.itemId}"/>">"></iframe>
   </div>
...
<!-- normally these would go in the search jsp - but in this case there is no search jsp... -->
