...
<th width="30"><fmt:message key="label.lne"/></th>

<th width="140"><fmt:message key="label.item"/></th>

<th width="4"><fmt:message key="label.type"/></th>

<th width="70"><fmt:message key="label.needed"/></th>

<th width="40"><fmt:message key="label.promised.ship.date"/></th>

<th width="40"><fmt:message key="label.projecteddeliverydate"/></th>

<th width="40"><fmt:message key="label.qty"/></th>

<th width="100"><fmt:message key="label.uom"/></th>

<th width="40"><fmt:message key="label.unitprice"/></th>

<th width="110"><fmt:message key="label.extprice"/></th>

<th width="30"><fmt:message key="label.qtyrecd"/></th>

<th width="30"><fmt:message key="label.qtyvoc"/></th>

<th width="30"><fmt:message key="label.qtyreturned"/></th>

<th width="60"><fmt:message key="label.status"/></th>

</tr>
<!--  just formateed msg here... -->
    <%--<tr>
