...
<script type="text/javascript" src="/js/supply/posuppliercontactmain.js"></script>
...
<fmt:message key="label.purchaseordersuppliercontact"/>
</td>
...
<!-- action=start is there to decide in the action to query the database for the drop down in the search section.
 ...
 <iframe id="searchFrame" name="searchFrame" width="100%" height="150" frameborder="0" marginwidth="0" style="" 
 		 src="posuppliercontactsearch.do?supplierId=<c:out value="${param.supplierId}"/>"></iframe>
</div>
<!-- Search Frame Ends -->
