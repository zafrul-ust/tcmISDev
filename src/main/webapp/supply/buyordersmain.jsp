...
<script src="/js/supply/buyordersmain.js" language="JavaScript"></script>
...
{ 
  ...
  mrLineNotesAreaTitle.innerHTML = mrLine; 	         
...
<!-- action=start is there to decide in the action to query the database for the drop down in the search section.
 ...
 -->
 <iframe id="searchFrame" name="searchFrame" width="100%" height="200" frameborder="0" marginwidth="0" style="" src="/tcmIS/supply/buyorderssearch.do?action=init"></iframe>
</div>
<!-- Search Frame Ends -->
    ...
    <div class="boxhead"> <%-- boxhead Begins --%>
     <%-- Place all update links in divs that can be turned on or off depending on the search criteria that is selected
      ...
      <span id="showlegendLink">
        <a href="#" onclick="showBuyPageLegend();"><fmt:message key="label.showlegend"/></a>
      </span>
      <span id="updateResultLink" style="display: none">
        | <a href="#" onclick="submitUpdate(); return false;"><fmt:message key="label.update"/></a>
	      <span id="convertPoResultLink" style="display: none">
	        | <a href="#" onclick="submitConvert(); return false;"><fmt:message key="label.converttocustomerpurchase"/></a>
	      </span>
      </span>
		<span id="createPoResultLink" style="display: none">
			<%--
		  | <a href="#" onclick="createPo(); return false;"><fmt:message key="label.createpo"/></a>
		  --%>
      </span>
		&nbsp;
...
<div id="showLegendAreaBody" class="bd">
  ...
  <tr>
    ...
    <td width="20%"><div><fmt:message key="buyorders.legend.supercritical"/></div><div><fmt:message key="label.lddown"/></div></td>
  </tr>
  <tr>
    <td class="red" width="5%">&nbsp;</td>
    <td width="20%"><fmt:message key="buyorders.legend.priority1"/></td>
  </tr>
  <tr>
    <td class="yellow" width="5%">&nbsp;</td>
    <td width="20%"><fmt:message key="buyorders.legend.priority2"/></td>
  </tr>
  <tr>
    <td class="green" width="5%">&nbsp;</td>
    <td width="20%"><fmt:message key="buyorders.legend.priority3"/></td>
  </tr>
  <tr>
    <td class="purple" width="5%">&nbsp;</td>
    <td width="20%"><fmt:message key="buyorders.legend.engineeringevaluation"/></td>
  </tr>
  <tr>
    <td class="lightgray" width="5%">&nbsp;</td>
    <td width="20%"><fmt:message key="buyorders.legend.mxitem"/></td>
  </tr>
  <tr>
    <td class="black" width="5%">&nbsp;</td>
    <td width="20%"><fmt:message key="buyorders.legend.cancel"/></td>
  </tr>
  </table>
</div>
</div>
...
<div id="mrLineNotesArea" class="successMessages" style="display:none;z-index:5;">
<div id="mrLineNotesAreaTitle" class="hd"></div>
<div id="mrLineNotesAreaBody" class="bd">
</div>
</div>
