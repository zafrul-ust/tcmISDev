...
<script type="text/javascript" src="/js/supply/showsuggestedsupplier.js"></script>
...
<title>
<fmt:message key="label.suggestedsupplier"/>
</title>
...
var config = [
              ...
              { 
                  ...
                  columnName:'<fmt:message key="label.contactemail"/>',
                  width:12
              },
              { 
                  columnId:"contactPhone",
                  columnName:'<fmt:message key="label.contactphone"/>',
                  width:5,
                  tooltip:"Y" 
              },
              { 
                  columnId:"supplierPartNo",
                  columnName:'<fmt:message key="label.supplierpartno"/>',
                  width:5,
                  tooltip:"Y" 
              }
          ];
...
<tcmis:form action="/showsuggestedsupplier.do" onsubmit="return submitFrameOnlyOnce();">
...
<c:if test="${suggestedSupplierBeansCol != null}" >

<%--NEW - storing the data to be displayed in the grid in a JSON.--%>
<c:set var="dataCount" value='${0}'/>
<c:if test="${!empty suggestedSupplierBeansCol}" >
    <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="tableResults">       
        <c:set var="dataCount" value='${dataCount+1}'/>
        <c:forEach var="bean" items="${suggestedSupplierBeansCol}" varStatus="status">
           <tr>
               <td class="optionTitleBoldRight" width="15%">Supplier Name:</td>
               <td class="optionTitleBoldLeft" width="15%">${bean.suggestedVendor}</td>
           </tr>
            <tr>
               <td class="optionTitleBoldRight" width="15%">Contact Name:</td>
               <td class="optionTitleBoldLeft" width="15%">${bean.vendorContactName}</td>
           </tr>
           <tr>
               <td class="optionTitleBoldRight" width="15%">Contact Email:</td>
               <td class="optionTitleBoldLeft" width="15%">${bean.vendorContactEmail}</td>
           </tr>
           <tr>
               <td class="optionTitleBoldRight" width="15%">Contact Phone/Fax:</td>
               <td class="optionTitleBoldLeft" width="15%">${bean.vendorContactPhone}/${bean.vendorContactFax}</td>
           </tr>
           <tr>
               <td class="optionTitleBoldRight" width="15%">Supplier Part No:</td>
               <td class="optionTitleBoldLeft" width="15%">${bean.vendorPartNo}</td>
           </tr>
           <c:set var="dataCount" value='${dataCount+1}'/>
       </c:forEach>   
   </table>
