...
<title>
    <fmt:message key="dbuyconsolidationfreq.title"/>
</title>
...
<body bgcolor="#ffffff" onload="loadLayoutWin('','dBuyConsolidationFreq');setOps();" onresize="resizeFrames()" onunload = "closeAllchildren()">
...
<tcmis:form action="/dbuyconsolidationfreqresults.do" onsubmit="return submitSearchOnlyOnce();" target="resultFrame">
...
<div class="roundcont filterContainer">
 <div class="roundright">
   ...
   <div class="roundContent">
    ...
    <tr>
      <td width="8%"  class="optionTitleBoldRight" nowrap><fmt:message key="label.hub"/>:</td>
      <td  class="optionTitleBoldLeft">
    ...
    <tr>
      <td width="8%" class="optionTitleBoldRight" nowrap><fmt:message key="label.inventorygroup"/>:</td>
      <td class="optionTitleBoldLeft">
     ...
     <%-- Place all update links in divs that can be turned on or off depending on the search criteria that is selected
	  ...
	  <div id="mainUpdateLinks" style="display: none"> <%-- mainUpdateLinks Begins --%>
	   <span id="updateResultLink" style="display: none">
         <a href="#" onclick="call('addNew');return false;"><fmt:message key="label.new"/></a> |
         <a href="#" onclick="call('doUpdate');return false;"><fmt:message key="label.update"/></a> |
         <a href="#" onclick="call('doDelete');return false;"><fmt:message key="label.delete"/></a>
      </span>
