...
<tcmis:form action="/blanketnotesresults.do" onsubmit="return submitFrameOnlyOnce();" target="resultFrame">
   ...
   <div class="roundContent">
	...
	<tr>
		...
		<td width="92%" colspan="2">
			<textarea name="note" id="note" rows="5" cols="100" class="inputBox"></textarea>
		</td>
	</tr>
	<tr>
