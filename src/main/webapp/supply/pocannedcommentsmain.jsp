...
<script type="text/javascript" src="/js/supply/pocannedcommentsmain.js"></script>
...
<title>
<fmt:message key="label.purchaseordercannedcomments"/>
</title>
...
<body bgcolor="#ffffff" onload="loadLayoutWin('','cannedCommentsPage');document.genericForm.submit();" onresize="resizeFrames()">
<div class="interface" id="mainPage" style="">
<!-- Search Frame Begins -->
<div id="searchFrameDiv">
<tcmis:form action="/pocannedcommentsresults.do" onsubmit="return submitSearchOnlyOnce();" target="resultFrame">
...
<div class="roundcont filterContainer">
 <div class="roundright">
   ...
   <div class="roundContent">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableSearch"></table>
...
<input type="hidden" name="poLineID" id="poLineID" value="${param.poLineID}" />
...
<div id="errorMessagesAreaBody" class="bd"></div>
</div>
