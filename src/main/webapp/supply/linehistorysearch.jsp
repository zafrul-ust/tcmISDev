...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableSearch">
	<tr>
		<td width="20%" class="optionTitleBoldRight"><fmt:message key="label.po"/>:
		</td>
		<td width="70%">
			<!--  query value -->
		</td>
	...
	<tr>
		<td width="20%" class="optionTitleBoldRight"><fmt:message key="label.po"/> <fmt:message key="label.line"/>:
		</td>
		<td width="70%">
			<!--  query value -->
		</td>
