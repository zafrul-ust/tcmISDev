...
<th width="10%"><fmt:message key="label.catalogid"/></th>

<th width="10%"><fmt:message key="label.partnum"/></th>

<th width="5%"><fmt:message key="label.priority"/></th>

<th width="5%"><fmt:message key="label.status"/></th>

<th width="35%"><fmt:message key="label.itemdesc"/></th>
...
<td width="3%"><c:out value="${status.current.type}"/></td>

<td width="10%"><c:out value="${status.current.catalogId}"/></td>

<td width="10%"><c:out value="${status.current.partNum}"/></td>

<td width="5%"><c:out value="${status.current.priority}"/></td>

<td width="5%"><c:out value="${status.current.status}"/></td>

<td width="35%"><c:out value="${status.current.itemDesc}"/></td>

<td width="15%"><c:out value="${status.current.packaging}"/></td>
