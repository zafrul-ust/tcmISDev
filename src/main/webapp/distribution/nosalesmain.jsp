...
<body bgcolor="#ffffff" onload="loadLayoutWin('','noSales');setOps();" onresize="resizeFrames()">
...
<tcmis:form action="/nosalesresults.do" onsubmit="return submitSearchOnlyOnce();" target="resultFrame">
   ...
   <div class="roundContent">
    ...
    <tr>
      ...
      <td width="10%" class="optionTitleBoldRight" nowrap>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <fmt:message key="label.within"/>&nbsp;<input class="inputBox" type="text" name="notIssuedIn" id="notIssuedIn" value='30' size="3"/>&nbsp;<fmt:message key="label.days"/></td>     
    </tr>
    <tr>
