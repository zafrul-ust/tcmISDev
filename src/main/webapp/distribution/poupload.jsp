...
<title>
<fmt:message key="label.customerpoupload"/>
</title>
...
<tcmis:form action="/poupload.do" onsubmit="return submitOnlyOnce();" enctype="multipart/form-data">
   ...
   <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableSearch">
    ...
    <tr>
     ...
     <td width="85%" class="optionTitleBoldLeft">
      <html:file property="theFile" styleId="theFile" value="c:\po.csv" size="50" styleClass="HEADER"/>
