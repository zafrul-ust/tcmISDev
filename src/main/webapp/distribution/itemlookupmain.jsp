...
<head>
	...
	<script type="text/javascript" src="/js/distribution/itemlookupmain.js"></script>
...
<body bgcolor="#ffffff" onload="loadLayoutWin('','itemLookup'); setOps(); try{document.getElementById('searchText').focus()}catch(ex){};" onresize="resizeFrames()">
	...
	<c:if test="${!empty personnelBean.opsHubIgOvBeanCollection}">
		<c:forEach var="opsEntity" items="${personnelBean.opsHubIgOvBeanCollection}" varStatus="status"> 
				<script language="JavaScript" type="text/javascript">
						opsCurrMap['${opsEntity.opsEntityId}'] = '${opsEntity.homeCurrencyId}';
				</script>
		</c:forEach>
	</c:if>		
				<tcmis:form action="/itemlookupresults.do" onsubmit="return submitSearchOnlyOnce(value);" target="resultFrame">
									   	...
									   	<div class="roundContent">
											...
											<table width="100%" id="searchTable" border="0" cellpadding="0" cellspacing="0" class="tableSearch">
												<tr>
													...
													<td width="*" class="optionTitleLeft">
												...
												<TR>
													...
													<TD class="optionTitleBoldLeft" nowrap colspan=2>
													        <input type="checkbox" name="inCatalog" id="inCatalog" value="true">&nbsp;<fmt:message key="label.itemindistributorcatalog"/>&nbsp;
													</TD>
												</TR>
												<TR>
													...
													<TD class="optionTitleBoldLeft" nowrap colspan=2>
													        <input type="checkbox" name="approvedForGroup" id=""approvedForGroup"" value="true">&nbsp;<fmt:message key="label.approvedforselectedinventorygroups"/>&nbsp;
													</TD>
												</TR>
												<tr>
													<td colspan="4">
					...
					<div id="hiddenElements" style="display: none;">
						...
						<input type="hidden" name="homeCurrency" id="homeCurrency" value=""/>
