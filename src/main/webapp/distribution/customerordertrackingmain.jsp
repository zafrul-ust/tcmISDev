 ...
 <div class="roundright">
   ...
   <div class="roundContent">
    ...
    <tr>
      ...
      <td rowspan="3" width="2%" class="optionTitleBoldRight"><fmt:message key="label.status"/>:</td>
	...
	<c:if test="${sessionScope.personnelBean.openCustomer}">
      ...
      <td nowrap class="optionTitleBoldLeft">
            <select name="searchField"  class="selectBox" id="searchField">                                
                <option value="pr_number" selected><fmt:message key="label.mr"/></option>
                <option value="alternate_name"><fmt:message key="label.catalogitem"/></option>
                <option value="po_number"> <fmt:message key="label.customerpo"/></option>
            </select>
            &nbsp;
