...
<script type="text/javascript" src="/js/distribution/quickcustomerview.js"></script>
...
<title>
<fmt:message key="quickCustomerView"/>
</title>
...
defaults = {
	   ops: {id:'',name:'<fmt:message key="label.pleaseselect"/>'},
   	   hub: {id:'',name:'<fmt:message key="label.pleaseselect"/>'},
   	   inv: {id:'',name:'<fmt:message key="label.pleaseselect"/>'}
}
...
j$().ready(function() {
	function log(event, data, formatted) {
		...
		if(formatted.split(":")[3] != null && formatted.split(":")[3] != "null" && formatted.split(":")[3].length > 0)
			$('abcClassification').innerHTML = messagesData.customerclass+": "+formatted.split(":")[3]+"";
		else
			$('abcClassification').innerHTML = messagesData.customerclass+": "+messagesData.na;
			
		j$('#billToCompanyId').val(formatted.split(":")[4]);
	} 
...
<tcmis:form action="/quickcustomerviewresults.do" onsubmit="return submitSearchOnlyOnce();" >
<!-- Search Frame Begins -->
...
<div class="roundcont filterContainer">
 <div class="roundright">
   ...
   <div class="roundContent">
    ...
    <tr>
	  <td nowrap  width="8%" class="optionTitleBoldLeft" nowrap><fmt:message key="label.invoicingoperatingentity"/>:</td>
	...
	<%-- 
	 ...
	 --%>
	      <td class="optionTitleBoldLeft" colspan="4" nowrap> <fmt:message key="label.customer"/>:&nbsp;
	      	<input type="text" id="customerName" value="" class="inputBox" size="50" /> 
 		 	...
 		 	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 		 	<span id="abcClassification" name="abcClassification"> </span>
	 	  </td>
	 	  <td class="optionTitleBoldLeft" colspan="2" nowrap>
	 		<fmt:message key="label.within"/>
	 		<input name="days" id="days" type="text" class="inputBox" size="5" value="180">
...
<div id="hiddenElements" style="display: none;">
    ...
    <input name="billToCompanyId" id="billToCompanyId" type="text" value="">
