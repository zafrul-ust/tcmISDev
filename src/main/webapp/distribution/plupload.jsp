...
<tcmis:form action="/plupload.do" onsubmit="return submitOnlyOnce();" enctype="multipart/form-data">
...
<td colspan="2" class="optionTitleBoldLeft">
 <input type="submit" name="uploadButton" class="inputBtns" onmouseover="this.className='inputBtns inputBtnsOver'" onmouseout="this.className='inputBtns'"
  ...
  <fmt:message key="label.select" />:
	<select name="pricelistAction" class="selectBox" id="pricelistAction" >
		<option value="new"><fmt:message key="label.createnewpricelist"/></option>
		<option value="update"><fmt:message key="label.updatepricelist" /></option>
	</select>
</td>
</tr>
