...
<script type="text/javascript" src="/js/distribution/addspecspmain.js"></script>
...
<body bgcolor="#ffffff" onload="loadLayoutWin('','addSpecs');mainOnLoad();closeAllchildren();document.getElementById('searchArgument').focus();" onresize="resizeFrames()" onunload="closeAllchildren();" >
...
<tcmis:form action="/addspecsresults.do" onsubmit="return submitSearchOnlyOnce();" target="resultFrame">
 ...
 <div class="roundright">
   ...
   <div class="roundContent">
    ...
    <tr>        
	  ...
	  <td  class="optionTitleBoldRight"><fmt:message key="label.spec"/>:</td>
     ...
     <td colspan="4"  class="optionTitleBoldLeft" nowrap>
          <input name="submitSearch" type="button" class="inputBtns" value="<fmt:message key="label.search"/>" id="submitSearch" onmouseover="this.className='inputBtns inputBtnsOver'" onMouseout="this.className='inputBtns'"
           ...
           <input name="buttonNew" id="buttonNew" type="button"
                                    class="inputBtns" value="<fmt:message key="newspecs.title"/>"
