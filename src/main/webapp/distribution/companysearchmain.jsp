...
<body bgcolor="#ffffff" onload="loadLayoutWin('','companySearch');document.genericForm.searchArgument.focus();" onresize="resizeFrames()">
...
<tcmis:form action="/companysearchresults.do" onsubmit="return submitSearchOnlyOnce();" target="resultFrame">
...
<table width="100%" id="searchTable" border="0" cellpadding="0" cellspacing="0" class="tableSearch">
	<tr>
		...
		<td width="40%" class="optionTitleLeft">
			<input type="hidden" name="searchField" id="searchField" value="companyName" size="25"/>
