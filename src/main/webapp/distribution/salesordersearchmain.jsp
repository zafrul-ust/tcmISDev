...
<script type="text/javascript" src="/js/distribution/salesordermain.js"></script>
...
<body bgcolor="#ffffff" onload="loadLayoutWin('','mrHistory');setOps();" onunload="try{closeAllchildren();}catch(ex){}" onresize="resizeFrames()">
...
<tcmis:form action="/salesordersearchresults.do" onsubmit="return submitSearchOnlyOnce();" target="resultFrame">
    ...
    <tr>
      ...
      <td  width="10%" class="optionTitleBoldLeft">
       ...
       <td rowspan="3" width="10%" class="optionTitleBoldLeft">
        <select name="orderStatus"  class="selectBox" id="orderStatus" onchange="getOrderStatusList();" multiple size="4" >
            <option value=""><fmt:message key="label.all"/></option>
<%--        <option value="Draft"> <fmt:message key="label.draft"/>  </option>   --%>      
            <option value="Open" selected> <fmt:message key="label.open(status)"/>  </option>
    ...
    <td class="optionTitleBoldRight"><fmt:message key="label.orderdate"/>:</td>
	 <td nowrap class="optionTitleBoldLeft">
		 ...
		 <input class="inputBox pointer" readonly type="text" name="orderFromDate" id="orderFromDate" value="<tcmis:getDateTag numberOfDaysFromToday="-30" datePattern="${dateFormatPattern}"/>" 
		 	onClick="return getCalendar(document.salesordersearch.orderFromDate,null,document.salesordersearch.orderToDate);" maxlength="10" size="9"/>
		 <fmt:message key="label.to"/>&nbsp;
		 <input class="inputBox pointer" readonly type="text" name="orderToDate" id="orderToDate" value="" onClick="return getCalendar(document.salesordersearch.orderToDate,document.salesordersearch.orderFromDate);"
		        maxlength="10" size="9"/>
	 </td>
    </tr>
    <tr>
    <td nowrap  class="optionTitleBoldRight"><fmt:message key="label.promised.ship.date"/>:</td>
	 <td nowrap class="optionTitleBoldLeft">
		 <fmt:message key="label.from"/>
		 <input class="inputBox pointer" readonly type="text" name="promiseShipFromDate" id="promiseShipFromDate" value="" onClick="return getCalendar(document.salesordersearch.promiseShipFromDate,null,document.salesordersearch.promiseShipToDate);"
		        maxlength="10" size="9"/>
		 <fmt:message key="label.to"/>&nbsp;
		 <input class="inputBox pointer" readonly type="text" name="promiseShipToDate" id="promiseShipToDate" value="" onClick="return getCalendar(document.salesordersearch.promiseShipToDate,document.salesordersearch.promiseShipFromDate);"
		        maxlength="10" size="9"/>
	</td> 
	<td class="optionTitleBoldRight" nowrap> <fmt:message key="label.search"/>:</td>
      <td nowrap class="optionTitleBoldLeft">
            <select name="searchField"  class="selectBox" id="searchField">                                
                ...
                <option value="catalogItem"><fmt:message key="label.catalogitem"/></option>
    ...
    <tr>
      <td class="optionTitleBoldRight"> <fmt:message key="label.csr"/>:</td>   
      <td class="optionTitleLeft" nowrap>
    ...
    <tr>    
      <td colspan="4">
		<input type="checkbox" name="showOnlyLateOrders" value="Y" id="showOnlyLateOrders" />
	    <span class="optionTitleBoldLeft"><fmt:message key="label.showlateorders"/></span>&nbsp;
	    <input type="checkbox" name="showGrossMarginExceptions" value="Y" id="showGrossMarginExceptions" />
	    <span class="optionTitleBoldLeft"><fmt:message key="label.showgrossmargins"/></span>
	     <input type="checkbox" name="backOrdersOnly" value="Y" id="backOrdersOnly" />
	    <span class="optionTitleBoldLeft"><fmt:message key="label.backordersonly"/></span>
	  </td>  
