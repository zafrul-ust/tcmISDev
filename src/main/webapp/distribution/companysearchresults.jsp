...
var config = [
  ...
  {
  	columnId:"companyShortName",
  	columnName:'<fmt:message key="label.shortname"/>'
  	,width:15
  },
  {
  	columnId:"companyName",
  	columnName:'<fmt:message key="label.legalcompanyname"/>',
  	width:35
  }
  ];
...
<tcmis:form action="/companysearchresults.do" onsubmit="return submitFrameOnlyOnce();">
...
<tcmis:jsReplace var="shortname" value="${bean.companyShortName}"/>
<tcmis:jsReplace var="companyname" value="${bean.companyName}" processMultiLines="true"/>
{ id:${status.index +1},
 data:[
  '${bean.companyId}',
  '${shortname}',
