...
<script type="text/javascript" src="/js/distribution/catalogitemsynonymmain.js"></script>
...
missingSearchArgument:"<fmt:message key="label.searchargumentrequired"/>", 
...
<body bgcolor="#ffffff" onload="loadLayoutWin('','catalogItemSynonym');" onresize="resizeFrames()">
...
<tcmis:form action="/catalogitemsynonymresults.do" onsubmit="return submitSearchOnlyOnce();" target="resultFrame">
			...
			<tr>
				...
				<td class="optionTitleBoldLeft">
					<select name="searchField" class="selectBox" id="searchField">
						...
						<option value="partSynonym"><fmt:message key="label.synonym"/></option>
					</select>
  ...
  <div class="roundContent">
    ...
    <%-- Place all update links in divs that can be turned on or off depending on the search criteria that is selected
      ...
      <div id="mainUpdateLinks" style="display: none"> <%-- mainUpdateLinks Begins --%>
    	...
    	<span id="addItemSpan" style="display: none"><a href="javascript:addItemSynonym()"><fmt:message key="label.additemsynonym"/></a></span>
