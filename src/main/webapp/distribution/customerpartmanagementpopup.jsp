...
<script type="text/javascript" src="/js/distribution/customerpartmanagementpopup.js"></script>
...
<tcmis:form action="/customerpartmanagementpopup.do" onsubmit="" target="_self">
...
<div class="interface" id="resultsPage" style="margin: 4px 4px 0px 4px;">
  ...
  <div class="roundContent">
    <div class="boxhead"> <%-- boxhead Begins --%>
          <div id="mainUpdateLinks" style="display: none"> <%-- mainUpdateLinks Begins --%>
				 ...
				 <a href="#" onclick="createExcel();"><fmt:message key="label.createExcel"/></a>
...
<div id="customerPartManagementPopupDiv" style="width:100%;%;height:400px;" style="display: none;"></div>	
