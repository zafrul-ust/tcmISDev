...
<title>
<fmt:message key="label.itemsynonym"/>	
</title>
...
<body bgcolor="#ffffff" onload="loadLayoutWin('','');" onresize="resizeFrames()" onunload="closeThisWindow();">
...
<tcmis:form action="/itemsynonymlookupresults.do" onsubmit="return submitSearchOnlyOnce();" target="resultFrame">
