...
<title>  
	<fmt:message key="label.catalogitemnotes"/> <fmt:message key="label.for"/> ${param.itemId}
</title>
...
<body bgcolor="#ffffff" onload="loadLayoutWin('','catalogItemNotes');validateSearchForm();" onunload="" onresize="resizeFrames()">
...
<tcmis:form action="/catalogitemnotesresults.do" onsubmit="return submitSearchOnlyOnce();" target="resultFrame">
   ...
   <div class="roundContent">
    ...
    <tr>
        <td width="5%" class="optionTitleBoldRight" nowrap>
          ...
          <input name="submitSearch" id="submitSearch" type="submit" class="inputBtns" value='<fmt:message key="label.search"/>' onmouseover="this.className='inputBtns inputBtnsOver'" onmouseout="this.className='inputBtns'" onclick="return validateSearchForm();">
        </td>
    </tr>
    </table>
