...
<title>
<fmt:message key="label.consignmentcountupload"/>
</title>
...
<tcmis:form action="/consignmentcountupload.do" onsubmit="return submitOnlyOnce();" enctype="multipart/form-data">
...
<div class="roundcont filterContainer">
 <div class="roundright">
   ...
   <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableSearch">
    <tr>
     <td width="5%" class="optionTitleBoldRight"><fmt:message key="label.client"/>:</td>
    <td width="70%" class="optionTitleLeft">
        <select name="companyId" id="companyId" style="selectBox">
        	<option value="">NONE</option>
        	<option value="BAE">BAE Rochester</option>
        	<option value="Hamilton-Autocrib">Hamilton-Autocrib</option>
        	<option value="SAS_TECH">SAS</option>
        	<option value="BAE">MA-10H</option>
        	<option value="BAE">MA-16H</option>
        	<option value="BAE">MA-17H</option>
        	<option value="BAE">MA-22H</option>
        	<option value="BAE">MA-23MA</option>
        	<option value="BAE">MA-FIRE</option>
        	<option value="BAE">MA-RHAG</option>
        	<option value="BAE">MA-TRG</option>
        	<option value="BAE">MA-WOOD</option>
        	<option value="BAE">MA-1H</option>
        	<option value="BAE">MA-2H</option>
        	<option value="BAE">MA-5H</option>
        	<option value="BAE">MA-PAINT</option>
        </select>
	</td>
    </tr>
    <tr>
