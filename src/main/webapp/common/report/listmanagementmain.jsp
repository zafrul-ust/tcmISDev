...
<body bgcolor="#ffffff"  onload="loadLayoutWin('','listManagement');" onresize="resizeFrames()" onunload="closeAllchildren()">
...
<tcmis:form action="/listmanagementresults.do" onsubmit="return submitSearchOnlyOnce();" target="resultFrame">
...
<table width="600" border="0" cellpadding="0" cellspacing="0" class="tableSearch">
	  <tr>
        ...
        <td class="optionTitleBoldLeft">
          <input name="listName" id="listName" type="text" class="inputBox" size="110" value="${param.listName}" onkeypress="return onKeyPress()"/>											
       </td>
      </tr>
	<tr>
		...
		<input name="uploadListB" id="uploadListB" type="button"
                                    class="inputBtns" value="<fmt:message key="label.uploadlist"/>"
                                    onmouseover="this.className='inputBtns inputBtnsOver'"
                                    onmouseout="this.className='inputBtns'"
...
<div class="roundright">
  ...
  <div class="roundContent">
    ...
    <div id="mainUpdateLinks"> <%-- mainUpdateLinks Begins --%>
    	...
    	<a href="#" onclick="call('addNewList');return false;"><fmt:message key="label.newlist"/></a><br/>
    	</div>
