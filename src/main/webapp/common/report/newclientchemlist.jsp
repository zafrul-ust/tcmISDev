...
<body bgcolor="#ffffff"  onload="if ( showErrorMessage )showErrorMessages()" onunload="parent.opener.stopShowingWait();">

<tcmis:form action="/manualconsumptionimport.do"   onsubmit="return submitSearchOnlyOnce();">
