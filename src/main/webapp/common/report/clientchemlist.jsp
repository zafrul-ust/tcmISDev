...
//	if (validateSearchForm()) 
	{
		...
		openWinGenericViewFile('/tcmIS/common/loadingfile.jsp',
				'_Client_Chemical_Excel', '650', '600', 'yes');
		document.genericForm.target = '_Client_Chemical_Excel';
...
function uploadList() {
	openWinGeneric("uploadclientchemlist.do?uAction=showUploadList&facilityId="+$v('facilityId'),"uploadList","450","170","yes","80","80");
...
<body bgcolor="#ffffff"  onload="loadLayoutWin('','manualConsumptionImport');myOnLoad();" onresize="resizeFrames()">
...
<tcmis:form action="/clientchemlistresults.do" onsubmit="return submitSearchOnlyOnce();" target="resultFrame">
...
<tr>
	<td width="15%" class="optionTitleBoldRight" nowrap="true"><fmt:message key="label.partnumber"/>:</td>
	<td width="25%" class="optionTitleBoldLeft">
...
<tr>
	...
	<td width="15%" class="optionTitleBoldRight" nowrap="true"><fmt:message key="label.usagedate"/>:</td>
	<td width="25%" class="optionTitleBoldLeft" nowrap="nowrap">
...
<tr>
	<td colspan=4 class="optionTitleBoldLeft">
		 ...
		 <input name="uploadB" id="uploadB" type="button"
                                    class="inputBtns" value="<fmt:message key="label.uploadusagedata"/>"
                                    onmouseover="this.className='inputBtns inputBtnsOver'"
                                    onmouseout="this.className='inputBtns'"
  ...
  <div class="roundContent">
    ...
    <div id="mainUpdateLinks"> <%-- mainUpdateLinks Begins --%>
         <div id="updateResultLink" style="display:">
        	  	<a href="#" onclick="call('addListChemical');return false;"><fmt:message key="label.add"/></a>&nbsp;|&nbsp;
