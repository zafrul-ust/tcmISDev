...
function showExample() {
	openWinGeneric("/template/ManualConsumptionTemplate.xlsx","uploadListExample","250","150","yes","80","80");
}
function submitRequest() {
	...
	if($("fileName") == null || $v("fileName").length == 0) {
		...
		document.myFileUploadForm.reset();
		return false;
	}
	else {
		$("uAction").value = "save";
		document.myFileUploadForm.submit();
	}
}
...
<tcmis:form action="/clientchemlistupload.do" onsubmit="return submitSearchOnlyOnce();" enctype="multipart/form-data">
