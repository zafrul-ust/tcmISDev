...
<title>
<fmt:message key="label.uploadinventorydata"/>
</title>
...
function goback() {
	...
	target.$('partNo').value = '';
	target.$('msdsNo').value = '';
	target.$('usageEndDate').value = '';
	target.$('usageStartDate').value = '';
	target.$('entryEndDate').value = '';
	target.$('entryStartDate').value = '';
	target.search();
//	target.$('msdsUnitOfMeasure').value = '';//$v('purchaseSource');
...
function showExample() {
	openWinGeneric("/template/ManualInventoryTemplate.csv","uploadInventoryExample","250","150","yes","80","80");
}
...
<tcmis:form action="/uploadinventoryimport.do" onsubmit="return submitSearchOnlyOnce();" enctype="multipart/form-data">
...
<fieldset>
<legend><fmt:message key="label.uploadinventorydata"/>:</legend>
