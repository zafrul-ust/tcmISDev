...
function createXSL(){
  ...
  if(flag) {
    ...
    openWinGenericViewFile('/tcmIS/common/loadingfile.jsp','_Open_MaterialRequests_Excel','650','600','yes');
    document.genericForm.target='_Open_MaterialRequests_Excel';
...
<body bgcolor="#ffffff" onload="loadLayoutWin('','openMaterialRequests');" onresize="resizeFrames()">
...
<tcmis:form action="/openmaterialrequestsresults" onsubmit="return submitSearchOnlyOnce();" target="resultFrame">
   ...
   <div class="roundContent">
		<table width="500" id="searchTable" border="0" cellpadding="0" cellspacing="0" class="tableSearch">
			<tr>
                ...
                <%--
                <tr>
				<td width="30%" class="optionTitleBoldRight"><fmt:message key="label.mrnumber"/>:</td>
