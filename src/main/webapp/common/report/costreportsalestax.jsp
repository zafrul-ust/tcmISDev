...
<title>
<fmt:message key="label.salestaxdistribution"/>
</title>
...
<c:if test="${salesTaxCollection != null}" >
...
<div class="roundright">
  ...
  <div class="roundContent">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableResults">
		 ...
		 <c:forEach var="costReportSalesTaxBean" items="${salesTaxCollection}" varStatus="status">
			 ...
			 <tr class="<c:out value="${colorClass}"/>" id="rowId<c:out value="${status.index}"/>">
			  <td width="5%"><c:out value="${status.current.salesTaxDesc}"/></td>
			  <td width="5%"><fmt:formatNumber maxFractionDigits="6" minFractionDigits="0"><c:out value="${status.current.salesTaxAmount}"/></fmt:formatNumber></td>
   ...
   <c:if test="${empty salesTaxCollection}" >
