...
<script type="text/javascript" src="/js/client/report/scanscorereportmain.js"></script>
...
<body bgcolor="#ffffff" onload="loadLayoutWin('','workAreaScanReport');loadOptions();" onresize="resizeFrames()">
...
<tcmis:form action="/scanscorereportresults.do" onsubmit="return submitSearchOnlyOnce();" target="resultFrame">
