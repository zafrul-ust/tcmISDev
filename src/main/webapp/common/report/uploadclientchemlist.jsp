...
<title>
<fmt:message key="label.uploadusagedata"/>
</title>
...
function showExample() {
	openWinGeneric("/template/ManualConsumptionTemplate.csv","uploadListExample","250","150","yes","80","80");
}
...
<tcmis:form action="/uploadclientchemlist.do" onsubmit="return submitSearchOnlyOnce();" enctype="multipart/form-data">
...
<fieldset>
<legend><fmt:message key="label.uploadusagedata"/>:</legend>
