...
<div class="roundright">
  ...
  <div class="roundContent">
    <div class="boxhead"> <%-- boxhead Begins --%>
     <%-- Place all update links in divs that can be turned on or off depending on the search criteria that is selected
      ...
      <span id="updateResultLink" style="display:none">
         <a href="#" onclick="call('deleteReport'); return false;"><fmt:message key="label.update"/></a> |
      </span>
    ...
    <div class="dataContent">
     <iframe id="resultFrame" name="resultFrame" width="100%" height="250" frameborder="0" marginwidth="0" src="batchreportviewerresults.do?action=search"></iframe>
   </div>
