...
<%--<tcmis:form action="/shipinfo.do" onsubmit="return submitFrameOnlyOnce();" target="resultFrame">--%>
...
<table id="searchMaskTable" width="550" border="1" cellpadding="0" cellspacing="0">
<tr><td>
    ...
    <table width="100%" border="1" cellpadding="0" cellspacing="0" class="tableSearch">
		...
		<td width="80%" class="optionTitleLeft">      
 			<select name="searchField" id="searchField" class="selectBox"> 							
				<option  selected value="field1">Part Number</option>
				<option  value="field2">Description</option>			
  			</select>	
		...
		<td width="25%" class="optionTitleLeft" colspan="2">    --%>   		
   			<input class="inputBox" type="text" name="searchArgument" id="searchArgument" size="35">
 		</td>
 	  </tr>  
