...
<script SRC="/js/common/changepassword.js" language="JavaScript"></script>
<%-- Add any other javascript you need for the page here --%>

<title>
<fmt:message key="password.label.submit"/>
</title>
...
<tcmis:form action="/changepassword.do" onsubmit="return submitOnlyOnce();">
...
<!-- Menu Ends-->
<!-- Header Ends -->
<span style='font-size:10.0pt;color:red'><fmt:message key="label.expiredpassordmsg"/></span>
</c:if>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableSearch">
		    ...
		    <c:when test="${updateStatus == 'success'}">
		        <tr>
		            <td width="100%" class="optionTitleBoldCenter">
		              <fmt:message key="label.passwordchangedsuccess"/>&nbsp;
		            </td>
		        </tr>
			    <tr>
		            <td width="100%" class="optionTitleBoldCenter">
        ...
        <tr>
          <td width="20%" class="optionTitleBoldRight">
            <fmt:message key="password.label.passwordold"/>:&nbsp;
          </td>
          <td width="80%" class="optionTitleBoldLeft">
            <input name="oldPassword" id="oldPassword" type="password" class="inputBox" value="<c:out value="${param.oldPassword}"/>">
          </td>
        </tr>
        <!-- new password -->
        <tr>
        ...
        <tr>
          <td width="100%" class="optionTitleBoldRight">
            <input name="changePassword" id="changePassword" type="submit" class="inputBtns" value="<fmt:message key="password.label.submit"/>" onmouseover="this.className='inputBtns inputBtnsOver'" onmouseout="this.className='inputBtns'" onclick= "return checkPassword()">
          </td>
          <td width="100%" class="optionTitleBoldLeft">
            <input name="reset" id="reset" type="submit" class="inputBtns" value="<fmt:message key="button.reset"/>" onmouseover="this.className='inputBtns inputBtnsOver'" onmouseout="this.className='inputBtns'" onclick= "return resetPassword()">
          </td>
        </tr>
		    </c:otherwise>
	    </c:choose>
