...
<body bgcolor="#ffffff" onload="initializeThisWindow();" onunload="closeThisWindow();">
	<tcmis:form action="/docViewer.do" onsubmit="return submitOnlyOnce();">
			...
			<div class="contentArea">
	 							...
	 							<div class="roundright">
	   								...
	   								<div class="roundContent">
										<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableSearch">
											...
											<tr>
												<td>
													<center><input name="viewDoc" id="viewDoc" type="submit" value="<fmt:message key="label.viewspecification"/>" class="inputBtns" onmouseover="this.className='inputBtns inputBtnsOver'" onmouseout="this.className='inputBtns'"></center>
	      											</td>
	      										</tr>
	    									</table>
									</div>
				...
				<div id="errorMessagesArea" class="errorMessages">
				 ...
				 <div id="hiddenElements" style="display: none;">
                     ...
                     <input type="hidden" name="hasSpecificFacility" id="hasSpecificFacility" value='${param.hasSpecificFacility}'/>
                     <input type="hidden" name="facility" id="facility" value='${param.facility}'/>
                     ...
                     <input type="hidden" name="spec" id="spec" value='${param.spec}'/>
                     <input type="hidden" name="catalogAddRequestId" id="catalogAddRequestId" value='${param.catalogAddRequestId}'/>
