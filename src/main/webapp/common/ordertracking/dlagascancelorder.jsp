...
<script type="text/javascript" src="/yui/build/dragdrop/dragdrop.js" ></script>
  ...
  <script type="text/javascript" src="/js/common/ordertracking/cancelorder.js"></script>
...
<body bgcolor="#ffffff" onload="CancelOrder()">
 ...
 <div class="roundright">
   ...
   <div class="roundContent">
    ...
    <td width="10%" class="optionTitleBoldLeft">     
      <textarea cols="50" rows="5" class="inputBox" name="comments" id="comments">Cancelled by DLA</textarea>
   	</td>
      </tr>
      <tr>
      <td>
...
<!-- Hidden element start -->
 ...
 <input type="hidden" name="userAction" id="userAction" value="cancelOrderDone"/>
 <input name="docNumWithSuffix" id="docNumWithSuffix" value="${param.docNumWithSuffix}" type="hidden"/>
