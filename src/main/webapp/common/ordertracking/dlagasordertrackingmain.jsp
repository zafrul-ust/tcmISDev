...
<script type="text/javascript" src="/js/common/ordertracking/dlagasordertrackingmain.js"></script>
...
<title>
<fmt:message key="dlagasordertracking.title"/>
</title>
...
<!-- action=start is there to decide in the action to query the database for the drop down in the search section.
 ...
 -->
 <iframe id="searchFrame" name="searchFrame" width="100%" height="170" frameborder="0" marginwidth="0" style="" src="dlagasordertrackingsearch.do"></iframe>
</div>
<!-- Search Frame Ends -->
...
<%--
    <tr><td width="100px" class="legendText">PO not confirmed</td><td class="legendText"></td></tr>
    <tr><td width="100px" class="legendText">PO confirmed</td><td class="legendText"></td></tr>
--%>
    <tr><td width="100px" class="legendText">Picked not shipped</td><td class="legendText">These POs were picked from the USGOV shipment selection page. This order is being worked on (labels, packing etc).</td></tr>
    <!--<tr><td width="100px" class="legendText">Shipped</td><td class="legendText"></td></tr>-->
    <tr><td width="100px" class="legendText"><fmt:message key="label.usgovorderdate"/></td><td class="legendText">Date Haas got the order from DLA.</td></tr>
    <tr><td width="100px" class="legendText"><fmt:message key="label.datesent"/></td><td class="legendText">Date the order was sent to supplier.</td></tr>
    <tr><td width="100px" class="legendText"><fmt:message key="label.dlametricdate"/></td><td class="legendText">If an order is shipped by this date, it is considered to be on time and meet the metric set by DLA.</td></tr>
    <tr><td width="100px" class="legendText"><fmt:message key="label.orderage"/></td><td class="legendText">This is the number of days past the DLA Metric date.</td></tr>     
    <tr><td width="100px" class="red legendText">&nbsp;</td><td class="legendText">Order is past the DLA Metric Date.</td></tr>
    <tr><td width="100px" class="yellow legendText">&nbsp;</td><td class="legendText">Order is Open.</td></tr>
    <tr><td width="100px" class="legendText"><fmt:message key="label.date.created"/></td><td class="legendText">Date Haas PO was created.</td></tr>
  </table>
</div>
</div>
...
<div id="deliveryCommentsMessagesAreaTitle" class="hd"><fmt:message key="label.comments"/></div>
