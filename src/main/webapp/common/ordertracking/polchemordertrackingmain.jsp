...
<!-- action=start is there to decide in the action to query the database for the drop down in the search section.
 ...
 -->
 <iframe id="searchFrame" name="searchFrame" width="100%" height="165" frameborder="0" marginwidth="0" style="" src="/tcmIS/haas/polchemordertrackingsearch.do"></iframe>
</div>
<!-- Search Frame Ends -->
...
<%--
 <a href="#" onclick="submitCancel(); return false;"><fmt:message key="label.cancel"/></a>
        <tcmis:permission indicator="true" userGroupId="freightAdvice">
