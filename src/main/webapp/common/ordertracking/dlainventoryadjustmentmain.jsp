...
<body bgcolor="#ffffff"  onload="loadLayoutWin('','dlaInventoryAdjustments');" onresize="resizeFrames()">
...
<tcmis:form action="/dlainventoryadjustmentresults.do" onsubmit="return submitSearchOnlyOnce();" target="resultFrame">
...
<table width="600" border="0" cellpadding="0" cellspacing="0" class="tableSearch">
	  <tr>
        <td class="optionTitleBoldLeft"><fmt:message key="label.nsn"/>:
          <input name="catPartNo" id="catPartNo" type="text" class="inputBox" size="20" value="" onkeypress="return onKeyPress()"/>											
       </td>
      </tr>
      	  <tr>
        <td class="optionTitleBoldLeft"><fmt:message key="label.dateinserted"/>:
				<fmt:message key="label.from"/>
				<input class="inputBox pointer" readonly type="text" name="dateInsertedFromDate" id="dateInsertedFromDate" value="" onClick="return getCalendar(document.getElementById('dateInsertedFromDate'),null,document.getElementById('dateInsertedToDate'));" maxlength="10" size="9"/>
				<fmt:message key="label.to"/>&nbsp;
				<input class="inputBox pointer" readonly type="text" name="dateInsertedToDate" id="dateInsertedToDate" value="" onClick="return getCalendar(document.getElementById('dateInsertedToDate'),document.getElementById('dateInsertedFromDate'));" maxlength="10" size="9"/>  								
       </td>
      </tr>
	<tr>
...
<div class="roundright">
  ...
  <div class="roundContent">
    ...
    <div id="mainUpdateLinks"> <%-- mainUpdateLinks Begins --%>
        <a href="#" onclick="resultFrame.update();return false;"><fmt:message key="label.update"/></a> |
    	<a href="#" onclick="resultFrame.insertRow();return false;"><fmt:message key="label.add"/></a>
