...
<script type="text/javascript" src="/yui/build/dragdrop/dragdrop.js" ></script>
  ...
  <script type="text/javascript" src="/js/common/ordertracking/changesupplier.js"></script>

<title>
<fmt:message key="label.changesupplier"/>
</title>
...
<body bgcolor="#ffffff" onload="changeSupplier()">
 ...
 <div class="roundright">
   ...
   <div class="roundContent">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableSearch">
      <tr>
        ...
        <td width="10%" class="optionTitleBoldLeft">
          <select name="inventoryGroup" id="inventoryGroup" class="selectBox">
    		<c:forEach var="inventoryGroupBean" items="${inventoryGroupColl}" varStatus="status">
				<option value="${inventoryGroupBean.inventoryGroup}">${inventoryGroupBean.inventoryGroup}</option>
			</c:forEach>
		  </select>
        </td>
 	  </tr>
      <tr>
      <td>
       <input name="ok" id="ok" type="button" value="<fmt:message key="label.ok"/>" onclick="document.supplierLocationForm.submit()" class="smallBtns" onmouseover="this.className='smallBtns smallBtnsOver'" onmouseout="this.className='smallBtns'"/>
       <input name="cancel" id="cancel" type="button" value="<fmt:message key="label.cancel"/>"  onclick="window.close()" class="smallBtns" onmouseover="this.className='smallBtns smallBtnsOver'" onmouseout="this.className='smallBtns'">
      </tr>
    </table>
   <!-- End search options -->
   </div>
...
<!-- Hidden element start -->
 ...
 <input type="hidden" name="userAction" id="userAction" value="changeSupplierDone"/>
