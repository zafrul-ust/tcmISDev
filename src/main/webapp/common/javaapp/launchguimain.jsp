...
<script type="text/javascript" src="/js/common/javaapp/launchguimain.js"></script>
...
<!-- action=start is there to decide in the action to query the database for the drop down in the search section.
 ...
 -->
 <iframe id="searchFrame" name="searchFrame" width="100%" height="95" frameborder="0" marginwidth="0" style="" src="launchguisearch.do?"></iframe>
</div>
<!-- Search Frame Ends -->
