...
<c:choose>
<c:when test="${locationLabelPrinterCollection != null}" >
...
<c:otherwise>
	...
	<tr>
	<td width="100%">
	<fmt:message key="error.noprinterlocationpleaseselect"/>
	</td>
	</tr>
	</table>
</c:otherwise>
...
<!-- Hidden element start -->
 <div id="hiddenElements" style="display: none;">
  ...
  <input type="hidden" id="catPartNo" name="catPartNo" value="<tcmis:jsReplace value='${param.itemId}' />"/>">
   <input type="hidden" id="itemId" name="itemId" value="<tcmis:jsReplace value='${param.itemId}' />"/>"> 
  <%--
