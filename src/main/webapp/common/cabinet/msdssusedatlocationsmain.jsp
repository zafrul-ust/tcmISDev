...
<script type="text/javascript" src="/js/common/cabinet/msdssusedatlocationsmain.js"></script>
...
<title>
	<fmt:message key="msdssUsedAtLocations"/>
</title>
...
<body bgcolor="#ffffff" onload="loadLayoutWin('','msdssUsedAtLocations');myOnLoad();" onunload="closeAllchildren();" onresize="resizeFrames()">

<div class="interface" id="mainPage" style="">
	<!-- Search Frame Begins -->
<div id="searchFrameDiv">
<div class="contentArea">
<tcmis:form action="/msdssusedatlocationsresults.do" onsubmit="return submitSearchOnlyOnce();" target="resultFrame">
 ...
 <div class="roundright">
   ...
   <div class="roundContent">
	<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableSearch">
	  <%-- Row 1 --%>
	  <c:set var="hideMultiSel" value='Y'/>
	 <%@ include file="/common/cabinet/workareasearchtemplate.jsp" %>
      <tr>
        ...
        <html:select property="countTypeArraySel" styleClass="selectBox" styleId="countTypeArraySel" onchange="countTypeArrayChanged()">
           ...
           <html:option value="Counted" key="label.counted"/>
           <html:option value="Not Counted" key="label.notcounted"/>
           <html:option value="Nonmanaged" key="label.nonmanaged"/>
		...
		<button id="countTypeMultiSel" class="listButton" onmouseover="this.className='listButton listButtonOvr'" onmouseout="this.className='listButton'" name="None" value=""  onclick="popMultiSel('countTypeArray');return false;" style="display:none;"></button>
        ...
        <td width="100%"   class="optionTitleBoldLeft">
          <fmt:message key="label.search"/>:
			...
			<html:option value="msds_number" key="label.msds"/>
...
<div id="hiddenElements" style="display: none;">
    ...
    <input name="maxData" id="maxData" type="hidden" value="200"/> 
</div>
<!-- Hidden elements end -->
</tcmis:form>
</div>
