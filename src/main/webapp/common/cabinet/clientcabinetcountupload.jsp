...
<link rel="stylesheet" type="text/css" href="/css/inventorycountupload.css"></link>
 -->
 <script type="text/javascript" src="/js/common/cabinet/clientcabinetcountupload.js"></script>
...
<body bgcolor="#ffffff">
 ...
 -->
<body bgcolor="#ffffff">
<tcmis:form action="/clientcabinetcountupload.do" onsubmit="return SubmitOnlyOnce();" enctype="multipart/form-data">
