...
<script src="/js/common/cabinet/useapprovalstatus.js" language="JavaScript"></script>
<script src="/js/common/cabinet/useapprovalajax.js" language="JavaScript"></script>
