	...
	<div class="interface" id="mainPage" style="">
		...
		<div id="searchFrameDiv">
			<div class="contentArea">
				<tcmis:form action="/workareaacknowledgementresults.do" onsubmit="return submitSearchOnlyOnce();" target="resultFrame">
 									...
 									<div class="roundright">
										...
										<div class="roundContent">
											<table  class="tableSearch" width="800" border="0" cellpadding="0" cellspacing="0">
										        ...
										        <tr>
										        	  <td width="100%"   class="optionTitleBoldLeft">
										        	  <fmt:message key="label.disbursedinthelast"/>
										        	  <input class="inputBox" type="text" name="dateProcessed" id="dateProcessed" value="" size="4">
										        	  <fmt:message key="label.days"/>
										        	</td>
										        </tr>
										           <tr>
										        	  <td width="100%"   class="optionTitleBoldLeft">
										        	  <input type="checkbox" name="includeAckDisburse" value="" id="includeAckDisburse" onclick="this.value=this.checked;" />
										        	  <fmt:message key="label.includeacknowledgeddisbursements"/>
										        	</td>
										        </tr>
												<tr>
