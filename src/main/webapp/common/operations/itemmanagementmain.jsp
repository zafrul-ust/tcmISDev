...
<script type="text/javascript" src="/js/common/operations/itemmanagementmain.js"></script>
...
<!-- action=start is there to decide in the action to query the database for the drop down in the search section.
 ...
 -->
 <iframe id="searchFrame" name="searchFrame" width="100%" height="190" frameborder="0" marginwidth="0" style="" src="itemmanagementsearch.do"></iframe>
</div>
<!-- Search Frame Ends -->
    ...
    <div class="boxhead"> <%-- boxhead Begins --%>
     <%-- Place all update links in divs that can be turned on or off depending on the search criteria that is selected
      ...
      <span id="showlegendLink">
        <a href="javascript:showItemManagementLegend()"><fmt:message key="label.showlegend"/></a>
      </span>
      <span id="updateResultLink" style="display: none">
       <c:set var="updatePermission" value=''/>
       <tcmis:inventoryGroupPermission indicator="true" userGroupId="ItemMgmt">
        <c:set var="updatePermission" value='Yes'/>
       </tcmis:inventoryGroupPermission>

       <tcmis:inventoryGroupPermission indicator="true" userGroupId="ForceBuy">
        <c:set var="updatePermission" value='Yes'/>
       </tcmis:inventoryGroupPermission>

       <c:if test="${updatePermission == 'Yes'}">
        | <a href="#" onclick="resultFrame.doSubmitUpdates(); return false;"><fmt:message key="label.update"/></a>
       </c:if>
      </span>
