...
<script type="text/javascript" src="/js/common/operations/dropshipreceivingmain.js"></script>
...
messagesData={alert:"<fmt:message key="label.alert"/>",and:"<fmt:message key="label.and"/>",novalidlineselected:"<fmt:message key="label.novalidlineselected"/>",
...
<!-- action=start is there to decide in the action to query the database for the drop down in the search section.
 ...
 -->
 <iframe id="searchFrame" name="searchFrame" width="100%" height="158" frameborder="0" marginwidth="0" style="" src="/tcmIS/hub/dropshipreceivingsearch.do"></iframe>
</div>
<!-- Search Frame Ends -->
  ...
  <div class="roundContent">
    <div class="boxhead"> <%-- boxhead Begins --%>
     <%-- Place all update links in divs that can be turned on or off depending on the search criteria that is selected
      ...
      <span id="updateResultLink" style="display: none">|&nbsp;<a href="#" onclick="submitUpdate(); return false;"><fmt:message key="label.receive"/></a></span>
...
<div id="showLegendAreaBody" class="bd">
  <table width="100%" class="tableResults" border="0" cellpadding="0" cellspacing="0">
   <tr><td width="100px" class="red legendText">&nbsp;</td><td class="legendText"><fmt:message key="label.nomrallocatedforpo"/></td></tr>  
   </table>
</div>
</div>
