...
<script type="text/javascript" src="/js/common/operations/clientcabinetinventorymain.js"></script>
...
<body bgcolor="#ffffff"  onload="loadLayoutWin('','clientCabinetInventory');myOnLoad();" onresize="resizeFrames()">
...
<tcmis:form action="/clientcabinetinventoryresults.do" onsubmit="return submitSearchOnlyOnce();" target="resultFrame">
...
<table id="searchMaskTable" width="860" border="0" cellpadding="0" cellspacing="0">
    <tr>
        <td>
  ...
  <!-- Insert all the search option within this div -->
    <table width="900" border="0" cellpadding="0" cellspacing="2" class="tableSearch">
      <tr>
      ...
      <td colspan="4" class="optionTitleBoldLeft">
			...
			&nbsp;
			<select name="matchingMode" id="matchingMode"  class="selectBox">
			<option value="contains"> <fmt:message key="label.contain"/></option>
