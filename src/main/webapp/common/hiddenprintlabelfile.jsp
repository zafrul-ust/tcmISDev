...
<title>
<fmt:message key="label.labelgenerator"/>
</title>
...
<body onLoad="initPage();" bgcolor="#ffffff">
  ...
  <iframe id="hiddenPrintTxtFrame" name="hiddenPrintTxtFrame" width="0" height="0" frameborder="0" marginwidth="0" src="<c:out value="${filePath}" />" onLoad="finishPrinting();"></iframe>
  ...
  <c:choose>
   ...
   <c:otherwise>
  <fmt:message key="label.labelgenerator"/><br><br><br><br>
  <fmt:message key="label.pleasewaitforlabels"/><br><br><br><br>
  <fmt:message key="label.closeafterprinting"/>
   </c:otherwise>
  </c:choose>
  </div>
</body>
