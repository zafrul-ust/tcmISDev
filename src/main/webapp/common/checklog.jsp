									...
									<div class="roundright">
										<div class="roundtop">
											<div class="roundtopright">
												<img src="/images/rndBoxes/borderTL_filter.gif" alt="" width="15" height="10" class="corner_filter"
													style="display: none" />
											</div>
										</div>
											...
											<table width="400" id="searchTable" border="0" cellpadding="0" cellspacing="0" class="tableSearch">
												<tr>
													<td width="10%" class="optionTitleBoldLeft" nowrap="nowrap">
														<c:forEach var="logname" items="${lognameList}" varStatus="status">
															<c:set var="checked" value="" />
															<c:if test="${param.logname == logname or (empty param.logname and status.first)}">
																<c:set var="checked" value='checked="checked"'/>
															</c:if>
															<input type="radio" name="logname" value="${logname}" ${checked}/>&nbsp;${logname}
													...
													<td width="70%" class="optionTitleBoldLeft" nowrap="nowrap">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
														<input type="text" name="lines" value="${lines}" />
													</td>
													<td width="10%" class="optionTitleBoldLeft" nowrap="nowrap">
														<input type="checkbox" name="order" value="reverse"
														<c:if test="${ param.order == 'reverse' }">checked="checked"</c:if> />Reverse<br/>
														<input type="checkbox" name="wrap" value="wrap"
														<c:if test="${ param.wrap == 'wrap' }">checked="checked"</c:if> />Wrap&nbsp;
													</td>
												</tr>
												<tr>
						...
						<td>
							<div class="roundcont contentContainer">
								<div class="roundright">
									<div class="roundtop">
										<div class="roundtopright">
											<img src="/images/rndBoxes/borderTL.gif" alt="" width="15"
									...
									<div class="roundContent">
										...
										<div class="dataContent">
											<iframe scrolling="no" id="resultFrame" name="resultFrame"
