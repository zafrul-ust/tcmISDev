...
<title>
<fmt:message key="label.startupPages"/> (${fullName})
</title>
...
<div class="roundright">
  ...
  <div class="roundContent">
    <div class="boxhead"> <%-- boxhead Begins --%>
     <%-- Place all update links in divs that can be turned on or off depending on the search criteria that is selected
      ...
      <span id="updateResultLink" style="display: none">
        <a href="#" onclick="getResultFrame().updatePersonalInfo(); return false;"><fmt:message key="label.update"/></a> | 
      </span>
      <a href="#" onclick="call('createXSL');"><fmt:message key="label.createExcel"/></a> |
    ...
    <div class="dataContent">
     <iframe id="resultFrame" name="resultFrame" width="100%" height="250" frameborder="0" marginwidth="0" src="startuppagesresults.do?personnelId=${personnelId}&action=display"></iframe>
   </div>
