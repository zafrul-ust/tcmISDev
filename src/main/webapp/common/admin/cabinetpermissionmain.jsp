...
<title>
<fmt:message key="label.cabinetPermissionsTitle"/> (${fullName})
</title>
...
<!-- action=start is there to decide in the action to query the database for the drop down in the search section.
 ...
 -->
 <iframe id="searchFrame" name="searchFrame" width="600" height="150" frameborder="0" marginwidth="0" style="" src="cabinetpermissionsearch.do?uAction=display&personnelId=${personnelId}"></iframe>
</div>
<!-- Search Frame Ends -->
...
<div class="roundright">
  ...
  <div class="roundContent">
	  ...
	  <span id="legendLink" style="display: none">
       <a href="#" onclick="showLegend()"><fmt:message key="label.legend"/></a>
      </span>
	  <span id="updateResultLink" style="display: none">
       | <a href="#" onclick="call('applicationPermissionsUpdate')"><fmt:message key="label.update"/></a>
      </span>
...
<div id="showLegendAreaBody" class="bd">
  ...
  <tr>
    <td class="green" width="10%" colspan="2">&nbsp;</td>
    <td width="40%"><fmt:message key="label.allcabinets"/></td>
  </tr>
  <tr>
    <td class="alt" width="5%">&nbsp;</td>
    <td class="white" width="5%">&nbsp;</td>
    <td width="40%"><fmt:message key="label.singleCabinet"/></td>
  </tr>
  </table>
</div>
</div>
