  ...
  <div class="roundContent">
    <div class="boxhead"> 
        <span id="updateResultLink" style="display:none">
  		<a href="#" onclick="call('editFacilityPermissionsUpdate')"><fmt:message key="label.update"/></a> |
  		</span> 
  		<a href="#" onclick="call('createEditXSL');"><fmt:message key="label.createExcel"/></a> |
		<a href="#" onclick="parent.window.close()"><fmt:message key="label.cancel"/></a>&nbsp;         
  		</div>
    <div class="dataContent">
     <iframe id="resultFrame" name="resultFrame" width="100%" height="250" frameborder="0" marginwidth="0" src="editfacilitypermissionmain.do?personnelId=${personnelId}&uAction=showResults&companyId=${param.companyId}&companyName=${param.companyName}&facilityId=${param.facilityId}"></iframe>
   </div>
