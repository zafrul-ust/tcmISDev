...
// default maxlength is 0
  ...
  {
   columnId:"oldInventoryGroupAccess"
  },
  {
...
_gridConfig.divName = 'UserIgAdmin';
...
<tcmis:form action="/igpermission.do" onsubmit="return submitFrameOnlyOnce();">
  ...
  <div class="roundContent">
    <div class="boxhead"> <%-- boxhead Begins --%>
     <%-- Place all update links in divs that can be turned on or off depending on the search criteria that is selected
      ...
      <span id="updateResultLink" style="display:none"><a href="#" onclick="javascript:_simpleUpdate(); return false;"><fmt:message key="label.update"/></a></span>  
     </div> <%-- mainUpdateLinks Ends --%>
    </div> <%-- boxhead Ends --%>

<div class="dataContent">
<!--  result page section start -->
<div id="UserIgAdmin" style="height:400px;display: none;" ></div>
...
<c:forEach var="bean" items="${beanColl}" varStatus="status">
	...
	<c:set var="inventoryGroupAccess" value="false"/>       
	<c:set var="adminRole" value="false"/>
	
	<c:if test="${status.current.inventoryGroupAccess == 'Y'}">
		<c:set var="inventoryGroupAccess" value="true"/>       
	</c:if>
