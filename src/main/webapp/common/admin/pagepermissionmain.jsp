...
<title>
<fmt:message key="label.pagePermissionsTitle"/> (${fullName})
</title>
...
<body bgcolor="#ffffff" onload="loadLayoutWin('','pagePermission');" onresize="resizeFrames()">
<div class="interface" id="mainPage" style=""> <!-- start of interface-->
<div id="searchFrameDiv" >
<tcmis:form action="/pagepermissionresults.do" onsubmit="return submitSearchOnlyOnce();" target="resultFrame">
...
<table width="70%" border="0" cellpadding="0" cellspacing="0" class="tableSearch">
      <tr>
      ...
      <tr>
      	<td class="optionTitleRight" colspan="3" nowrap>
...
<div class="roundright">
  ...
  <div class="roundContent">
    ...
    <div id="mainUpdateLinks"> <%-- mainUpdateLinks Begins --%>
         ...
         <a href="#" onclick="call('pagePermissionsUpdate'); return false;"><fmt:message key="label.update"/></a>
         </div>
