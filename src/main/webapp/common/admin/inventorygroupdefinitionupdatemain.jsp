...
<html:html lang="true">
	<head>
		...
		<script type="text/javascript" src="/js/common/admin/inventorygroupdefinitionupdatemain.js"></script> 
	...
	-->
	<body bgcolor="#ffffff" onload="loadLayoutWin('','inventorygroupdefinition');setOps();" onresize="resizeFrames()" onunload="closeAllchildren();try{opener.closeTransitWin();}catch(ex){}">
		<div class="interface" id="mainPage" style="">
			<!-- Search div Begins -->
			<div id="searchFrameDiv">
				<!-- start of contentArea -->
				<div class="contentArea">
					<tcmis:form action="/inventorygroupdefinitionupdateresults.do" onsubmit="return submitSearchOnlyOnce();" target="resultFrame">
  ...
  <div class="roundContent">
    <div class="boxhead"> <%-- boxhead Begins --%>
     <%-- Place all update links in divs that can be turned on or off depending on the search criteria that is selected
      ...
      --%>
      <span id="updateResultLink" style="display: none"><a href="#" onclick="call('submitUpdate'); return false;"><fmt:message key="label.update"/></a></span>
      </div> 
