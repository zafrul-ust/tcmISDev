...
<title>
<fmt:message key="label.financialApproverTitle"/> (${fullName})
</title>
...
<!-- action=start is there to decide in the action to query the database for the drop down in the search section.
 ...
 -->
 <iframe id="searchFrame" name="searchFrame" width="500" height="120" frameborder="0" marginwidth="0" style="" src="financialapproversearch.do?uAction=display&personnelId=${personnelId}&fullName=${fullName}"></iframe>
</div>
<!-- Search Frame Ends -->
...
<div class="roundright">
  ...
  <div class="roundContent">
      ...
      <div id="updateResultLink" style="display: none">
			<a href="#" onclick="call('Add'); return false;"><fmt:message key="label.add"/></a> <b>|</b>
			<a href="#" onclick="call('Edit'); return false;"><fmt:message key="label.edit"/></a> <b>|</b>
			<a href="#" onclick="call('Delete'); return false;"><fmt:message key="label.delete"/></a> <b>|</b>
			<a href="#" onclick="call('AltApprover'); return false;"><fmt:message key="label.altapprover"/></a>
      </div>
