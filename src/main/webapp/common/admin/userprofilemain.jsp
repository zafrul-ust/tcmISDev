...
<c:set var="homeLink" value='${param.homeLink}'/>
<c:choose>
 <c:when test="${homeLink == 'hub'}">
  <a href="/tcmIS/hub/home.do" style="color:#FFFFFF"><fmt:message key="label.home"/></a>
 </c:when>
 <c:when test="${homeLink == 'supply'}">
  <a href="/tcmIS/supply/home.do" style="color:#FFFFFF"><fmt:message key="label.home"/></a>
 </c:when>
 <c:otherwise>
...
<!-- action=start is there to decide in the action to query the database for the drop down in the search section.
 ...
 -->
 <iframe id="searchFrame" name="searchFrame" width="100%" height="190" frameborder="0" marginwidth="0" style="" src="userprofilesearch.do?action=login"></iframe>
</div>
<!-- Search Frame Ends -->
...
<div class="roundright">
  ...
  <div class="roundContent">
    ...
    <div class="dataContent">
     <iframe id="resultFrame" name="resultFrame" width="100%" height="250" frameborder="0" marginwidth="0" src=""></iframe>
   </div>
