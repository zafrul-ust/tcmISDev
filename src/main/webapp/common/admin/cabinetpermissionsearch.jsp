...
<title>
<fmt:message key="label.cabinetPermissionsTitle"/> (${logonId})
</title>
...
<tcmis:form action="/cabinetpermissionresults.do" onsubmit="return submitFrameOnlyOnce();" target="resultFrame">
