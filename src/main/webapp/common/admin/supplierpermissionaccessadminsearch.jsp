...
<script type="text/javascript" src="/js/common/admin/supplierpermissionaccessadminsearch.js"></script>
...
<tcmis:form action="/supplierpermissionaccessadminresults.do" onsubmit="return submitFrameOnlyOnce();" target="resultFrame">
...
<table id="searchMaskTable" width="350" border="0" cellpadding="0" cellspacing="0">
<tr><td>
<div class="roundcont filterContainer">
 <div class="roundright">
   ...
   <div class="roundContent">
    ...
    <table width="100%" border="0" cellpadding="2" cellspacing="2" class="tableSearch">      
      <tr>
        <td width="5%" class="optionTitleBoldLeft"><fmt:message key="label.supplier"/>:</td>
        <td>
          <input name="supplierName" id="supplierName" type="text" size="30" maxlength="50" class="inputBox pointer" onkeypress="return onKeyPress();">         
       </td>	   
      </tr>
      <tr>
      <td colspan="3">
