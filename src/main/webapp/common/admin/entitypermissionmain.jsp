...
//defaults.ops.name='<fmt:message key="label.all"/>';
//defaults.hub.name=labelnone;
//defaults.inv.name=labelnone;

defaults.ops.nodefault=false;
...
<title>
<fmt:message key="label.entitypermission">
...
function editOpsList() {
 openWinGeneric("opspermission.do?personnelId="+$v('personnelId')+"&uAction=editops" +
 				"&companyId="+$v('companyId')+"&fullName="+encodeURIComponent($v('fullName')) 
                ,"editopspage","720","600","yes","40","40","no");
}

function showLegend() {
	 openWinGeneric("entitypermissionresults.do?uAction=legend" ,"permissionlegend","600","600","yes","40","40","no");
}
...
<body bgcolor="#ffffff" onload="loadLayoutWin('','operationsPermission');setOps();" onresize="resizeFrames()">
...
<tcmis:form action="/entitypermissionresults.do" onsubmit="return submitSearchOnlyOnce();" target="resultFrame">
...
<div class="roundcont filterContainer">
 <div class="roundright">
   ...
   <div class="roundContent">
    ...
    <table width="380" id="searchTable" border="0" cellpadding="0" cellspacing="0" class="tableSearch">
    <tr>
