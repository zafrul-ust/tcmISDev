...
<script language="JavaScript" type="text/javascript">
	...
	// larry note, to use this array or to use the on 
	var facilityPermissionArray = new Array();
	<c:set var="counter" value='${0}'/>
	<c:forEach var="hubBean" items="${personnelBean.permissionBean.userGroupMemberBeanCollection}">
		<c:if test="${hubBean.userGroupId == 'Administrator'}">
			facilityPermissionArray["<c:out value="${counter}"/>"] = "<tcmis:jsReplace value="${hubBean.facilityId}"/>";
...
<tcmis:form action="/financialapproverresults.do" onsubmit="return submitFrameOnlyOnce();" target="resultFrame">
 ...
 <div class="roundright">
   ...
   <div class="roundContent">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableSearch">
      ...
      <tr>
      	<td width="33%" colspan="3" class="optionTitleRight" nowrap>
			<input name="Search" id="Search" type="button" value="<fmt:message key="label.search"/>" class="inputBtns" onmouseover="this.className='inputBtns inputBtnsOver'" onmouseout="this.className='inputBtns'" onclick="return search()"/>
			...
			<input name="cancel" id="cancel" type="button" value="<fmt:message key="label.cancel"/>" class="inputBtns" onmouseover="this.className='inputBtns inputBtnsOver'" onmouseout="this.className='inputBtns'" onclick="parent.window.close()"/>
		</td>
      	<td/>
      </tr>
    </table>
