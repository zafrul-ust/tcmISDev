...
<script type="text/javascript" src="/js/common/admin/editfacilitylistapprovalmain.js"></script>
...
<div class="roundright">
  ...
  <div class="roundContent">
    <div class="boxhead"> 
		...
		<a href="javascript:createXls()"><fmt:message key="label.createExcel"/></a> | 
		<a href="#" onclick="parent.window.close()"><fmt:message key="label.cancel"/></a>&nbsp;
  		</div>
    <div class="dataContent">
     <iframe id="resultFrame" name="resultFrame" width="100%" height="250" frameborder="0" marginwidth="0" src="editfacilitylistapprovalresults.do?personnelId=${personnelId}&action=search&companyId=${param.companyId}&facilityName=${param.facilityName}&facilityId=${param.facilityId}"></iframe>
   </div>
