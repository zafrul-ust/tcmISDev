...
<title>
<fmt:message key="label.pagePermissionsTitle"/>  (${logonId})
</title>
...
<body bgcolor="#ffffff" onload="setSearchFrameSize();checkCompany();">

<!--Uncomment for production-->
<tcmis:form action="/pagepermissionresults.do" onsubmit="return submitFrameOnlyOnce();" target="resultFrame">
