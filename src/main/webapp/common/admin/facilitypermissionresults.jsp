...
<fmt:bundle basename="com.tcmis.common.resources.VvUserGroup">
	 	<c:forEach var="HeaderBean" items="${facilityPermissionsHeaderBeanCollection}">
...
function validateForm() {
	for(i=0;i<haasGrid.getRowsNum();i++) {
		...
		for( j=0;j< headerCount; j++) {
			uacc+= haasGrid.cells(rowid,4+2*j).getValue()+"=";
...
<tcmis:form action="/facilitypermissionresults.do" onsubmit="return submitFrameOnlyOnce();">

<div class="interface" id="resultsPage">
<div class="backGroundContent">
<c:set var="dataCount" value='${0}'/>

<c:if test="${!empty FacilityAdminBeanCollection}" >
...
var jsonMainData = {
rows:[
<c:forEach var="bean" items="${FacilityAdminBeanCollection}" varStatus="status">
...
{ id:${status.index +1},
 data:[
  ...
  '${bean.companyId}',
  '<tcmis:jsReplace processAmpersand="true" value="${bean.facilityId}"/>',  
