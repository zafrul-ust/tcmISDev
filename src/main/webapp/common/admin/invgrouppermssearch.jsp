...
<%--<tcmis:form action="/invgroupperms.do" onsubmit="return submitFrameOnlyOnce();" target="resultFrame">--%>
...
<table id="searchMaskTable" width="500" border="1" cellpadding="0" cellspacing="0">
<tr><td>
<div class="roundcont filterContainer">
 <div class="roundright">
   ...
   <div class="roundContent">
    ...
    <table width="500" border="1" cellpadding="0" cellspacing="0" class="tableSearch">
 	  <tr >  
		...
		<td width="75%" class="optionTitleLeft" >      
 			<select name="hub" id="hub" class="selectBox">  
				<option value="hub01">hub 01</option>
				<option value="hub02">hub 02</option>
 			</select>
 		</td>    
	  </tr>  
 	  ...
 	  <tr >          
		...
		<td width="75%" class="optionTitleLeft">      
 			<select name="invGroup" id="invGroup" class="selectBox">  
				<option selected value="invGroup01">invGroup01</option>
				<option selected value="invGroup02">invGroup02</option>
 			</select>
			<input name="editInvGroupList" id="editInvGroupList" type="button" value="<fmt:message key="label.editlist"/>" class="inputBtns" onmouseover="this.className='inputBtns inputBtnsOver'" onmouseout="this.className='inputBtns'">
 		</td>       		  
	  </tr>  
