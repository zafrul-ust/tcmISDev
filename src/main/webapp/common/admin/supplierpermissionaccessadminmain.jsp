...
<script type="text/javascript" src="/js/common/admin/supplierpermissionaccessadminmain.js"></script>
...
<!-- action=start is there to decide in the action to query the database for the drop down in the search section.
 ...
 -->
<iframe id="searchFrame" name="searchFrame" width="100%" height="100" frameborder="0" marginwidth="0" style="" src="supplierpermissionaccessadminsearch.do?action=init&personnelId=<c:out value="${personnelId}"/>"></iframe>
...
<div class="roundright">
  ...
  <div class="roundContent">
    <div class="boxhead"> <%-- boxhead Begins --%>
     <%-- Place all update links in divs that can be turned on or off depending on the search criteria that is selected
      ...
      <span id="updateResultLink" style="display: none">
	      <a href="javascript:submitUpdate()"><fmt:message key="label.updatesupplierpermissionaccessadmin"/></a> | 
      </span>
	    <span id="cancelResultLink" style="display: none">
	      <a href="javascript:submitCancel()"><fmt:message key="label.cancel"/></a>
      </span>
      &nbsp;
    ...
    <div class="dataContent">
     <!-- 
     <iframe id="resultFrame" name="resultFrame" width="100%" height="250" frameborder="0" marginwidth="0" src="supplierpermissionaccessadminresults.do?action=search&personnelId=<c:out value="${personnelId}"/>"></iframe>
     -->
