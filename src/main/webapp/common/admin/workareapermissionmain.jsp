...
<title>
<fmt:message key="label.workareaPermissionsTitle"/> (${fullName})
</title>
...
<body bgcolor="#ffffff" onload="loadLayoutWin('','facilityDockPermission');setCompany();" onresize="resizeFrames()">
	...
	<div class="interface" id="mainPage" style="">
		<div id="searchFrameDiv" >
			<tcmis:form action="/workareapermissionresults.do" onsubmit="return submitSearchOnlyOnce();" target="resultFrame">
											...
											<table width="80%" border="0" cellpadding="0" cellspacing="0" class="tableSearch">
												...
												<tr>
													...
													<td class="optionTitleLeft" nowrap="nowrap">
														<input type="checkbox" id="hide" name="hide" value="hide" checked="checked"/><fmt:message key="label.showcurrentpermissiononly"/>
													</td>
												</tr>
												<tr>
