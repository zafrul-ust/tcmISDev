...
<script type="text/javascript" src="/js/common/admin/supplierpermissionmain.js"></script>
...
<title>
<fmt:message key="supplierpermission.title"/> (${fullName})
</title>
...
<!-- action=start is there to decide in the action to query the database for the drop down in the search section.
 ...
 -->
 <iframe id="searchFrame" name="searchFrame" width="100%" height="120" frameborder="0" marginwidth="0" style="" src="supplierpermissionsearch.do?personnelId=<c:out value="${personnelId}"/>"></iframe>
</div>
<!-- Search Frame Ends -->
    ...
    <div class="boxhead"> <%-- boxhead Begins --%>
     <%-- Place all update links in divs that can be turned on or off depending on the search criteria that is selected
      ...
      <span id="updateResultLink" style="display: none">
	      <a href="javascript:submitUpdate()"><fmt:message key="label.updatesupplierpermissions"/></a>
      </span>
      &nbsp;
