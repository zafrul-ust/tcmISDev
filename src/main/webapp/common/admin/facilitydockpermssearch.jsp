...
<script type="text/javascript" src="/js/common/admin/dockPermission.js"></script>
...
<title>
<fmt:message key="label.facilitydockperms"/> (${logonId})
</title>
...
<tcmis:form action="/dockpermissionresults.do" onsubmit="return submitFrameOnlyOnce();" target="resultFrame">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableSearch">
      ...
      <tr>
      	<td width="33%" class="optionTitleRight">
	   	...
	   	<td width="66%" class="optionTitleLeft" colspan="2">
