...
<%--<tcmis:form action="/hubperms.do" onsubmit="return submitFrameOnlyOnce();" target="resultFrame">--%>
    ...
    <table width="500" border="1" cellpadding="0" cellspacing="0" class="tableSearch">
 	  <tr >  
		...
		<td width="75%" class="optionTitleLeft">      
 			<select name="company" id="company" class="selectBox">  
				<option value="company01">company 01</option>
				<option value="company02">company 01</option>
 			</select>
 		</td>    
	  </tr>  
 	  ...
 	  <tr >              
		...
		<td width="75%" class="optionTitleLeft" >      
			...
			<input name="editHubList" id="editIHubList" type="button" value="<fmt:message key="label.editlist"/>" class="inputBtns" onmouseover="this.className='inputBtns inputBtnsOver'" onmouseout="this.className='inputBtns'"> 			
 		</td>    
	  </tr>  
