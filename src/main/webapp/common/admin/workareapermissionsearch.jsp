...
<title>
<fmt:message key="label.workareaPermissionsTitle"/> (${logonId})
</title>
...
<tcmis:form action="/workareapermissionresults.do" onsubmit="return submitFrameOnlyOnce();" target="resultFrame">
