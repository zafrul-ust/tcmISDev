...
<script type="text/javascript" src="/js/common/admin/supplierlocationpermissionsearch.js"></script>
...
<tcmis:form action="/supplierlocationpermissionresults.do" onsubmit="return submitFrameOnlyOnce();" target="resultFrame">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableSearch">
      ...
      <tr>
        ...
        <td>
	     ...
	     <td>
				<input type="checkbox" class="" name="hideSupplierLocation" id="hideSupplierLocation" value="<fmt:message key="label.hidesupplierlocation"/>" checked>
				<fmt:message key="label.hidesupplierlocation"/>
			</td>
      </tr>
      <tr>
      <td colspan="3">
