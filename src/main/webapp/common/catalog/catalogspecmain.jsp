...
<script type="text/javascript" src="/js/catalog/catalogspecmain.js"></script>
...
<title>
<fmt:message key="catalogspec.title"/>
</title>
...
<!-- action=start is there to decide in the action to query the database for the drop down in the search section.
 ...
 -->
 <iframe id="searchFrame" name="searchFrame" width="100%" height="115" frameborder="0" marginwidth="0" style="" src="catalogspecsearch.do?action=start&criterion=contains"></iframe>
</div>
<!-- Search Frame Ends -->
    ...
    <div class="boxhead"> <%-- boxhead Begins --%>
     <%-- Place all update links in divs that can be turned on or off depending on the search criteria that is selected
      ...
      <span id="showlegendLink">
        <a href="javascript:showCatalogSpecLegend()"><fmt:message key="label.showlegend"/></a>
      </span>
      <span id="updateResultLink" style="display: none">
<tcmis:catalogPermission indicator="true" userGroupId="CatalogSpec" catalogId="${param.catalogId}">
...
<div id="showLegendAreaBody" class="bd">
  <table width="100%" class="tableResults" border="0" cellpadding="0" cellspacing="0">
    <tr><td width="100px" class="yellow legendText">&nbsp;</td><td class="legendText"><fmt:message key="catalogspec.label.newrow"/></td></tr>
    <tr><td width="100px" class="black legendText">&nbsp;</td><td class="legendText"><fmt:message key="catalogspec.label.markedfordeletion"/></td></tr>
  </table>
</div>
</div>
