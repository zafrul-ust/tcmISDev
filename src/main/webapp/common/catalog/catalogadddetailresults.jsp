...
<tr class="alt">
	...
	<td>
		<c:out value="${catalogBean.requestor}"/>
	</td>
</tr>
<tr>
...
<tr class="alt">
	...
	<td>
		<c:out value="${catalogBean.facility}"/>
	</td>
</tr>
<tr>
	<td width="20%" class="optionTitleBoldLeft">
	...
	<td>
		<c:out value="${catalogBean.workarea}"/>
	</td>
</tr>
<tr class="alt">
	<td width="20%" class="optionTitleBoldLeft">
	...
	<td>
		<c:out value="${catalogBean.requestId}"/>
	</td>
</tr>
<tr>
	<td width="20%" class="optionTitleBoldLeft">
	...
	<td>
		<c:out value="${catalogBean.partDesc}"/>
	</td>
</tr>
<tr class="alt">
	<td width="20%" class="optionTitleBoldLeft">
	...
	<td>
		<c:out value="${catalogBean.processDesc}"/>
	</td>
</tr>
<tr>
...
<tr>
	...
	<td>
		<c:out value="${catalogBean.component}"/>
	</td>
</tr>
<tr class="alt">
	<td width="20%" class="optionTitleBoldLeft">
	...
	<td>
		<c:out value="${catalogBean.materialDesc}"/>
	</td>
</tr>
<tr>
	<td width="20%" class="optionTitleBoldLeft">
...
<tr class="alt">
	...
	<td>
		<c:out value="${catalogBean.tradeName}"/>
	</td>
</tr>
<tr>
	<td width="20%" class="optionTitleBoldLeft">
	...
	<td>
		<c:out value="${catalogBean.manufacturer}"/>
	</td>
</tr>
<tr class="alt">
	<td width="20%" class="optionTitleBoldLeft">
	...
	<td>
		<c:out value="${catalogBean.mfgPartNum}"/>
	</td>
</tr>
<tr>
	<td width="20%" class="optionTitleBoldLeft">
	...
	<td>
		<a href="/tcmIS/fec/ViewMsds?act=msds&showspec=N&id=<c:out value="${catalogBean.msdsNumber}"/>&cl=fec" target="msds">
			<c:out value="${catalogBean.msdsNumber}"/>
		</a>
	</td>
</tr>
<tr class="alt">
	...
	<td>
		<c:out value="${catalogBean.packaging}"/>
	</td>
</tr>
<tr>
	<td width="20%" class="optionTitleBoldLeft">
	...
	<td>
		<c:out value="${catalogBean.shellLife}"/>
	</td>
</tr>
<tr class="alt">
	<td width="20%" class="optionTitleBoldLeft">
	...
	<td>
		<c:out value="${catalogBean.storageTemp}"/>
	</td>
</tr>
<tr>
	<th class="optionTitleBoldCenter" colspan="2">
...
<tr>
	...
	<td>
		<c:out value="${catalogBean.supplier}"/>
	</td>
</tr>
<tr class="alt">
	<td width="20%" class="optionTitleBoldLeft">
	...
	<td>
		<c:out value="${catalogBean.contact}"/>
	</td>
</tr>
<tr>
	<td width="20%" class="optionTitleBoldLeft">
	...
	<td>
		<c:out value="${catalogBean.contactPhone}"/>
	</td>
</tr>
<tr class="alt">
	<td width="20%" class="optionTitleBoldLeft">
	...
	<td>
		<c:out value="${catalogBean.contactFax}"/>
	</td>
</tr>
<tr>
	<td width="20%" class="optionTitleBoldLeft">
	...
	<td>
		<c:out value="${catalogBean.contactEmail}"/>
	</td>
</tr>
<tr class="alt">
	<td width="20%" class="optionTitleBoldLeft">
	...
	<td>
		<c:out value="${catalogBean.supplierPartNum}"/>
	</td>
</tr>
<tr>
	<th class="optionTitleBoldCenter" colspan="2">
...
<tr>
	...
	<td>
		<c:out value="${catalogBean.itemId}"/>
	</td>
</tr>
<tr class="alt">
	<td width="20%" class="optionTitleBoldLeft">
	...
	<td>
		<c:out value="${catalogBean.itemDescription}"/>
	</td>
</tr>
<tr>
	<td width="20%" class="optionTitleBoldLeft">
...
<tr>
	<th class="optionTitleBoldCenter" colspan="2">
		<fmt:message key="label.partnumber"/> <fmt:message key="label.information"/>
	</th>
</tr>
<tr>
	<td width="20%" class="optionTitleBoldLeft">
	...
	<td>
		<select class="selectBox" name="catalogId" ID="catalogId">
		<!--  database valuss -->
		</select>	
	</td>
</tr>
<tr class="alt">
	<td width="20%" class="optionTitleBoldLeft">
		<fmt:message key="label.haas"/> <fmt:message key="label.item"/> <fmt:message key="label.price"/>:
	</td>
	<td>
		<c:out value="${catalogBean.haasItemPrice}"/>
	</td>
</tr>
<tr>
	<td width="20%" class="optionTitleBoldLeft">
		<fmt:message key="label.goodUntil"/>:
	</td>
	<td>
		<c:out value="${catalogBean.goodUntil}"/>
	</td>
</tr>
<tr class="alt">
	<td width="20%" class="optionTitleBoldLeft">
		<fmt:message key="label.partNno"/>:
	</td>
	<td>
		<input type="text" name="csmPartNo" value="<c:out value="${catalogBean.partNum}"/>" size="30">
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<b><fmt:message key="label.uom"/>:</b>
	<select class="selectBox" name="uom" id="uom">
		<option value="None"><fmt:message key="label.selectOne"/></option>
		<!-- database value -->
	</select>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<b><fmt:message key="label.unitprice"/>:</b>
	<input type="text" class="inputBox" name="unitOfSaleQtyPerEach" id="unitOfSaleQtyPerEach" value="<c:out value="${catalogBean.unitPrice}"/>" size="15"/>
</td>
</tr>
<tr/>
<tr>
	<td colspan="2">
		<input type="submit" class="inputBtns" onmouseover="this.className='inputBtns inputBtnsOver'" onmouseout="this.className='inputBtns'" value="<fmt:message key="label.approve"/>" name="approve"/>
	</td>
</tr>
<tr>
	<td colspan="2" class="optionTitleCenter">
		<a href="/tcmIS/fec/cataloging?Session=0&searchBy=Catalog">
			<fmt:message key="label.showAllRequestsPendingCatalog"/>
		</a>
	</td>
</tr>
