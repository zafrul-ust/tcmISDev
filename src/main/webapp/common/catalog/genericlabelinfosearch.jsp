...
<tr>
	<td width="5%" class="optionTitleBoldRight">
		<fmt:message key="label.haas"/> <fmt:message key="label.itemid"/>:
	</td>
	<td width="15%" class="optionTitleLeft">
		<input class="inputBox" type="text" name="itemId" id="itemId" value="" size="10"/>
	</td>
	<td width="10%" class="optionTitleBoldRight">
		<fmt:message key="label.seagate"/> <fmt:message key="label.catalogpartnumber"/>:
	</td>
	<td width="15%" class="optionTitleLeft">
		<input class="inputBox" type="text" name="csmPartNo" id="csmPartNo" value="" size="10"/>
	</td>
	<td width="5%">
		<input type="submit" class="inputBtns" onmouseover="this.className='inputBtns inputBtnsOver'" onmouseout="this.className='inputBtns'" value="Search" name="SearchButton"/>
	</td>
	<td width="5%"/>
</tr>
<tr>
...
<tr>
	...
	<td witdh="85%">
		<select class="selectBox" name="health" id="health">
			<option value="">
...
<tr>
	...
	<td witdh="85%" class="optionTitleLeft">
		<select class="selectBox" name="flamability" id="flamability">
			<option value="">
				<fmt:message key="label.pleaseselect"/>
			</option>
			<!-- query value -->
...
<tr>
	...
	<td witdh="85%">
		<select class="selectBox" name="reactivity" id="reactivity">
			<option value="">
				<fmt:message key="label.pleaseselect"/>
			</option>
			<!-- query value -->
...
<tr>
	...
	<td witdh="85%" CLASS="Inbluel">
		<select class="selectBox" name="chemicalStorage" id="chemicalStorage">
			<option value="">
				<fmt:message key="label.pleaseselect"/>
			</option>
			<!-- query value -->
...
<tr>
	...
	<td witdh="85%">
		<select class="selectBox" name="perprotectiveEquip" id="perprotectiveEquip">
			<option value="">
				<fmt:message key="label.pleaseselect"/>
			</option>
			<!-- query value -->
...
<tr>
	...
	<td witdh="85%">
		<select class="selectBox" name="hazard" id="hazard">
			<option value="">
				<fmt:message key="label.pleaseselect"/>
			</option>
			<!-- query value -->
...
<tr>
	...
	<td witdh="85%">
		<select class="selectBox" name="disposableCode" id="disposableCode">
			<option value="">
				<fmt:message key="label.pleaseselect"/>
			</option>
			<!-- query value -->
...
<tr>
	...
	<td witdh="85%">
		<select class="selectBox" name="disposableContainerCode" id="disposableContainerCode">
			<option value="">
				<fmt:message key="label.pleaseselect"/>
			</option>
			<!-- query value -->
