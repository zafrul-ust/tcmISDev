...
<title>
<fmt:message key="label.labelinforequest"/>
</title>
...
<tr>
	...
	<th><fmt:message key="label.seagate"/> <fmt:message key="label.requestid"/></th>
    ...
    <tr class="<c:out value="${colorClass}"/>" id="rowId<c:out value="${status.index}"/>">
     <td width="5%">
     	<c:out value="${status.current.requestId}"/>
     </td>
     <td width="5%">
       	<c:out value="${status.current.seagate}"/>
     </td>
     <td width="5%">
       	<c:out value="${status.current.requested}"/>
     </td>
     <td width="5%">
       	<c:out value="${status.current.requestor}"/>
     </td>
     <td width="5%">
       	<c:out value="${status.current.facility}"/>
     </td>
     <td width="5%">
      	<c:out value="${status.current.workarea}"/>
     </td>
   </tr>
