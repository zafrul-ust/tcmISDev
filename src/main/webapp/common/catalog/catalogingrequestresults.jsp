...
<title>
<fmt:message key="label.catalogingrequest"/>
</title>
...
<c:set var="dataCount" value='${0}'/>
 ...
 <%--<c:if test="${!empty pageNameViewBeanCollection}" >--%>
    ...
    <tr>
<th><fmt:message key="label.requestid"/></th>
<th><fmt:message key="label.requested"/></th>
<th><fmt:message key="label.requestor"/></th>
<th><fmt:message key="label.facility"/></th>
...
<td>
	<a href="/tcmIS/fec/cataloging?Session=1&approvalRole=Catalog&request_id=<c:out value="${status.current.requestid}"/>"><c:out value="${status.current.requestid}"/>
	</a>
</td>
<td><c:out value="${status.current.requested}"/></td>
<td><c:out value="${status.current.requestor}"/></td>
<td><c:out value="${status.current.facility}"/></td>
<td><c:out value="${status.current.workarea}"/></td>
   </tr>
