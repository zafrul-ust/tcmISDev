...
<tcmis:form action="/catalogspecresult.do" onsubmit="return submitFrameOnlyOnce();" target="resultFrame">
...
<%--
          <select name="catalogId" id="catalogId" class="selectBox">
            <option value="Andover" selected>Andover</option>
          </select>
--%>

        <html:select property="catalogId" styleClass="selectBox" styleId="catalogId">
          <html:options collection="personnelCatalogViewBeanCollection" property="catalogId"/>
        </html:select>


       </td>
        <td>
        <html:select property="criteria" styleClass="selectBox" styleId="criteria">
          <html:option value="catPartNo" key="label.partnumber"/>
          <html:option value="specId" key="label.specification"/>
        </html:select>
...
<input name="search" id="search" type="text" class="inputBox" value="<c:out value="${param.search}"/>">
       </td>
      </tr>
      ...
      <tr>
        ...
        <html:select property="sortBy" styleClass="selectBox" styleId="sortBy">
          <html:option value="cps" key="catalogspec.label.catalogpartspec"/>
          <html:option value="scp" key="catalogspec.label.speccatalogpart"/>
        </html:select>
       </td>
        <td>&nbsp;</td>
      </tr>
