...
<title>
<fmt:message key="label.showstoragelocations"/>-${param.materialId}
</title>
...
<!--
 var gridConfig = {
	divName:'workAreaBean', // the div id to contain the grid.
...
<tcmis:form action="/storagelocations.do" onsubmit="return submitFrameOnlyOnce();">
      ...
      <div id="mainUpdateLinks"> 
         <table>
         	<tr>
         		...
         		<td>${param.facilityName}</td>
         	</tr>
         	<tr>
         		<td class="optionTitleBoldRight" nowrap><fmt:message key="label.msds"/> : </td>
         		<td>${param.msdsNo}</td>
         	</tr>
         	<tr>
         		<td class="optionTitleBoldRight" nowrap><fmt:message key="label.tradename"/> : </td>
         		<td>${param.tradeName}</td>
         	</tr>
         	<tr>
         		<td class="optionTitleBoldRight" nowrap><fmt:message key="label.description"/> : </td>
         		<td>${param.desc}</td>
         	</tr>
         	<tr>
         		<td class="optionTitleBoldRight" nowrap><fmt:message key="label.manufacturer"/> : </td>
         		<td>${param.mfgDesc}</td>
         	</tr>
         	<tr>
         	...
         	<tr>
         		<td class="optionTitleBoldLeft" nowrap><fmt:message key="label.locations"/> : </td>
         		<td>&nbsp;</td>
         	</tr>
         </table>
...
<div id="workAreaBean" style="height:400px;display: none;" ></div>
<c:if test="${workAreaColl != null}" >

<%--NEW - storing the data to be displayed in the grid in a JSON.--%>
<c:set var="dataCount" value='${0}'/>
<c:if test="${!empty workAreaColl}" >
    <script type="text/javascript">
    <!--
        var jsonMainData = new Array();
        var jsonMainData = {
        rows:[
        <c:forEach var="workAreaBean" items="${workAreaColl}" varStatus="status">
   
        <c:if test="${status.index > 0}">,</c:if>
  		<tcmis:jsReplace var="applicationDesc" value='${workAreaBean.applicationDesc}' processMultiLines="true"/>
