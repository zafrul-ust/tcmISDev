...
<SCRIPT SRC="/js/cal/inventory.js" LANGUAGE="JavaScript"></SCRIPT>
...
<TD width="5%" rowspan="<c:out value="${mainRowSpan}"/>"><c:out value="${status.current.qtyInPurchasing}"/></TD>
...
<c:forEach var="pkgInventoryDetailItemBean" items="${itemCollection}" varStatus="status1">
  ...
  <TD width="5%" rowspan="<c:out value="${componentSize}"/>"><c:out value="${itemId}"/></TD>
...
<DIV class="menuitems" url="javascript:showInventoryDetails();">Inventory Detail<BR><BR></DIV>
</DIV>
