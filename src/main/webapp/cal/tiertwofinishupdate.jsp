...
<html:form action="/tiertwo3update.do" onsubmit="return validateTiertwoForm(this);">
<table border="0">
  <tr>
    <th >
...
<%-- third section of page, only shows after location is picked --%>
    ...
    <td>
      <font face=Verdana size=2>
        <logic:present name="sicBeanCollection" scope="request">
          <html:select name="TierTwoInputBean" property="sicCode">
 ...
 <logic:present name="FacTierIiBean" scope="request">
  ...
  <tr>
    ...
    <td>
      <font face=Verdana size=2>
          <html:text name="FacTierIiBean" property="ownerOperatorName"/>
      </font>
    </td>
  </tr>
  <tr>
    ...
    <td>
      <font face=Verdana size=2>
          <html:text name="FacTierIiBean" property="ownerOperatorPhone"/>
      </font>
    </td>
  </tr>
  <tr>
    ...
    <td>
      <font face=Verdana size=2>
          <html:text name="FacTierIiBean" property="ownerOperatorMail"/>
      </font>
    </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>
      <font face=Verdana size=2>
          <html:text name="FacTierIiBean" property="emergencyName1"/>
      </font>
    </td>
  </tr>
  <tr>
    ...
    <td>
      <font face=Verdana size=2>
          <html:text name="FacTierIiBean" property="emergencyTitle1"/>
      </font>
    </td>
  </tr>
  <tr>
    ...
    <td>
      <font face=Verdana size=2>
          <html:text name="FacTierIiBean" property="emergencyPhone1"/>
      </font>
    </td>
  </tr>
  <tr>
    ...
    <td>
      <font face=Verdana size=2>
          <html:text name="FacTierIiBean" property="emergency24HrPhone1"/>
      </font>
    </td>
  </tr>
  <tr><td>&nbsp;</td></tr>
  <tr>
    ...
    <td>
      <font face=Verdana size=2>
          <html:text name="FacTierIiBean" property="emergencyName2"/>
      </font>
    </td>
  </tr>
  <tr>
    ...
    <td>
      <font face=Verdana size=2>
          <html:text name="FacTierIiBean" property="emergencyTitle2"/>
      </font>
    </td>
  </tr>
  <tr>
    ...
    <td>
      <font face=Verdana size=2>
          <html:text name="FacTierIiBean" property="emergencyPhone2"/>
      </font>
    </td>
  </tr>
  <tr>
    ...
    <td>
      <font face=Verdana size=2  color="white">
          <html:text name="FacTierIiBean" property="emergency24HrPhone2"/>
      </font>
    </td>
  </tr>
  <tr>
    ...
    <td>
      <font face=Verdana size=2>
          <html:text name="FacTierIiBean" property="dateSigned"/>
      </font>
    </td>
  </tr>
  <tr>
    <td colspan="2">
      <font face=Verdana size=2>
          ...
          <html:checkbox name="FacTierIiBean" property="identicalToPriorYear" value="Y"/>
      </font>
    </td>
  </tr>
  <tr>
    <td colspan="2">
      <font face=Verdana size=2>
          <bean:message key="tiertwo.label.process"/>
          <html:checkbox property="process" value="Y"/>
      </font>
    </td>
  </tr>
  <tr>
    <td colspan="2">
      <font face=Verdana size=2>
          ...
          <html:checkbox name="FacTierIiBean" property="sitePlanAttached" value="Y"/>
      </font>
    </td>
  </tr>
  <tr>
    <td colspan="2">
      <font face=Verdana size=2>
          ...
          <html:checkbox name="FacTierIiBean" property="siteCoordAbbrAttached" value="Y"/>
      </font>
    </td>
  </tr>
  <tr>
    <td colspan="2">
      <font face=Verdana size=2>
          ...
          <html:checkbox name="FacTierIiBean" property="dikeDescAttached" value="Y"/>
      </font>
    </td>
  </tr>
  </logic:present>
    ...
    <td colspan="2">
      <font face=Verdana size=2>
        <html:submit property="submit">
          <bean:message key="tiertwo.button.generateupdate"/>
        </html:submit>
      </font>
    </td>
  </tr>
