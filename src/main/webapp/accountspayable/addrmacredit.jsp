...
<title>
<fmt:message key="label.addrmaline"/>
</title>
...
<%--<tcmis:form action="/addrmacreditline.do" onsubmit="return submitOnlyOnce();">--%>
   ...
   <div class="roundContent">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableSearch">
      ...
      <tr>
        ...
        <td width="70%" ><input name="reference" id="reference" type="text" class="inputBox" value="<c:out value="${status.current.reference}"/>"></td>
      </tr>
      ...
      <tr>
        <td width="10%" class="optionTitleBoldCenter"><fmt:message key="label.rma"/>:</td>
        <td width="20%" class="optionTitleBoldCenter"><input name="rmaQty" id="rmaQty" type="text" class="inputBox" value="<c:out value="${status.current.rmaQty}"/>"></td>
        <td width="70%" class="optionTitleBoldCenter"><input name="rmaUnitPrice" id="rmaUnitPrice" type="text" class="inputBox" value="<c:out value="${status.current.rmaUnitPrice}"/>"></td>        
      </tr>
...
<!--Uncomment for production-->
<%--<c:if test="${addrmacreditlineViewBeanCollection != null}" >--%>
