...
<script SRC="/js/common/report/receiptdocumentviewer.js" language="JavaScript"></script>
...
<tcmis:form action="/receiptdocumentviewer.do" onsubmit="return submitOnlyOnce();">
...
<table border=0 width=100% >
  ...
  <td align="right">
   <img src="/images/deliveries.gif" border=0 align="right">
  </td>
  </tr>
</table>
...
<%@ include file="/common/report/receiptdocumentviewersearch.jsp" %>
<%@ include file="/common/report/receiptdocumentviewerdetail.jsp" %>
