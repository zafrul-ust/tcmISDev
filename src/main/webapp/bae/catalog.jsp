...
<tr>
<td width="10%" class="optionTitleBoldRight">
<html:submit property="submitSearch" styleId="submitSearch" styleClass="inputBtns" onmouseover="this.className='inputBtns inputBtnsOver'" onmouseout="this.className='inputBtns'" onclick="document.genericForm.target='';document.genericForm.action='/tcmIS/ray/catalog.do'">
     <fmt:message key="label.search"/>
</html:submit>
</td>

<td width="90%"  class="optionTitleBoldLeft">
<html:submit property="buttonCreateExcel" styleId="submitSearch" styleClass="inputBtns" onmouseover="this.className='inputBtns inputBtnsOver'" onmouseout="this.className='inputBtns'" onclick="document.genericForm.target='';document.genericForm.action='/tcmIS/ray/catalog.do'">
...
<html:hidden property="catalog" value=""/>
