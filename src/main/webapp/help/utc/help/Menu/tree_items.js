					...
					item:[ 
						{id:400, text:"Order Management",userdata:[{name:"location", content:"../SupplyChain/OrderManagement.htm"}], 
							item:[
								{id:410, text:"Catalog",userdata:[{name:"location", content:"../Catalog/Catalog.htm"}],
									item:[
										{id:4100, text:"Engineering Evaluation",userdata:[{name:"location", content:"../EngineeringEval/EngineeringEval.htm"}]},
										{id:4150, text:"Catalog Add Requests",userdata:[{name:"location", content:"../CatalogAdd/CatAddReq.htm"}],
											item:[
												{id:4151, text:"CatAddReq-QPL",userdata:[{name:"location", content:"../CatalogAdd/CatAddReq-QPL.htm"}]}, 
												{id:4152, text:"CatAddReq-Use Approval",userdata:[{name:"location", content:"../CatalogAdd/CatAddReq-UseApproval.htm"}]}, 
												{id:4153, text:"CatAddReq-Spec",userdata:[{name:"location", content:"../CatalogAdd/CatAddReq-Spec.htm"}]}, 
												{id:4154, text:"CatAddReq-Flowdown",userdata:[{name:"location", content:"../CatalogAdd/CatAddReq-Flowdown.htm"}]}
											]}
									]},
								...
								{id:470, text:"Customer Purchasing",userdata:[{name:"location", content:"../SupplyChain/Purchasing.htm"}],
									item:[
										{id:4700, text:"Customer Buy Orders",userdata:[{name:"location", content:"../CustomerPurchasing/CustomerBuyOrders.htm"}]},		  		    	        	    	                  
										{id:4710, text:"Customer Purchasing",userdata:[{name:"location", content:"../CustomerPurchasing/CustomerPurchasing.htm"}]}		  		    	        	    	                  
									]},		
								{id:480, text:"Spec Update",userdata:[{name:"location", content:"../SpecUpdate/SpecUpdate.htm"}]}
							]},	
						{id:500, text:"Reports",userdata:[{name:"location", content:"../SupplyChain/Reports.htm"}],
							item:[
								...
								{id:540, text:"Inventory",userdata:[{name:"location", content:"../SupplyChain/Reports-Inventory.htm"}],
									item:[
										{id:541, text:"Work Area Stock Turns",userdata:[{name:"location", content:"../WorkAreaStockTurns/WorkAreaStockTurnsReport.htm"}]}, 
										{id:543, text:"Consigned Inventory Report",userdata:[{name:"location", content:"../ConsignmentReport/ConsignmentReport.htm"}]}, 
								...
								{id:590, text:"Usage",userdata:[{name:"location", content:"../SupplyChain/UsageReport.htm"}],
									item:[
										...
										{id:592, text:"Ad Hoc Usage",userdata:[{name:"location", content:"../AdHocUsage/AdHocUsage.htm"}]}		  		    	        	    	                  
									]}			
							]},	
						{id:600, text:"Supply Chain",userdata:[{name:"location", content:"../SupplyChain/SupplyChain.htm"}],
							item:[
								{id:610, text:"Charge Numbers Set Up",userdata:[{name:"location", content:"../ChargeNumbers/ChargeNumbers.htm"}]},
								{id:620, text:"Stock Room Operations",userdata:[{name:"location", content:"../SupplyChain/StockRoomOperations.htm"}],
									item:[
										{id:6200, text:"Receiving",userdata:[{name:"location", content:"../SupplyChain/Receiving.htm"}],
											item:[
												{id:6210, text:"MARS Request",userdata:[{name:"location", content:"../IncomingTest/IncomingTest.htm"}]}
											]}
									]},
