					...
					item:[ 
						{id:400, text:"Order Management",userdata:[{name:"location", content:"../SupplyChain/OrderManagement.htm"}], 
							item:[
									...
									item:[
										...
										{id:4100, text:"Catalog Add Requests",userdata:[{name:"location", content:"../CatalogAdd/CatAddReq.htm"}],
											item:[
												...
												{id:4103, text:"CatAddReq-Use Approval",userdata:[{name:"location", content:"../CatalogAdd/CatAddReq-UseApproval.htm"}]}, 
												{id:4104, text:"CatAddReq-Spec",userdata:[{name:"location", content:"../CatalogAdd/CatAddReq-Spec.htm"}]}, 
												{id:4105, text:"CatAddReq-Flowdown",userdata:[{name:"location", content:"../CatalogAdd/CatAddReq-Flowdown.htm"}]}
											]}
									]},
								...
								{id:440, text:"Delivery Confirmation",userdata:[{name:"location", content:"../DeliveryConfirmation/DeliveryConfirmation.htm"}]},
								...
								{id:480, text:"Customer Purchasing",userdata:[{name:"location", content:"../SupplyChain/Purchasing.htm"}],
									item:[
										{id:4810, text:"Customer Buy Orders",userdata:[{name:"location", content:"../CustomerPurchasing/CustomerBuyOrders.htm"}]},
										{id:4820, text:"Customer Purchasing",userdata:[{name:"location", content:"../CustomerPurchasing/CustomerPurchasing.htm"}]}
									]}
							]},	
						{id:500, text:"Reports",userdata:[{name:"location", content:"../SupplyChain/Reports.htm"}],
							item:[
								...
								{id:525, text:"MSDS Analysis",userdata:[{name:"location", content:"../MSDSAnalysis/MSDSAnalysis.htm"}]},
								...
								{id:540, text:"Inventory",userdata:[{name:"location", content:"../SupplyChain/InventoryReport.htm"}],
									item:[
										{id:541, text:"Work Area Stock Turns",userdata:[{name:"location", content:"../WorkAreaStockTurns/WorkAreaStockTurnsReport.htm"}]}, 
										{id:542, text:"Consigned Inventory Report",userdata:[{name:"location", content:"../ConsignmentReport/ConsignmentReport.htm"}]}, 
										{id:553, text:"Stocked Inventory",userdata:[{name:"location", content:"../StockedInventory/StockedInventory.htm"}]},  		    	        	    	         		    	        	    	        	       
										{id:554, text:"Work Area Scan Score Report",userdata:[{name:"location", content:"../WorkAreaScanScore/WorkAreaScanScoreReport.htm"}]},  		    	        	    	         		    	        	    	        	       
										{id:545, text:"Work Area Detail",userdata:[{name:"location", content:"../WorkAreaDetail/WorkAreaDetail.htm"}]}, 
										{id:546, text:"Work Area Inventory",userdata:[{name:"location", content:"../WorkAreaInventory/WorkAreaInventory.htm"}]},
										{id:801, text:"Ad Hoc Inventory",userdata:[{name:"location", content:"../AdHocInventory/AdHocInventory.htm"}]}  
									]},
								{id:590, text:"Usage",userdata:[{name:"location", content:"../SupplyChain/UsageReport.htm"}],
									item:[
										{id:593, text:"Ad Hoc Material Matrix",userdata:[{name:"location", content:"../MaterialMatrix/MaterialMatrix.htm"}]},
						...
						{id:600, text:"Supply Chain",userdata:[{name:"location", content:"../SupplyChain/SupplyChain.htm"}],
							item:[
								{id:620, text:"Charge Numbers Set Up",userdata:[{name:"location", content:"../ChargeNumbers/ChargeNumbers.htm"}]},
								{id:630, text:"Stock Room Operations",userdata:[{name:"location", content:"../SupplyChain/StockRoomOperations.htm"}],
									item:[
										{id:635, text:"Receiving",userdata:[{name:"location", content:"../SupplyChain/Receiving.htm"}],
											item:[
												{id:6350, text:"MARS Requests",userdata:[{name:"location", content:"../MARSRequests/MARSRequests.htm"}]}
											]}
									]},
								{id:640, text:"Work Area Inventory",userdata:[{name:"location", content:"../SupplyChain/WorkAreaInventory.htm"}],
									item:[
										{id:641, text:"Scanner Training",userdata:[{name:"location", content:"../ScannerTraining/ScannerTraining.htm"}]}, 
										{id:642, text:"Work Area Count",userdata:[{name:"location", content:"../WorkAreas/WorkAreaCount.htm"}]},  
										{id:643, text:"Work Area Definition",userdata:[{name:"location", content:"../WorkAreas/WorkAreaDefinition.htm"}]},  
										{id:644, text:"Work Area Labels",userdata:[{name:"location", content:"../WorkAreas/WorkAreaLabels.htm"}]},
										{id:645, text:"Work Area Stock Management",userdata:[{name:"location", content:"../WorkAreas/WorkAreaStockMgmt.htm"}],
											item:[
												{id:6450, text:"Nonmanaged Materials",userdata:[{name:"location", content:"../WorkAreas/NonmanagedMaterials.htm"}]}
											]},
										{id:646, text:"Work Area Inventory",userdata:[{name:"location", content:"../WorkAreaInventory/WorkAreaInventory.htm"}]}
									]}
							]}, //end supply chain
						{id:700, text:"Administration",userdata:[{name:"location", content:"../SupplyChain/Admin.htm"}],
							item:[
								...
								{id:703, text:"Charge Number Management",userdata:[{name:"location", content:"../ChargeNumbers/ChargeNumberManagement.htm"}]}
							]},
	...
	['tcmIS Application', './intropage.html',
		...
		['Menu Structure', './intropage.html',
			['Order Management',  '../SupplyChain/OrderManagement.htm',
				['Engineering Evaluation','../EngineeringEval/EngineeringEval.htm'],
				['Material Catalog','../MaterialCatalog/MaterialCatalog.htm'],
				['Catalog','../Catalog/Catalog.htm',
					['Catalog Addition Requests','../CatalogAdd/CatAddReq.htm'
						['CatAddReq-QPL','../CatalogAdd/CatAddReq-QPL.htm'],
						['CatAddReq-HMRB','../CatalogAdd/CatAddReq-HMRB.htm'],
				...
				['Order Tracking',  '../OrderTracking/OrderTracking.htm'
					['Material Requests','../MaterialRequest/MaterialRequest.htm'],
					['MR Allocation','../MRAllocation/MRAllocation.htm'],
				],
			...
			['Reports',  '../SupplyChain/Reports.htm',
				...
				['MSDS Analysis',  '../MSDSAnalysis/MSDSAnalysis.htm'],
				...
				['Usage',  '../SupplyChain/UsageReport.htm',
					['Usage Import Info','../UsageImport/UsageImportInfo.htm'],
					['Usage Import','../UsageImport/UsageImport.htm'],
		...
		['Administration',  '../SupplyChain/Admin.htm',
			...
			['Charge Number Management',  '../ChargeNumbers/ChargeNumberManagement.htm'],
		],
		['MSDS', '../MSDS/MSDS.htm'],			
		],//end menu structure
