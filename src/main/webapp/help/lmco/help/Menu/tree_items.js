							...
							item:[
								{id:410, text:"Catalog",userdata:[{name:"location", content:"../Catalog/Catalog.htm"}],
									item:[
										...
										{id:4060, text:"Material Catalog",userdata:[{name:"location", content:"../MaterialCatalog/MaterialCatalog.htm"}]},
										{id:4100, text:"Catalog Add Requests",userdata:[{name:"location", content:"../CatalogAdd/CatAddReq.htm"}],
											item:[
												...
												{id:4102, text:"CatAddReq-HMRB",userdata:[{name:"location", content:"../CatalogAdd/CatAddReq-HMRB.htm"}]}, 
						...
						{id:500, text:"Reports",userdata:[{name:"location", content:"../SupplyChain/Reports.htm"}],
							item:[
								...
								{id:590, text:"Usage",userdata:[{name:"location", content:"../SupplyChain/UsageReport.htm"}],
									item:[
										{id:591, text:"Usage Import Info",userdata:[{name:"location", content:"../UsageImport/UsageImportInfo.htm"}]},
										{id:592, text:"Usage Import",userdata:[{name:"location", content:"../UsageImport/UsageImport.htm"}]},
