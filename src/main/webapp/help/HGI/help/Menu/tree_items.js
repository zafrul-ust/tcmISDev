...
{id:0,
	item:[ 
		{id:1, text:"tcmIS Haas Home", userdata:[{name:"location", content:"../Home/Home.htm"}],
			item:[
						...
						{id:400, text:"Order Management",userdata:[{name:"location", content:"../SupplyChain/OrderManagement.htm"}], 
							item:[
								{id:410, text:"Catalog",userdata:[{name:"location", content:"../Catalog/Catalog.htm"}],
									item:[
										{id:4100, text:"Catalog Addition Requests",userdata:[{name:"location", content:"../CatalogAdd/CatAddReq.htm"}],
											item:[
							...
							item:[
								...
								{id:640, text:"Work Area Inventory",userdata:[{name:"location", content:"../SupplyChain/WorkAreaInventory.htm"}],
									item:[
										...
										{id:643, text:"Work Area Definition",userdata:[{name:"location", content:"../WorkAreas/WorkAreaDefinitions.htm"}]},  
