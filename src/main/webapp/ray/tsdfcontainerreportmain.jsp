...
<script src="/js/common/waste/tsdfcontainerreportmain.js" language="JavaScript"></script>
...
<!-- action=start is there to decide in the action to query the database for the drop down in the search section.
 ...
 -->
 <iframe id="searchFrame" name="searchFrame" width="100%" height="150" frameborder="0" marginwidth="0" style="" src="/tcmIS/ray/tsdfcontainerreport.do?action=start"></iframe>
</div>
<!-- Search Frame Ends -->
