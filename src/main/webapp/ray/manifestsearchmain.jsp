...
<script src="/js/common/waste/manifestsearchmain.js" language="JavaScript"></script>

<!-- These are for the Grid, uncomment if you are going to use the grid -->
<script src="/js/dhtmlxGrid/dhtmlXCommon.js"></script>

<title>
<fmt:message key="manifestsearch.title"/>
</title>
...
<!-- action=start is there to decide in the action to query the database for the drop down in the search section.
 ...
 -->
 <iframe id="searchFrame" name="searchFrame" width="100%" height="150" frameborder="0" marginwidth="0" style="" src="/tcmIS/ray/manifestsearch.do"></iframe>
</div>
<!-- Search Frame Ends -->
