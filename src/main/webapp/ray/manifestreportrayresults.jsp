...
selectedManifest:"<fmt:message key="label.selectedmanifest"/>",
...
<tcmis:form action="/manifestreport.do" onsubmit="return submitFrameOnlyOnce();">
...
<%@ include file="/common/waste/manifestreportresults.jsp" %>
