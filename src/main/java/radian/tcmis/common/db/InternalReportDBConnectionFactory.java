 ...
 * radian.tcmis.sql.ConnectionPool. Remember to return connections to the
 * connection pool once you are done using them.
 */
public class InternalReportDBConnectionFactory {
   ...
   ****************************************************************************/
  public InternalReportDBConnectionFactory() {
    //connection pool for production
    if (cp == null) {
      //resource = new ResourceLibrary("InternalReportTcmISDatabase");
      try {
    ...
    if (cpTest == null) {
      //resourceTest = new ResourceLibrary("InternalReportTestTcmISDatabase");
      try {
   ...
   ****************************************************************************/
  public InternalReportDBConnectionFactory(String logonVersion) {
    this();
  }
   ...
   ****************************************************************************/
  public InternalReportDBConnectionFactory getInstance() {
    return new InternalReportDBConnectionFactory();
  }
   ...
   ****************************************************************************/
  public InternalReportDBConnectionFactory getInstance(String logonVersion) {
  ...
  public Connection getFreshConnection() throws Exception {
    return cp.getConnection("INTERNAL_REPORT");
  }
  ...
  public Connection getFreshTestConnection() throws Exception {
    return cpTest.getConnection("INTERNAL_REPORT_TEST");
  }
