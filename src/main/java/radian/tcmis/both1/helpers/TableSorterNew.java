 ...
 */
public class TableSorterNew implements Serializable{
  AttributiveCellTableModel model;

  public TableSorterNew(AttributiveCellTableModel model) {
    this.model = model;
  }
  ...
  public void sort(int column, boolean isAscent) {
    ...
    for (int l = 0; l < indexes.length; l++) {
          ...
          //System.out.println("----- sortByColumn values: "+model.getValueAt(indexes[l], column));
    }
