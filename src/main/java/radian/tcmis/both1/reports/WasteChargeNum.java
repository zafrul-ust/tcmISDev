...
public class WasteChargeNum {
  ...
  //public WasteChargeNum(String vendorProfile, String cnum1,String cnum2,String percent){
  public WasteChargeNum(String tempLine, String cnum1,String cnum2,String percent){
  ...
  //public WasteChargeNum(String vendorProfile){
  public WasteChargeNum(String tempLine){
    //this.vendorProfile = vendorProfile;
    this.line = tempLine;
    cNum = "";
    cNum2 = "";
  ...
  public static Vector getVector(Vector lineItems){
    ...
    for(int i=0;i<lineItems.size();i++){
      ...
      //String vendorProfile = h.get("VENDOR_PROFILE").toString();
      String tempLine = h.get("LINE_NUM").toString();
      ...
      for(int j=0;j<v2.size();j++){
        ...
        v.addElement(new WasteChargeNum(tempLine,cnum1,cnum2,percentage));
      }
      if(!hasOne){
        //System.out.println("doesn't have one");
        //v.addElement(new WasteChargeNum(vendorProfile));
        v.addElement(new WasteChargeNum(tempLine));
      }
    }
    return v;
  }
