...
public class SeagateMaterialRequest extends HttpServlet {
   ...
   public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    SeagateTcmISDBModel db = null;
      try {
        ...
        MaterialRequest obj = new MaterialRequest((ServerResourceBundle) new SeagateServerResourceBundle(),db);
