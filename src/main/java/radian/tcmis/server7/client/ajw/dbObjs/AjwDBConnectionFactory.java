package radian.tcmis.server7.client.ajw.dbObjs;
	 ...
	 */
	public class AjwDBConnectionFactory {
	   ...
	   ****************************************************************************/
	  public AjwDBConnectionFactory(String logonVersion) {
	    this();
	  }
	   ...
	   ****************************************************************************/
	  public AjwDBConnectionFactory getInstance() {
	    return new AjwDBConnectionFactory();
	  }
	   ...
	   ****************************************************************************/
	  public AjwDBConnectionFactory getInstance(String logonVersion) {
