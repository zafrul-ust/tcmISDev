 ...
 */
public class DRSDBConnectionFactory {
  ...
  public DRSDBConnectionFactory() {
    ...
    if (cpTest == null) {
      //resourceTest = new ResourceLibrary("DRSTestTcmISDatabase");
      try {
   ...
   ****************************************************************************/
  public DRSDBConnectionFactory(String logonVersion) {
    this();
  }
   ...
   ****************************************************************************/
  public DRSDBConnectionFactory getInstance() {
    return new DRSDBConnectionFactory();
  }
   ...
   ****************************************************************************/
  public DRSDBConnectionFactory getInstance(String logonVersion) {
  ...
  public Connection getFreshTestConnection() throws Exception {
    return cpTest.getConnection("DRS_TEST");
  }
