package radian.tcmis.server7.client.bombardier.dbObjs;
	 ...
	 */
	public class BombardierDBConnectionFactory {
	   ...
	   ****************************************************************************/
	  public BombardierDBConnectionFactory() {
	    //connection pool for production
	    if (cp == null) {
	      //resource = new ResourceLibrary("BombardierTcmISDatabase");
	      try {
	    ...
	    if (cpTest == null) {
	      //resourceTest = new ResourceLibrary("BombardierTestTcmISDatabase");
	      try {
	   ...
	   ****************************************************************************/
	  public BombardierDBConnectionFactory(String logonVersion) {
	    this();
	  }
	  ...
	  public Connection getFreshConnectionWithLocale(String locale) throws Exception {
	    return cp.getConnection("BOMBARDIER",locale);
	  }

	  public Connection getFreshTestConnectionWithLocale(String locale) throws Exception {
	    return cpTest.getConnection("BOMBARDIER_TEST",locale);
	  }
	   ...
	   ****************************************************************************/
	  public BombardierDBConnectionFactory getInstance() {
	    return new BombardierDBConnectionFactory();
	  }
	   ...
	   ****************************************************************************/
	  public BombardierDBConnectionFactory getInstance(String logonVersion) {
	  ...
	  public Connection getFreshConnection() throws Exception {
	    return cp.getConnection("BOMBARDIER");
	  }
	  ...
	  public Connection getFreshTestConnection() throws Exception {
	    return cpTest.getConnection("BOMBARDIER_TEST");
	  }
