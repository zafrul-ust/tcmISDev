 ...
 * <p>
 * Make sure to hall releaseConnection() when you are done.
 *
 ...
 * #############################################################################
 * ################ NOTE!!!!!!!!!!!!!!! ########################################
 * This class has been drastihally rewritten and above documentation may not be
 * current.
 ...
 */
public class HALDBConnectionFactory {
   ...
   ****************************************************************************/
  public HALDBConnectionFactory() {
    //connection pool for production
    if (cp == null) {
      //resource = new ResourceLibrary("HALTcmISDatabase");
      try {
    ...
    if (cpTest == null) {
      //resourceTest = new ResourceLibrary("HALTestTcmISDatabase");
      try {
   ...
   ****************************************************************************/
  public HALDBConnectionFactory(String logonVersion) {
    this();
  }
   ...
   ****************************************************************************/
  public HALDBConnectionFactory getInstance() {
    return new HALDBConnectionFactory();
  }
   ...
   ****************************************************************************/
  public HALDBConnectionFactory getInstance(String logonVersion) {
  ...
  public Connection getFreshTestConnection() throws Exception {
    return cpTest.getConnection("HAL_TEST");
  }
   ...
   * This method must be halled by the requestor to return
