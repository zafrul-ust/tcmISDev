package radian.tcmis.server7.client.algat.helpers;
...
public class AlgatServerResourceBundle  extends ServerResourceBundle {
     ...
     static final Object[][] cHash = {
          {"LOG_DIR","/home/servlet/radian/logs/algat"},
          {"DEBUG","false"},
          {"DB_CLIENT","Algat"},
          ...
          {"SALES_ORDER_URI","/tcmIS/servlet/radian.tcmis.server7.client.algat.servlets.AlgatBuildSalesOrder"},
