...
public class SalesWasteOrderTracking extends HttpServlet {
   ...
   public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      try {
        ...
        WasteOrderTracking obj = new WasteOrderTracking((ServerResourceBundle) new SalesServerResourceBundle(),db);
