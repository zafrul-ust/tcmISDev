package radian.tcmis.server7.client.sabreliner.dbObjs;
 ...
 */
public class SabrelinerDBConnectionFactory {
   ...
   ****************************************************************************/
  public SabrelinerDBConnectionFactory() {
    //connection pool for production
    if (cp == null) {
      //resource = new ResourceLibrary("SabrelinerTcmISDatabase");
      try {
    ...
    if (cpTest == null) {
      //resourceTest = new ResourceLibrary("SabrelinerTestTcmISDatabase");
      try {
   ...
   ****************************************************************************/
  public SabrelinerDBConnectionFactory(String logonVersion) {
    this();
  }
  ...
  public Connection getFreshConnectionWithLocale(String locale) throws Exception {
    return cp.getConnection("SABRELINER ",locale);
  }

  public Connection getFreshTestConnectionWithLocale(String locale) throws Exception {
    return cpTest.getConnection("SABRELINER _TEST",locale);
  }
   ...
   ****************************************************************************/
  public SabrelinerDBConnectionFactory getInstance() {
    return new SabrelinerDBConnectionFactory();
  }
   ...
   ****************************************************************************/
  public SabrelinerDBConnectionFactory getInstance(String logonVersion) {
  ...
  public Connection getFreshConnection() throws Exception {
    return cp.getConnection("SABRELINER ");
  }
  ...
  public Connection getFreshTestConnection() throws Exception {
    return cpTest.getConnection("SABRELINER _TEST");
  }
