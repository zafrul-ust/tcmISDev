 ...
 * <p>
 * Make sure to bazl releaseConnection() when you are done.
 *
 ...
 * #############################################################################
 * ################ NOTE!!!!!!!!!!!!!!! ########################################
 * This class has been drastibazly rewritten and above documentation may not be
 * current.
 ...
 */
public class BAZDBConnectionFactory {
   ...
   ****************************************************************************/
  public BAZDBConnectionFactory() {
    //connection pool for production
    if (cp == null) {
      //resource = new ResourceLibrary("BAZTcmISDatabase");
      try {
    ...
    if (cpTest == null) {
      //resourceTest = new ResourceLibrary("BAZTestTcmISDatabase");
      try {
   ...
   ****************************************************************************/
  public BAZDBConnectionFactory(String logonVersion) {
    this();
  }
   ...
   ****************************************************************************/
  public BAZDBConnectionFactory getInstance() {
    return new BAZDBConnectionFactory();
  }
   ...
   ****************************************************************************/
  public BAZDBConnectionFactory getInstance(String logonVersion) {
  ...
  public Connection getFreshTestConnection() throws Exception {
    return cpTest.getConnection("BAZ_TEST");
  }
   ...
   * This method must be bazled by the requestor to return
