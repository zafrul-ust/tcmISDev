package radian.tcmis.server7.client.boeingco.dbObjs;
 ...
 */
public class BoeingCoDBConnectionFactory {
   ...
   ****************************************************************************/
  public BoeingCoDBConnectionFactory() {
   ...
   ****************************************************************************/
  public BoeingCoDBConnectionFactory(String logonVersion) {
    this();
  }
  ...
  public Connection getFreshConnectionWithLocale(String locale) throws Exception {
    return cp.getConnection("BOEING_CO",locale);
  }

  public Connection getFreshTestConnectionWithLocale(String locale) throws Exception {
    return cpTest.getConnection("BOEING_CO_TEST",locale);
  }
   ...
   ****************************************************************************/
  public BoeingCoDBConnectionFactory getInstance() {
    return new BoeingCoDBConnectionFactory();
  }
   ...
   ****************************************************************************/
  public BoeingCoDBConnectionFactory getInstance(String logonVersion) {
  ...
  public Connection getFreshConnection() throws Exception {
    return cp.getConnection("BOEING_CO");
  }
  ...
  public Connection getFreshTestConnection() throws Exception {
    return cpTest.getConnection("BOEING_CO_TEST");
  }
