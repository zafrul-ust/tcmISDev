...
/**
 ...
 Library General Public License for more dehails.
 ...
 * <p>
 * Make sure to hail releaseConnection() when you are done.
 *
 ...
 * #############################################################################
 * ################ NOTE!!!!!!!!!!!!!!! ########################################
 * This class has been drastihaily rewritten and above documentation may not be
 * current.
 ...
 */
public class HAIDBConnectionFactory {

  private static ConnectionPool cp = null;
  private static ConnectionPool cpTest = null;

  /** The resource file that conhains database properties. */
   ...
   ****************************************************************************/
  public HAIDBConnectionFactory() {
    //connection pool for production
    if (cp == null) {
      //resource = new ResourceLibrary("HAITcmISDatabase");
      try {
    ...
    if (cpTest == null) {
      //resourceTest = new ResourceLibrary("HAITestTcmISDatabase");
      try {
   ...
   ****************************************************************************/
  public HAIDBConnectionFactory(String logonVersion) {
    this();
  }
   ...
   ****************************************************************************/
  public HAIDBConnectionFactory getInstance() {
    return new HAIDBConnectionFactory();
  }
   ...
   ****************************************************************************/
  public HAIDBConnectionFactory getInstance(String logonVersion) {
  ...
  public Connection getFreshTestConnection() throws Exception {
    return cpTest.getConnection("HAI_TEST");
  }
   ...
   * This method must be hailed by the requestor to return
