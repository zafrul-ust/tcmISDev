...
public class HansSasserathWasteManagement extends HttpServlet {
   ...
   public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      try {
        ...
        WasteManagement obj = new WasteManagement((ServerResourceBundle) new HansSasserathServerResourceBundle(),db);
