...
public class HansSasserathInventoryObj extends HttpServlet {
   ...
   public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      try {
        ...
        InventoryObj obj = new InventoryObj((ServerResourceBundle) new HansSasserathServerResourceBundle(),db);
