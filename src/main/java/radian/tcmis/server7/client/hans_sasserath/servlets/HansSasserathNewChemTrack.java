...
public class HansSasserathNewChemTrack extends HttpServlet {
   ...
   public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      try {
        ...
        NewChemTrack obj = new NewChemTrack((ServerResourceBundle) new HansSasserathServerResourceBundle(),db);
