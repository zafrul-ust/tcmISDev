...
public class HansSasserathscannerDownload extends HttpServlet {
   ...
   public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      try {
        ...
        scannerDownload obj = new scannerDownload((ServerResourceBundle) new HansSasserathServerResourceBundle(),db);
