...
public class HansSasserathPrintScreen extends HttpServlet {
   ...
   public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      try {
        ...
        PrintScreen obj = new PrintScreen((ServerResourceBundle) new HansSasserathServerResourceBundle(),db);
