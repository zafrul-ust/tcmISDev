...
public class HansSasserathNewChemical extends HttpServlet {
   ...
   public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      try {
        ...
        NewChemical obj = new NewChemical((ServerResourceBundle) new HansSasserathServerResourceBundle(),db);
