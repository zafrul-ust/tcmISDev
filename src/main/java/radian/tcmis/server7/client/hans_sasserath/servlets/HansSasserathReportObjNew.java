...
public class HansSasserathReportObjNew extends HttpServlet {
   ...
   public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      try {
        ...
        ReportObjNew obj = new ReportObjNew((ServerResourceBundle) new HansSasserathServerResourceBundle(),db);
