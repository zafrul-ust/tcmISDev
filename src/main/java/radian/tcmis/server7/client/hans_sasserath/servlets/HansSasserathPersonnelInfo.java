...
public class HansSasserathPersonnelInfo extends HttpServlet {
   ...
   public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      try {
        ...
        PersonnelInfo obj = new PersonnelInfo((ServerResourceBundle) new HansSasserathServerResourceBundle(),db);
