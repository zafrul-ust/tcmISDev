...
public class HansSasserathUserProfileNew extends HttpServlet {
   ...
   public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      try {
        ...
        UserProfileNew obj = new UserProfileNew((ServerResourceBundle) new HansSasserathServerResourceBundle(),db);
