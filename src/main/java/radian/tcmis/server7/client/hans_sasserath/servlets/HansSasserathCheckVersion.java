...
public class HansSasserathCheckVersion extends HttpServlet {
   ...
   public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      try {
        ...
        CheckVersion obj = new CheckVersion((ServerResourceBundle) new HansSasserathServerResourceBundle(),db);
