...
public class HansSasserathLoadChoices extends HttpServlet {
   ...
   public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      try {
        ...
        LoadChoices obj = new LoadChoices((ServerResourceBundle) new HansSasserathServerResourceBundle(),db);
