...
public class HansSasserathCheckClient extends HttpServlet {
   ...
   public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      try {
        ...
        CheckClient obj = new CheckClient((ServerResourceBundle) new HansSasserathServerResourceBundle(),db);
