...
public class HansSasserathUserProfile extends HttpServlet {
   ...
   public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      try {
        ...
        UserProfile obj = new UserProfile((ServerResourceBundle) new HansSasserathServerResourceBundle(),db);
