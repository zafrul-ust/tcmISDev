 ...
 * <p>
 * Make sure to hans_sasserathl releaseConnection() when you are done.
 *
 ...
 * #############################################################################
 * ################ NOTE!!!!!!!!!!!!!!! ########################################
 * This class has been drastihans_sasserathly rewritten and above documentation may not be
 * current.
 ...
 */
public class HansSasserathDBConnectionFactory {
   ...
   ****************************************************************************/
  public HansSasserathDBConnectionFactory() {
    //connection pool for production
    if (cp == null) {
      //resource = new ResourceLibrary("HansSasserathTcmISDatabase");
      try {
    ...
    if (cpTest == null) {
      //resourceTest = new ResourceLibrary("HansSasserathTestTcmISDatabase");
      try {
   ...
   ****************************************************************************/
  public HansSasserathDBConnectionFactory(String logonVersion) {
    this();
  }
  ...
  public Connection getFreshConnectionWithLocale(String locale) throws Exception {
    return cp.getConnection("HANS_SASSERATH",locale);
  }

  public Connection getFreshTestConnectionWithLocale(String locale) throws Exception {
    return cpTest.getConnection("HANS_SASSERATH_TEST",locale);
  }
   ...
   ****************************************************************************/
  public HansSasserathDBConnectionFactory getInstance() {
    return new HansSasserathDBConnectionFactory();
  }
   ...
   ****************************************************************************/
  public HansSasserathDBConnectionFactory getInstance(String logonVersion) {
  ...
  public Connection getFreshConnection() throws Exception {
    return cp.getConnection("HANS_SASSERATH");
  }
  ...
  public Connection getFreshTestConnection() throws Exception {
    return cpTest.getConnection("HANS_SASSERATH_TEST");
  }
   ...
   * This method must be hans_sasserathled by the requestor to return
