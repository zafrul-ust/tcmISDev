...
public class HansSasserathWastePrintLabel extends HttpServlet {
   ...
   public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      try {
        ...
        WasteLabel obj = new WasteLabel((ServerResourceBundle) new HansSasserathServerResourceBundle(),db);
