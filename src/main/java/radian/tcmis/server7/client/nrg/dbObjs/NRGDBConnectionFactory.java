 ...
 * <p>
 * Make sure to nrgl releaseConnection() when you are done.
 *
 ...
 * #############################################################################
 * ################ NOTE!!!!!!!!!!!!!!! ########################################
 * This class has been drastinrgly rewritten and above documentation may not be
 * current.
 ...
 */
public class NRGDBConnectionFactory {
   ...
   ****************************************************************************/
  public NRGDBConnectionFactory() {
    //connection pool for production
    if (cp == null) {
      //resource = new ResourceLibrary("NRGTcmISDatabase");
      try {
    ...
    if (cpTest == null) {
      //resourceTest = new ResourceLibrary("NRGTestTcmISDatabase");
      try {
   ...
   ****************************************************************************/
  public NRGDBConnectionFactory(String logonVersion) {
    this();
  }
   ...
   ****************************************************************************/
  public NRGDBConnectionFactory getInstance() {
    return new NRGDBConnectionFactory();
  }
   ...
   ****************************************************************************/
  public NRGDBConnectionFactory getInstance(String logonVersion) {
  ...
  public Connection getFreshTestConnection() throws Exception {
    return cpTest.getConnection("NRG_TEST");
  }
   ...
   * This method must be nrgled by the requestor to return
