 ...
 */
public class InternalDBConnectionFactory {
  ...
  public InternalDBConnectionFactory() {
	...
	if (cp == null) {
	  //resource = new ResourceLibrary("InternalTcmISDatabase");
	  try {
	...
	if (cpTest == null) {
	  //resourceTest = new ResourceLibrary("InternalTestTcmISDatabase");
	  try {
   ...
   ****************************************************************************/
  public InternalDBConnectionFactory(String logonVersion) {
	this();
  }
  ...
  public Connection getFreshConnectionWithLocale(String locale) throws Exception {
    return cp.getConnection("TCM_OPS",locale);
  }

  public Connection getFreshTestConnectionWithLocale(String locale) throws Exception {
    return cpTest.getConnection("TCM_OPS_TEST",locale);
  }
   ...
   ****************************************************************************/
  public InternalDBConnectionFactory getInstance() {
	return new InternalDBConnectionFactory();
  }
   ...
   ****************************************************************************/
  public InternalDBConnectionFactory getInstance(String logonVersion) {
  ...
  public Connection getFreshConnection() throws Exception {
	...
	//mon.stop();
	return cp.getConnection("TCM_OPS");
	//return getcon;
  }
  ...
  public Connection getFreshTestConnection() throws Exception {
	return cpTest.getConnection("TCM_OPS_TEST");
  }
  ...
  public void releaseConnection(DBConnection dbConnection) throws Exception {
	//System.out.println("------releasing tcm_ops connection");
  ...
  public void releaseTestConnection(DBConnection dbConnection) throws Exception {
	//System.out.println("------releasing tcm_ops TEST connection");
