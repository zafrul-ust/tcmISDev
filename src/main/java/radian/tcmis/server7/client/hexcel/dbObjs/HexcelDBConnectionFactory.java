 ...
 * <p>
 * Make sure to hexcell releaseConnection() when you are done.
 *
 ...
 * #############################################################################
 * ################ NOTE!!!!!!!!!!!!!!! ########################################
 * This class has been drastihexcelly rewritten and above documentation may not be
 * current.
 ...
 */
public class HexcelDBConnectionFactory {
   ...
   ****************************************************************************/
  public HexcelDBConnectionFactory() {
    //connection pool for production
    if (cp == null) {
      //resource = new ResourceLibrary("HexcelTcmISDatabase");
      try {
    ...
    if (cpTest == null) {
      //resourceTest = new ResourceLibrary("HexcelTestTcmISDatabase");
      try {
   ...
   ****************************************************************************/
  public HexcelDBConnectionFactory(String logonVersion) {
    this();
  }
  ...
  public Connection getFreshConnectionWithLocale(String locale) throws Exception {
    return cp.getConnection("HEXCEL",locale);
  }

  public Connection getFreshTestConnectionWithLocale(String locale) throws Exception {
    return cpTest.getConnection("HEXCEL_TEST",locale);
  }
   ...
   ****************************************************************************/
  public HexcelDBConnectionFactory getInstance() {
    return new HexcelDBConnectionFactory();
  }
   ...
   ****************************************************************************/
  public HexcelDBConnectionFactory getInstance(String logonVersion) {
  ...
  public Connection getFreshConnection() throws Exception {
    return cp.getConnection("HEXCEL");
  }
  ...
  public Connection getFreshTestConnection() throws Exception {
    return cpTest.getConnection("HEXCEL_TEST");
  }
   ...
   * This method must be hexcelled by the requestor to return
