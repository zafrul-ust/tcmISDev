 ...
 */
public class CatalogVendorDBConnectionFactory {
   ...
   ****************************************************************************/
  public CatalogVendorDBConnectionFactory() {
    //connection pool for production
    if (cp == null) {
      //resource = new ResourceLibrary("CATALOGVENDORTcmISDatabase");
      try {
    ...
    if (cpTest == null) {
      //resourceTest = new ResourceLibrary("CATALOGVENDORTestTcmISDatabase");
      try {
   ...
   ****************************************************************************/
  public CatalogVendorDBConnectionFactory(String logonVersion) {
    this();
  }
  ...
  public Connection getFreshConnectionWithLocale(String locale) throws Exception {
    return cp.getConnection("CATALOG_VENDOR",locale);
  }

  public Connection getFreshTestConnectionWithLocale(String locale) throws Exception {
    return cpTest.getConnection("CATALOG_VENDOR_TEST",locale);
  }
   ...
   ****************************************************************************/
  public CatalogVendorDBConnectionFactory getInstance() {
    return new CatalogVendorDBConnectionFactory();
  }
   ...
   ****************************************************************************/
  public CatalogVendorDBConnectionFactory getInstance(String logonVersion) {
  ...
  public Connection getFreshConnection() throws Exception {
    return cp.getConnection("CATALOG_VENDOR");
  }
  ...
  public Connection getFreshTestConnection() throws Exception {
    return cpTest.getConnection("CATALOG_VENDOR_TEST");
  }
