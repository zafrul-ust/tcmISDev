package radian.tcmis.server7.client.tpl_ll.dbObjs;
	 ...
	 */
	public class Tpl_llDBConnectionFactory {
	   ...
	   ****************************************************************************/
	  public Tpl_llDBConnectionFactory() {
	    //connection pool for production
	    if (cp == null) {
	      //resource = new ResourceLibrary("Tpl_llTcmISDatabase");
	      try {
	    ...
	    if (cpTest == null) {
	      //resourceTest = new ResourceLibrary("Tpl_llTestTcmISDatabase");
	      try {
	   ...
	   ****************************************************************************/
	  public Tpl_llDBConnectionFactory(String logonVersion) {
	    this();
	  }
	  ...
	  public Connection getFreshConnectionWithLocale(String locale) throws Exception {
	    return cp.getConnection("TPL_LL",locale);
	  }

	  public Connection getFreshTestConnectionWithLocale(String locale) throws Exception {
	    return cpTest.getConnection("TPL_LL_TEST",locale);
	  }
	   ...
	   ****************************************************************************/
	  public Tpl_llDBConnectionFactory getInstance() {
	    return new Tpl_llDBConnectionFactory();
	  }
	   ...
	   ****************************************************************************/
	  public Tpl_llDBConnectionFactory getInstance(String logonVersion) {
	  ...
	  public Connection getFreshConnection() throws Exception {
	    return cp.getConnection("TPL_LL");
	  }
	  ...
	  public Connection getFreshTestConnection() throws Exception {
	    return cpTest.getConnection("TPL_LL_TEST");
	  }
