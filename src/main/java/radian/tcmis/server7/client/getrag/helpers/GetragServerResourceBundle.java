package radian.tcmis.server7.client.getrag.helpers;
...
public class GetragServerResourceBundle  extends ServerResourceBundle {
     ...
     static final Object[][] cHash = {
          {"LOG_DIR","/home/servlet/radian/logs/getrag"},
          {"DEBUG","false"},
          {"DB_CLIENT","Getrag"},
          ...
          {"SALES_ORDER_URI","/tcmIS/servlet/radian.tcmis.server7.client.getrag.servlets.GetragBuildSalesOrder"},
