...
public class SWACheckClient extends HttpServlet {
   ...
   public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      try {
      //System.out.println("\n\n------------ in checkclient new structure inside client swa.\n\n");
        //db = new SWATcmISDBModel();
        db = new SWATcmISDBModel("SWA",(String)request.getHeader("logon-version"));
        CheckClient obj = new CheckClient((ServerResourceBundle) new SWAServerResourceBundle(),db);
