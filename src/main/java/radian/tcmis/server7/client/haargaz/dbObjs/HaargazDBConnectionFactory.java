 ...
 * <p>
 * Make sure to haargazl releaseConnection() when you are done.
 *
 ...
 * #############################################################################
 * ################ NOTE!!!!!!!!!!!!!!! ########################################
 * This class has been drastihaargazly rewritten and above documentation may not be
 * current.
 ...
 */
public class HaargazDBConnectionFactory {
   ...
   ****************************************************************************/
  public HaargazDBConnectionFactory() {
    //connection pool for production
    if (cp == null) {
      //resource = new ResourceLibrary("HaargazTcmISDatabase");
      try {
    ...
    if (cpTest == null) {
      //resourceTest = new ResourceLibrary("HaargazTestTcmISDatabase");
      try {
   ...
   ****************************************************************************/
  public HaargazDBConnectionFactory(String logonVersion) {
    this();
  }
  ...
  public Connection getFreshConnectionWithLocale(String locale) throws Exception {
    return cp.getConnection("HAARGAZ",locale);
  }

  public Connection getFreshTestConnectionWithLocale(String locale) throws Exception {
    return cpTest.getConnection("HAARGAZ_TEST",locale);
  }
   ...
   ****************************************************************************/
  public HaargazDBConnectionFactory getInstance() {
    return new HaargazDBConnectionFactory();
  }
   ...
   ****************************************************************************/
  public HaargazDBConnectionFactory getInstance(String logonVersion) {
  ...
  public Connection getFreshConnection() throws Exception {
    return cp.getConnection("HAARGAZ");
  }
  ...
  public Connection getFreshTestConnection() throws Exception {
    return cpTest.getConnection("HAARGAZ_TEST");
  }
   ...
   * This method must be haargazled by the requestor to return
