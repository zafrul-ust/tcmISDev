package radian.tcmis.server7.client.timken.helpers;
...
public class TimkenServerResourceBundle  extends ServerResourceBundle {
     ...
     static final Object[][] cHash = {
          {"LOG_DIR","/home/servlet/radian/logs/timken"},
          {"DEBUG","false"},
          {"DB_CLIENT","Timken"},
          ...
          {"SALES_ORDER_URI","/tcmIS/servlet/radian.tcmis.server7.client.timken.servlets.TimkenBuildSalesOrder"},
