...
public class OptimetalUserProfileNew extends HttpServlet {
   ...
   public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      try {
        ...
        UserProfileNew obj = new UserProfileNew((ServerResourceBundle) new OptimetalServerResourceBundle(),db);
