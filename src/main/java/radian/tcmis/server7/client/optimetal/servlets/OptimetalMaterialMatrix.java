...
public class OptimetalMaterialMatrix extends HttpServlet {
   ...
   public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      try {
        ...
        MaterialMatrix obj = new MaterialMatrix((ServerResourceBundle) new OptimetalServerResourceBundle(),db);
