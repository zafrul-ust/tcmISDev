...
import radian.tcmis.server7.client.usgov.helpers.USGOVServerResourceBundle;
import javax.servlet.*;
import javax.servlet.http.*;
import java.io.*;


public class USGOVWaste extends HttpServlet {
   ...
   public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      try {
        ...
        Waste obj = new Waste((ServerResourceBundle) new USGOVServerResourceBundle(),db);
