package radian.tcmis.server7.client.cessna.dbObjs;
 ...
 */
public class CessnaDBConnectionFactory {
   ...
   ****************************************************************************/
  public CessnaDBConnectionFactory() {
   ...
   ****************************************************************************/
  public CessnaDBConnectionFactory(String logonVersion) {
    this();
  }
   ...
   ****************************************************************************/
  public CessnaDBConnectionFactory getInstance() {
    return new CessnaDBConnectionFactory();
  }
   ...
   ****************************************************************************/
  public CessnaDBConnectionFactory getInstance(String logonVersion) {
  ...
  public Connection getFreshConnection() throws Exception {
    return cp.getConnection("CESSNA");
  }
  ...
  public Connection getFreshTestConnection() throws Exception {
    return cpTest.getConnection("CESSNA");
  }
