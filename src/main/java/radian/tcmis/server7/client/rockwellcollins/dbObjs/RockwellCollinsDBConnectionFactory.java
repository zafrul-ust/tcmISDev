package radian.tcmis.server7.client.rockwellcollins.dbObjs;
 ...
 */
public class RockwellCollinsDBConnectionFactory {
   ...
   ****************************************************************************/
  public RockwellCollinsDBConnectionFactory() {
    //connection pool for production
    if (cp == null) {
      //resource = new ResourceLibrary("RockwellCollinsTcmISDatabase");
      try {
    ...
    if (cpTest == null) {
      //resourceTest = new ResourceLibrary("RockwellCollinsTestTcmISDatabase");
      try {
   ...
   ****************************************************************************/
  public RockwellCollinsDBConnectionFactory(String logonVersion) {
    this();
  }
  ...
  public Connection getFreshConnectionWithLocale(String locale) throws Exception {
    return cp.getConnection("ROCKWELL_COLLINS",locale);
  }

  public Connection getFreshTestConnectionWithLocale(String locale) throws Exception {
    return cpTest.getConnection("ROCKWELL_TEST",locale);
  }
   ...
   ****************************************************************************/
  public RockwellCollinsDBConnectionFactory getInstance() {
    return new RockwellCollinsDBConnectionFactory();
  }
   ...
   ****************************************************************************/
  public RockwellCollinsDBConnectionFactory getInstance(String logonVersion) {
  ...
  public Connection getFreshConnection() throws Exception {
    return cp.getConnection("ROCKWELL_COLLINS");
  }
  ...
  public Connection getFreshTestConnection() throws Exception {
    return cpTest.getConnection("ROCKWELL_TEST");
  }
