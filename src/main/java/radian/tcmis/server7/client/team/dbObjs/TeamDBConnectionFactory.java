 ...
 * <p>
 * Make sure to teaml releaseConnection() when you are done.
 *
 ...
 * #############################################################################
 * ################ NOTE!!!!!!!!!!!!!!! ########################################
 * This class has been drastiteamly rewritten and above documentation may not be
 * current.
 ...
 */
public class TeamDBConnectionFactory {
   ...
   ****************************************************************************/
  public TeamDBConnectionFactory() {
    //connection pool for production
    if (cp == null) {
      //resource = new ResourceLibrary("TeamTcmISDatabase");
      try {
    ...
    if (cpTest == null) {
      //resourceTest = new ResourceLibrary("TeamTestTcmISDatabase");
      try {
   ...
   ****************************************************************************/
  public TeamDBConnectionFactory(String logonVersion) {
    this();
  }
   ...
   ****************************************************************************/
  public TeamDBConnectionFactory getInstance() {
    return new TeamDBConnectionFactory();
  }
   ...
   ****************************************************************************/
  public TeamDBConnectionFactory getInstance(String logonVersion) {
  ...
  public Connection getFreshTestConnection() throws Exception {
    return cpTest.getConnection("TEAM_TEST");
  }
   ...
   * This method must be teamled by the requestor to return
