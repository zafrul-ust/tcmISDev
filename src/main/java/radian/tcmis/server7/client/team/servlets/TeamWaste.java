...
import radian.tcmis.server7.client.team.helpers.TeamServerResourceBundle;
import javax.servlet.*;
import javax.servlet.http.*;
import java.io.*;


public class TeamWaste extends HttpServlet {
   ...
   public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      try {
        ...
        Waste obj = new Waste((ServerResourceBundle) new TeamServerResourceBundle(),db);
