 ...
 * #############################################################################
 * ################ NOTE!!!!!!!!!!!!!!! ########################################
 * This class has been drastically rewritten and above documentation may not be
 * current.
 ...
 */
public class supplierDBConnectionFactory {
   ...
   ****************************************************************************/
  public supplierDBConnectionFactory() {
	//connection pool for production
	if (cp == null) {
	  //resource = new ResourceLibrary("supplierTcmISDatabase");
	  try {
	...
	if (cpTest == null) {
	  //resourceTest = new ResourceLibrary("supplierTcmISDatabase");
	  try {
   ...
   ****************************************************************************/
  public supplierDBConnectionFactory(String logonVersion) {
	this();
  }
  ...
  public Connection getFreshConnectionWithLocale(String locale) throws Exception {
    return cp.getConnection("SUPPLIER",locale);
  }

  public Connection getFreshTestConnectionWithLocale(String locale) throws Exception {
    return cpTest.getConnection("SUPPLIER_TEST",locale);
  }
   ...
   ****************************************************************************/
  public supplierDBConnectionFactory getInstance() {
	return new supplierDBConnectionFactory();
  }
   ...
   ****************************************************************************/
  public supplierDBConnectionFactory getInstance(String logonVersion) {
  ...
  public Connection getFreshConnection() throws Exception {
	...
	//Monitor mon=MonitorFactory.start("Database TCM_OPS");
	//getcon = cp.getConnection();
	//mon.stop();
	return cp.getConnection("SUPPLIER");
	//return getcon;
  }
  ...
  public Connection getFreshTestConnection() throws Exception {
	return cpTest.getConnection("SUPPLIER_TEST");
  }
  ...
  public void releaseConnection(DBConnection dbConnection) throws Exception {
	//System.out.println("------releasing supplier connection");
  ...
  public void releaseTestConnection(DBConnection dbConnection) throws Exception {
	//System.out.println("------releasing supplier TEST connection");
