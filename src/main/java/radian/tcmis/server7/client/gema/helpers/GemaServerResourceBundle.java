package radian.tcmis.server7.client.gema.helpers;
...
public class GemaServerResourceBundle  extends ServerResourceBundle {
     ...
     static final Object[][] cHash = {
          {"LOG_DIR","/home/servlet/radian/logs/gema"},
          {"DEBUG","false"},
          {"DB_CLIENT","GEMA"},
          ...
          {"SALES_ORDER_URI","/tcmIS/servlet/radian.tcmis.server7.client.gema.servlets.GemaBuildSalesOrder"},
