package radian.tcmis.server7.client.tpl_kpt.dbObjs;
	 ...
	 */
	public class Tpl_KptDBConnectionFactory {
	   ...
	   ****************************************************************************/
	  public Tpl_KptDBConnectionFactory() {
	   ...
	   ****************************************************************************/
	  public Tpl_KptDBConnectionFactory(String logonVersion) {
	    this();
	  }
	  ...
	  public Connection getFreshConnectionWithLocale(String locale) throws Exception {
	    return cp.getConnection("TPL_KPT",locale);
	  }

	  public Connection getFreshTestConnectionWithLocale(String locale) throws Exception {
	    return cpTest.getConnection("TPL_KPT_TEST",locale);
	  }
	   ...
	   ****************************************************************************/
	  public Tpl_KptDBConnectionFactory getInstance() {
	    return new Tpl_KptDBConnectionFactory();
	  }
	   ...
	   ****************************************************************************/
	  public Tpl_KptDBConnectionFactory getInstance(String logonVersion) {
