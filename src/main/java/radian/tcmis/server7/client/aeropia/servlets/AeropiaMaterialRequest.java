...
public class AeropiaMaterialRequest extends HttpServlet {
   ...
   public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      try {
        ...
        MaterialRequest obj = new MaterialRequest((ServerResourceBundle) new AeropiaServerResourceBundle(),db);
