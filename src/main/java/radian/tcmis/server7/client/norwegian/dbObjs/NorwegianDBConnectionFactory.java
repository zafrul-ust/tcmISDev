package radian.tcmis.server7.client.norwegian.dbObjs;
	 ...
	 */
	public class NorwegianDBConnectionFactory {
	   ...
	   ****************************************************************************/
	  public NorwegianDBConnectionFactory() {
	    //connection pool for production
	    if (cp == null) {
	      //resource = new ResourceLibrary("NorwegianTcmISDatabase");
	      try {
	    ...
	    if (cpTest == null) {
	      //resourceTest = new ResourceLibrary("NorwegianTestTcmISDatabase");
	      try {
	   ...
	   ****************************************************************************/
	  public NorwegianDBConnectionFactory(String logonVersion) {
	    this();
	  }
	  ...
	  public Connection getFreshConnectionWithLocale(String locale) throws Exception {
	    return cp.getConnection("NORWEGIAN",locale);
	  }

	  public Connection getFreshTestConnectionWithLocale(String locale) throws Exception {
	    return cpTest.getConnection("NORWEGIAN_TEST",locale);
	  }
	   ...
	   ****************************************************************************/
	  public NorwegianDBConnectionFactory getInstance() {
	    return new NorwegianDBConnectionFactory();
	  }
	   ...
	   ****************************************************************************/
	  public NorwegianDBConnectionFactory getInstance(String logonVersion) {
	  ...
	  public Connection getFreshConnection() throws Exception {
	    return cp.getConnection("NORWEGIAN");
	  }
	  ...
	  public Connection getFreshTestConnection() throws Exception {
	    return cpTest.getConnection("NORWEGIAN_TEST");
	  }
