 ...
 * com.tcmis.common.sql.ConnectionPool. Remember to return connections to the
 * connection pool once you are done using them.
 */
public class RayDBConnectionFactory {
  ...
  public RayDBConnectionFactory() {
    ...
    if (cpTest == null) {
      //resourceTest = new ResourceLibrary("RayTestTcmISDatabase");
      try {
   ...
   ****************************************************************************/
  public RayDBConnectionFactory(String logonVersion) {
    this();
  }
   ...
   ****************************************************************************/
  public RayDBConnectionFactory getInstance() {
    return new RayDBConnectionFactory();
  }
   ...
   ****************************************************************************/
  public RayDBConnectionFactory getInstance(String logonVersion) {
  ...
  public Connection getFreshConnection() throws Exception {
	...
	//Monitor mon=MonitorFactory.start("Database Ray");
	//getcon = cp.getConnection();
	//mon.stop();
    return cp.getConnection("RAY");
	//return getcon;
  }
  ...
  public Connection getFreshTestConnection() throws Exception {
    return cpTest.getConnection("RAY_TEST");
  }
  ...
  public void releaseConnection(DBConnection dbConnection) throws Exception {
    //System.out.println("------releasing Ray connection");
  ...
  public void releaseTestConnection(DBConnection dbConnection) throws Exception {
    //System.out.println("------releasing Ray TEST connection");
