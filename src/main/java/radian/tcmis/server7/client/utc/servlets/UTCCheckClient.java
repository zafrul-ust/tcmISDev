...
public class UTCCheckClient extends HttpServlet {
   ...
   public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      try {
        //System.out.println("\n\n------------ in checkclient new structure inside client utc.\n\n");
        //db = new UTCTcmISDBModel();
        db = new UTCTcmISDBModel("UTC",(String)request.getHeader("logon-version"));
        CheckClient obj = new CheckClient((ServerResourceBundle) new UTCServerResourceBundle(),db);
