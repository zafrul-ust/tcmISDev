 ...
 * <p>
 * Make sure to siemensl releaseConnection() when you are done.
 *
 ...
 * #############################################################################
 * ################ NOTE!!!!!!!!!!!!!!! ########################################
 * This class has been drastisiemensly rewritten and above documentation may not be
 * current.
 ...
 */
public class SiemensDBConnectionFactory {
   ...
   ****************************************************************************/
  public SiemensDBConnectionFactory() {
    //connection pool for production
    if (cp == null) {
      //resource = new ResourceLibrary("SiemensTcmISDatabase");
      try {
    ...
    if (cpTest == null) {
      //resourceTest = new ResourceLibrary("SiemensTestTcmISDatabase");
      try {
   ...
   ****************************************************************************/
  public SiemensDBConnectionFactory(String logonVersion) {
    this();
  }
  ...
  public Connection getFreshConnectionWithLocale(String locale) throws Exception {
    return cp.getConnection("SIEMENS",locale);
  }

  public Connection getFreshTestConnectionWithLocale(String locale) throws Exception {
    return cpTest.getConnection("SIEMENS_TEST",locale);
  }
   ...
   ****************************************************************************/
  public SiemensDBConnectionFactory getInstance() {
    return new SiemensDBConnectionFactory();
  }
   ...
   ****************************************************************************/
  public SiemensDBConnectionFactory getInstance(String logonVersion) {
  ...
  public Connection getFreshConnection() throws Exception {
    return cp.getConnection("SIEMENS");
  }
  ...
  public Connection getFreshTestConnection() throws Exception {
    return cpTest.getConnection("SIEMENS_TEST");
  }
   ...
   * This method must be siemensled by the requestor to return
