...
public class TambourWasteAhocReport extends HttpServlet {
   ...
   public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      try {
        ...
        WasteAhocReport obj = new WasteAhocReport((ServerResourceBundle) new TambourServerResourceBundle(),db);
