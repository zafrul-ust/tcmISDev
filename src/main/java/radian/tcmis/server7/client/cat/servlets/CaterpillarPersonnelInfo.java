...
public class CaterpillarPersonnelInfo extends HttpServlet {
   ...
   public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      try {
        ...
        PersonnelInfo obj = new PersonnelInfo((ServerResourceBundle) new CaterpillarServerResourceBundle(),db);
