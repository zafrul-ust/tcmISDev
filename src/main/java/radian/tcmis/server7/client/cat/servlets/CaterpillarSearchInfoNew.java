...
public class CaterpillarSearchInfoNew extends HttpServlet {
   ...
   public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      try {
        ...
        SearchInfoNew obj = new SearchInfoNew((ServerResourceBundle) new CaterpillarServerResourceBundle(),db);
