...
public class GoodrichWasteManagement extends HttpServlet {
   ...
   public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      try {
        ...
        WasteManagement obj = new WasteManagement((ServerResourceBundle) new GoodrichServerResourceBundle(),db);
