 ...
 * <p>
 * Make sure to cyclonel releaseConnection() when you are done.
 *
 ...
 * #############################################################################
 * ################ NOTE!!!!!!!!!!!!!!! ########################################
 * This class has been drasticyclonely rewritten and above documentation may not be
 * current.
 ...
 */
public class CycloneDBConnectionFactory {
   ...
   ****************************************************************************/
  public CycloneDBConnectionFactory() {
    //connection pool for production
    if (cp == null) {
      //resource = new ResourceLibrary("CycloneTcmISDatabase");
      try {
    ...
    if (cpTest == null) {
      //resourceTest = new ResourceLibrary("CycloneTestTcmISDatabase");
      try {
   ...
   ****************************************************************************/
  public CycloneDBConnectionFactory(String logonVersion) {
    this();
  }
  ...
  public Connection getFreshConnectionWithLocale(String locale) throws Exception {
    return cp.getConnection("CYCLONE",locale);
  }

  public Connection getFreshTestConnectionWithLocale(String locale) throws Exception {
    return cpTest.getConnection("CYCLONE_TEST",locale);
  }
   ...
   ****************************************************************************/
  public CycloneDBConnectionFactory getInstance() {
    return new CycloneDBConnectionFactory();
  }
   ...
   ****************************************************************************/
  public CycloneDBConnectionFactory getInstance(String logonVersion) {
  ...
  public Connection getFreshConnection() throws Exception {
    return cp.getConnection("CYCLONE");
  }
  ...
  public Connection getFreshTestConnection() throws Exception {
    return cpTest.getConnection("CYCLONE_TEST");
  }
   ...
   * This method must be cycloneled by the requestor to return
