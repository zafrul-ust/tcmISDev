...
public class WasteWastePrRules {

  public WasteWastePrRules() {
  }
}*/
package radian.tcmis.server7.share.dbObjs;
...
public class WastePrRules {
   ...
   public WastePrRules(TcmISDBModel db){
      this.db = db;
   }
   ...
   public void loadAccSys() throws Exception {
    /* not until we go ahead with this - commodity_type
    String query = "select * from pr_num_rules_view where facility_id = '"+getFacilityId()+"'";
    query += " and commodity_type = 'Waste' and account_sys_id = '" +getAccountSysId()+"'";
  ...
  public void load() throws Exception {
    ...
    try {
      ...
      //System.out.println("\n\n---- what's going on: "+num_charge_types + " - "+accountSysId);
