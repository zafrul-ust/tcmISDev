...
public class TcmisInputStreamServer {
   ...
   protected boolean firstTimeFlag = false;
   protected TcmISDBModel db = null;

   protected String token = null;
   protected Object sent_obj = null;

   public TcmisInputStreamServer(HttpServletRequest r ,TcmISDBModel db) throws IOException  {
