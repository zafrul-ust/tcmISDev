...
import radian.tcmis.server7.share.helpers.AlternateApprover;

public class AlternateApproverReportGenerator {
    //ACJEngine
    ...
    public AlternateApproverReportGenerator() {
    }

  public String buildReport(Vector chemicalData, String facilityDesc, String approverName) {
    String url = "";
    ...
    try {
      ...
      erw.readTemplate(""+templatpath+"AlternateApprover.erw");
      //modifying template
      tm = erw.getTemplateManager();
      tm.setLabel("LBL01",facilityDesc);
      tm.setLabel("LBL014",approverName);
      //register table...
      ...
      erw.setCacheOption(true, ""+tempwritefilepath+"AlternateApprover"+tmpReqNum.toString()+".joi");
      ...
      ec.setPDFProperty("FileName",""+tempwritefilepath+"AlternateApprover"+tmpReqNum.toString()+".pdf");
      ...
      url = tempurlpath + "AlternateApprover"+tmpReqNum.toString()+".pdf";
    }catch (Exception e) {
      e.printStackTrace();
      url = "";
    }
  ...
  public RegisterTable[] getData(Vector reportData1) throws Exception{
      ...
      try {
        rt[0] = new RegisterTable(AlternateApprover.getVector(reportData1),"ALTERNATEAPPROVER",AlternateApprover.getFieldVector(),null);
      }catch(Exception e1) {
        e1.printStackTrace();
        throw e1;
      }
