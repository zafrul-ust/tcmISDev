package radian.tcmis.client.client.algat.gui;

import java.io.FileOutputStream;
import java.security.Security;

import radian.tcmis.client.client.algat.helpers.AlgatClientResourceBundle;
import radian.tcmis.client.client.algat.helpers.AlgatReportPanelBundle;
import radian.tcmis.client.share.gui.CmisApp;
import radian.tcmis.client.share.gui.ReportInputPanel;
import radian.tcmis.client.share.helpers.ClientResourceBundle;

public class AlgatCmisApp extends CmisApp {

  AlgatClientResourceBundle cConstants = new AlgatClientResourceBundle();
  AlgatReportPanelBundle reportBundle;
  FileOutputStream fOutStream;

  public AlgatCmisApp(){
    reportBundle = new AlgatReportPanelBundle(this);
  }
  //Main method
  static public void main(String[] args) {
    AlgatCmisApp cmisApp = new AlgatCmisApp();
