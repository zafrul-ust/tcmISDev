...
public class Tcmis {
  ...
  protected static String classpath = "-cp jre"+System.getProperty("file.separator")+"1.1"+System.getProperty("file.separator")+"lib"+System.getProperty("file.separator")+"rt.jar;" +
             ...
             System.getProperty("file.separator")+"ERWMain.jar;classes"+System.getProperty("file.separator")+"RadianGui.jar;classes"+System.getProperty("file.separator")+"RadianSeagate.jar;classes"+
  ...
  protected static String execPW = new String("jre"+System.getProperty("file.separator")+"1.1"+System.getProperty("file.separator")+"bin"+System.getProperty("file.separator")+"jrew.exe -ms32m -mx128m -Dsun.java2d.noddraw "+classpath);
  protected static String execP  = new String("jre"+System.getProperty("file.separator")+"1.1"+System.getProperty("file.separator")+"bin"+System.getProperty("file.separator")+"jre.exe -ms32m -mx128m -Dsun.java2d.noddraw " +classpath);
  ...
  static public void main(String[] args) {
    System.out.println("----in Tcmis main----");
    Tcmis tcmis = new Tcmis();
    tcmis.doCheck(args);
  }

  void doCheck(String[] args){
    System.out.println("----in Tcmis docheck----");
    try{
       ...
       System.out.println("----in Tcmis docheck user dir: "+wDir);
      ...
      if (test.exists()) {  // Run update
         ...
         if (args.length > 0){
                ...
                prog[1] = "radian.tcmis.client.client.seagate.gui.SeagateCmisApp";
                for (int i=0;i<add;i++) {
