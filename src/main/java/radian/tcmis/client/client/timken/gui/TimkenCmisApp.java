package radian.tcmis.client.client.timken.gui;
...
import radian.tcmis.client.client.timken.helpers.*;
import java.security.Security;

import javax.swing.*;

public class TimkenCmisApp extends CmisApp {

  TimkenClientResourceBundle cConstants = new TimkenClientResourceBundle();
  TimkenReportPanelBundle reportBundle;
  FileOutputStream fOutStream;

  public TimkenCmisApp(){
    reportBundle = new TimkenReportPanelBundle(this);
  }
  //Main method
  static public void main(String[] args) {
    TimkenCmisApp cmisApp = new TimkenCmisApp();
