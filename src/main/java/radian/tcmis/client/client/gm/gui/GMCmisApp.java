package radian.tcmis.client.client.gm.gui;
...
import radian.tcmis.client.client.gm.helpers.*;
import java.security.Security;

import javax.swing.*;

public class GMCmisApp extends CmisApp {

  GMClientResourceBundle cConstants = new GMClientResourceBundle();
  GMReportPanelBundle reportBundle;
  FileOutputStream fOutStream;

  public GMCmisApp(){
    reportBundle = new GMReportPanelBundle(this);
  }
  //Main method
  static public void main(String[] args) {
    GMCmisApp cmisApp = new GMCmisApp();
