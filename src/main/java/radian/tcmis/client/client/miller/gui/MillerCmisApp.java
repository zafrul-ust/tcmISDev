package radian.tcmis.client.client.miller.gui;
...
import radian.tcmis.client.client.miller.helpers.*;
import java.security.Security;

import javax.swing.*;

public class MillerCmisApp extends CmisApp {

  MillerClientResourceBundle cConstants = new MillerClientResourceBundle();
  MillerReportPanelBundle reportBundle;
  FileOutputStream fOutStream;

  public MillerCmisApp(){
    reportBundle = new MillerReportPanelBundle(this);
  }
  //Main method
  static public void main(String[] args) {
    MillerCmisApp cmisApp = new MillerCmisApp();
