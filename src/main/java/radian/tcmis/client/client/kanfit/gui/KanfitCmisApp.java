package radian.tcmis.client.client.kanfit.gui;
...
import radian.tcmis.client.client.kanfit.helpers.*;
import java.security.Security;

import javax.swing.*;

public class KanfitCmisApp extends CmisApp {

  KanfitClientResourceBundle cConstants = new KanfitClientResourceBundle();
  KanfitReportPanelBundle reportBundle;
  FileOutputStream fOutStream;

  public KanfitCmisApp(){
    reportBundle = new KanfitReportPanelBundle(this);
  }
  //Main method
  static public void main(String[] args) {
    KanfitCmisApp cmisApp = new KanfitCmisApp();
