package radian.tcmis.client.client.siemens.gui;
...
import radian.tcmis.client.client.siemens.helpers.*;
import java.security.Security;

import javax.swing.*;

public class SiemensCmisApp extends CmisApp {

  SiemensClientResourceBundle cConstants = new SiemensClientResourceBundle();
  SiemensReportPanelBundle reportBundle;
  FileOutputStream fOutStream;

  public SiemensCmisApp(){
    reportBundle = new SiemensReportPanelBundle(this);
  }
  //Main method
  static public void main(String[] args) {
    SiemensCmisApp cmisApp = new SiemensCmisApp();
