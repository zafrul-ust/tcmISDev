package radian.tcmis.client.client.zf.gui;
...
import radian.tcmis.client.client.zf.helpers.*;
import java.security.Security;

import javax.swing.*;

public class ZFCmisApp extends CmisApp {

  ZFClientResourceBundle cConstants = new ZFClientResourceBundle();
  ZFReportPanelBundle reportBundle;
  FileOutputStream fOutStream;

  public ZFCmisApp(){
    reportBundle = new ZFReportPanelBundle(this);
  }
  //Main method
  static public void main(String[] args) {
    ZFCmisApp cmisApp = new ZFCmisApp();
