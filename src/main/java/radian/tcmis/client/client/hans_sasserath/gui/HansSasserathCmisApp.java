package radian.tcmis.client.client.hans_sasserath.gui;
...
import radian.tcmis.client.client.hans_sasserath.helpers.*;
import java.security.Security;

import javax.swing.*;

public class HansSasserathCmisApp extends CmisApp {

  HansSasserathClientResourceBundle cConstants = new HansSasserathClientResourceBundle();
  HansSasserathReportPanelBundle reportBundle;
  FileOutputStream fOutStream;

  public HansSasserathCmisApp(){
    reportBundle = new HansSasserathReportPanelBundle(this);
  }
  //Main method
  static public void main(String[] args) {
    HansSasserathCmisApp cmisApp = new HansSasserathCmisApp();
