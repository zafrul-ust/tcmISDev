package radian.tcmis.client.client.qos.gui;
...
import radian.tcmis.client.client.qos.helpers.*;
import java.security.Security;

import javax.swing.*;

public class QOSCmisApp extends CmisApp {

  QOSClientResourceBundle cConstants = new QOSClientResourceBundle();
  QOSReportPanelBundle reportBundle;
  FileOutputStream fOutStream;

  public QOSCmisApp(){
    reportBundle = new QOSReportPanelBundle(this);
  }
  //Main method
  static public void main(String[] args) {
    QOSCmisApp cmisApp = new QOSCmisApp();
