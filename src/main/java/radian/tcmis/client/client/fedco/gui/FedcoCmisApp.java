package radian.tcmis.client.client.fedco.gui;
...
import radian.tcmis.client.client.fedco.helpers.*;
import java.security.Security;

import javax.swing.*;

public class FedcoCmisApp extends CmisApp {

  FedcoClientResourceBundle cConstants = new FedcoClientResourceBundle();
  FedcoReportPanelBundle reportBundle;
  FileOutputStream fOutStream;

  public FedcoCmisApp(){
    reportBundle = new FedcoReportPanelBundle(this);
  }
  //Main method
  static public void main(String[] args) {
    FedcoCmisApp cmisApp = new FedcoCmisApp();
