package radian.tcmis.client.client.am.gui;

import java.io.FileOutputStream;
import java.security.Security;

import radian.tcmis.client.client.am.helpers.AMClientResourceBundle;
import radian.tcmis.client.client.am.helpers.AMReportPanelBundle;
import radian.tcmis.client.share.gui.CmisApp;
import radian.tcmis.client.share.gui.ReportInputPanel;
import radian.tcmis.client.share.helpers.ClientResourceBundle;

public class AMCmisApp extends CmisApp {

  AMClientResourceBundle cConstants = new AMClientResourceBundle();
  AMReportPanelBundle reportBundle;
  FileOutputStream fOutStream;

  public AMCmisApp(){
    reportBundle = new AMReportPanelBundle(this);
  }
  //Main method
  static public void main(String[] args) {
    AMCmisApp cmisApp = new AMCmisApp();
