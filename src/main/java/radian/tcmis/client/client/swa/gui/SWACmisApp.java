package radian.tcmis.client.client.swa.gui;
...
import radian.tcmis.client.client.swa.helpers.*;
import java.security.Security;

import javax.swing.*;

public class SWACmisApp extends CmisApp {

  SWAClientResourceBundle cConstants = new SWAClientResourceBundle();
  SWAReportPanelBundle reportBundle;
  FileOutputStream fOutStream;

  public SWACmisApp(){
    reportBundle = new SWAReportPanelBundle(this);
  }
  //Main method
  static public void main(String[] args) {
    SWACmisApp cmisApp = new SWACmisApp();
