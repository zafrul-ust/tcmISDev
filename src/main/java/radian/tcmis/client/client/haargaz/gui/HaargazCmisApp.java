package radian.tcmis.client.client.haargaz.gui;
...
import radian.tcmis.client.client.haargaz.helpers.*;
import java.security.Security;

import javax.swing.*;

public class HaargazCmisApp extends CmisApp {

  HaargazClientResourceBundle cConstants = new HaargazClientResourceBundle();
  HaargazReportPanelBundle reportBundle;
  FileOutputStream fOutStream;

  public HaargazCmisApp(){
    reportBundle = new HaargazReportPanelBundle(this);
  }
  //Main method
  static public void main(String[] args) {
    HaargazCmisApp cmisApp = new HaargazCmisApp();
