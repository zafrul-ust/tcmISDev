package radian.tcmis.client.client.sgd.gui;
...
import radian.tcmis.client.client.sgd.helpers.*;
import java.security.Security;

import javax.swing.*;

public class SGDCmisApp extends CmisApp {

  SGDClientResourceBundle cConstants = new SGDClientResourceBundle();
  SGDReportPanelBundle reportBundle;
  FileOutputStream fOutStream;

  public SGDCmisApp(){
    reportBundle = new SGDReportPanelBundle(this);
  }
  //Main method
  static public void main(String[] args) {
    SGDCmisApp cmisApp = new SGDCmisApp();
