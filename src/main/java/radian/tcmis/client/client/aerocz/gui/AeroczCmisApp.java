package radian.tcmis.client.client.aerocz.gui;

import java.io.FileOutputStream;
import java.security.Security;

import radian.tcmis.client.client.aerocz.helpers.AeroczClientResourceBundle;
import radian.tcmis.client.client.aerocz.helpers.AeroczReportPanelBundle;
import radian.tcmis.client.share.gui.CmisApp;
import radian.tcmis.client.share.gui.ReportInputPanel;
import radian.tcmis.client.share.helpers.ClientResourceBundle;

public class AeroczCmisApp extends CmisApp {

  AeroczClientResourceBundle cConstants = new AeroczClientResourceBundle();
  AeroczReportPanelBundle reportBundle;
  FileOutputStream fOutStream;

  public AeroczCmisApp(){
    reportBundle = new AeroczReportPanelBundle(this);
  }
  //Main method
  static public void main(String[] args) {
    AeroczCmisApp cmisApp = new AeroczCmisApp();
