package radian.tcmis.client.client.hrgivon.gui;
...
import radian.tcmis.client.client.hrgivon.helpers.*;
import java.security.Security;

import javax.swing.*;

public class HrgivonCmisApp extends CmisApp {

  HrgivonClientResourceBundle cConstants = new HrgivonClientResourceBundle();
  HrgivonReportPanelBundle reportBundle;
  FileOutputStream fOutStream;

  public HrgivonCmisApp(){
    reportBundle = new HrgivonReportPanelBundle(this);
  }
  //Main method
  static public void main(String[] args) {
    HrgivonCmisApp cmisApp = new HrgivonCmisApp();
