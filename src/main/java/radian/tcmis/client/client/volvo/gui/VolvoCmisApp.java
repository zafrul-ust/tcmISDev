package radian.tcmis.client.client.volvo.gui;
...
import radian.tcmis.client.client.volvo.helpers.*;
import java.security.Security;

import javax.swing.*;

public class VolvoCmisApp extends CmisApp {

  VolvoClientResourceBundle cConstants = new VolvoClientResourceBundle();
  VolvoReportPanelBundle reportBundle;
  FileOutputStream fOutStream;

  public VolvoCmisApp(){
    reportBundle = new VolvoReportPanelBundle(this);
  }
  //Main method
  static public void main(String[] args) {
    VolvoCmisApp cmisApp = new VolvoCmisApp();
