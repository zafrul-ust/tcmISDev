package radian.tcmis.client.client.hexcel.gui;
...
import radian.tcmis.client.client.hexcel.helpers.*;
import java.security.Security;

import javax.swing.*;

public class HexcelCmisApp extends CmisApp {

  HexcelClientResourceBundle cConstants = new HexcelClientResourceBundle();
  HexcelReportPanelBundle reportBundle;
  FileOutputStream fOutStream;

  public HexcelCmisApp(){
    reportBundle = new HexcelReportPanelBundle(this);
  }
  //Main method
  static public void main(String[] args) {
    HexcelCmisApp cmisApp = new HexcelCmisApp();
