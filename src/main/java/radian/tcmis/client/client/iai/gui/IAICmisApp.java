package radian.tcmis.client.client.iai.gui;
...
import radian.tcmis.client.client.iai.helpers.*;
import java.security.Security;

import javax.swing.*;

public class IAICmisApp extends CmisApp {

  IAIClientResourceBundle cConstants = new IAIClientResourceBundle();
  IAIReportPanelBundle reportBundle;
  FileOutputStream fOutStream;

  public IAICmisApp(){
    reportBundle = new IAIReportPanelBundle(this);
  }
  //Main method
  static public void main(String[] args) {
    IAICmisApp cmisApp = new IAICmisApp();
