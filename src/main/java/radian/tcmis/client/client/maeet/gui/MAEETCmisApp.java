package radian.tcmis.client.client.maeet.gui;
...
import radian.tcmis.client.client.maeet.helpers.*;
import java.security.Security;

import javax.swing.*;

public class MAEETCmisApp extends CmisApp {

  MAEETClientResourceBundle cConstants = new MAEETClientResourceBundle();
  MAEETReportPanelBundle reportBundle;
  FileOutputStream fOutStream;

  public MAEETCmisApp(){
    reportBundle = new MAEETReportPanelBundle(this);
  }
  //Main method
  static public void main(String[] args) {
    MAEETCmisApp cmisApp = new MAEETCmisApp();
