package radian.tcmis.client.client.hal.gui;
...
import radian.tcmis.client.client.hal.helpers.*;
import java.security.Security;

import javax.swing.*;

public class HALCmisApp extends CmisApp {

  HALClientResourceBundle cConstants = new HALClientResourceBundle();
  HALReportPanelBundle reportBundle;
  FileOutputStream fOutStream;

  public HALCmisApp(){
    reportBundle = new HALReportPanelBundle(this);
  }
  //Main method
  static public void main(String[] args) {
    HALCmisApp cmisApp = new HALCmisApp();
