package radian.tcmis.client.client.kemfast.gui;
...
import radian.tcmis.client.client.kemfast.helpers.*;
import java.security.Security;

import javax.swing.*;

public class KemfastCmisApp extends CmisApp {

  KemfastClientResourceBundle cConstants = new KemfastClientResourceBundle();
  KemfastReportPanelBundle reportBundle;
  FileOutputStream fOutStream;

  public KemfastCmisApp(){
    reportBundle = new KemfastReportPanelBundle(this);
  }
  //Main method
  static public void main(String[] args) {
    KemfastCmisApp cmisApp = new KemfastCmisApp();
