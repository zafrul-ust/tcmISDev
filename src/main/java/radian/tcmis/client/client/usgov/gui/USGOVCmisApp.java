package radian.tcmis.client.client.usgov.gui;
...
import radian.tcmis.client.client.usgov.helpers.*;
import java.security.Security;

import javax.swing.*;

public class USGOVCmisApp extends CmisApp {

  USGOVClientResourceBundle cConstants = new USGOVClientResourceBundle();
  USGOVReportPanelBundle reportBundle;
  FileOutputStream fOutStream;

  public USGOVCmisApp(){
    reportBundle = new USGOVReportPanelBundle(this);
  }
  //Main method
  static public void main(String[] args) {
    USGOVCmisApp cmisApp = new USGOVCmisApp();
