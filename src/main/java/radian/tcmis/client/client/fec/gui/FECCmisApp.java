package radian.tcmis.client.client.fec.gui;
...
import radian.tcmis.client.client.fec.helpers.*;
import java.security.Security;

import javax.swing.*;

public class FECCmisApp extends CmisApp {

  FECClientResourceBundle cConstants = new FECClientResourceBundle();
  FECReportPanelBundle reportBundle;
  FileOutputStream fOutStream;

  public FECCmisApp(){
    reportBundle = new FECReportPanelBundle(this);
  }
  //Main method
  static public void main(String[] args) {
    FECCmisApp cmisApp = new FECCmisApp();
