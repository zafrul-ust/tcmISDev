...
public class Tcmis {
  ...
  protected static String classpath = "-cp jre"+System.getProperty("file.separator")+"1.1"+System.getProperty("file.separator")+"lib"+System.getProperty("file.separator")+"rt.jar;" +
             ...
             System.getProperty("file.separator")+"ERWMain.jar;classes"+System.getProperty("file.separator")+"RadianGui.jar;classes"+System.getProperty("file.separator")+"RadianUTC.jar;classes"+
    ...
    try{
      ...
      if (test.exists()) {  // Run update
         ...
         if (args.length > 0){
                ...
                prog[1] = "radian.tcmis.client.client.utc.gui.UTCCmisApp";
                for (int i=0;i<add;i++) {
