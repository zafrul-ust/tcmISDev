package radian.tcmis.client.client.utc.gui;
...
import radian.tcmis.client.client.utc.helpers.*;
import java.security.Security;

import javax.swing.*;

public class UTCCmisApp extends CmisApp {

  UTCClientResourceBundle cConstants = new UTCClientResourceBundle();
  UTCReportPanelBundle reportBundle;
  FileOutputStream fOutStream;

  public UTCCmisApp(){
    reportBundle = new UTCReportPanelBundle(this);
  }
  //Main method
  static public void main(String[] args) {
    UTCCmisApp cmisApp = new UTCCmisApp();
