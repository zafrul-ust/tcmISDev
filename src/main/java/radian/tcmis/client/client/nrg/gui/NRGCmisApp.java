package radian.tcmis.client.client.nrg.gui;
...
import radian.tcmis.client.client.nrg.helpers.*;
import java.security.Security;

import javax.swing.*;

public class NRGCmisApp extends CmisApp {

  NRGClientResourceBundle cConstants = new NRGClientResourceBundle();
  NRGReportPanelBundle reportBundle;
  FileOutputStream fOutStream;

  public NRGCmisApp(){
    reportBundle = new NRGReportPanelBundle(this);
  }
  //Main method
  static public void main(String[] args) {
    NRGCmisApp cmisApp = new NRGCmisApp();
