package radian.tcmis.client.client.pge.gui;
...
import radian.tcmis.client.client.pge.helpers.*;
import java.security.Security;

import javax.swing.*;

public class PGECmisApp extends CmisApp {

  PGEClientResourceBundle cConstants = new PGEClientResourceBundle();
  PGEReportPanelBundle reportBundle;
  FileOutputStream fOutStream;

  public PGECmisApp(){
    reportBundle = new PGEReportPanelBundle(this);
  }
  //Main method
  static public void main(String[] args) {
    PGECmisApp cmisApp = new PGECmisApp();
