package radian.tcmis.client.client.ommc.gui;
...
import radian.tcmis.client.client.ommc.helpers.*;
import java.security.Security;

import javax.swing.*;

public class OMMCCmisApp extends CmisApp {

  OMMCClientResourceBundle cConstants = new OMMCClientResourceBundle();
  OMMCReportPanelBundle reportBundle;
  FileOutputStream fOutStream;

  public OMMCCmisApp(){
    reportBundle = new OMMCReportPanelBundle(this);
  }
  //Main method
  static public void main(String[] args) {
    OMMCCmisApp cmisApp = new OMMCCmisApp();
