package radian.tcmis.client.client.sales.gui;
...
import radian.tcmis.client.client.sales.helpers.*;
import java.security.Security;

import javax.swing.*;

public class SalesCmisApp extends CmisApp {

  SalesClientResourceBundle cConstants = new SalesClientResourceBundle();
  SalesReportPanelBundle reportBundle;
  FileOutputStream fOutStream;

  public SalesCmisApp(){
    reportBundle = new SalesReportPanelBundle(this);
  }
  //Main method
  static public void main(String[] args) {
    SalesCmisApp cmisApp = new SalesCmisApp();
