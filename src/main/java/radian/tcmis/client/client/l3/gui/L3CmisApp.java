package radian.tcmis.client.client.l3.gui;
...
import radian.tcmis.client.client.l3.helpers.*;
import java.security.Security;

import javax.swing.*;

public class L3CmisApp extends CmisApp {

  L3ClientResourceBundle cConstants = new L3ClientResourceBundle();
  L3ReportPanelBundle reportBundle;
  FileOutputStream fOutStream;

  public L3CmisApp(){
    reportBundle = new L3ReportPanelBundle(this);
  }
  //Main method
  static public void main(String[] args) {
    L3CmisApp cmisApp = new L3CmisApp();
