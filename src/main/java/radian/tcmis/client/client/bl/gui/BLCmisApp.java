package radian.tcmis.client.client.bl.gui;

import java.io.FileOutputStream;
import java.security.Security;

import radian.tcmis.client.client.bl.helpers.BLClientResourceBundle;
import radian.tcmis.client.client.bl.helpers.BLReportPanelBundle;
import radian.tcmis.client.share.gui.CmisApp;
import radian.tcmis.client.share.gui.ReportInputPanel;
import radian.tcmis.client.share.helpers.ClientResourceBundle;

public class BLCmisApp extends CmisApp {

  BLClientResourceBundle cConstants = new BLClientResourceBundle();
  BLReportPanelBundle reportBundle;
  FileOutputStream fOutStream;

  public BLCmisApp(){
    reportBundle = new BLReportPanelBundle(this);
  }
  //Main method
  static public void main(String[] args) {
    BLCmisApp cmisApp = new BLCmisApp();
