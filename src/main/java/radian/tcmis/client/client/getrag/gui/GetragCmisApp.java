package radian.tcmis.client.client.getrag.gui;
...
import radian.tcmis.client.client.getrag.helpers.*;
import java.security.Security;

import javax.swing.*;

public class GetragCmisApp extends CmisApp {

  GetragClientResourceBundle cConstants = new GetragClientResourceBundle();
  GetragReportPanelBundle reportBundle;
  FileOutputStream fOutStream;

  public GetragCmisApp(){
    reportBundle = new GetragReportPanelBundle(this);
  }
  //Main method
  static public void main(String[] args) {
    GetragCmisApp cmisApp = new GetragCmisApp();
