package radian.tcmis.client.client.gkn.gui;
...
import radian.tcmis.client.client.gkn.helpers.*;
import java.security.Security;

import javax.swing.*;

public class GKNCmisApp extends CmisApp {

  GKNClientResourceBundle cConstants = new GKNClientResourceBundle();
  GKNReportPanelBundle reportBundle;
  FileOutputStream fOutStream;

  public GKNCmisApp(){
    reportBundle = new GKNReportPanelBundle(this);
  }
  //Main method
  static public void main(String[] args) {
    GKNCmisApp cmisApp = new GKNCmisApp();
