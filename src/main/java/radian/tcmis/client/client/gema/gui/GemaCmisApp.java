package radian.tcmis.client.client.gema.gui;
...
import radian.tcmis.client.client.gema.helpers.*;
import java.security.Security;

import javax.swing.*;

public class GemaCmisApp extends CmisApp {

  GemaClientResourceBundle cConstants = new GemaClientResourceBundle();
  GemaReportPanelBundle reportBundle;
  FileOutputStream fOutStream;

  public GemaCmisApp(){
    reportBundle = new GemaReportPanelBundle(this);
  }
  //Main method
  static public void main(String[] args) {
    GemaCmisApp cmisApp = new GemaCmisApp();
