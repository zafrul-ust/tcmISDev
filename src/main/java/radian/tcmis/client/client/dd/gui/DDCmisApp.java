package radian.tcmis.client.client.dd.gui;

import java.io.FileOutputStream;
import java.security.Security;

import radian.tcmis.client.client.dd.helpers.DDClientResourceBundle;
import radian.tcmis.client.client.dd.helpers.DDReportPanelBundle;
import radian.tcmis.client.share.gui.CmisApp;
import radian.tcmis.client.share.gui.ReportInputPanel;
import radian.tcmis.client.share.helpers.ClientResourceBundle;

public class DDCmisApp extends CmisApp {

  DDClientResourceBundle cConstants = new DDClientResourceBundle();
  DDReportPanelBundle reportBundle;
  FileOutputStream fOutStream;

  public DDCmisApp(){
    reportBundle = new DDReportPanelBundle(this);
  }
  //Main method
  static public void main(String[] args) {
    DDCmisApp cmisApp = new DDCmisApp();
