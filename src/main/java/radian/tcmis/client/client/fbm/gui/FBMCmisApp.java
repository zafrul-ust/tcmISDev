package radian.tcmis.client.client.fbm.gui;
...
import radian.tcmis.client.client.fbm.helpers.*;
import java.security.Security;

import javax.swing.*;

public class FBMCmisApp extends CmisApp {

  FBMClientResourceBundle cConstants = new FBMClientResourceBundle();
  FBMReportPanelBundle reportBundle;
  FileOutputStream fOutStream;

  public FBMCmisApp(){
    reportBundle = new FBMReportPanelBundle(this);
  }
  //Main method
  static public void main(String[] args) {
    FBMCmisApp cmisApp = new FBMCmisApp();
