package radian.tcmis.client.client.pepsi.gui;
...
import radian.tcmis.client.client.pepsi.helpers.*;
import java.security.Security;

import javax.swing.*;

public class PepsiCmisApp extends CmisApp {

  PepsiClientResourceBundle cConstants = new PepsiClientResourceBundle();
  PepsiReportPanelBundle reportBundle;
  FileOutputStream fOutStream;

  public PepsiCmisApp(){
    reportBundle = new PepsiReportPanelBundle(this);
  }
  //Main method
  static public void main(String[] args) {
    PepsiCmisApp cmisApp = new PepsiCmisApp();
