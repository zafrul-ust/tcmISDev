package radian.tcmis.client.client.alcoa.gui;

import java.io.FileOutputStream;
import java.security.Security;

import radian.tcmis.client.client.alcoa.helpers.AlcoaClientResourceBundle;
import radian.tcmis.client.client.alcoa.helpers.AlcoaReportPanelBundle;
import radian.tcmis.client.share.gui.CmisApp;
import radian.tcmis.client.share.gui.ReportInputPanel;
import radian.tcmis.client.share.helpers.ClientResourceBundle;

public class AlcoaCmisApp extends CmisApp {

  AlcoaClientResourceBundle cConstants = new AlcoaClientResourceBundle();
  AlcoaReportPanelBundle reportBundle;
  FileOutputStream fOutStream;

  public AlcoaCmisApp(){
    reportBundle = new AlcoaReportPanelBundle(this);
  }
  //Main method
  static public void main(String[] args) {
    AlcoaCmisApp cmisApp = new AlcoaCmisApp();
