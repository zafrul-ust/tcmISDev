package radian.tcmis.client.client.nalco.gui;
...
import radian.tcmis.client.client.nalco.helpers.*;
import java.security.Security;

import javax.swing.*;

public class NalcoCmisApp extends CmisApp {

  NalcoClientResourceBundle cConstants = new NalcoClientResourceBundle();
  NalcoReportPanelBundle reportBundle;
  FileOutputStream fOutStream;

  public NalcoCmisApp(){
    reportBundle = new NalcoReportPanelBundle(this);
  }
  //Main method
  static public void main(String[] args) {
    NalcoCmisApp cmisApp = new NalcoCmisApp();
