...
public class UseApprovalDlg extends JDialog {
  ...
  public UseApprovalDlg(RequestsWin rw, JFrame fr, String title, String prNum, String line, String stat) {
  ...
  public void loadIt(){
    UseApprovalLoadThread x = new UseApprovalLoadThread(this);
    x.start();
  }
...
class UseApprovalLoadThread extends Thread {
  UseApprovalDlg parent;
  public UseApprovalLoadThread(UseApprovalDlg parent){
     super("UseApprovalLoadThread");
     this.parent = parent;
  }
  public void run(){
     parent.loadItAction();
