...
public class UseApprovalApprovedRejectedDlg extends JDialog {
  ...
  public UseApprovalApprovedRejectedDlg(RequestsWin rw,JFrame fr, String title, String prNum, String line, String stat) {
  ...
  public void loadIt(){
    UseApprovalApprovedRejectedLoadThread x = new UseApprovalApprovedRejectedLoadThread(this);
    x.start();
  }
  ...
  void loadItAction() {
    ...
    try {
      ...
      query.put("FUNCTION","GET_USE_APPROVAL_INFO"); //String, String
      ...
      if (bool.booleanValue()) {
        Hashtable useApprovalH = (Hashtable)result.get("USE_APPROVAL_INFO");
  ...
  void closeWindow() {
    requestWin.useApprovalDlgOpen = false;
...
class UseApprovalApprovedRejectedLoadThread extends Thread {
  UseApprovalApprovedRejectedDlg parent;
  public UseApprovalApprovedRejectedLoadThread(UseApprovalApprovedRejectedDlg parent){
     super("UseApprovalApprovedRejectedLoadThread");
     this.parent = parent;
  }
  public void run(){
     parent.loadItAction();
