...
public class forcerepackstart  extends HttpServlet implements SingleThreadModel
{
    ...
    public void doPost(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException
    {
      ...
      try
      {
        ...
        else
        {
          ...
          obj = new forceRepack((ServerResourceBundle) new InternalServerResourceBundle(),db);
