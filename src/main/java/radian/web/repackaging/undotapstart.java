...
public class undotapstart  extends HttpServlet implements SingleThreadModel
{
    ...
    public void doPost(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException
    {
      ...
      try
      {
        ...
        else
        {
          ...
          obj = new undoTap((ServerResourceBundle) new InternalServerResourceBundle(),db);
		  ...
		  else
          {
            ...
            {
              out.println(radian.web.HTMLHelpObj.printLoginScreenOptions("You don't have access to this page.", "Undo Tap",session));
              out.close();
              return;
            }
          }
