...
public class clientdotshippingname
{
    ...
    public clientdotshippingname(TcmISDBModel d)
    {
        db = d;
    }
    ...
    public void doResult(HttpServletRequest request, HttpServletResponse response,HttpSession dotsession)  throws ServletException,  IOException
    {
        ...
        clientDothelpObj cataddqcObj = new clientDothelpObj(db);
  ...
  public void buildDetails( PrintWriter dotout,String Message,Hashtable DataH,Hashtable HeaderData1,String item_idsersch,HttpSession dotsession1 ) throws Exception
  {
    ...
    dotout.println( "<FORM METHOD=\"POST\" name=\"MainForm\" onSubmit=\"return SubmitOnlyOnce()\" action=\"/tcmIS/swa/dotshipname?session=Active\" >\n" );
  ...
  public void buildDivs( Hashtable DataH,int TabNumber,HttpSession dotsession2,PrintWriter dotout )
  {
    ...
    try
    {
      ...
      dotout.println("<TR>\n<TD WIDTH=\"10%\" CLASS=\"Inwhiter\" ALIGN=\"LEFT\"><B>Proper Shipping Name: </B></TD>\n");
      dotout.println("<TD COLSPAN=\"3\" WIDTH=\"10%\" CLASS=\"Inwhitel\"><INPUT type=\"text\" MAXLENGTH=\"80\" CLASS=\"Inwhitel\" name=\"ground_shipping_name"+numbervar+"\" value=\"");
      dotout.println(materialData.get("GROUND_SHIPPING_NAME"));
      dotout.println("\" SIZE=\"70\"><INPUT TYPE=\"button\" CLASS=\"SUBMIT\" onmouseover=\"className='SUBMITHOVER'\" onMouseout=\"className='SUBMIT'\" name=\"propershpnamelike\" value=\"Lookup\" OnClick=\"getpropershipname("+numbervar+")\"></TD></TR>\n");
      ...
      dotout.println( "<SELECT CLASS=\"HEADER\" NAME=\"hazard_class" + numbervar + "\" size=\"1\">\n" );
      ...
      dotout.println( "<SELECT CLASS=\"HEADER\" NAME=\"packing_group" + numbervar + "\" size=\"1\">\n" );
      dotout.println( "<OPTION VALUE=\"\">Please Select</OPTION>\n" );
      ...
      dotout.println("<TD WIDTH=\"10%\" CLASS=\"Inwhitel\"><INPUT type=\"text\" MAXLENGTH=\"30\" CLASS=\"Inwhitel\" name=\"un_number"+numbervar+"\" value=\"");
      dotout.println(materialData.get("UN_NUMBER"));
      dotout.println("\" SIZE=\"15\"></TD>");
      dotout.println("</TR>\n");
      //RQ_WEIGHT_IN_LBS
      dotout.println("<TR>\n<TD WIDTH=\"10%\" CLASS=\"Inbluer\" ALIGN=\"LEFT\"><B>RQ Weight(lb): </B></TD>\n");
      dotout.println("<TD WIDTH=\"10%\" CLASS=\"Inbluel\"><INPUT type=\"text\" MAXLENGTH=\"40\" CLASS=\"Inbluel\" name=\"reportable_quantity_lb"+numbervar+"\" value=\"");
      ...
      dotout.println("<TD WIDTH=\"8%\" CLASS=\"Inbluer\"><INPUT TYPE=\"checkbox\" value=\""+chkbox_value+"\"  " + rqcheckednon+ "  name=\"pkg_gt_rq"+numbervar+"\"></TD><TD WIDTH=\"20%\" CLASS=\"Inbluel\">");
      dotout.println("Component Net Weight > RQ</TD>\n</TR>\n");

     dotout.println( "<TR>\n<TD WIDTH=\"10%\" CLASS=\"Inwhiter\" ALIGN=\"LEFT\"><B>ERG: </B></TD>\n" );
     dotout.println( "<TD WIDTH=\"10%\" CLASS=\"Inwhitel\"><INPUT type=\"text\" MAXLENGTH=\"30\" CLASS=\"Inwhitel\" name=\"erg" + numbervar + "\" value=\"" );
     dotout.println( materialData.get( "ERG" ) );
     dotout.println( "\" SIZE=\"15\"></TD>" );
     dotout.println( "\n<TD WIDTH=\"10%\" CLASS=\"Inwhiter\" ALIGN=\"LEFT\"><B></B></TD>\n" );
     dotout.println( "<TD WIDTH=\"10%\" CLASS=\"Inwhitel\"></TD>");
     dotout.println("</TR>\n");
     ...
     dotout.println("<TR>\n<TD WIDTH=\"10%\" CLASS=\"Inbluer\"><INPUT TYPE=\"checkbox\" value=\""+chkbox_value+"\" " + checkednon+ "  name=\"marine_pollutant"+numbervar+"\"></TD><TD WIDTH=\"15%\" CLASS=\"Inbluel\">");
     ...
     dotout.println("<TD WIDTH=\"10%\" CLASS=\"Inbluer\"><INPUT TYPE=\"checkbox\" value=\""+chkbox_value+"\" " + checkednon+ "  name=\"bulk_pkg_marine_pollutant"+numbervar+"\"></TD><TD WIDTH=\"15%\" CLASS=\"Inbluel\">");
...
*/
      //Comments
      dotout.println("<TR>\n<TD WIDTH=\"10%\" CLASS=\"Inwhiter\" ALIGN=\"LEFT\"><B>Shipping Remarks: </B></TD>\n");
      dotout.println("<TD WIDTH=\"15%\" CLASS=\"Inwhitel\" COLSPAN=\"3\">");
    ...
    public void buildreadonlyDivs( Hashtable DataH,int TabNumber,HttpSession dotsession2,PrintWriter dotout )
      {
        ...
        try
        {
          ...
          String ormd = materialData.get("ORM_D").toString();
          String grundshipingname = materialData.get("ORM_D").toString();
          dotout.println("<TR><TD WIDTH=\"2%\" CLASS=\"Inbluer\"></TD><TD WIDTH=\"10%\" CLASS=\"Inbluel\">");
          ...
          //GROUND_SHIPPING_NAME
          dotout.println("<TR>\n<TD WIDTH=\"10%\" CLASS=\"Inwhiter\" ALIGN=\"LEFT\"><B>Proper Shipping Name: </B></TD>\n");
          dotout.println("<TD COLSPAN=\"3\" WIDTH=\"10%\" CLASS=\"Inwhitel\"><INPUT type=\"text\" MAXLENGTH=\"80\" CLASS=\"INVISIBLEHEADWHITE\" name=\"ground_shipping_name"+numbervar+"\" value=\"");
          dotout.println(materialData.get("GROUND_SHIPPING_NAME"));
          dotout.println("\" SIZE=\"70\"></TD></TR>\n");
          ...
          //RQ_WEIGHT_IN_LBS
          dotout.println("<TR>\n<TD WIDTH=\"10%\" CLASS=\"Inbluer\" ALIGN=\"LEFT\"><B>RQ Weight(lb): </B></TD>\n");
          dotout.println("<TD WIDTH=\"10%\" CLASS=\"Inbluel\"><INPUT type=\"text\" MAXLENGTH=\"40\" CLASS=\"INVISIBLEHEADBLUE\" name=\"reportable_quantity_lb"+numbervar+"\" value=\"");
          dotout.println(materialData.get("REPORTABLE_QUANTITY_LB"));
          dotout.println("\" SIZE=\"5\" onChange= \"checkrqweight('"+numbervar+"')\"></TD>");

          String rqchangesshipname = materialData.get("TEST_PKG_GT_RQ").toString();
          String pkggtrq = materialData.get("PKG_GT_RQ").toString();
          dotout.println("<TD WIDTH=\"8%\" CLASS=\"Inbluer\"></TD><TD WIDTH=\"20%\" CLASS=\"Inbluel\">");
          if ("Y".equalsIgnoreCase(rqchangesshipname) || "Y".equalsIgnoreCase(pkggtrq)) {dotout.println("Component Net Weight > RQ</TD>\n</TR>\n");}
          else {dotout.println("</TD>\n");}

         dotout.println( "<TR>\n<TD WIDTH=\"10%\" CLASS=\"Inwhiter\" ALIGN=\"LEFT\"><B>ERG: </B></TD>\n" );
         dotout.println( "<TD WIDTH=\"10%\" CLASS=\"Inwhitel\"><INPUT type=\"text\" MAXLENGTH=\"30\" CLASS=\"INVISIBLEHEADWHITE\" name=\"erg" + numbervar + "\" value=\"" );
         dotout.println( materialData.get( "ERG" ) );
         dotout.println( "\" SIZE=\"15\"></TD>" );
         dotout.println( "\n<TD WIDTH=\"10%\" CLASS=\"Inwhiter\" ALIGN=\"LEFT\"><B></B></TD>\n" );
         dotout.println( "<TD WIDTH=\"10%\" CLASS=\"Inwhitel\"></TD>");
         ...
         //Water Hazard
         String bulkpkging = materialData.get("BULK_PKG_MARINE_POLLUTANT").toString();
         dotout.println("<TD WIDTH=\"10%\" CLASS=\"Inbluer\"></TD><TD WIDTH=\"15%\" CLASS=\"Inbluel\">");
    ...
    */
    ...
    {
      clientDothelpObj cataddqcObj1=new clientDothelpObj( db );
