...
public class dotshippingnamestart  extends HttpServlet implements SingleThreadModel
{
    ...
    */
    ...
    public void doPost(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException
    {
        ...
        {
          out.println( radian.web.HTMLHelpObj.printLoginScreen( errormsg,"DoT Shipping Information" ) );
          out.flush();
        }
        else
        {
          obj=new dotshippingname( db );
		  ...
		  if ( radian.web.HTMLHelpObj.hasaccessto(session,"Dotinfo"))
          {
            ...
            {
              out.println( radian.web.HTMLHelpObj.printLoginScreenOptions( "<B>You don't have access to this page.</B>","DoT Shipping Information" ) );
              out.close();
              return;
            }*/
          }
