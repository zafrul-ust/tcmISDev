...
public class cabinetdefinitionstart  extends HttpServlet implements SingleThreadModel
{
    ...
    */
    ...
    public void doPost(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException
    {
        ...
        try
        {
          ...
          {
            out.println( radian.web.HTMLHelpObj.printLoginScreen( errormsg,"Cabinet Definition" ) );
            out.flush();
          }
          else
          {
            obj=new cabinetDefinition( ( ServerResourceBundle )new InternalServerResourceBundle(),db );
			...
			else
			{
              ...
              {
                out.println( radian.web.HTMLHelpObj.printLoginScreenOptions( "You don't have access to this page.","Cabinet Definition",session ) );
                out.close();
                return;
              }
            }
