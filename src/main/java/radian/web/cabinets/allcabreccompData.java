...
public class allcabreccompData
{
    ...
    public allcabreccompData(Hashtable h,int size)
    {
        DETAIL_0 ="";
        DETAIL_1 ="";
        DETAIL_2 ="";
	...
	try
	{
	  ...
	  for ( int i=0; i < in.size(); i++ )
	  {
		...
		if ( "RECEIPT".equalsIgnoreCase( whichdata ) )
		{
		  ...
		  {
			out.addElement( new allcabreccompData( h1,h1.size() ) );
		  }
		}
		else
		{
		  out.addElement( new allcabreccompData( h,h.size() ) );
		}
	  }
	}
	catch ( Exception e11 )
