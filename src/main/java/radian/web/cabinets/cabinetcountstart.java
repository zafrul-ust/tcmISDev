...
public class cabinetcountstart  extends HttpServlet implements SingleThreadModel
{
    ...
    */
    ...
    public void doPost(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException
    {
        ...
        try
        {
          ...
          {
            obj=new cabinetCount( ( ServerResourceBundle )new InternalServerResourceBundle(),db );
