...
/**
 * Title:        TcmIS
 * Description:  Total Chemioma Mgmt
...
public class OMADropShipReceiving extends HttpServlet implements SingleThreadModel
{
  ...
  public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
  {
    ...
    try
    {
      ...
      ServerResourceBundle bundleoma=new OMAServerResourceBundle();
      HeaderFooter hf=new HeaderFooter( bundleoma,db );
      ...
      else
      {
        ...
        obj=new dropShipReceiving( bundleoma,db );
