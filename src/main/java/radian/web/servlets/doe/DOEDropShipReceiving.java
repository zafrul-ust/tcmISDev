...
/**
 * Title:        TcmIS
 * Description:  Total Chemidoe Mgmt
...
public class DOEDropShipReceiving extends HttpServlet implements SingleThreadModel
{
  ...
  public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
  {
    ...
    try
    {
      ...
      ServerResourceBundle bundledoe=new DOEServerResourceBundle();
      HeaderFooter hf=new HeaderFooter( bundledoe,db );
      ...
      else
      {
        ...
        obj=new dropShipReceiving( bundledoe,db );
