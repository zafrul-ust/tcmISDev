...
/**
 * Title:        TcmIS
 * Description:  Total Chemicyclone Mgmt
...
public class CycloneDropShipReceiving extends HttpServlet implements SingleThreadModel
{
  ...
  public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
  {
    ...
    try
    {
      db=new RayTcmISDBModel( "Cyclone" );
      if ( db == null )
      {
      ...
      ServerResourceBundle bundlecyclone=new CycloneServerResourceBundle();
      HeaderFooter hf=new HeaderFooter( bundlecyclone,db );
      ...
      else
      {
        ...
        obj=new dropShipReceiving( bundlecyclone,db );
