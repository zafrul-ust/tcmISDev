...
/**
 * Title:        TcmIS
 * Description:  Total Chemifec Mgmt
...
public class FECDropShipReceiving extends HttpServlet implements SingleThreadModel
{
  ...
  public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
  {
    ...
    try
    {
      ...
      else
      {
        ...
        obj=new dropShipReceiving( bundlefec,db );
