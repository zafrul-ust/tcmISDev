...
public class FECSourcing extends HttpServlet
{
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
          ...
          ServerResourceBundle bundlefec=new FECServerResourceBundle();
          ...
          if (errormsg == null) {errormsg = "";}
           ...
           if ( ! ( auth.equalsIgnoreCase( "authenticated" ) ) ) {
             ...
             out.println( hf.printclientLoginScreen( errormsg,"Customer Sourcing","tcmistcmis32.gif",intcmIsApplication ) );
             out.flush();
           } else {
             CatalogSourcing obj = new CatalogSourcing((ServerResourceBundle) new FECServerResourceBundle(),db);
