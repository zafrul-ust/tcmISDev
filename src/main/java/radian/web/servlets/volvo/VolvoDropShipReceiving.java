...
/**
 * Title:        TcmIS
 * Description:  Total Chemivolvo Mgmt
...
public class VolvoDropShipReceiving extends HttpServlet implements SingleThreadModel
{
  ...
  public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
  {
    ...
    try
    {
      ...
      ServerResourceBundle bundlevolvo=new VolvoServerResourceBundle();
      HeaderFooter hf=new HeaderFooter( bundlevolvo,db );
      ...
      else
      {
        ...
        obj=new dropShipReceiving( bundlevolvo,db );
