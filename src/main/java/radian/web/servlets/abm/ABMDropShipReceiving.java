...
/**
 * Title:        TcmIS
 * Description:  Total Chemiabm Mgmt
...
public class ABMDropShipReceiving extends HttpServlet implements SingleThreadModel
{
  ...
  public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
  {
    ...
    try
    {
      ...
      ServerResourceBundle bundleabm=new ABMServerResourceBundle();
      HeaderFooter hf=new HeaderFooter( bundleabm,db );
      ...
      else
      {
        ...
        obj=new dropShipReceiving( bundleabm,db );
