...
import radian.web.servlets.fbm.FBMServerResourceBundle;
import radian.web.servlets.share.batchReport;

public class FBMBatchReport extends HttpServlet {
   ...
   public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      try
      {
        ...
        batchReport obj = new batchReport((ServerResourceBundle) new FBMServerResourceBundle(),db);
