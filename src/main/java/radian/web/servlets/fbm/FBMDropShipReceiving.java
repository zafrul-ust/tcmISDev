...
/**
 * Title:        TcmIS
 * Description:  Total Chemifbm Mgmt
...
public class FBMDropShipReceiving extends HttpServlet implements SingleThreadModel
{
  ...
  public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
  {
    ...
    try
    {
      ...
      ServerResourceBundle bundlefbm=new FBMServerResourceBundle();
      HeaderFooter hf=new HeaderFooter( bundlefbm,db );
      ...
      else
      {
        ...
        obj=new dropShipReceiving( bundlefbm,db );
