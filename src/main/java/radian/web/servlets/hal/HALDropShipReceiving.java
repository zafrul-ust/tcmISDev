...
/**
 * Title:        TcmIS
 * Description:  Total Chemihal Mgmt
...
public class HALDropShipReceiving extends HttpServlet implements SingleThreadModel
{
  ...
  public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
  {
    ...
    try
    {
      ...
      ServerResourceBundle bundlehal=new HALServerResourceBundle();
      HeaderFooter hf=new HeaderFooter( bundlehal,db );
      ...
      else
      {
        ...
        obj=new dropShipReceiving( bundlehal,db );
