...
/**
 * Title:        TcmIS
 * Description:  Total Chemitimken Mgmt
...
public class TimkenDropShipReceiving extends HttpServlet implements SingleThreadModel
{
  ...
  public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
  {
    ...
    try
    {
      ...
      ServerResourceBundle bundletimken=new TimkenServerResourceBundle();
      HeaderFooter hf=new HeaderFooter( bundletimken,db );
      ...
      else
      {
        ...
        obj=new dropShipReceiving( bundletimken,db );
