...
/**
 * Title:        TcmIS
 * Description:  Total Chemiqos Mgmt
...
public class QOSDropShipReceiving extends HttpServlet implements SingleThreadModel
{
  ...
  public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
  {
    ...
    try
    {
      ...
      ServerResourceBundle bundleqos=new QOSServerResourceBundle();
      HeaderFooter hf=new HeaderFooter( bundleqos,db );
      ...
      else
      {
        ...
        obj=new dropShipReceiving( bundleqos,db );
