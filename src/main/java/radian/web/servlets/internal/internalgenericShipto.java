...
import radian.web.servlets.share.genericShipto;
...
public class internalgenericShipto  extends HttpServlet implements SingleThreadModel
{
    ...
    */
    ...
    public void doPost(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException
    {
        ...
        try
        {
         ...
         {
           obj=new genericShipto( ( ServerResourceBundle )new InternalServerResourceBundle(),db );
