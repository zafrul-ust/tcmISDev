...
import radian.web.servlets.share.soundsLikeMaterial;
...
public class InternalsoundsLikeMaterial  extends HttpServlet implements SingleThreadModel
{
    ...
    */
    ...
    public void doPost(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException
    {
        ...
        {
          out.println( radian.web.HTMLHelpObj.printCatalogLoginScreen( errormsg,"Material Id" ) );
          out.flush();
        }
        else
        {
          obj=new soundsLikeMaterial( ( ServerResourceBundle )new InternalServerResourceBundle(),db );
