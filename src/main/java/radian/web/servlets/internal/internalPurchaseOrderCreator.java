...
import radian.web.servlets.share.purchaseOrderCreator;
...
public class internalPurchaseOrderCreator  extends HttpServlet implements SingleThreadModel
{
    ...
    */
    ...
    public void doPost(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException
    {
        ...
        else
        {
          ...
          obj=new purchaseOrderCreator( ( ServerResourceBundle )new InternalServerResourceBundle(),db );
		  ...
		  if ( radian.web.HTMLHelpObj.hasaccessto( session,"PaymentTerms" ) )
		  {
		  ...
		  if ( radian.web.HTMLHelpObj.hasaccessto( session,"chgCurrency" ) )
		  {
			obj.setallowCurrencyupdate( true );
		  }
		  else
		  {
			obj.setallowCurrencyupdate( false );
		  }
