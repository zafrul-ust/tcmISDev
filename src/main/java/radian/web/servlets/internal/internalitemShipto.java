...
import radian.web.servlets.share.itemShipto;
...
public class internalitemShipto  extends HttpServlet implements SingleThreadModel
{
    ...
    */
    ...
    public void doPost(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException
    {
        ...
        try
        {
		 ...
		 {
		   obj=new itemShipto( ( ServerResourceBundle )new InternalServerResourceBundle(),db );
