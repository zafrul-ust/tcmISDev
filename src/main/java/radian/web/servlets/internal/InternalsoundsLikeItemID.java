...
import radian.web.servlets.share.soundsLikeItemID;
...
public class InternalsoundsLikeItemID  extends HttpServlet implements SingleThreadModel
{
    ...
    */
    ...
    public void doPost(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException
    {
        ...
        {
          out.println( radian.web.HTMLHelpObj.printCatalogLoginScreen( errormsg,"Item Id" ) );
          out.flush();
        }
        else
        {
          obj=new soundsLikeItemID( ( ServerResourceBundle )new InternalServerResourceBundle(),db );
