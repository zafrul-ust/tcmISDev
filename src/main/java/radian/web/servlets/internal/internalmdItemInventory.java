...
import radian.web.servlets.share.mditemInventory;
...
public class internalmdItemInventory  extends HttpServlet implements SingleThreadModel
{
    ...
    public void doPost(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException
    {
      ...
      try
      {
        ...
        if (errormsg == null) {errormsg = "";}
          ...
          {
              out.println(radian.web.HTMLHelpObj.printLoginScreen(errormsg,"Item Management"));
              out.flush();
          }
          else
          {
            obj = new mditemInventory((ServerResourceBundle) new InternalServerResourceBundle(),db);

			if ( radian.web.HTMLHelpObj.hasaccessto( session,"ItemMgmt" ) || radian.web.HTMLHelpObj.hasaccessto( session,"ForceBuy" ))
			{
			...
			else
            {
              ...
              {
                out.println(radian.web.HTMLHelpObj.printLoginScreenOptions("You don't have access to this page.", "Item Management",session));
                out.close();
                return;
              }
            }
