...
import radian.web.servlets.share.reprintbols;
...
public class internalreprintbols  extends HttpServlet implements SingleThreadModel
{
    ...
    */
    ...
    public void doPost(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException
    {
      ...
      try
      {
        ...
        {
          out.println( radian.web.HTMLHelpObj.printLoginScreen( errormsg,"Generic BOLs" ) );
          out.flush();
        }

        else
        {
          obj=new reprintbols( ( ServerResourceBundle )new InternalServerResourceBundle(),db );
