...
import radian.web.servlets.share.showFlowdowns;
...
public class internalShowFlowdowns  extends HttpServlet implements SingleThreadModel
{
    ...
    */
    ...
    public void doPost(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException
    {
        ...
        try
        {
         ...
         {
           out.println( radian.web.HTMLHelpObj.printpoLoginScreen( errormsg,"Flow Downs" ) );
           out.flush();
         }
         else
         {
           obj=new showFlowdowns( ( ServerResourceBundle )new InternalServerResourceBundle(),db );
		   ...
		   else
           {
             ...
             {
               out.println( radian.web.HTMLHelpObj.printpoLoginScreenOptions( "You don't have access to this page.","Purchase Order Flow Downs",session ) );
               out.close();
               return;
             }
           }
