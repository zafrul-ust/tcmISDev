...
import radian.web.servlets.share.poNotes;
...
public class internalPoNotes  extends HttpServlet implements SingleThreadModel
{
    ...
    */
    ...
    public void doPost(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException
    {
        ...
        try
        {
          ...
          {
            obj=new poNotes( ( ServerResourceBundle )new InternalServerResourceBundle(),db );
