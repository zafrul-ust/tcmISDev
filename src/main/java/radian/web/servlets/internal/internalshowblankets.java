...
import radian.web.servlets.share.showBlanketorders;
...
public class internalshowblankets  extends HttpServlet implements SingleThreadModel
{
    ...
    */
    ...
    public void doPost(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException
    {
        ...
        try
        {
          ...
          {
              out.println(radian.web.HTMLHelpObj.printpoLoginScreen(errormsg,"PO Notes"));
              out.flush();
          }
          else
          {
            obj=new showBlanketorders( ( ServerResourceBundle )new InternalServerResourceBundle(),db );
			...
			{
			  out.println( radian.web.HTMLHelpObj.printLoginScreenOptions( "You don't have access to this page.","Purchase Order",session ) );
			  out.close();
			  return;
			}
