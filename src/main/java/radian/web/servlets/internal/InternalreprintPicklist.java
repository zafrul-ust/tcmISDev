...
import radian.web.servlets.share.reprintPicklist;
/**
 * Title:        TcmIS
...
public class InternalreprintPicklist  extends HttpServlet implements SingleThreadModel
{
    ...
    */
    ...
    public void doPost(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException
    {
        ...
        {
          out.println( radian.web.HTMLHelpObj.printLoginScreen( errormsg,"Re-Print Picklist" ) );
          out.flush();
        }
        else
        {
          obj=new reprintPicklist( ( ServerResourceBundle )new InternalServerResourceBundle(),db );
