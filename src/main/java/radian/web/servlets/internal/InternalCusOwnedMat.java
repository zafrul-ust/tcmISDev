...
import radian.web.servlets.share.CusOwnedMat;
...
public class InternalCusOwnedMat  extends HttpServlet implements SingleThreadModel
{
    ...
    */
    ...
    public void doPost(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException
    {
        ...
        if (errormsg == null) {errormsg = "";}
          ...
          {
              out.println(radian.web.HTMLHelpObj.printLoginScreen(errormsg,"Customer Returns"));
              out.flush();
          }
          else
          {
            ...
            obj = new CusOwnedMat((ServerResourceBundle) new InternalServerResourceBundle(),db);

			if ( radian.web.HTMLHelpObj.hasaccessto( session,"CusReturns" ) )
			{
			...
			else
            {
              ...
              out.println( radian.web.HTMLHelpObj.printLoginScreenOptions( "You don't have access to this page.","Customer Returns",session ) );
              out.close();
              return;
            }
