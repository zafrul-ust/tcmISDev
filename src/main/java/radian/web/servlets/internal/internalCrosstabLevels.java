...
import radian.web.servlets.share.corssTabLevels;
...
public class internalCrosstabLevels  extends HttpServlet implements SingleThreadModel
{
    ...
    public void doPost(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException
    {
        ...
        if (errormsg == null) {errormsg = "";}
          ...
          else
          {
            ...
            obj = new corssTabLevels((ServerResourceBundle) new InternalServerResourceBundle(),db);
