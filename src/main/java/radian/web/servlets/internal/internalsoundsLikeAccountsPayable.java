...
import radian.web.servlets.share.soundsLikeAccountsPayable;
/**
 * Title:        TcmIS
...
public class internalsoundsLikeAccountsPayable extends HttpServlet implements SingleThreadModel
{
  ...
  public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
  {
    ...
    soundsLikeAccountsPayable obj=null;
    HttpSession session=request.getSession();
	//Monitor mon=MonitorFactory.start("Recal PO for AP");
	//String personnelid= session.getAttribute( "PERSONNELID" ) == null ? "" : session.getAttribute( "PERSONNELID" ).toString();
	//Monitor monuser=MonitorFactory.start("Recal PO for AP by "+personnelid+"");
    ...
    try
    {
      ...
      {
        obj=new soundsLikeAccountsPayable( ( ServerResourceBundle )new InternalServerResourceBundle(),db );
		...
		obj.setallinvocieStatus(!radian.web.HTMLHelpObj.hasaccessto(session,"ShowonlyOpenInv"));
