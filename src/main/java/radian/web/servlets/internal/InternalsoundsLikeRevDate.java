...
import radian.web.servlets.share.soundsLikeRevDate;
...
public class InternalsoundsLikeRevDate  extends HttpServlet implements SingleThreadModel
{
    ...
    */
    ...
    public void doPost(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException
    {
        ...
        {
          out.println( radian.web.HTMLHelpObj.printCatalogLoginScreen( errormsg,"Revision Date" ) );
          out.flush();
        }
        else
        {
          obj=new soundsLikeRevDate( ( ServerResourceBundle )new InternalServerResourceBundle(),db );
