...
import radian.web.servlets.share.showClientBuys;
...
public class internalShowClientBuys  extends HttpServlet implements SingleThreadModel
{
    ...
    */
    ...
    public void doPost(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException
    {
        ...
        {
          out.println( radian.web.HTMLHelpObj.printpoLoginScreen( errormsg,"Client Buys" ) );
          out.flush();
        }
        else
        {
          ...
          {
            out.println( radian.web.HTMLHelpObj.printpoLoginScreenOptions( "You don't have access to this page.","Purchase Order Client Buys",session ) );
            out.close();
            return;
          }

          obj=new showClientBuys( ( ServerResourceBundle )new InternalServerResourceBundle(),db );
