...
import radian.web.servlets.share.soundsLikeSupplier;
...
public class internalsoundsLikeSupplier extends HttpServlet implements SingleThreadModel
{
  ...
  public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
  {
    ...
    try
    {
      ...
      if ( db == null )
      {
        ...
        {
		  obj=new soundsLikeSupplier( ( ServerResourceBundle )new InternalServerResourceBundle(),db );
