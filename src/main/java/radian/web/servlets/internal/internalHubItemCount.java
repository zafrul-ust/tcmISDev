...
import radian.web.servlets.share.hubitemCount;
...
public class internalHubItemCount  extends HttpServlet implements SingleThreadModel
{
    ...
    public void doPost(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException
    {
      ...
      try
      {
        ...
        if (errormsg == null) {errormsg = "";}
          ...
          {
            obj = new hubitemCount((ServerResourceBundle) new InternalServerResourceBundle(),db);
