...
import radian.web.servlets.share.invtransferRequest;
...
public class internalTransferRequest  extends HttpServlet implements SingleThreadModel
{
    ...
    public void doPost(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException
    {
      ...
      try
      {
        ...
        if (errormsg == null) {errormsg = "";}
          ...
          {
              out.println(radian.web.HTMLHelpObj.printLoginScreen(errormsg,"Inventory Transfer Page"));
              out.flush();
          }
          else
          {
            obj = new invtransferRequest((ServerResourceBundle) new InternalServerResourceBundle(),db);

			if ( radian.web.HTMLHelpObj.hasaccessto( session,"InvTransfer" ) )
			{
			...
			else
            {
              ...
              {
                out.println(radian.web.HTMLHelpObj.printLoginScreenOptions("You don't have access to this page.", "Inventory Transfer Page",session));
                out.close();
                return;
              }
            }
