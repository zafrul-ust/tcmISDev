...
import radian.web.servlets.share.soundsLikpoItemId;
...
public class internalsoundsLikpoItemId  extends HttpServlet implements SingleThreadModel
{
    ...
    */
    ...
    public void doPost(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException
    {
        ...
        try
        {
         ...
         {
           out.println( radian.web.HTMLHelpObj.printpoLoginScreen( errormsg,"Item Id" ) );
           out.flush();
         }
         else
         {
           ...
           obj=new soundsLikpoItemId( ( ServerResourceBundle )new InternalServerResourceBundle(),db );
