...
import radian.web.servlets.share.reprintboxlabels;
...
public class internalreprintboxlabels  extends HttpServlet implements SingleThreadModel
{
    ...
    */
    ...
    public void doPost(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException
    {
      ...
      try
      {
        ...
        {
          out.println( radian.web.HTMLHelpObj.printLoginScreen( errormsg,"Print BOX Labels" ) );
          out.flush();
        }

        else
        {
          obj=new reprintboxlabels( ( ServerResourceBundle )new InternalServerResourceBundle(),db );
