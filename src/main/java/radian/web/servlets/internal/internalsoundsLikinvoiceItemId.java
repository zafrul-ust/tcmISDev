...
import radian.web.servlets.share.soundsLikinvoiceItemId;
...
public class internalsoundsLikinvoiceItemId extends HttpServlet implements SingleThreadModel
{
  ...
  public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
  {
    ...
    soundsLikinvoiceItemId obj=null;
    ...
    try
    {
      ...
      {
        out.println( radian.web.HTMLHelpObj.printapLoginScreen( errormsg,"Invoice Item Id" ) );
        out.flush();
      }
      else
      {
        obj=new soundsLikinvoiceItemId( ( ServerResourceBundle )new InternalServerResourceBundle(),db );
