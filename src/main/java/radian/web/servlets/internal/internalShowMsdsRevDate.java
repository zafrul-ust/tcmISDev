...
import radian.web.servlets.share.showMsdsRevDate;
...
public class internalShowMsdsRevDate  extends HttpServlet implements SingleThreadModel
{
    ...
    */
    ...
    public void doPost(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException
    {
        ...
        {
          out.println( radian.web.HTMLHelpObj.printpoLoginScreen( errormsg,"MSDS Rev Date" ) );
          out.flush();
        }
        else
        {
          obj=new showMsdsRevDate( ( ServerResourceBundle )new InternalServerResourceBundle(),db );
