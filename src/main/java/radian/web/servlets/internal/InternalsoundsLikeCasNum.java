...
import radian.web.servlets.share.soundsLikeCasNum;
...
public class InternalsoundsLikeCasNum  extends HttpServlet implements SingleThreadModel
{
    ...
    */
    ...
    public void doPost(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException
    {
        ...
        {
          out.println( radian.web.HTMLHelpObj.printCatalogLoginScreen( errormsg,"Cas Num" ) );
          out.flush();
        }
        else
        {
          obj=new soundsLikeCasNum( ( ServerResourceBundle )new InternalServerResourceBundle(),db );
