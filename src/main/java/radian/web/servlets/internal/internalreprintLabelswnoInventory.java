...
import radian.web.servlets.share.reprintLabelswnoInventory;
/**
 * Title:        TcmIS
...
public class internalreprintLabelswnoInventory  extends HttpServlet implements SingleThreadModel
{
    ...
    */
    ...
    public void doPost(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException
    {
        ...
        reprintLabelswnoInventory obj = null;
        ...
        {
          obj=new reprintLabelswnoInventory( ( ServerResourceBundle )new InternalServerResourceBundle(),db );
