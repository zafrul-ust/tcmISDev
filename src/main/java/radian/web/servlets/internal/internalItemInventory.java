...
import radian.web.servlets.share.itemInventory;
...
public class internalItemInventory  extends HttpServlet implements SingleThreadModel
{
    ...
    public void doPost(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException
    {
      ...
      try
      {
        ...
        if (errormsg == null) {errormsg = "";}
          ...
          {
            obj = new itemInventory((ServerResourceBundle) new InternalServerResourceBundle(),db);
