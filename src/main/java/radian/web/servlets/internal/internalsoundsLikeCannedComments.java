...
import radian.web.servlets.share.soundsLikeCannedComments;
...
public class internalsoundsLikeCannedComments  extends HttpServlet implements SingleThreadModel
{
    ...
    */
    ...
    public void doPost(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException
    {
        ...
        soundsLikeCannedComments obj = null;
        ...
        {
          out.println( radian.web.HTMLHelpObj.printpoLoginScreen( errormsg,"Canned Comments" ) );
          out.flush();
        }
        else
        {
          ...
          obj=new soundsLikeCannedComments( ( ServerResourceBundle )new InternalServerResourceBundle(),db );
