...
public class internalsdhubHome  extends HttpServlet implements SingleThreadModel
{
    ...
    */
    ...
    public void doPost(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException
    {
        ...
        /*try
        {
          ...
          {
            out.println( radian.web.HTMLHelpObj.printLoginScreen( errormsg,"SD Hub Home" ) );
            out.flush();
          }
          else
          {
            ...
            session.setAttribute( "SDPAGE","Yes" );
						...
						personnelBean.setHome("sdhubhome");
            ...
            if ( "LOGOUT".equalsIgnoreCase( User_Action ) )
            {
              ...
              {
                out.println( "<META HTTP-EQUIV=\"Refresh\" CONTENT=\"0; url=/tcmIS/Hub/sd/" + CompanyID + "\">\n" );
              }
              else
              {
                out.println( "<META HTTP-EQUIV=\"Refresh\" CONTENT=\"0; url=/tcmIS/Hub/sd\">\n" );
              }
              out.println( "<META HTTP-EQUIV=\"Pragma\" CONTENT=\"no-cache\">\n" );
              String httphost = radian.web.tcmisResourceLoader.gethttphosturl();
              out.println( "<LINK REL=\"SHORTCUT ICON\" HREF=\""+httphost+"images/buttons/tcmIS.ico\"></LINK>\n" );
              out.println( "<META HTTP-EQUIV=\"Expires\" CONTENT=\"-1\">\n" );
              out.println( "<TITLE>SD Hub Home</TITLE>\n" );
              out.println( "</HEAD>  \n" );
              out.println( "<BODY BGCOLOR=\"#FFFFFF\" TEXT=\"#000000\">  \n" );
            ...
            else
            {
              ...
              out.println( "</HEAD>  \n" );
              out.println( "<BODY BGCOLOR=\"#FFFFFF\" TEXT=\"#000000\">  \n" );
              out.println( radian.web.HTMLHelpObj.PrintTitleBar( "SD Hub Home" ) );
              ...
              out.println( "<TD ALIGN=\"CENTER\" BGCOLOR=\"#E6E8FA\" onmouseover=\"className='menuh1'\" onMouseout=\"className='menu1'\" width=\"33%\" height=\"30\">\n" );
              out.println( "<A HREF=\"/tcmIS/sd/Register\" STYLE=\"color:#e86915\" TARGET=\"sd\">SD tcmIS</A></TD>\n" );
              out.println( "</TR>\n" );
              out.println( "<TR>\n" );
              ...
              out.println( "<TD ALIGN=\"CENTER\" onmouseover=\"className='menuh1'\" onMouseout=\"className='menu1'\" width=\"33%\" height=\"30\">\n" );
              out.println( "Picking</TD>\n" );
			  //out.println( "<A HREF=\"/tcmIS/Hub/Picking\" STYLE=\"color:#e86915\">Picking</A></TD>\n" );
              out.println( "</TR>\n" );
              out.println( "<TR>\n" );
              out.println( "<TD ALIGN=\"CENTER\" BGCOLOR=\"#E6E8FA\" onmouseover=\"className='menuh1'\" onMouseout=\"className='menu1'\" width=\"33%\" height=\"30\">\n" );
              out.println( "Force a Buy Order</TD>\n" );
              out.println( "<TD ALIGN=\"CENTER\" BGCOLOR=\"#E6E8FA\" onmouseover=\"className='menuh1'\" onMouseout=\"className='menu1'\" width=\"33%\" height=\"30\">\n" );
