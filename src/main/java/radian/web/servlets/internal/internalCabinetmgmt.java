...
import radian.web.servlets.share.cabinetManagement;
...
public class internalCabinetmgmt  extends HttpServlet implements SingleThreadModel
{
        ...
        try
        {
         ...
         if ( ! ( auth.equalsIgnoreCase( "authenticated" ) ) )
         {
          ...
          else
          {
            ...
            obj=new cabinetManagement( ( ServerResourceBundle )new InternalServerResourceBundle(),db );
