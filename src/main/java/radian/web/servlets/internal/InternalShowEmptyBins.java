...
import radian.web.servlets.share.showEmptyBins;
...
public class InternalShowEmptyBins  extends HttpServlet implements SingleThreadModel
{
    ...
    */
    ...
    public void doPost(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException
    {
        ...
        {
          obj=new showEmptyBins( ( ServerResourceBundle )new InternalServerResourceBundle(),db );
