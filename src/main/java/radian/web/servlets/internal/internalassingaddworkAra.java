...
import radian.web.servlets.share.assingaddworkAra;
...
public class internalassingaddworkAra  extends HttpServlet implements SingleThreadModel
{
    ...
    public void doPost(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException
    {
        ...
        try
        {
         ...
         else
         {
           ...
           obj=new assingaddworkAra( ( ServerResourceBundle )new InternalServerResourceBundle(),db );
