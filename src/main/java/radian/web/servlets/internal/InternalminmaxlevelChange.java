...
import radian.web.servlets.share.minmaxlevelChange;
...
public class InternalminmaxlevelChange  extends HttpServlet implements SingleThreadModel
{
    ...
    */
    ...
    public void doPost(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException
    {
        ...
        if (errormsg == null) {errormsg = "";}
          ...
          {
              out.println(radian.web.HTMLHelpObj.printLoginScreen(errormsg,"Min Max Level Management"));
              out.flush();
          }
          else
          {
			obj = new minmaxlevelChange((ServerResourceBundle) new InternalServerResourceBundle(),db);

			if ( radian.web.HTMLHelpObj.hasaccessto( session,"MinMaxChg" ) || radian.web.HTMLHelpObj.hasaccessto( session,"Purchasing" ) )
			{
