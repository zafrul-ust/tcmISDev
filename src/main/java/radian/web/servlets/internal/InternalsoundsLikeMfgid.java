...
import radian.web.servlets.share.soundsLikeMfgid;
...
public class InternalsoundsLikeMfgid  extends HttpServlet implements SingleThreadModel
{
    ...
    */
    ...
    public void doPost(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException
    {
        ...
        try
        {
         ...
         {
           obj=new soundsLikeMfgid( ( ServerResourceBundle )new InternalServerResourceBundle(),db );
