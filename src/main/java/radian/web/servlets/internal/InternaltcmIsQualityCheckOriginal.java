...
import radian.web.servlets.share.tcmIsQualityCheckOriginal;
...
public class InternaltcmIsQualityCheckOriginal  extends HttpServlet implements SingleThreadModel
{
    ...
    */
    ...
    public void doPost(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException
    {
        ...
        tcmIsQualityCheckOriginal obj = null;
        ...
        {
          out.println( radian.web.HTMLHelpObj.printCatalogLoginScreen( errormsg,"Original Data" ) );
          out.flush();
        }
        else
        {
          obj=new tcmIsQualityCheckOriginal( ( ServerResourceBundle )new InternalServerResourceBundle(),db );
