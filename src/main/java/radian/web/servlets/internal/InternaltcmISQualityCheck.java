...
import radian.web.servlets.share.tcmISQualityCheck;
...
public class InternaltcmISQualityCheck  extends HttpServlet implements SingleThreadModel
{
  ...
  public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
  {
    ...
    try
    {
      ...
      if ( db == null )
      {
        ...
        {
          out.println( radian.web.HTMLHelpObj.printCatalogLoginScreen( errormsg,"Catalog Add QC" ) );
          out.flush();
        }
        else
        {
				 obj=new tcmISQualityCheck( ( ServerResourceBundle )new InternalServerResourceBundle(),db );
		     ...
		     PersonnelBean personnelBean = session.getAttribute("personnelBean") == null ? null :
				 ...
				 if (personnelBean != null && (personnelBean.getPermissionBean().hasFacilityPermission("msdsMaintenance",null,null) || personnelBean.getPermissionBean().hasFacilityPermission("catalogAddItemQc",null,null))) {
					obj.setMsdsUpdateAllowed(true);
				 }
				 if (personnelBean != null && personnelBean.getPermissionBean().hasFacilityPermission("catalogAddItemQc",null,null)) {
					obj.setItemQcAllowed(true);
				 }
