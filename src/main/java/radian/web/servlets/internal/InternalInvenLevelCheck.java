...
import radian.web.servlets.share.InvenLevelCheck;
...
public class InternalInvenLevelCheck  extends HttpServlet implements SingleThreadModel
{
    ...
    */
    ...
    public void doPost(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException
    {
        ...
        if (errormsg == null) {errormsg = "";}
          ...
          {
              out.println(radian.web.HTMLHelpObj.printLoginScreen(errormsg,"Inventory Level Management"));
              out.flush();
          }
          else
          {
            ...
            obj = new InvenLevelCheck((ServerResourceBundle) new InternalServerResourceBundle(),db);
