...
public class internalsoundsLikeInvoice  extends HttpServlet  implements SingleThreadModel
{
  ...
  public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
  {
    ...
    try
    {
      ...
      {
        obj=new soundsLikeInvoice( ( ServerResourceBundle )new InternalServerResourceBundle(),db );
