...
import radian.web.servlets.share.itemNotes;
...
public class internalitemNotes  extends HttpServlet implements SingleThreadModel
{
   ...
   public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
   {
     ...
     try
     {
       ...
       if ( db == null )
       {
        ...
        {
          out.println( radian.web.HTMLHelpObj.printpoLoginScreen( errormsg,"Item Notes" ) );
          out.flush();
        }
        else
        {
		  ...
		  else
          {
            ...
            {
              out.println( radian.web.HTMLHelpObj.printpoLoginScreenOptions( "You don't have access to this page.","Purchase Order Item Notes",session ) );
              out.close();
              return;
            }
          }

          obj=new itemNotes( ( ServerResourceBundle )new InternalServerResourceBundle(),db );
