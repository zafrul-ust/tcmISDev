...
import radian.web.servlets.share.tcmIsQualityCheckDetails;
...
public class InternaltcmIsQualityCheckDetails  extends HttpServlet implements SingleThreadModel
{
    ...
    */
    ...
    public void doPost(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException
    {
        ...
        tcmIsQualityCheckDetails obj = null;
        ...
        {
          out.println( radian.web.HTMLHelpObj.printCatalogLoginScreen( errormsg,"QC Details" ) );
          out.flush();
        }
        else
        {
					...
					if (personnelBean != null && personnelBean.getPermissionBean().hasFacilityPermission("catalogAddItemQc", null,null)) {
					 obj = new tcmIsQualityCheckDetails( (ServerResourceBundle)new
					 ...
					 out.println(radian.web.HTMLHelpObj.printLoginScreenOptions(
						"You don't have access to this page.", "MSDS QC", session));
					 out.close();
					 return;
					}
				}
