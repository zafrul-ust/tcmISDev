...
import radian.web.servlets.share.showSpecs;
...
public class internalShowSpecs  extends HttpServlet implements SingleThreadModel
{
    ...
    */
    ...
    public void doPost(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException
    {
        ...
        {
          out.println( radian.web.HTMLHelpObj.printpoLoginScreen( errormsg,"Specs" ) );
          out.flush();
        }
        else
        {
          ...
          obj=new showSpecs( ( ServerResourceBundle )new InternalServerResourceBundle(),db );
