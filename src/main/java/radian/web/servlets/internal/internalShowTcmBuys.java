...
import radian.web.servlets.share.showTcmBuys;
...
public class internalShowTcmBuys  extends HttpServlet implements SingleThreadModel
{
    ...
    */
    ...
    public void doPost(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException
    {
        ...
        {
          out.println( radian.web.HTMLHelpObj.printpoLoginScreen( errormsg,"TCM Buys" ) );
          out.flush();
        }
        else
        {
          ...
          {
            out.println( radian.web.HTMLHelpObj.printpoLoginScreenOptions( "You don't have access to this page.","Purchase Order TCM Buys",session ) );
            out.close();
            return;
          }

          obj=new showTcmBuys( ( ServerResourceBundle )new InternalServerResourceBundle(),db );
