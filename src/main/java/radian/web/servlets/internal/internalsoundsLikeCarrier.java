...
import radian.web.servlets.share.soundsLikeCarrier;
...
public class internalsoundsLikeCarrier  extends HttpServlet implements SingleThreadModel
{
    ...
    */
    ...
    public void doPost(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException
    {
        ...
        {
          out.println( radian.web.HTMLHelpObj.printpoLoginScreen( errormsg,"Carrier" ) );
          out.flush();
        }
        else
        {
          ...
          obj=new soundsLikeCarrier( ( ServerResourceBundle )new InternalServerResourceBundle(),db );
