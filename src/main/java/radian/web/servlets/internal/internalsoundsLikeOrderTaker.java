...
import radian.web.servlets.share.soundsLikeOrderTaker;
...
public class internalsoundsLikeOrderTaker  extends HttpServlet implements SingleThreadModel
{
    ...
    */
    ...
    public void doPost(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException
    {
        ...
        {
          out.println( radian.web.HTMLHelpObj.printpoLoginScreen( errormsg,"Order Taker" ) );
          out.flush();
        }
        else
        {
          ...
          obj=new soundsLikeOrderTaker( ( ServerResourceBundle )new InternalServerResourceBundle(),db );
