...
import radian.web.servlets.share.NewPick;
...
public class InternalNewPick  extends HttpServlet implements SingleThreadModel
{
    ...
    */
    ...
    public void doPost(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException
    {
        ...
        try
        {
          ...
          {
            out.println( radian.web.HTMLHelpObj.printLoginScreen( errormsg,"New Pick" ) );
            out.flush();
          }
          else
          {
			...
			{
			   obj=new NewPick( ( ServerResourceBundle )new InternalServerResourceBundle(),db );
			}
			else
			{
				out.println( radian.web.HTMLHelpObj.printLoginScreenOptions( "You don't have access to this page.","New Pick",session ) );
				out.close();
				return;
			}
          }
