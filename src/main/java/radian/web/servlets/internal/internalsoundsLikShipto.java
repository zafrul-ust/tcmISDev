...
import radian.web.servlets.share.soundsLikShipto;
...
public class internalsoundsLikShipto  extends HttpServlet implements SingleThreadModel
{
    ...
    public void doPost(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException
    {
        ...
        try
        {
         ...
         else
         {
           ...
           obj=new soundsLikShipto( ( ServerResourceBundle )new InternalServerResourceBundle(),db );
