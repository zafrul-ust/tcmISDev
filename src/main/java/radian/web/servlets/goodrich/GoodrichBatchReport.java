...
import radian.web.servlets.goodrich.GoodrichServerResourceBundle;
import radian.web.servlets.share.batchReport;

public class GoodrichBatchReport extends HttpServlet {
   ...
   public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      try
      {
        ...
        batchReport obj = new batchReport((ServerResourceBundle) new GoodrichServerResourceBundle(),db);
