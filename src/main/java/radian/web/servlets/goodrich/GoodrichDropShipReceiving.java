...
/**
 * Title:        TcmIS
 * Description:  Total Chemigoodrich Mgmt
...
public class GoodrichDropShipReceiving extends HttpServlet implements SingleThreadModel
{
  ...
  public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
  {
    ...
    try
    {
      db=new RayTcmISDBModel( "Goodrich" );
      if ( db == null )
      {
      ...
      ServerResourceBundle bundlegoodrich=new GoodrichServerResourceBundle();
      HeaderFooter hf=new HeaderFooter( bundlegoodrich,db );
      ...
      else
      {
        ...
        obj=new dropShipReceiving( bundlegoodrich,db );
