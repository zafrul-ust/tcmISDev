...
public class GoodrichmsdsSideView extends HttpServlet {
   ...
   public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      try {
        ...
        msdsSideView obj = new msdsSideView((ServerResourceBundle) new GoodrichServerResourceBundle(),db);
