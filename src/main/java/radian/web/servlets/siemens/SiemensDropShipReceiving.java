...
/**
 * Title:        TcmIS
 * Description:  Total Chemisiemens Mgmt
...
public class SiemensDropShipReceiving extends HttpServlet implements SingleThreadModel
{
  ...
  public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
  {
    ...
    try
    {
      db=new RayTcmISDBModel( "Siemens" );
      if ( db == null )
      {
      ...
      ServerResourceBundle bundlesiemens=new SiemensServerResourceBundle();
      HeaderFooter hf=new HeaderFooter( bundlesiemens,db );
      ...
      else
      {
        ...
        obj=new dropShipReceiving( bundlesiemens,db );
