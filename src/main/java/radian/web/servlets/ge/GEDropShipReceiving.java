...
/**
 * Title:        TcmIS
 * Description:  Total Chemige Mgmt
...
public class GEDropShipReceiving extends HttpServlet implements SingleThreadModel
{
  ...
  public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
  {
    ...
    try
    {
      ...
      ServerResourceBundle bundlege=new GEServerResourceBundle();
      HeaderFooter hf=new HeaderFooter( bundlege,db );
      ...
      else
      {
        ...
        obj=new dropShipReceiving( bundlege,db );
