...
/**
 * Title:        TcmIS
 * Description:  Total Chemicmm Mgmt
...
public class CMMDropShipReceiving extends HttpServlet implements SingleThreadModel
{
  ...
  public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
  {
    ...
    try
    {
      ...
      ServerResourceBundle bundlecmm=new CMMServerResourceBundle();
      HeaderFooter hf=new HeaderFooter( bundlecmm,db );
      ...
      else
      {
        ...
        obj=new dropShipReceiving( bundlecmm,db );
