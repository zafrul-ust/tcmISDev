...
/**
 * Title:        TcmIS
 * Description:  Total Chemigetrag Mgmt
...
public class GetragDropShipReceiving extends HttpServlet implements SingleThreadModel
{
  ...
  public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
  {
    ...
    try
    {
      ...
      ServerResourceBundle bundlegetrag=new GetragServerResourceBundle();
      HeaderFooter hf=new HeaderFooter( bundlegetrag,db );
      ...
      else
      {
        ...
        obj=new dropShipReceiving( bundlegetrag,db );
