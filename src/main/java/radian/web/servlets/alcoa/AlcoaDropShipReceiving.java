...
/**
 * Title:        TcmIS
 * Description:  Total Chemialcoa Mgmt
...
public class AlcoaDropShipReceiving extends HttpServlet implements SingleThreadModel
{
  ...
  public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
  {
    ...
    try
    {
      ...
      ServerResourceBundle bundlealcoa=new AlcoaServerResourceBundle();
      HeaderFooter hf=new HeaderFooter( bundlealcoa,db );
      ...
      else
      {
        ...
        obj=new dropShipReceiving( bundlealcoa,db );
