...
/**
 * Title:        TcmIS
 * Description:  Total Chemifedco Mgmt
...
public class FedcoDropShipReceiving extends HttpServlet implements SingleThreadModel
{
  ...
  public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
  {
    ...
    try
    {
      ...
      ServerResourceBundle bundlefedco=new FedcoServerResourceBundle();
      HeaderFooter hf=new HeaderFooter( bundlefedco,db );
      ...
      else
      {
        ...
        obj=new dropShipReceiving( bundlefedco,db );
