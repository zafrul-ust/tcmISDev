...
/**
 * Title:        TcmIS
 * Description:  Total Chemidcx Mgmt
...
public class DCXDropShipReceiving extends HttpServlet implements SingleThreadModel
{
  ...
  public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
  {
    ...
    try
    {
      ...
      ServerResourceBundle bundledcx=new DCXServerResourceBundle();
      HeaderFooter hf=new HeaderFooter( bundledcx,db );
      ...
      else
      {
        ...
        obj=new dropShipReceiving( bundledcx,db );
