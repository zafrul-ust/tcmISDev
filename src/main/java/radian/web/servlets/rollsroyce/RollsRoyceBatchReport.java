...
import radian.web.servlets.rollsroyce.RollsRoyceServerResourceBundle;
import radian.web.servlets.share.batchReport;

public class RollsRoyceBatchReport extends HttpServlet {
   ...
   public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      try
      {
        ...
        batchReport obj = new batchReport((ServerResourceBundle) new RollsRoyceServerResourceBundle(),db);
