...
public class HexcelWasteVendorUpdate extends HttpServlet
{
   ...
   public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
   {
 	...
 	try
	 {
	   ...
	   {
		 WasteVendorUpdate obj=new WasteVendorUpdate( ( ServerResourceBundle )new HexcelServerResourceBundle(),db );
