...
import radian.web.servlets.hexcel.HexcelServerResourceBundle;
import radian.web.servlets.share.batchReport;

public class HexcelBatchReport extends HttpServlet {
   ...
   public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      try
      {
        ...
        batchReport obj = new batchReport((ServerResourceBundle) new HexcelServerResourceBundle(),db);
