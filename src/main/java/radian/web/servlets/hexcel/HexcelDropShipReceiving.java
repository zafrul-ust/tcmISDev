...
/**
 * Title:        TcmIS
 * Description:  Total Chemihexcel Mgmt
...
public class HexcelDropShipReceiving extends HttpServlet implements SingleThreadModel
{
  ...
  public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
  {
    ...
    try
    {
      ...
      ServerResourceBundle bundlehexcel=new HexcelServerResourceBundle();
      HeaderFooter hf=new HeaderFooter( bundlehexcel,db );
      ...
      else
      {
        ...
        obj=new dropShipReceiving( bundlehexcel,db );
