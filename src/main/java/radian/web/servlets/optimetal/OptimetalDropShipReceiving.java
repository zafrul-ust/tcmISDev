...
/**
 * Title:        TcmIS
 * Description:  Total Chemioptimetal Mgmt
...
public class OptimetalDropShipReceiving extends HttpServlet implements SingleThreadModel
{
  ...
  public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
  {
    ...
    try
    {
      db=new RayTcmISDBModel( "Optimetal" );
      if ( db == null )
      {
      ...
      ServerResourceBundle bundleoptimetal=new OptimetalServerResourceBundle();
      HeaderFooter hf=new HeaderFooter( bundleoptimetal,db );
      ...
      else
      {
        ...
        obj=new dropShipReceiving( bundleoptimetal,db );
