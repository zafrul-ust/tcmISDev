...
public class HansSasserathmsdsSideView extends HttpServlet {
   ...
   public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      try {
        //System.out.println("\n\n============ HansSasserathmsdssideview check");
        ...
        msdsSideView obj = new msdsSideView((ServerResourceBundle) new HansSasserathServerResourceBundle(),db);
