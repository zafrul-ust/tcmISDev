...
/**
 * Title:        TcmIS
 * Description:  Total Chemihans_sasserath Mgmt
...
public class HansSasserathDropShipReceiving extends HttpServlet implements SingleThreadModel
{
  ...
  public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
  {
    ...
    try
    {
      db=new RayTcmISDBModel( "HansSasserath" );
      if ( db == null )
      {
      ...
      ServerResourceBundle bundlehans_sasserath=new HansSasserathServerResourceBundle();
      HeaderFooter hf=new HeaderFooter( bundlehans_sasserath,db );
      ...
      else
      {
        ...
        obj=new dropShipReceiving( bundlehans_sasserath,db );
