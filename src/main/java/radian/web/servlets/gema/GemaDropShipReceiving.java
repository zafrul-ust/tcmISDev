...
/**
 * Title:        TcmIS
 * Description:  Total Chemiam Mgmt
...
public class GemaDropShipReceiving extends HttpServlet implements SingleThreadModel
{
  ...
  public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
  {
    ...
    try
    {
      ...
      ServerResourceBundle bundleam=new GemaServerResourceBundle();
      HeaderFooter hf=new HeaderFooter( bundleam,db );
      ...
      else
      {
        ...
        obj=new dropShipReceiving( bundleam,db );
