...
public class LMCODropShipReceiving extends HttpServlet implements SingleThreadModel
{
  ...
  public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
  {
    ...
    try
    {
      ...
      HeaderFooter hf=new HeaderFooter( bundlelmco,db );
      ...
      else
      {
        ...
        obj=new dropShipReceiving( bundlelmco,db );
