...
public class GMDropShipReceiving extends HttpServlet implements SingleThreadModel
{
  ...
  public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
  {
    ...
    try
    {
      ...
      ServerResourceBundle bundlegm=new GMServerResourceBundle();
      HeaderFooter hf=new HeaderFooter( bundlegm,db );
      ...
      else
      {
        ...
        obj=new dropShipReceiving( bundlegm,db );
