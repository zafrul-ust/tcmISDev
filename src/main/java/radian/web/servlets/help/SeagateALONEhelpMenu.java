...
public class SeagateALONEhelpMenu extends HttpServlet
{
    ...
    public SeagateALONEhelpMenu(ServerResourceBundle b)
    {
        bundle = b;
        db = null;
        msg = "";
        ...
        jscript = "<SCRIPT LANGUAGE = \"JavaScript\">\n<!--\n        if (document.images) {\n            img1on = new Image();   img1on.src = \""+html_FilePath+"faq2.gif\";\n            img1off = new Image();  img1off.src = \""+html_FilePath+"faq1.gif\";\n         }\n    function imgOn(imgName) {\n            if (document.images) {\n                document[imgName].src = eval(imgName + \"on.src\");\n            }\n    }\n    function imgOff(imgName) {\n            if (document.images) {\n                document[imgName].src = eval(imgName + \"off.src\");\n            }\n    }\n// -->\n</script>";
        gettingHTML = false;
        checkingFAQ = false;
        gettingFAQ = false;
        gettingAnswer = false;
    ...
    public void buildHTML(PrintWriter out)
    {
      ...
      msg.append("<img src=\""+WWWhomeDirectory+"/images/buttons/menu/pos.gif\" border=0></a>&nbsp;Installation<BR>\n");
        ...
        if((stru9.equalsIgnoreCase("o")) && (sol_count.equalsIgnoreCase("Y")))
        {
            ...
            msg.append("<img src=\""+WWWhomeDirectory+"/images/buttons/menu/neg.gif\" border=0></a>&nbsp;&nbsp;");
            msg.append("<a href=\""+Help_Servlet_Path+"?stru9=c&stru0=" + stru0 + "&stru1=" + stru1 + "&stru2=" + stru2 + "&stru3=" + stru3 + "&stru4=" + stru4 + "&stru5=" + stru5 + "&stru6=" + stru6 + "&stru7=" + stru7 + "&stru8=" + stru8 + "&s=" + sol_count + "\" onMouseOver=\"window.status='Help -> Frequently Asked Questions';return true\" onMouseOut=\"window.status='Help';return true\">");
            msg.append("<img src=\""+html_FilePath+"faq1.gif\" name=\"img1\" border=0></a><BR>\n");
        ...
        {
            //msg.append("<a href=\""+Help_Servlet_Path+"?faq=on&s=" + sol_count + "\" target=\"content\" onMouseOver=\"imgOn('img1')\" onMouseOut=\"imgOff('img1')\"><img src=\""+html_FilePath+"faq1.gif\" name=\"img1\" border=0></a><BR>\n");
        }
