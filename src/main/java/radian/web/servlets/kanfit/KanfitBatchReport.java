...
import radian.web.servlets.kanfit.KanfitServerResourceBundle;
import radian.web.servlets.share.batchReport;

public class KanfitBatchReport extends HttpServlet {
   ...
   public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      try
      {
        ...
        batchReport obj = new batchReport((ServerResourceBundle) new KanfitServerResourceBundle(),db);
