...
/**
 * Title:        TcmIS
 * Description:  Total Chemikanfit Mgmt
...
public class KanfitDropShipReceiving extends HttpServlet implements SingleThreadModel
{
  ...
  public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
  {
    ...
    try
    {
      ...
      ServerResourceBundle bundlekanfit=new KanfitServerResourceBundle();
      HeaderFooter hf=new HeaderFooter( bundlekanfit,db );
      ...
      else
      {
        ...
        obj=new dropShipReceiving( bundlekanfit,db );
