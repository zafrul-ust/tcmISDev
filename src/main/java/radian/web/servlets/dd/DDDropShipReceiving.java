...
/**
 * Title:        TcmIS
 * Description:  Total Chemidd Mgmt
...
public class DDDropShipReceiving extends HttpServlet implements SingleThreadModel
{
  ...
  public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
  {
    ...
    try
    {
      ...
      ServerResourceBundle bundledd=new DDServerResourceBundle();
      HeaderFooter hf=new HeaderFooter( bundledd,db );
      ...
      else
      {
        ...
        obj=new dropShipReceiving( bundledd,db );
