...
/**
 * Title:        TcmIS
 * Description:  Total Cheminalco Mgmt
...
public class NalcoDropShipReceiving extends HttpServlet implements SingleThreadModel
{
  ...
  public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
  {
    ...
    try
    {
      ...
      ServerResourceBundle bundlenalco=new NalcoServerResourceBundle();
      HeaderFooter hf=new HeaderFooter( bundlenalco,db );
      ...
      else
      {
        ...
        obj=new dropShipReceiving( bundlenalco,db );
