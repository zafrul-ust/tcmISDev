...
/**
 * Title:        TcmIS
 * Description:  Total Chemiimco Mgmt
...
public class IMCODropShipReceiving extends HttpServlet implements SingleThreadModel
{
  ...
  public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
  {
    ...
    try
    {
      ...
      ServerResourceBundle bundleimco=new IMCOServerResourceBundle();
      HeaderFooter hf=new HeaderFooter( bundleimco,db );
      ...
      else
      {
        ...
        obj=new dropShipReceiving( bundleimco,db );
