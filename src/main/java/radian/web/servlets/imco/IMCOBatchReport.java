...
import radian.web.servlets.imco.IMCOServerResourceBundle;
import radian.web.servlets.share.batchReport;

public class IMCOBatchReport extends HttpServlet {
   ...
   public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      try
      {
        ...
        batchReport obj = new batchReport((ServerResourceBundle) new IMCOServerResourceBundle(),db);
