...
/**
 * Title:        TcmIS
 * Description:  Total Chemitambour Mgmt
...
public class TambourDropShipReceiving extends HttpServlet implements SingleThreadModel
{
  ...
  public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
  {
    ...
    try
    {
      db=new RayTcmISDBModel( "Tambour" );
      if ( db == null )
      {
      ...
      ServerResourceBundle bundletambour=new TambourServerResourceBundle();
      HeaderFooter hf=new HeaderFooter( bundletambour,db );
      ...
      else
      {
        ...
        obj=new dropShipReceiving( bundletambour,db );
