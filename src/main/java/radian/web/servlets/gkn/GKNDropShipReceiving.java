...
/**
 * Title:        TcmIS
 * Description:  Total Chemigkn Mgmt
...
public class GKNDropShipReceiving extends HttpServlet implements SingleThreadModel
{
  ...
  public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
  {
    ...
    try
    {
      ...
      ServerResourceBundle bundlegkn=new GKNServerResourceBundle();
      HeaderFooter hf=new HeaderFooter( bundlegkn,db );
      ...
      else
      {
        ...
        obj=new dropShipReceiving( bundlegkn,db );
