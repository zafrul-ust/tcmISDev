...
/**
 * Title:        TcmIS
 * Description:  Total Chemiablaero Mgmt
...
public class ABLaeroDropShipReceiving extends HttpServlet implements SingleThreadModel
{
  ...
  public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
  {
    ...
    try
    {
      db=new RayTcmISDBModel( "ABLaero" );
      if ( db == null )
      {
      ...
      ServerResourceBundle bundleablaero=new ABLaeroServerResourceBundle();
      HeaderFooter hf=new HeaderFooter( bundleablaero,db );
      ...
      else
      {
        ...
        obj=new dropShipReceiving( bundleablaero,db );
