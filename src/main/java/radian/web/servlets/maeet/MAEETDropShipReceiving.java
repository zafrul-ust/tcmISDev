...
/**
 * Title:        TcmIS
 * Description:  Total Chemimaeet Mgmt
...
public class MAEETDropShipReceiving extends HttpServlet implements SingleThreadModel
{
  ...
  public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
  {
    ...
    try
    {
      ...
      ServerResourceBundle bundlemaeet=new MAEETServerResourceBundle();
      HeaderFooter hf=new HeaderFooter( bundlemaeet,db );
      ...
      else
      {
        ...
        obj=new dropShipReceiving( bundlemaeet,db );
