...
import radian.web.servlets.ommc.OMMCServerResourceBundle;
import radian.web.servlets.share.batchReport;

public class OMMCBatchReport extends HttpServlet {
   ...
   public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      try
      {
        ...
        batchReport obj = new batchReport((ServerResourceBundle) new OMMCServerResourceBundle(),db);
