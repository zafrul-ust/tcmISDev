...
/**
 * Title:        TcmIS
 * Description:  Total Chemiommc Mgmt
...
public class OMMCDropShipReceiving extends HttpServlet implements SingleThreadModel
{
  ...
  public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
  {
    ...
    try
    {
      ...
      ServerResourceBundle bundleommc=new OMMCServerResourceBundle();
      HeaderFooter hf=new HeaderFooter( bundleommc,db );
      ...
      else
      {
        ...
        obj=new dropShipReceiving( bundleommc,db );
