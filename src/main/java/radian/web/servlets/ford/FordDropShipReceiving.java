...
/**
 * Title:        TcmIS
 * Description:  Total Chemiford Mgmt
...
public class FordDropShipReceiving extends HttpServlet implements SingleThreadModel
{
  ...
  public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
  {
    ...
    try
    {
      ...
      ServerResourceBundle bundleford=new FordServerResourceBundle();
      HeaderFooter hf=new HeaderFooter( bundleford,db );
      ...
      else
      {
        ...
        obj=new dropShipReceiving( bundleford,db );
