...
import radian.web.servlets.hrgivon.HrgivonServerResourceBundle;
import radian.web.servlets.share.batchReport;

public class HrgivonBatchReport extends HttpServlet {
   ...
   public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      try
      {
        ...
        batchReport obj = new batchReport((ServerResourceBundle) new HrgivonServerResourceBundle(),db);
