...
/**
 * Title:        TcmIS
 * Description:  Total Chemihrgivon Mgmt
...
public class HrgivonDropShipReceiving extends HttpServlet implements SingleThreadModel
{
  ...
  public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
  {
    ...
    try
    {
      db=new RayTcmISDBModel( "Hrgivon" );
      if ( db == null )
      {
      ...
      ServerResourceBundle bundlehrgivon=new HrgivonServerResourceBundle();
      HeaderFooter hf=new HeaderFooter( bundlehrgivon,db );
      ...
      else
      {
        ...
        obj=new dropShipReceiving( bundlehrgivon,db );
