...
public class AeropiamsdsSideView extends HttpServlet {
   ...
   public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      try {
        ...
        msdsSideView obj = new msdsSideView((ServerResourceBundle) new AeropiaServerResourceBundle(),db);
