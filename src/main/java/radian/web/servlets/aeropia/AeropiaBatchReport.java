...
import radian.web.servlets.aeropia.AeropiaServerResourceBundle;
import radian.web.servlets.share.batchReport;

public class AeropiaBatchReport extends HttpServlet {
   ...
   public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      try
      {
        ...
        batchReport obj = new batchReport((ServerResourceBundle) new AeropiaServerResourceBundle(),db);
