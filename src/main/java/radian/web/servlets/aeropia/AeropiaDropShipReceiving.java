...
/**
 * Title:        TcmIS
 * Description:  Total Chemiaeropia Mgmt
...
public class AeropiaDropShipReceiving extends HttpServlet implements SingleThreadModel
{
  ...
  public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
  {
    ...
    try
    {
      db=new RayTcmISDBModel( "Aeropia" );
      if ( db == null )
      {
      ...
      ServerResourceBundle bundleaeropia=new AeropiaServerResourceBundle();
      HeaderFooter hf=new HeaderFooter( bundleaeropia,db );
      ...
      else
      {
        ...
        obj=new dropShipReceiving( bundleaeropia,db );
