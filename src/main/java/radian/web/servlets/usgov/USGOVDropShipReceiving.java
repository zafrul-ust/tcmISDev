...
/**
 * Title:        TcmIS
 * Description:  Total Chemiusgov Mgmt
...
public class USGOVDropShipReceiving extends HttpServlet implements SingleThreadModel
{
  ...
  public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
  {
    ...
    try
    {
      ...
      ServerResourceBundle bundleusgov=new USGOVServerResourceBundle();
      HeaderFooter hf=new HeaderFooter( bundleusgov,db );
      ...
      else
      {
        ...
        obj=new dropShipReceiving( bundleusgov,db );
