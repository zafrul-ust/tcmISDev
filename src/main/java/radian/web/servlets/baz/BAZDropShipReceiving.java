...
/**
 * Title:        TcmIS
 * Description:  Total Chemibaz Mgmt
...
public class BAZDropShipReceiving extends HttpServlet implements SingleThreadModel
{
  ...
  public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
  {
    ...
    try
    {
      ...
      ServerResourceBundle bundlebaz=new BAZServerResourceBundle();
      HeaderFooter hf=new HeaderFooter( bundlebaz,db );
      ...
      else
      {
        ...
        obj=new dropShipReceiving( bundlebaz,db );
