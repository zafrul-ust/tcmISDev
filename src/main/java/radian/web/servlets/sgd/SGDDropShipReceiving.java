...
/**
 * Title:        TcmIS
 * Description:  Total Chemisgd Mgmt
...
public class SGDDropShipReceiving extends HttpServlet implements SingleThreadModel
{
  ...
  public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
  {
    ...
    try
    {
      ...
      ServerResourceBundle bundlesgd=new SGDServerResourceBundle();
      HeaderFooter hf=new HeaderFooter( bundlesgd,db );
      ...
      else
      {
        ...
        obj=new dropShipReceiving( bundlesgd,db );
