...
public class SeagateDropShipReceiving extends HttpServlet implements SingleThreadModel
{
  ...
  public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
  {
    ...
    try
    {
      ...
      ServerResourceBundle bundleseagate=new SeagateServerResourceBundle();
      HeaderFooter hf=new HeaderFooter( bundleseagate,db );
      ...
      else
      {
        ...
        obj=new dropShipReceiving( bundleseagate,db );
