...
public class SeagateSourcing extends HttpServlet
{
    ...
    public void doPost(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException {
        ...
        try {
            ...
            CatalogSourcing obj = new CatalogSourcing((ServerResourceBundle) new SeagateServerResourceBundle(),db);
            ...
            if ( "challenge".equals( auth ) && ( loginId1.length() > 0 ) ) {
              ...
              try {
                ...
                if ( personnelId == null) {
                  ...
                  Vector approvalRoleV = caah.getApprovalRoles(personnelId,"sourcing");
                  if ( approvalRoleV.size() > 0 ) {
                    ...
                    errormsg="This Logon Id is not Setup to Enter Sourcing Information, Please contact your CSR for Further Information.\n";
                    out.println( radian.web.HTMLHelpObj.printSeagateLoginScreen( errormsg,"Seagate Cataloging" ) );
                    out.flush();
                    return;
                  }
              ...
              String personnelId = sessionlable.getAttribute("PERSONNELID").toString();
              CatalogAddApprovalHelper caah = new CatalogAddApprovalHelper(db);
              Vector approvalRoleV = caah.getApprovalRoles(personnelId,"sourcing");
              sessionlable.setAttribute( "APPROVAL_ROLES",approvalRoleV);
            }else{
