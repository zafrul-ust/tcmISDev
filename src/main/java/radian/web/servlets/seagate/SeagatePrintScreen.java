...
public class SeagatePrintScreen  extends HttpServlet implements SingleThreadModel
{
    ...
    */
    ...
    public void doPost(HttpServletRequest request,HttpServletResponse response) throws ServletException,  IOException
    {
        ...
        try
        {
          ...
          obj = new SPrintScreen((ServerResourceBundle) new SeagateServerResourceBundle(),db);
