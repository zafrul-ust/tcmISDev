...
import radian.tcmis.server7.client.zf.dbObjs.ZFTcmISDBModel;
import radian.tcmis.server7.share.helpers.ServerResourceBundle;
import radian.web.HeaderFooter;

public class ZFWasteVendorUpdate extends HttpServlet
{
   ...
   public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
   {
 	...
 	try
	 {
	   ...
	   ServerResourceBundle bundleZF=new ZFServerResourceBundle();
	   HeaderFooter hf=new HeaderFooter( bundleZF,db );
	   ...
	   {
		 WasteVendorUpdate obj=new WasteVendorUpdate( ( ServerResourceBundle )new ZFServerResourceBundle(),db );
