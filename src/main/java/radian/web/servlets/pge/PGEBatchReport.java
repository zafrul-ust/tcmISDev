...
import radian.web.servlets.pge.PGEServerResourceBundle;
import radian.web.servlets.share.batchReport;

public class PGEBatchReport extends HttpServlet {
   ...
   public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      try
      {
        ...
        batchReport obj = new batchReport((ServerResourceBundle) new PGEServerResourceBundle(),db);
