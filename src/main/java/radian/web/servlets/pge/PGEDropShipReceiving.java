...
/**
 * Title:        TcmIS
 * Description:  Total Chemipge Mgmt
...
public class PGEDropShipReceiving extends HttpServlet implements SingleThreadModel
{
  ...
  public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
  {
    ...
    try
    {
      ...
      ServerResourceBundle bundlepge=new PGEServerResourceBundle();
      HeaderFooter hf=new HeaderFooter( bundlepge,db );
      ...
      else
      {
        ...
        obj=new dropShipReceiving( bundlepge,db );
