...
import radian.tcmis.server7.share.servlets.MaterialMatrix;
...
public class WebMaterialMatrix extends HttpServlet {
  ...
  public void buildURL(PrintWriter out, String sessionID, String client, String userID) {
    ...
    if (client.equalsIgnoreCase("Ray")) {
      ...
      MaterialMatrix obj = new MaterialMatrix( (ServerResourceBundle)new RayServerResourceBundle(), db);
      //ReportTable1 = (Hashtable)MaterialMatrix.ReportTable.get(Session_ID);
      try {
      ...
      MaterialMatrix obj = new MaterialMatrix( (ServerResourceBundle)new SWAServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      MaterialMatrix obj = new MaterialMatrix( (ServerResourceBundle)new LMCOServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      MaterialMatrix obj = new MaterialMatrix( (ServerResourceBundle)new SeagateServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      MaterialMatrix obj = new MaterialMatrix( (ServerResourceBundle)new SDServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      MaterialMatrix obj = new MaterialMatrix( (ServerResourceBundle)new BAEServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      MaterialMatrix obj = new MaterialMatrix( (ServerResourceBundle)new UTCServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      MaterialMatrix obj = new MaterialMatrix( (ServerResourceBundle)new MillerServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      MaterialMatrix obj = new MaterialMatrix( (ServerResourceBundle)new CALServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      MaterialMatrix obj = new MaterialMatrix( (ServerResourceBundle)new GMServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      MaterialMatrix obj = new MaterialMatrix( (ServerResourceBundle)new FECServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      MaterialMatrix obj = new MaterialMatrix( (ServerResourceBundle)new BoeingServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      MaterialMatrix obj = new MaterialMatrix( (ServerResourceBundle)new AeroEcoServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      MaterialMatrix obj = new MaterialMatrix( (ServerResourceBundle)new DanaServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      MaterialMatrix obj = new MaterialMatrix( (ServerResourceBundle)new ABLaeroServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      MaterialMatrix obj = new MaterialMatrix( (ServerResourceBundle)new IAIServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      MaterialMatrix obj = new MaterialMatrix( (ServerResourceBundle)new L3ServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      MaterialMatrix obj = new MaterialMatrix( (ServerResourceBundle)new AMServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      MaterialMatrix obj = new MaterialMatrix( (ServerResourceBundle)new PGEServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      MaterialMatrix obj = new MaterialMatrix( (ServerResourceBundle)new QOSServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      MaterialMatrix obj = new MaterialMatrix( (ServerResourceBundle)new DCXServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      MaterialMatrix obj = new MaterialMatrix( (ServerResourceBundle)new FordServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      MaterialMatrix obj = new MaterialMatrix( (ServerResourceBundle)new CMMServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      MaterialMatrix obj = new MaterialMatrix( (ServerResourceBundle)new KanfitServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      MaterialMatrix obj = new MaterialMatrix( (ServerResourceBundle)new FedcoServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      MaterialMatrix obj = new MaterialMatrix( (ServerResourceBundle)new IMCOServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      MaterialMatrix obj = new MaterialMatrix( (ServerResourceBundle)new KemfastServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      MaterialMatrix obj = new MaterialMatrix( (ServerResourceBundle)new BLServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      MaterialMatrix obj = new MaterialMatrix( (ServerResourceBundle)new VerasunServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      MaterialMatrix obj = new MaterialMatrix( (ServerResourceBundle)new HrgivonServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      MaterialMatrix obj = new MaterialMatrix( (ServerResourceBundle)new HaargazServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      MaterialMatrix obj = new MaterialMatrix( (ServerResourceBundle)new CycloneServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      MaterialMatrix obj = new MaterialMatrix( (ServerResourceBundle)new NalcoServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      MaterialMatrix obj = new MaterialMatrix( (ServerResourceBundle)new PepsiServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      MaterialMatrix obj = new MaterialMatrix( (ServerResourceBundle)new HALServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      MaterialMatrix obj = new MaterialMatrix( (ServerResourceBundle)new ABMServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      MaterialMatrix obj = new MaterialMatrix( (ServerResourceBundle)new MTLServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      MaterialMatrix obj = new MaterialMatrix( (ServerResourceBundle)new TimkenServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      MaterialMatrix obj = new MaterialMatrix( (ServerResourceBundle)new NRGServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      MaterialMatrix obj = new MaterialMatrix( (ServerResourceBundle)new MAEETServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      MaterialMatrix obj = new MaterialMatrix( (ServerResourceBundle)new SGDServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      MaterialMatrix obj = new MaterialMatrix( (ServerResourceBundle)new CaterpillarServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      MaterialMatrix obj = new MaterialMatrix( (ServerResourceBundle)new OMAServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      MaterialMatrix obj = new MaterialMatrix( (ServerResourceBundle)new SiemensServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      MaterialMatrix obj = new MaterialMatrix( (ServerResourceBundle)new GetragServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      MaterialMatrix obj = new MaterialMatrix( (ServerResourceBundle)new AlcoaServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      MaterialMatrix obj = new MaterialMatrix( (ServerResourceBundle)new ZWLServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      MaterialMatrix obj = new MaterialMatrix( (ServerResourceBundle)new HansSasserathServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      MaterialMatrix obj = new MaterialMatrix( (ServerResourceBundle)new GKNServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      MaterialMatrix obj = new MaterialMatrix( (ServerResourceBundle)new GoodrichServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      MaterialMatrix obj = new MaterialMatrix( (ServerResourceBundle)new OMMCServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      MaterialMatrix obj = new MaterialMatrix( (ServerResourceBundle)new FBMServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      MaterialMatrix obj = new MaterialMatrix( (ServerResourceBundle)new AeroczServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      MaterialMatrix obj = new MaterialMatrix( (ServerResourceBundle)new SalesServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      MaterialMatrix obj = new MaterialMatrix( (ServerResourceBundle)new HexcelServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      MaterialMatrix obj = new MaterialMatrix( (ServerResourceBundle)new ZFServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      MaterialMatrix obj = new MaterialMatrix( (ServerResourceBundle)new AvcorpServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      MaterialMatrix obj = new MaterialMatrix( (ServerResourceBundle)new BAServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
  ...
  public void buildHTML(PrintWriter out, String Session_ID, String client, String userID) {
    ...
    out.println("    var winHandlemm = null\n");
    out.println("    function winClose(){    // close all open pop-up windows\n");
    out.println("      if ((winHandlemm != null) && !winHandlemm.closed) winHandlemm.close()\n");
    out.println("      }\n");
    out.println("function openwin2 (str)\n");
    out.println("        {\n");
    out.println("    winHandlemm = window.open(\"/Timer.html\", \"Timer2\",\n");
    ...
    out.println("  return winHandlemm; \n");
    out.println("        }\n");
    out.println("function DoLoad()\n");
    out.println("{ \n");
    out.println("openwin2(); \n");
    out.println("window.location.replace(\"/tcmIS/servlet/radian.web.servlets.reports.WebMaterialMatrix?session=1&client=" + client + "&sessionID=" + Session_ID + "&userID=" + userID + "\");\n");
    out.println("} \n");
    out.println("//-->     \n");
    out.println("</SCRIPT>\n");
    out.println("</HEAD>  \n");
