...
import radian.tcmis.server7.share.servlets.AdHocReports;
...
public class WebUsageAdhoc extends HttpServlet {
  ...
  public void buildURL(PrintWriter out, String sessionID, String client, String userID) {
    Hashtable Result = new Hashtable();
    //Hashtable ReportTable1 = new Hashtable();
    TcmISDBModel db = null;
    if (client.equalsIgnoreCase("Ray")) {
      db = new RayTcmISDBModel("Ray", "2");
      AdHocReports obj = new AdHocReports( (ServerResourceBundle)new RayServerResourceBundle(), db);
      //ReportTable1 = (Hashtable)AdHocReports.ReportTable.get(Session_ID);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
        buildERROR(out, "");
      } finally {
      ...
      //obj.ReportTable.remove(Session_ID);
      obj = null;
    } else if (client.equalsIgnoreCase("SWA")) {
      db = new RayTcmISDBModel("SWA", "2");
      AdHocReports obj = new AdHocReports( (ServerResourceBundle)new SWAServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      AdHocReports obj = new AdHocReports( (ServerResourceBundle)new LMCOServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      AdHocReports obj = new AdHocReports( (ServerResourceBundle)new DRSServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      AdHocReports obj = new AdHocReports( (ServerResourceBundle)new SeagateServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      AdHocReports obj = new AdHocReports( (ServerResourceBundle)new SDServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      AdHocReports obj = new AdHocReports( (ServerResourceBundle)new BAEServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      AdHocReports obj = new AdHocReports( (ServerResourceBundle)new UTCServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      AdHocReports obj = new AdHocReports( (ServerResourceBundle)new MillerServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      AdHocReports obj = new AdHocReports( (ServerResourceBundle)new CALServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      AdHocReports obj = new AdHocReports( (ServerResourceBundle)new GMServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      AdHocReports obj = new AdHocReports( (ServerResourceBundle)new FECServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      AdHocReports obj = new AdHocReports( (ServerResourceBundle)new BoeingServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      AdHocReports obj = new AdHocReports( (ServerResourceBundle)new AeroEcoServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      AdHocReports obj = new AdHocReports( (ServerResourceBundle)new DanaServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      AdHocReports obj = new AdHocReports( (ServerResourceBundle)new ABLaeroServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      AdHocReports obj = new AdHocReports( (ServerResourceBundle)new DOEServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      AdHocReports obj = new AdHocReports( (ServerResourceBundle)new IAIServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      AdHocReports obj = new AdHocReports( (ServerResourceBundle)new L3ServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      AdHocReports obj = new AdHocReports( (ServerResourceBundle)new AMServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      AdHocReports obj = new AdHocReports( (ServerResourceBundle)new GemaServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      AdHocReports obj = new AdHocReports( (ServerResourceBundle)new PGEServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      AdHocReports obj = new AdHocReports( (ServerResourceBundle)new QOSServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      AdHocReports obj = new AdHocReports( (ServerResourceBundle)new DCXServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      AdHocReports obj = new AdHocReports( (ServerResourceBundle)new FordServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      AdHocReports obj = new AdHocReports( (ServerResourceBundle)new AlgatServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      AdHocReports obj = new AdHocReports( (ServerResourceBundle)new CMMServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      AdHocReports obj = new AdHocReports( (ServerResourceBundle)new KanfitServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      AdHocReports obj = new AdHocReports( (ServerResourceBundle)new GDServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      AdHocReports obj = new AdHocReports( (ServerResourceBundle)new IMCOServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      AdHocReports obj = new AdHocReports( (ServerResourceBundle)new KemfastServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      AdHocReports obj = new AdHocReports( (ServerResourceBundle)new BLServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      AdHocReports obj = new AdHocReports( (ServerResourceBundle)new VerasunServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      AdHocReports obj = new AdHocReports( (ServerResourceBundle)new HrgivonServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      AdHocReports obj = new AdHocReports( (ServerResourceBundle)new HaargazServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      AdHocReports obj = new AdHocReports( (ServerResourceBundle)new CycloneServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      AdHocReports obj = new AdHocReports( (ServerResourceBundle)new VolvoServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      AdHocReports obj = new AdHocReports( (ServerResourceBundle)new NalcoServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      AdHocReports obj = new AdHocReports( (ServerResourceBundle)new PepsiServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      AdHocReports obj = new AdHocReports( (ServerResourceBundle)new ABMServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      AdHocReports obj = new AdHocReports( (ServerResourceBundle)new MTLServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      AdHocReports obj = new AdHocReports( (ServerResourceBundle)new TimkenServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      AdHocReports obj = new AdHocReports( (ServerResourceBundle)new NRGServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      db = new RayTcmISDBModel("MAEET", "2");
      AdHocReports obj = new AdHocReports( (ServerResourceBundle)new MAEETServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      AdHocReports obj = new AdHocReports( (ServerResourceBundle)new SGDServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      AdHocReports obj = new AdHocReports( (ServerResourceBundle)new CaterpillarServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      AdHocReports obj = new AdHocReports( (ServerResourceBundle)new OMAServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      AdHocReports obj = new AdHocReports( (ServerResourceBundle)new SiemensServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      AdHocReports obj = new AdHocReports( (ServerResourceBundle)new GetragServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      AdHocReports obj = new AdHocReports( (ServerResourceBundle)new ZWLServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      AdHocReports obj = new AdHocReports( (ServerResourceBundle)new DDServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      AdHocReports obj = new AdHocReports( (ServerResourceBundle)new GKNServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      AdHocReports obj = new AdHocReports( (ServerResourceBundle)new AeropiaServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      AdHocReports obj = new AdHocReports( (ServerResourceBundle)new GoodrichServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      AdHocReports obj = new AdHocReports( (ServerResourceBundle)new OMMCServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      AdHocReports obj = new AdHocReports( (ServerResourceBundle)new FBMServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      AdHocReports obj = new AdHocReports( (ServerResourceBundle)new AeroczServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      AdHocReports obj = new AdHocReports( (ServerResourceBundle)new GEServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      AdHocReports obj = new AdHocReports( (ServerResourceBundle)new SalesServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      AdHocReports obj = new AdHocReports( (ServerResourceBundle)new HexcelServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      AdHocReports obj = new AdHocReports( (ServerResourceBundle)new ZFServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      AdHocReports obj = new AdHocReports( (ServerResourceBundle)new AvcorpServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
      ...
      AdHocReports obj = new AdHocReports( (ServerResourceBundle)new BAServerResourceBundle(), db);
      try {
        Result = obj.createReportNew(sessionID, userID);
      } catch (Exception e) {
        e.printStackTrace();
  ...
  public void buildHTML(PrintWriter out, String Session_ID, String client, String userID) {
    ...
    out.println("        {\n");
    out.println("    winHandle = window.open(\"/Timer.html\", \"Timer3\",\n");
    ...
    out.println("loc=loc + \"/tcmIS/servlet/radian.web.servlets.reports.WebUsageAdhoc?session=1&client=" + client + "&sessionID=" + Session_ID + "&userID=" + userID + "\"\n");
