...
/**
 * Title:        TcmIS
 * Description:  Total Chemihaargaz Mgmt
...
public class HaargazDropShipReceiving extends HttpServlet implements SingleThreadModel
{
  ...
  public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
  {
    ...
    try
    {
      db=new RayTcmISDBModel( "Haargaz" );
      if ( db == null )
      {
      ...
      ServerResourceBundle bundlehaargaz=new HaargazServerResourceBundle();
      HeaderFooter hf=new HeaderFooter( bundlehaargaz,db );
      ...
      else
      {
        ...
        obj=new dropShipReceiving( bundlehaargaz,db );
