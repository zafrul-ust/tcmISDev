...
/**
 * Title:        TcmIS
 * Description:  Total Chemibl Mgmt
...
public class BLDropShipReceiving extends HttpServlet implements SingleThreadModel
{
  ...
  public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
  {
    ...
    try
    {
      ...
      ServerResourceBundle bundlebl=new BLServerResourceBundle();
      HeaderFooter hf=new HeaderFooter( bundlebl,db );
      ...
      else
      {
        ...
        obj=new dropShipReceiving( bundlebl,db );
