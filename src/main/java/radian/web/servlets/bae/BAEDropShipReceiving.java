...
public class BAEDropShipReceiving extends HttpServlet implements SingleThreadModel
{
  ...
  public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
  {
    ...
    try
    {
      ...
      ServerResourceBundle bundlebae=new BAEServerResourceBundle();
      HeaderFooter hf=new HeaderFooter( bundlebae,db );
      ...
      else
      {
        ...
        obj=new dropShipReceiving( bundlebae,db );
