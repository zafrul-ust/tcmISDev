...
/**
 * Title:        TcmIS
 * Description:  Total Chemigd Mgmt
...
public class GDDropShipReceiving extends HttpServlet implements SingleThreadModel
{
  ...
  public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
  {
    ...
    try
    {
      ...
      ServerResourceBundle bundlegd=new GDServerResourceBundle();
      HeaderFooter hf=new HeaderFooter( bundlegd,db );
      ...
      else
      {
        ...
        obj=new dropShipReceiving( bundlegd,db );
