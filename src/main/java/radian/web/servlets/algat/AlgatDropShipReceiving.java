...
/**
 * Title:        TcmIS
 * Description:  Total Chemialgat Mgmt
...
public class AlgatDropShipReceiving extends HttpServlet implements SingleThreadModel
{
  ...
  public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
  {
    ...
    try
    {
      ...
      ServerResourceBundle bundlealgat=new AlgatServerResourceBundle();
      HeaderFooter hf=new HeaderFooter( bundlealgat,db );
      ...
      else
      {
        ...
        obj=new dropShipReceiving( bundlealgat,db );
