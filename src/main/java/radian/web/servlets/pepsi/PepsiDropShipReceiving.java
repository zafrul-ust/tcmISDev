...
/**
 * Title:        TcmIS
 * Description:  Total Chemipepsi Mgmt
...
public class PepsiDropShipReceiving extends HttpServlet implements SingleThreadModel
{
  ...
  public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
  {
    ...
    try
    {
      ...
      ServerResourceBundle bundlepepsi=new PepsiServerResourceBundle();
      HeaderFooter hf=new HeaderFooter( bundlepepsi,db );
      ...
      else
      {
        ...
        obj=new dropShipReceiving( bundlepepsi,db );
