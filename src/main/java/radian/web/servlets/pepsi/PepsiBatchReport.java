...
import radian.web.servlets.pepsi.PepsiServerResourceBundle;
import radian.web.servlets.share.batchReport;

public class PepsiBatchReport extends HttpServlet {
   ...
   public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      try
      {
        ...
        batchReport obj = new batchReport((ServerResourceBundle) new PepsiServerResourceBundle(),db);
