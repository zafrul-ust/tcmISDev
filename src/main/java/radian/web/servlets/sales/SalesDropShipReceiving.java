...
/**
 * Title:        TcmIS
 * Description:  Total Chemisales Mgmt
...
public class SalesDropShipReceiving extends HttpServlet implements SingleThreadModel
{
  ...
  public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
  {
    ...
    try
    {
      ...
      ServerResourceBundle bundlesales=new SalesServerResourceBundle();
      HeaderFooter hf=new HeaderFooter( bundlesales,db );
      ...
      else
      {
        ...
        obj=new dropShipReceiving( bundlesales,db );
