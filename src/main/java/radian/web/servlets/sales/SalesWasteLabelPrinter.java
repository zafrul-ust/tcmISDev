...
public class SalesWasteLabelPrinter extends HttpServlet {
   ...
   public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      try {
        ...
        WasteLabelPrinter obj = new WasteLabelPrinter((ServerResourceBundle) new SalesServerResourceBundle(),db);
