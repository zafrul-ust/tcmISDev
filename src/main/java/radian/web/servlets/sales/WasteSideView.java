...
public class WasteSideView
{
    ...
    public void buildHTML(PrintWriter out,String waste_profile_id1,String act1)
    {
        ...
        MsgSB.append("<frame src=\"/tcmIS/servlet/radian.web.servlets.sales.SalesWasteSideView?SESSION=0&id=" + waste_profile_id1 + "\" name=\"title\" scrolling=\"auto\">\n");
        MsgSB.append("<frameset cols=\"170,*\">\n");
        MsgSB.append("<frame src=\"/tcmIS/servlet/radian.web.servlets.sales.SalesWasteSideView?SESSION=1&id=" + waste_profile_id1 + "\" name=\"opts\" scrolling=\"auto\">\n");
        MsgSB.append("<frame src=\"/tcmIS/servlet/radian.web.servlets.sales.SalesWasteSideView?SESSION=2&act=" + act1 + "&id=" + waste_profile_id1 + "\" name=\"data\">\n");
    ...
    public void buildSideView(PrintWriter out,String waste_profile_ids)
    {
        ...
        MsgSv.append(    "<a href=\"/tcmIS/servlet/radian.web.servlets.sales.SalesWasteSideView?SESSION=2&act=profile&id=" + waste_profile_ids + "\" target=\"data\"");
       ...
       MsgSv.append(     "<a href=\"/tcmIS/servlet/radian.web.servlets.sales.SalesWasteSideView?SESSION=2&act=prop&id=" + waste_profile_ids + "\" target=\"data\"");
       ...
       MsgSv.append(     "<a href=\"/tcmIS/servlet/radian.web.servlets.sales.SalesWasteSideView?SESSION=2&act=disp&id=" + waste_profile_ids + "\" target=\"data\"");
