...
import radian.web.servlets.verasun.VerasunServerResourceBundle;
import radian.web.servlets.share.batchReport;

public class VerasunBatchReport extends HttpServlet {
   ...
   public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      try
      {
        ...
        batchReport obj = new batchReport((ServerResourceBundle) new VerasunServerResourceBundle(),db);
