...
/**
 * Title:        TcmIS
 * Description:  Total Chemiverasun Mgmt
...
public class VerasunDropShipReceiving extends HttpServlet implements SingleThreadModel
{
  ...
  public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
  {
    ...
    try
    {
      db=new RayTcmISDBModel( "Verasun" );
      if ( db == null )
      {
      ...
      ServerResourceBundle bundleverasun=new VerasunServerResourceBundle();
      HeaderFooter hf=new HeaderFooter( bundleverasun,db );
      ...
      else
      {
        ...
        obj=new dropShipReceiving( bundleverasun,db );
