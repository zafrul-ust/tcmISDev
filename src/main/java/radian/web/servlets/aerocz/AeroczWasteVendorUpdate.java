...
public class AeroczWasteVendorUpdate extends HttpServlet
{
   ...
   public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
   {
 	...
 	try
	 {
	   ...
	   {
		 WasteVendorUpdate obj=new WasteVendorUpdate( ( ServerResourceBundle )new AeroczServerResourceBundle(),db );
