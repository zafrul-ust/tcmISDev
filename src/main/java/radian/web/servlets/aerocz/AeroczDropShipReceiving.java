...
/**
 * Title:        TcmIS
 * Description:  Total Chemiaerocz Mgmt
...
public class AeroczDropShipReceiving extends HttpServlet implements SingleThreadModel
{
  ...
  public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
  {
    ...
    try
    {
      ...
      ServerResourceBundle bundleaerocz=new AeroczServerResourceBundle();
      HeaderFooter hf=new HeaderFooter( bundleaerocz,db );
      ...
      else
      {
        ...
        obj=new dropShipReceiving( bundleaerocz,db );
