 ...
 * value 'challenge' and the login form is redisplayed.
        ...
        throws ServletException, IOException
    {
        ...
        String originatingURL = (String) session.getAttribute("originatingURL");
        /*
                     try {
        ...
        if( "challenge".equals(state) && loginId != null && passwd != null )
        {
            ...
            try
            {
                Password pw = new Password((TcmISDBModel)session.getAttribute("TcmISDBModel"), loginId, passwd);
