...
/**
 * Title:        TcmIS
 * Description:  Total Chemizwl Mgmt
...
public class BoeingComairDropShipReceiving extends HttpServlet implements SingleThreadModel
{
  ...
  public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
  {
    ...
    try
    {
      db=new RayTcmISDBModel( "BOEING_COMAIR" );
      if ( db == null )
      {
      ...
      ServerResourceBundle bundlezwl=new BoeingComairServerResourceBundle();
      HeaderFooter hf=new HeaderFooter( bundlezwl,db );
      ...
      else
      {
        ...
        obj=new dropShipReceiving( bundlezwl,db );
