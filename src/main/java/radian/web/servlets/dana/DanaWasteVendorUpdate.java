...
public class DanaWasteVendorUpdate extends HttpServlet
{
 ...
 try
	 {
	   ...
	   ServerResourceBundle bundledana=new DanaServerResourceBundle();
	   HeaderFooter hf=new HeaderFooter( bundledana,db );
	   ...
	   {
		 WasteVendorUpdate obj=new WasteVendorUpdate( ( ServerResourceBundle )new DanaServerResourceBundle(),db );
		 ...
		 //System.out.println( "This is  the Session in DanaWaste   :" + Status + "  " );
		 ...
		 //System.out.println( "This is  the login_Id in DanaWaste   :" + loginId );
