...
"function refresh()\n" +
"{\n" +
"loc=\"/tcmIS/servlet/radian.web.servlets.dana.DanaWasteLabelPrinter?" + url + "&b=\" + browserDetect() ;\n" +
"target=\"_self\";\n" +
"window.location=loc;" +
"}\n" +
"// -->\n" +
...
"<font face=Arial size=4 color=000084><B>Dana Waste Traveler</b></font>\n" +
"</td></tr>\n" +
...
protected void labelData(Vector v){
  ...
  public String getServletInfo() {
    return "radian.web.servlets.dana.WasteLabelPrinter Information";
  }
}