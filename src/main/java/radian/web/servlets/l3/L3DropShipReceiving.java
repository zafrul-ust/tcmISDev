...
/**
 * Title:        TcmIS
 * Description:  Total Chemil3 Mgmt
...
public class L3DropShipReceiving extends HttpServlet implements SingleThreadModel
{
  ...
  public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
  {
    ...
    try
    {
      ...
      ServerResourceBundle bundlel3=new L3ServerResourceBundle();
      HeaderFooter hf=new HeaderFooter( bundlel3,db );
      ...
      else
      {
        ...
        obj=new dropShipReceiving( bundlel3,db );
