...
/**
 * Title:        TcmIS
 * Description:  Total Chemiorlite Mgmt
...
public class OrliteDropShipReceiving extends HttpServlet implements SingleThreadModel
{
  ...
  public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
  {
    ...
    try
    {
      ...
      ServerResourceBundle bundleorlite=new OrliteServerResourceBundle();
      HeaderFooter hf=new HeaderFooter( bundleorlite,db );
      ...
      else
      {
        ...
        obj=new dropShipReceiving( bundleorlite,db );
