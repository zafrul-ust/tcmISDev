...
/**
 * Title:        TcmIS
 * Description:  Total Chemimtl Mgmt
...
public class MTLDropShipReceiving extends HttpServlet implements SingleThreadModel
{
  ...
  public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
  {
    ...
    try
    {
      ...
      ServerResourceBundle bundlemtl=new MTLServerResourceBundle();
      HeaderFooter hf=new HeaderFooter( bundlemtl,db );
      ...
      else
      {
        ...
        obj=new dropShipReceiving( bundlemtl,db );
