...
public class WasteVendorUpdate
{
		...
		public void buildWasteDetail(PrintWriter out)
		{
			 ...
			 header += "<TABLE BORDER=\"0\" CELLPADDING=\"0\" WIDTH=\"100%\">\n"+
								 "<TR>\n"+
								 "<form method=\"POST\" name=\"MainForm\" action=\""+WWWHomeDirectory+"/servlet/radian.web.servlets.ba.BAWasteVendorUpdate?Session=2\">\n"+
...
String WWWHomeDirectory = bundle.getString("WEBS_HOME_WWWS");
				...
				msg += "<FORM method=\"POST\" name=\"MainForm\" action=\""+WWWHomeDirectory+"/servlet/radian.web.servlets.ba.BAWasteVendorUpdate?Session=2&openorders=openorders&vendor_id="+Vendor_Id+"\">\n";
				...
				if(!order_no.equalsIgnoreCase("0") && !Shp_id.equalsIgnoreCase("0"))
				{
						...
						if ((HasVendor))
						{
								...
								msg +="<FORM method=\"POST\" name=\"MainForm\" action=\""+WWWHomeDirectory+"/servlet/radian.web.servlets.ba.BAWasteVendorUpdate?Session=2&openorders=openorders&vendor_id="+Vendor_Id+"\">\n"+
										...
										"<TD VALIGN=\"MIDDLE\" ALIGN=\"RIGHT\" WIDTH=\"30%\" HEIGHT=\"24\">\n"+
										"<FORM method=\"POST\" name=\"UpdateForm\" action=\""+WWWHomeDirectory+"/servlet/radian.web.servlets.ba.BAWasteVendorUpdate?Session=4\">\n"+
						...
						{
								{
										...
										String url = new String(""+WWWHomeDirectory+"/servlet/radian.web.servlets.ba.BAWasteVendorUpdate?");
										...
										for (int K=0;K<resultHv.size(); K++)
										{
												...
												for (int i=0;i<data.size(); i++)
												{
														...
														msg +="</TR>\n";
														url = ""+WWWHomeDirectory+"/servlet/radian.web.servlets.ba.BAWasteVendorUpdate?";
														checked = "";
														Shp_id = "";
												}
										}
