...
public class StandardAeromsdsSideView extends HttpServlet {
   ...
   public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      try {
        //System.out.println("\n\n============ StandardAeromsdssideview check");
        ...
        msdsSideView obj = new msdsSideView((ServerResourceBundle) new StandardAeroServerResourceBundle(),db);
