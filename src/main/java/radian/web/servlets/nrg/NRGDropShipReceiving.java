...
/**
 * Title:        TcmIS
 * Description:  Total Cheminrg Mgmt
...
public class NRGDropShipReceiving extends HttpServlet implements SingleThreadModel
{
  ...
  public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
  {
    ...
    try
    {
      ...
      ServerResourceBundle bundlenrg=new NRGServerResourceBundle();
      HeaderFooter hf=new HeaderFooter( bundlenrg,db );
      ...
      else
      {
        ...
        obj=new dropShipReceiving( bundlenrg,db );
