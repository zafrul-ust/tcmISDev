...
/**
 * Title:        TcmIS
 * Description:  Total Chemicat Mgmt
...
public class CaterpillarDropShipReceiving extends HttpServlet implements SingleThreadModel
{
  ...
  public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
  {
    ...
    try
    {
      db=new RayTcmISDBModel( "Caterpillar" );
      if ( db == null )
      {
      ...
      ServerResourceBundle bundlecat=new CaterpillarServerResourceBundle();
      HeaderFooter hf=new HeaderFooter( bundlecat,db );
      ...
      else
      {
        ...
        obj=new dropShipReceiving( bundlecat,db );
