...
import radian.web.servlets.cat.CaterpillarServerResourceBundle;
import radian.web.servlets.share.batchReport;

public class CaterpillarBatchReport extends HttpServlet {
   ...
   public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      try
      {
        ...
        batchReport obj = new batchReport((ServerResourceBundle) new CaterpillarServerResourceBundle(),db);
