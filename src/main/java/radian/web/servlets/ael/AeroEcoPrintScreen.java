...
public class AeroEcoPrintScreen  extends HttpServlet implements SingleThreadModel
{
    ...
    */
                       ...
                       HttpServletResponse response) throws ServletException,  IOException
    {
        ...
        try
        {
          ...
          obj = new SPrintScreen((ServerResourceBundle) new AeroEcoServerResourceBundle(),db);
