...
public class AeroEcoDropShipReceiving extends HttpServlet implements SingleThreadModel
{
  ...
  public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
  {
    ...
    try
    {
      db=new RayTcmISDBModel( "AeroEco" );
      if ( db == null )
      {
      ...
      ServerResourceBundle bundlesd=new AeroEcoServerResourceBundle();
      ...
      else
      {
        ...
        obj=new dropShipReceiving( bundlesd,db );
