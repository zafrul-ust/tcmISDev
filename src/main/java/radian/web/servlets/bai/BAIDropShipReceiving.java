...
/**
 * Title:        TcmIS
 * Description:  Total Chemibai Mgmt
...
public class BAIDropShipReceiving extends HttpServlet implements SingleThreadModel
{
  ...
  public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
  {
    ...
    try
    {
      ...
      ServerResourceBundle bundlebai=new BAIServerResourceBundle();
      HeaderFooter hf=new HeaderFooter( bundlebai,db );
      ...
      else
      {
        ...
        obj=new dropShipReceiving( bundlebai,db );
