...
public class UTCDropShipReceiving extends HttpServlet implements SingleThreadModel
{
  ...
  public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
  {
    ...
    try
    {
      ...
      ServerResourceBundle bundleutc=new UTCServerResourceBundle();
      HeaderFooter hf=new HeaderFooter( bundleutc,db );
      ...
      else
      {
        ...
        obj=new dropShipReceiving( bundleutc,db );
