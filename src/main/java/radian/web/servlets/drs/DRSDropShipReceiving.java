...
public class DRSDropShipReceiving extends HttpServlet implements SingleThreadModel
{
  ...
  public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
  {
    ...
    try
    {
      ...
      ServerResourceBundle bundleDRS=new DRSServerResourceBundle();
      HeaderFooter hf=new HeaderFooter( bundleDRS,db );
      ...
      else
      {
        ...
        obj=new dropShipReceiving( bundleDRS,db );
