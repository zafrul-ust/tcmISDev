 ...
 * @version 1.0
 *
 * 03-08-04 - Changed the login process
 */
public class DRSWasteVendorUpdate extends HttpServlet
{
    ...
    */
        ...
        IOException
    {
        ...
        try
        {
            //System.out.println("\n\n============ DRSWasteVendorUpdate check");
			db=new RayTcmISDBModel( "DRS" );
			if ( db == null )
			{
			...
			ServerResourceBundle bundleray=new DRSServerResourceBundle();
            ...
            {
                WasteVendorUpdate obj=new WasteVendorUpdate( ( ServerResourceBundle )new DRSServerResourceBundle(),db );
                String loginId = BothHelpObjs.makeBlankFromNull((String)session.getValue("loginId"));
                Status = BothHelpObjs.makeBlankFromNull((String)request.getParameter("Session"));
                //System.out.println("This is  the Session in DRSWaste   :"+Status+"  ");
                ...
                //System.out.println("This is  the login_Id in DRSWaste   :"+loginId);

                session.putValue("SESSION",Status);
                ...
                if ((Status.equalsIgnoreCase("0")))
                {
                    ...
                    tmp1.put("BORC",borc);
                    session.putValue("ALL_I_NEED",tmp1);
