...
import radian.web.servlets.cal.CALServerResourceBundle;
import radian.web.servlets.share.batchReport;

public class CALBatchReport extends HttpServlet {
   ...
   public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      try
      {
        ...
        batchReport obj = new batchReport((ServerResourceBundle) new CALServerResourceBundle(),db);
