...
import radian.web.servlets.iai.IAIServerResourceBundle;
import radian.web.servlets.share.batchReport;

public class IAIBatchReport extends HttpServlet {
   ...
   public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      try
      {
        ...
        batchReport obj = new batchReport((ServerResourceBundle) new IAIServerResourceBundle(),db);
