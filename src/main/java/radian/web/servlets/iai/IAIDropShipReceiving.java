...
/**
 * Title:        TcmIS
 * Description:  Total Chemiiai Mgmt
...
public class IAIDropShipReceiving extends HttpServlet implements SingleThreadModel
{
  ...
  public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
  {
    ...
    try
    {
      ...
      ServerResourceBundle bundleiai=new IAIServerResourceBundle();
      HeaderFooter hf=new HeaderFooter( bundleiai,db );
      ...
      else
      {
        ...
        obj=new dropShipReceiving( bundleiai,db );
