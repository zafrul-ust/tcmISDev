...
public class RayWasteVendorUpdate extends HttpServlet
{
 ...
 try
	 {
	   ...
	   {
		 WasteVendorUpdate obj=new WasteVendorUpdate( ( ServerResourceBundle )new RayServerResourceBundle(),db );
		 ...
		 //System.out.println( "This is  the Session in RayWaste   :" + Status + "  " );
		 ...
		 //System.out.println( "This is  the login_Id in RayWaste   :" + loginId );
