...
/**
 * Title:        TcmIS
 * Description:  Total Chemiavcorp Mgmt
...
public class AvcorpDropShipReceiving extends HttpServlet implements SingleThreadModel
{
  ...
  public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
  {
    ...
    try
    {
      ...
      ServerResourceBundle bundleavcorp=new AvcorpServerResourceBundle();
      HeaderFooter hf=new HeaderFooter( bundleavcorp,db );
      ...
      else
      {
        ...
        obj=new dropShipReceiving( bundleavcorp,db );
