...
import radian.web.servlets.avcorp.AvcorpServerResourceBundle;
import radian.web.servlets.share.batchReport;

public class AvcorpBatchReport extends HttpServlet {
   ...
   public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      try
      {
        ...
        batchReport obj = new batchReport((ServerResourceBundle) new AvcorpServerResourceBundle(),db);
