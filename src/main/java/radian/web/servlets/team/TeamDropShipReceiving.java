...
/**
 * Title:        TcmIS
 * Description:  Total Chemiteam Mgmt
...
public class TeamDropShipReceiving extends HttpServlet implements SingleThreadModel
{
  ...
  public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
  {
    ...
    try
    {
      ...
      ServerResourceBundle bundleteam=new TeamServerResourceBundle();
      HeaderFooter hf=new HeaderFooter( bundleteam,db );
      ...
      else
      {
        ...
        obj=new dropShipReceiving( bundleteam,db );
