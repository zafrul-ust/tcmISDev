...
/**
 * Title:        TcmIS
 * Description:  Total Chemikemfast Mgmt
...
public class KemfastDropShipReceiving extends HttpServlet implements SingleThreadModel
{
  ...
  public void doPost( HttpServletRequest request,HttpServletResponse response ) throws ServletException,IOException
  {
    ...
    try
    {
      db=new RayTcmISDBModel( "Kemfast" );
      if ( db == null )
      {
      ...
      ServerResourceBundle bundlekemfast=new KemfastServerResourceBundle();
      HeaderFooter hf=new HeaderFooter( bundlekemfast,db );
      ...
      else
      {
        ...
        obj=new dropShipReceiving( bundlekemfast,db );
