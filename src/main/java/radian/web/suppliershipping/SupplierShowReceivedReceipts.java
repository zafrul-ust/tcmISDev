...
public class SupplierShowReceivedReceipts extends HttpServlet   implements SingleThreadModel
{
	 ...
	 throws ServletException,IOException
  {
	...
	try
	{
      ...
      hubNoforlabel = rs.getString( "BRANCH_PLANT" ) == null ? "" : rs.getString( "BRANCH_PLANT" );
			...
			{
			  out.println( "<td " + Color + "\" width=\"5%\" height=\"38\">TR " + transreqid + "</td>\n" );
			}
			else
			{
			  out.println( "<td " + Color + "\" width=\"5%\" height=\"38\">" + po + "-" + pol + "</td>\n" );
			}
