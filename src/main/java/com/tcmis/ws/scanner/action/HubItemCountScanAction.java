...
import com.tcmis.ws.scanner.process.HubItemCountScanProcess;
 ...
 * @version 1.0
 ******************************************************************************/
public class HubItemCountScanAction
...
//                            "Received order ", "ORDER:\n" + xmlString);
    ...
    String result = "<?xml version=\"1.0\" encoding=\"utf-8\"?><ItemScanSubmitResponse xmlns=\"http://beans.scanner.ws.tcmis.com/xsd\"><Result>Unknown Server Error.</Result></ItemScanSubmitResponse>";
...
//        	String emailUrl = requestURL.substring(0,requestURL.lastIndexOf("/")) + "/customermrtracking.do?";
        	...
        	HubItemCountScanProcess process = new HubItemCountScanProcess(this.getDbUser(request));//,emailUrl);
...
//        	getCabinetReceiptItem
            result = process.doUpload(xmlString);
