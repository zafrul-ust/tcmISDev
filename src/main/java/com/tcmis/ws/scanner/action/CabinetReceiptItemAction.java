...
import com.tcmis.ws.scanner.process.CabinetItemReceiptProcess;
 ...
 * @version 1.0
 ******************************************************************************/
public class CabinetReceiptItemAction
...
//                            "Received order ", "ORDER:\n" + xmlString);
    ...
    if(xmlString != null && xmlString.length() > 0) {
        try {
        	CabinetItemReceiptProcess process = new CabinetItemReceiptProcess(this.getDbUser(request));
...
//			String result = readFileAsString(outPath);
            ...
            e.printStackTrace();
            log.fatal("Error processing CabinetRectipItem " + e.getMessage(), e);
