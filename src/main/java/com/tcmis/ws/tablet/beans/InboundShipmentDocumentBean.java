...
public class InboundShipmentDocumentBean extends BaseDataBean {

	private BigDecimal inboundShipmentDocumentId;
	...
	//constructor
	public InboundShipmentDocumentBean() {
	}

	//setters
	public void setInboundShipmentDocumentId(BigDecimal inboundShipmentDocumentId) {
	...
	//getters
	public BigDecimal getInboundShipmentDocumentId() {
