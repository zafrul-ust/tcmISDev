...
public class ListReceivingStatusAction extends BaseTabletAction {
	...
	public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		if (!isLoggedIn(request, true)) {
			...
			Collection<VvReceivingStatusBean> beans = (Collection<VvReceivingStatusBean>) request.getSession().getServletContext().getAttribute("vvReceivingStatusCollection");
			for (VvReceivingStatusBean bean : beans) {
