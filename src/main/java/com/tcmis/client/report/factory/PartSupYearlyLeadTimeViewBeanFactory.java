...
/******************************************************************************
 * CLASSNAME: PartSupYearlyLeadTimeViewBeanFactory <br>
 * @version: 1.0, May 25, 2006 <br>
 *****************************************************************************/

public class PartSupYearlyLeadTimeViewBeanFactory
  ...
  //table name
  public String TABLE = "PART_SUP_YEARLY_LEAD_TIME_VIEW";

  //constructor
  public PartSupYearlyLeadTimeViewBeanFactory(DbManager dbManager) {
    super(dbManager);
  }
  ...
  public int getType(String attributeName) {
    return super.getType(attributeName, PartSupYearlyLeadTimeViewBean.class);
  }
  ...
  public Collection select(SearchCriteria criteria, Connection conn) throws
    ...
    Collection partSupYearlyLeadTimeViewBeanColl = new Vector();
    ...
    while (dataIter.hasNext()) {
      ...
      PartSupYearlyLeadTimeViewBean partSupYearlyLeadTimeViewBean = new PartSupYearlyLeadTimeViewBean();
      load(dataSetRow, partSupYearlyLeadTimeViewBean);
      partSupYearlyLeadTimeViewBeanColl.add(partSupYearlyLeadTimeViewBean);
    }

    return partSupYearlyLeadTimeViewBeanColl;
  }
}