...
import com.tcmis.common.db.SqlManager;
import com.tcmis.client.report.beans.CostReportSalesTaxViewBean;


/******************************************************************************
 * CLASSNAME: CostReportSalesTaxViewBeanFactory <br>
 * @version: 1.0, Jul 24, 2008 <br>
 *****************************************************************************/


public class CostReportSalesTaxViewBeanFactory extends BaseBeanFactory {
	...
	public String ATTRIBUTE_SALES_TAX_DESC = "SALES_TAX_DESC";
	public String ATTRIBUTE_SALES_TAX_AMOUNT = "SALES_TAX_AMOUNT";
	public String ATTRIBUTE_SALES_TAX_PERCENT = "SALES_TAX_PERCENT";
	...
	//table name
	public String TABLE = "COST_REPORT_SALES_TAX_VIEW";


	//constructor
	public CostReportSalesTaxViewBeanFactory(DbManager dbManager) {
		super(dbManager);
	}
	...
	public String getColumnName(String attributeName) {
		...
		else if(attributeName.equals("salesTaxDesc")) {
			return ATTRIBUTE_SALES_TAX_DESC;
		}
		else if(attributeName.equals("salesTaxAmount")) {
			return ATTRIBUTE_SALES_TAX_AMOUNT;
		}
		else if(attributeName.equals("salesTaxPercent")) {
			return ATTRIBUTE_SALES_TAX_PERCENT;
		}
	...
	public int getType(String attributeName) {
		return super.getType(attributeName, CostReportSalesTaxViewBean.class);
	}
	...
	public Collection select(SearchCriteria criteria, SortCriteria sortCriteria, Connection conn)
		...
		Collection costReportSalesTaxViewBeanColl = new Vector();
		...
		while (dataIter.hasNext()) {
			...
			CostReportSalesTaxViewBean costReportSalesTaxViewBean = new CostReportSalesTaxViewBean();
			load(dataSetRow, costReportSalesTaxViewBean);
			costReportSalesTaxViewBeanColl.add(costReportSalesTaxViewBean);
		}

		return costReportSalesTaxViewBeanColl;
	}
