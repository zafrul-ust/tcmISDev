...
public class MaterialsUsedInputBean extends BaseDataBean {
  ...
  public void setDateDeliveredStart(Date dateDeliveredStart) {
	...
	public Date getDateDeliveredStart() {
