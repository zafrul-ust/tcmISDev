...
/******************************************************************************
 * CLASSNAME: DivFacGrpFacReAppOvBean <br>
 * @version: 1.0, Apr 11, 2011 <br>
 *****************************************************************************/


public class DivFacGrpFacReAppOvBean extends BaseDataBean implements SQLData {

	private String companyId;
	private String divisionId;
	private String divisionDescription;
	private Collection<FacGrpFacReAppObjBean> facilityGroupList;
	private Array facilityGroupListArray;
	private String sqlType = "DIV_FAC_GRP_FAC_RE_APP_OV";


	//constructor
	public DivFacGrpFacReAppOvBean() {
	}
