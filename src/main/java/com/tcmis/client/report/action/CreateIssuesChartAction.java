 ...
 *          ****************************************************************************
 */
public class CreateIssuesChartAction extends TcmISBaseAction {
	...
	public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws BaseException, Exception {
		...
		String fileName = process.generateIssuesChart(inventoryGroup, catPartNo, partGroupNo, inventoryGroupName, catalogId, issueGeneration,catalogCompanyId);
		request.setAttribute("map", process.getMap());
		request.setAttribute("fileName", fileName);
		request.setAttribute("chartType", "Issues for " + catPartNo + " in " + inventoryGroupName);
