...
import com.tcmis.client.report.process.UploadVocetCSVFileProcess;
 ...
 * @version 1.0
 ******************************************************************************/
public class VocetCSVUploadAction extends TcmISBaseAction {

	@Override
	public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws BaseException, Exception {
		if (!isLoggedIn(request)) {
			request.setAttribute("requestedPage", "uploadvocetimport");
...
//			BeanHandler.copyAttributes(form, uploadFileInputBean, getTcmISLocale(request));
			...
			{
				UploadVocetCSVFileProcess process = new UploadVocetCSVFileProcess(this.getDbUser(request));
