 ...
 *          ****************************************************************************
 */
public class CreateSupplyLeadtimeChartAction extends TcmISBaseAction {
...
//    }
		...
		String fileName = process.generateSupplyLeadtimeChart(inventoryGroup, catPartNo, partGroupNo, inventoryGroupName, catalogId, issueGeneration,catalogCompanyId);
