 ...
 * @version 1.0
 ******************************************************************************/
public class CreateLeadtimeChartAction
...
//    }
    ...
    String fileName = process.generateLeadtimeChart(inventoryGroup,catPartNo,partGroupNo,inventoryGroupName,catalogId,issueGeneration,catalogCompanyId);
    request.setAttribute("map", process.getMap());
    request.setAttribute("fileName", fileName);
    request.setAttribute("chartType",
                         "Lead time for " + catPartNo + " in " + inventoryGroupName);
