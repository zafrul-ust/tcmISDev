...
public class InvoiceReconciliationProcessCommand
    implements Command {
  Log log = LogFactory.getLog(this.getClass());

  public InvoiceReconciliationProcessCommand() {
    super();
  }

  public Object execute(Object[] args) throws Exception {
    try {
      InvoiceReconciliationProcess process = new InvoiceReconciliationProcess(
          "UTC");
  ...
  protected void logInitializationError(Exception e) throws Exception {
    log.error("Invoice reconciliation error:", e);
    MailProcess.sendEmail("deverror@haastcm.com", null,
                          "deverror@haastcm.com",
                          "UTC - invoice reconciliation processing error",
                          e.getMessage());
  }
