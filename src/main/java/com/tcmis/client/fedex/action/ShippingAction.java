package com.tcmis.client.fedex.action;

import com.tcmis.client.fedex.process.ShippingProcess;
    ...
    try {
        ...
        if (form != null &&
         ...
         shippingProcess.reprint(inputBean);
            ...
            BeanHandler.copyAttributes(form, fedexShippingInfoBean);
            shippingProcess.voidShipment(inputBean.getShipmentId(), fedexShippingInfoBean);
        }
        else {
