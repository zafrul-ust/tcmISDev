...
public class FedexDangerousGoodsViewBeanFactory extends BaseBeanFactory {
	...
	//table name
	public String TABLE = "fedex_dangerous_goods_view";


	//constructor
	public FedexDangerousGoodsViewBeanFactory(DbManager dbManager) {
		super(dbManager);
	}
