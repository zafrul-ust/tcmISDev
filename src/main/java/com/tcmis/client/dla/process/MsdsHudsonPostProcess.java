...
public class MsdsHudsonPostProcess
extends GenericProcess{
	Log log = LogFactory.getLog(this.getClass());
	private ResourceLibrary library = null;

	public MsdsHudsonPostProcess(String client) throws BaseException {
		super(client);
...
//	}
	...
	public String getPostXml() throws BaseException {
		...
		try {
			...
			Vector<DlaGasRoadmapViewBean> data = (Vector<DlaGasRoadmapViewBean>)this.factory.selectQuery("select * from DLA_GAS_SDS_ROADMAP_VIEW ");
