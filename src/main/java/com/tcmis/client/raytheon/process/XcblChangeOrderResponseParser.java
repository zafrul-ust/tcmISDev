 ...
 * @version 1.0
 *****************************************************************************/
public class XcblChangeOrderResponseParser
    extends BaseProcess {

  public XcblChangeOrderResponseParser(String client) {
    super(client);
  }

  public String getChangeOrderResponse(XcblOrderBean xcblChangeOrderDataBean) throws
      BaseException {
    ...
    sw.write("ChangeOrderResponse");
    sw.write("</OrderResponseDocTypeCoded>");
    sw.write("<OrderReference>");
    sw.write("<Reference>");
    sw.write("<RefNum>");
    sw.write(StringHandler.emptyIfNull(xcblChangeOrderDataBean.getBuyerOrderNumber()));
    sw.write("</RefNum>");
    sw.write("<RefDate>");
    sw.write(XcblHandler.getXcblDateString(xcblChangeOrderDataBean.getOrderIssueDate()));
    sw.write("</RefDate>");
    sw.write("</Reference>");
    sw.write("</OrderReference>");
    //if change order
    //if (XcblProcess.OTHER.equalsIgnoreCase(xcblChangeOrderDataBean.getResponseOrderStatus())) {
      ...
      sw.write("</RefNum>");
      sw.write("<RefDate>");
      sw.write(XcblHandler.getXcblDateString(xcblChangeOrderDataBean.getChangeOrderDate()));
      sw.write("</RefDate>");
      sw.write("</Reference>");
      sw.write("</ChangeOrderReference>");
    //}
    ...
    sw.write("</Agency>");
    sw.write("<Ident>");
    sw.write(StringHandler.emptyIfNull(xcblChangeOrderDataBean.getSellerIdent()));
    sw.write("</Ident>");
    sw.write("</Identifier>");
    sw.write("</PartyID>");
    sw.write("<NameAddress>");
    sw.write("<Name1>");
    sw.write(StringHandler.emptyIfNull(xcblChangeOrderDataBean.getSellerName1()));
    sw.write("</Name1>");
    sw.write("</NameAddress>");
    ...
    sw.write("</Agency>");
    sw.write("<Ident>");
    sw.write(StringHandler.emptyIfNull(xcblChangeOrderDataBean.getOrderPartyIdent()));
    sw.write("</Ident>");
    sw.write("</Identifier>");
    sw.write("</PartyID>");
    sw.write("<NameAddress>");
    sw.write("<Name1>");
    sw.write(StringHandler.emptyIfNull(xcblChangeOrderDataBean.getOrderPartyName1()));
    sw.write("</Name1>");
    sw.write("</NameAddress>");
    sw.write("<OrderContact>");
    sw.write("<Contact>");
    sw.write("<ContactName>");
    sw.write(StringHandler.emptyIfNull(xcblChangeOrderDataBean.getOrderPartyContactName()));
    sw.write("</ContactName>");
    ...
    sw.write(StringHandler.emptyIfNull(xcblChangeOrderDataBean.getResponseType()));
    sw.write("</ResponseTypeCoded>");
    sw.write("</ResponseType>");
    ...
    sw.write(StringHandler.emptyIfNull(xcblChangeOrderDataBean.getStatusEvent()));
    sw.write("</StatusEventCoded>");
    sw.write("<StatusEventCodedOther>");
    sw.write(StringHandler.emptyIfNull(xcblChangeOrderDataBean.getStatusEventOther()));
    sw.write("</StatusEventCodedOther>");
    sw.write("</StatusEvent>");
    sw.write("<StatusNote>");
    sw.write(StringHandler.xmlEncode(StringHandler.emptyIfNull(xcblChangeOrderDataBean.
                                       getResponseOrderStatusNotes())));
    sw.write("</StatusNote>");
    sw.write("</Status>");
    sw.write("</OrderStatus>");
    //if change order
    if (XcblProcess.OTHER.equalsIgnoreCase(xcblChangeOrderDataBean.getResponseOrderStatus())) {
      ...
      sw.write(StringHandler.emptyIfNull(xcblChangeOrderDataBean.getChangeOrderSequence()));
      sw.write("</ChangeOrderSequence>");
    ...
    if(!XcblProcess.PROCESSING.equalsIgnoreCase(xcblChangeOrderDataBean.getStatusEvent())) {
      sw.write("<OrderResponseDetail>");
      sw.write("<ListOfOrderResponseItemDetail>");
//loop thru item detail
      Iterator iterator = xcblChangeOrderDataBean.getXcblOrderDetailBeanColl().iterator();
...
//item note to buyer
        ...
        sw.write("</Status>");
        sw.write("</ItemStatusEvent>");
        sw.write("<ChangeOrderItemDetail>");
        sw.write("<ItemDetailChangeCoded>");
        sw.write("Other");
        sw.write("</ItemDetailChangeCoded>");
        sw.write("<ItemDetailChangeCodedOther>");
        sw.write("N/A");
        sw.write("</ItemDetailChangeCodedOther>");
...
//loop thru schedules
        ...
        //Iterator iterator2 = detailBean.getXcblOrderDetailScheduleBeanColl().iterator();
        ...
        sw.write("</ChangeOrderItemDetail>");
//now the changes
        //if (XcblProcess.OTHER.equalsIgnoreCase(xcblChangeOrderDataBean.
        //                                       getResponseOrderStatus())) {
