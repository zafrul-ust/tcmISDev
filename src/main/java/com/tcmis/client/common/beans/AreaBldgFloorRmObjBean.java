...
/******************************************************************************
 * CLASSNAME: AreaBldgFloorRmObjBean <br>
 * @version: 1.0, Jan 13, 2012 <br>
 *****************************************************************************/


public class AreaBldgFloorRmObjBean extends BaseDataBean implements SQLData {

	private BigDecimal areaId;
	private String areaName;
	private String areaDescription;
	private Collection<BldgFloorObjBean> buildingList;
	private Array buildingListArray;
	private String sqlType = "AREA_BLDG_FLOOR_RM_OBJ";


	//constructor
	public AreaBldgFloorRmObjBean() {
	}
