...
public class CxmlOrderRequestBeanFactory
  ...
  public int getType(String attributeName) {
    return super.getType(attributeName, CxmlOrderRequestBean.class);
  }


//delete
   public int delete(CxmlOrderRequestBean cxmlOrderRequestBean)
   ...
   public int delete(CxmlOrderRequestBean cxmlOrderRequestBean, Connection conn)
    throws BaseException {
    SearchCriteria criteria = new SearchCriteria("payloadId", "SearchCriterion.EQUALS",
     "" + cxmlOrderRequestBean.getPayloadId());
...
//insert
   public int insert(CxmlOrderRequestBean cxmlOrderRequestBean)
    throws BaseException {
    Connection connection = null;
    int result = 0;
    try {
   ...
   public int insert(CxmlOrderRequestBean cxmlOrderRequestBean, Connection conn)
    throws BaseException {
...
//update
   public int update(CxmlOrderRequestBean cxmlOrderRequestBean)
    throws BaseException {
    Connection connection = null;
    int result = 0;
    try {
    ...
    return result;
       ...
       public int update(CxmlOrderRequestBean cxmlOrderRequestBean, Connection conn)
    throws BaseException {
