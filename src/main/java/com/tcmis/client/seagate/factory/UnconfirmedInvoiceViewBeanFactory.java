...
import com.tcmis.client.seagate.beans.UnconfirmedInvoiceViewBean;
...
public class UnconfirmedInvoiceViewBeanFactory
  ...
  public String ATTRIBUTE_ISSUES = "ISSUES";
  ...
  public String getColumnName(String attributeName) {
    ...
    else if (attributeName.equals("issues")) {
...
//insert
   ...
   public int insert(UnconfirmedInvoiceViewBean unconfirmedInvoiceViewBean, Connection conn)
    ...
    String query  =
     ...
     SqlHandler.delimitString(unconfirmedInvoiceViewBean.getIssues()) + ")";
