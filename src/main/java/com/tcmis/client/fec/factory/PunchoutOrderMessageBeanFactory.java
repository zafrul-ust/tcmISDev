...
public class PunchoutOrderMessageBeanFactory extends BaseBeanFactory {
...
*/
	...
	public int update(PunchoutOrderMessageBean punchoutOrderMessageBean, Connection conn)
		...
		String query  = "update " + TABLE + " set " +
			...
			"where " + ATTRIBUTE_PAYLOAD_ID + "=" +
				SqlHandler.delimitString( StringHandler.zeroIfNull(punchoutOrderMessageBean.getPayloadId()) );
	...
	public Collection select(SearchCriteria criteria, Connection conn)
		...
		while (dataIter.hasNext()) {
			...
			PunchoutOrderMessageBean punchoutOrderMessageBean = new PunchoutOrderMessageBean();
