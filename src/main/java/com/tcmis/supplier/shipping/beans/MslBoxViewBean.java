...
/******************************************************************************
 * CLASSNAME: MslBoxViewBean <br>
 * @version: 1.0, Dec 1, 2007 <br>
 *****************************************************************************/


public class MslBoxViewBean extends BaseDataBean {
 ...
 //constructor
	...
	public void setLineItem(String lineItem) {
		this.lineItem = StringHandler.emptyIfNull(lineItem);
	}
	public void setCatPartNo(String catPartNo) {
		this.catPartNo = StringHandler.emptyIfNull(catPartNo);
	}
	public void setQuantity(BigDecimal quantity) {
		this.quantity = quantity;
	}
	public void setUnitOfSale(String unitOfSale) {
		this.unitOfSale = StringHandler.emptyIfNull(unitOfSale);
	}
	public void setUnitPrice(BigDecimal unitPrice) {
		this.unitPrice = unitPrice;
	}
	public void setBoxId(String boxId) {
		this.boxId = StringHandler.emptyIfNull(boxId);
	}
	...
	public void setBoxRfid(String boxRfid) {
		this.boxRfid = StringHandler.emptyIfNull(boxRfid); 
	}
