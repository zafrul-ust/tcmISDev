...
/******************************************************************************
 * CLASSNAME: GasPalletShipmentViewBeanFactory <br>
 * @version: 1.0, May 28, 2008 <br>
 *****************************************************************************/


public class GasPalletShipmentViewBeanFactory extends BaseBeanFactory {
  ...
  //table name
	public String TABLE = "GAS_PALLET_SHIPMENT_VIEW";


	//constructor
	public GasPalletShipmentViewBeanFactory(DbManager dbManager) {
		super(dbManager);
	}
	...
	public int getType(String attributeName) {
		return super.getType(attributeName, GasPalletShipmentViewBean.class);
	}
...
/*
	//delete
	public int delete(GasPalletShipmentViewBean gasPalletShipmentViewBean)
		throws BaseException {

		SearchCriteria criteria = new SearchCriteria("supplier", "SearchCriterion.EQUALS",
			"" + gasPalletShipmentViewBean.getSupplier());
	...
	public int delete(GasPalletShipmentViewBean gasPalletShipmentViewBean, Connection conn)
		throws BaseException {
...
/*
	//insert
	public int insert(GasPalletShipmentViewBean gasPalletShipmentViewBean)
		throws BaseException {
		...
		try {
			connection = getDbManager().getConnection();
			result = insert(gasPalletShipmentViewBean, connection);
		}
		finally {
			this.getDbManager().returnConnection(connection);
		}
	...
	public int insert(GasPalletShipmentViewBean gasPalletShipmentViewBean, Connection conn)
		throws BaseException {
		...
		String query  = 
			...
			ATTRIBUTE_LINE_ITEM + ")" +
			" values (" +
			SqlHandler.delimitString(gasPalletShipmentViewBean.getSupplier()) + "," +
			SqlHandler.delimitString(gasPalletShipmentViewBean.getShipFromLocationId()) + "," +
			gasPalletShipmentViewBean.getRadianPo() + "," +
			SqlHandler.delimitString(gasPalletShipmentViewBean.getShipViaLocationId()) + "," +
			SqlHandler.delimitString(gasPalletShipmentViewBean.getShipViaCompanyId()) + "," +
			SqlHandler.delimitString(gasPalletShipmentViewBean.getUltimateDodaac()) + "," +
			SqlHandler.delimitString(gasPalletShipmentViewBean.getShipViaDodaac()) + "," +
			gasPalletShipmentViewBean.getReceiptId() + "," +
			gasPalletShipmentViewBean.getIssueId() + "," +
			SqlHandler.delimitString(gasPalletShipmentViewBean.getSupplierSalesOrderNo()) + "," +
			gasPalletShipmentViewBean.getQuantity() + "," +
			SqlHandler.delimitString(gasPalletShipmentViewBean.getCatPartNo()) + "," +
			SqlHandler.delimitString(gasPalletShipmentViewBean.getPartShortName()) + "," +
			SqlHandler.delimitString(gasPalletShipmentViewBean.getCurrentCarrierName()) + "," +
			SqlHandler.delimitString(gasPalletShipmentViewBean.getCurrentTrackingNumber()) + "," +
			gasPalletShipmentViewBean.getCurrentShipmentId() + "," +
			SqlHandler.delimitString(gasPalletShipmentViewBean.getPalletId()) + "," +
			gasPalletShipmentViewBean.getPrNumber() + "," +
			SqlHandler.delimitString(gasPalletShipmentViewBean.getLineItem()) + ")";
	...
	//update
	public int update(GasPalletShipmentViewBean gasPalletShipmentViewBean)
		throws BaseException {
		...
		try {
			connection = getDbManager().getConnection();
			result = update(gasPalletShipmentViewBean, connection);
		}
		finally {
			this.getDbManager().returnConnection(connection);
		}
	...
	public int update(GasPalletShipmentViewBean gasPalletShipmentViewBean, Connection conn)
		throws BaseException {
		...
		String query  = "update " + TABLE + " set " +
			...
			ATTRIBUTE_SHIP_FROM_LOCATION_ID + "=" + 
				SqlHandler.delimitString(gasPalletShipmentViewBean.getShipFromLocationId()) + "," +
			ATTRIBUTE_RADIAN_PO + "=" + 
				StringHandler.nullIfZero(gasPalletShipmentViewBean.getRadianPo()) + "," +
			ATTRIBUTE_SHIP_VIA_LOCATION_ID + "=" + 
				SqlHandler.delimitString(gasPalletShipmentViewBean.getShipViaLocationId()) + "," +
			ATTRIBUTE_SHIP_VIA_COMPANY_ID + "=" + 
				SqlHandler.delimitString(gasPalletShipmentViewBean.getShipViaCompanyId()) + "," +
			...
			ATTRIBUTE_SHIP_VIA_DODAAC + "=" + 
				SqlHandler.delimitString(gasPalletShipmentViewBean.getShipViaDodaac()) + "," +
			ATTRIBUTE_RECEIPT_ID + "=" + 
				StringHandler.nullIfZero(gasPalletShipmentViewBean.getReceiptId()) + "," +
			ATTRIBUTE_ISSUE_ID + "=" + 
				StringHandler.nullIfZero(gasPalletShipmentViewBean.getIssueId()) + "," +
			ATTRIBUTE_SUPPLIER_SALES_ORDER_NO + "=" + 
				SqlHandler.delimitString(gasPalletShipmentViewBean.getSupplierSalesOrderNo()) + "," +
			ATTRIBUTE_QUANTITY + "=" + 
				StringHandler.nullIfZero(gasPalletShipmentViewBean.getQuantity()) + "," +
			ATTRIBUTE_CAT_PART_NO + "=" + 
				SqlHandler.delimitString(gasPalletShipmentViewBean.getCatPartNo()) + "," +
			ATTRIBUTE_PART_SHORT_NAME + "=" + 
				SqlHandler.delimitString(gasPalletShipmentViewBean.getPartShortName()) + "," +
			...
			ATTRIBUTE_CURRENT_TRACKING_NUMBER + "=" + 
				SqlHandler.delimitString(gasPalletShipmentViewBean.getCurrentTrackingNumber()) + "," +
			ATTRIBUTE_CURRENT_SHIPMENT_ID + "=" + 
				StringHandler.nullIfZero(gasPalletShipmentViewBean.getCurrentShipmentId()) + "," +
			ATTRIBUTE_PALLET_ID + "=" + 
				SqlHandler.delimitString(gasPalletShipmentViewBean.getPalletId()) + "," +
			ATTRIBUTE_PR_NUMBER + "=" + 
				StringHandler.nullIfZero(gasPalletShipmentViewBean.getPrNumber()) + "," +
			ATTRIBUTE_LINE_ITEM + "=" + 
				SqlHandler.delimitString(gasPalletShipmentViewBean.getLineItem()) + " " +
...
*/
	...
	throws BaseException {
		...
		Collection gasPalletShipmentViewBeanColl = new Vector();
		...
		while (dataIter.hasNext()) {
			...
			GasPalletShipmentViewBean gasPalletShipmentViewBean = new GasPalletShipmentViewBean();
			load(dataSetRow, gasPalletShipmentViewBean);
			gasPalletShipmentViewBeanColl.add(gasPalletShipmentViewBean);
		}

		return gasPalletShipmentViewBeanColl;
	}
