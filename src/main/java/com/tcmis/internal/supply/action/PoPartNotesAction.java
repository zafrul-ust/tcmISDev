...
import com.tcmis.internal.supply.process.PurchaseOrderProcess;
	...
	public class PoPartNotesAction extends TcmISBaseAction {
			public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws BaseException, Exception {
				...
				else
				{
					...
					Collection<PoLineDetailViewBean> partNotesResults = process.buildPartNotes(input);
					if(partNotesResults == null)
					...
					else
					{
						...
						for (PoLineDetailViewBean bean : partNotesResults) {
							...
							dataArr.put(StringHandler.emptyIfNull(bean.getCatPartNoComment()));
