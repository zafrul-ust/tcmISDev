...
import com.tcmis.internal.supply.process.PoNotesProcess;
//import com.tcmis.internal.supply.beans.POTextViewBean;

/*****************************************************************************
 * Controller for Purchase Order Notes page
 * @version 1.0
 ******************************************************************************/

public class PoNotesAction extends TcmISBaseAction
{
                                     ...
                                     HttpServletResponse response) throws  BaseException, Exception 
    {
		...
		{
			request.setAttribute("requestedPage", "ponotesmain");
		...
		*/
		...
		PoNotesProcess process = new PoNotesProcess(this.getDbUser(request));
