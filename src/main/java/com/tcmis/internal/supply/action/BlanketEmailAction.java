...
import com.tcmis.internal.supply.process.BlanketEmailProcess;
//import com.tcmis.internal.supply.beans.POTextViewBean;

/******************************************************************************
 * Controller for Purchase Order Bpo Email Notes page
 * @version 1.0
 ******************************************************************************/

public class BlanketEmailAction extends TcmISBaseAction
{
                                     ...
                                     HttpServletResponse response) throws  BaseException, Exception 
    {
		...
		{
			request.setAttribute("requestedPage", "blanketemailmain");
		...
		*/
		...
		BlanketEmailProcess process = new BlanketEmailProcess(this.getDbUser(request));
		...
		{  
			BpoEmailViewBean insertBean = new BpoEmailViewBean();
