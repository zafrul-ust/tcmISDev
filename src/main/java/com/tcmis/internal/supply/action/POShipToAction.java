...
public class POShipToAction extends TcmISBaseAction {
   ...
   public ActionForward executeAction(ActionMapping mapping,
      ...
      if ("search".equalsIgnoreCase(uAction)) {
         Collection shipToLocationViewBeanCollection = process.getShipToLocationViewBeanCollection(inputBean);
         
         request.setAttribute("shipToLocationViewBeanCollection", shipToLocationViewBeanCollection);
