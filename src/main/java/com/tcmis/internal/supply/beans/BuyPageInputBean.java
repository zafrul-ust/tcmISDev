...
public class BuyPageInputBean extends BaseDataBean {
  ...
  public void setSubmitUpdate(String submitUpdate) {
	...
	public void setSubmitCreatePo(String submitCreatePo) {
		 this.submitCreatePo = submitCreatePo;
	}
  ...
  public String getSubmitCreatePo() {
	 return submitCreatePo;
	}
