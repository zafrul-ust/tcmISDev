...
/*
	//delete
	public int delete(CustomerReturnRequestBean customerReturnRequestBean)
	...
	public int delete(CustomerReturnRequestBean customerReturnRequestBean, Connection conn)
		throws BaseException {
...
//you need to verify the primary key(s) before uncommenting this
	...
	public BigDecimal insertCustomerRequest(CustomerReturnRequestBean customerReturnRequestBean)
	throws BaseException {
	...
	try {
		connection = getDbManager().getConnection();
		rmaId =new BigDecimal(getDbManager().getOracleSequence("customer_rma_seq"));
 ...
 /*		
		ATTRIBUTE_CUSTOMER_RMA_ID + "=" + 
			StringHandler.nullIfZero(customerReturnRequestBean.getCustomerRmaId()) + "," +
		ATTRIBUTE_COMPANY_ID + "=" + 
			SqlHandler.delimitString(customerReturnRequestBean.getCompanyId()) + "," +
		ATTRIBUTE_PR_NUMBER + "=" + 
			StringHandler.nullIfZero(customerReturnRequestBean.getPrNumber()) + "," +
		ATTRIBUTE_LINE_ITEM + "=" + 
			SqlHandler.delimitString(customerReturnRequestBean.getLineItem()) + "," +	
		ATTRIBUTE_OPS_ENTITY_ID + "=" + 
			SqlHandler.delimitString(customerReturnRequestBean.getOpsEntityId()) + "," +
...
/*		ATTRIBUTE_CUSTOMER_SERVICE_REP_ID + "=" + 
			StringHandler.nullIfZero(customerReturnRequestBean.getCustomerServiceRepId()) + "," +
*/		
		ATTRIBUTE_APPROVER_ID + "=" + 
