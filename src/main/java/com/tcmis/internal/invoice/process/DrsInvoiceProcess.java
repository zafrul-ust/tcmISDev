...
import com.tcmis.internal.invoice.factory.DrsInvoiceDetailViewBeanFactory;
...
public class DrsInvoiceProcess
    extends BaseProcess {
  Log log = LogFactory.getLog(this.getClass());

  public DrsInvoiceProcess(String client) {
    super(client);
  }
  ...
  public void getWordInvoice(InvoiceInputBean bean, Writer writer) throws NoDataException, BaseException {
    try {
      ...
      DrsInvoiceDetailViewBeanFactory factory = new
          DrsInvoiceDetailViewBeanFactory(dbManager);
      ...
      File xslFile = null;
      xslFile = new File(library.getString("word.drsinvoice.xsl"));
