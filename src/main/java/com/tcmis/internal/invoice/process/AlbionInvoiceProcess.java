...
public class AlbionInvoiceProcess
    extends BaseProcess {
  Log log = LogFactory.getLog(this.getClass());

  public AlbionInvoiceProcess(String client) {
    super(client);
  }
  ...
  public void getWordInvoice(InvoiceInputBean bean, Writer writer) throws NoDataException, BaseException {
    try {
      ...
      criteria.addCriterion("facilityId", SearchCriterion.EQUALS, "Albion");
      ...
      File xslFile = null;
      xslFile = new File(library.getString("word.verasunalbioninvoice.xsl"));
      ...
      BaseException be = new BaseException("Error creating word invoice for Verasun Albion:" + e.getMessage());
      be.setRootCause(e);
      throw be;
    }
  }
