 ...
 ***********************************************************/
public class GeneralDynamicsInvoiceProcess
    extends BaseProcess {
  Log log = LogFactory.getLog(this.getClass());

  public GeneralDynamicsInvoiceProcess(String client) {
    super(client);
  }
  ...
  public void getWordInvoice(InvoiceInputBean bean, Writer writer) throws
      ...
      SearchCriteria criteria = new SearchCriteria("companyId", SearchCriterion.EQUALS, "GD");
      criteria.addCriterion("invoiceGroup", SearchCriterion.EQUALS, "GD-SF");
      ...
      File xslFile = new File(library.getString("word.generaldynamicsinvoice.xsl"));
