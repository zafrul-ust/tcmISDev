...
public class FortDodgeInvoiceProcess
    extends BaseProcess {
  Log log = LogFactory.getLog(this.getClass());

  public FortDodgeInvoiceProcess(String client) {
    super(client);
  }
  ...
  public void getWordInvoice(InvoiceInputBean bean, Writer writer) throws NoDataException, BaseException {
    try {
      ...
      criteria.addCriterion("facilityId", SearchCriterion.EQUALS, "Fort Dodge");
      ...
      File xslFile = null;
      xslFile = new File(library.getString("word.verasunfortdodgeinvoice.xsl"));
