...
import com.tcmis.internal.invoice.factory.InvoiceFormatViewWilmingtonBeanFactory;
...
public class WilmingtonInvoiceProcess
    extends BaseProcess {

  public WilmingtonInvoiceProcess(String client) {
    super(client);
  }
  ...
  public void getWordInvoice(InvoiceInputBean bean, Writer writer) throws
      ...
      InvoiceFormatViewWilmingtonBeanFactory
          factory = new
          InvoiceFormatViewWilmingtonBeanFactory(
          dbManager);
      ...
      File xslFile = new File(library.getString("word.wilmingtoninvoice.xsl"));
