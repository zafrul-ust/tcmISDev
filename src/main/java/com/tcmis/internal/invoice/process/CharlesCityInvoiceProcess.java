...
public class CharlesCityInvoiceProcess
    extends BaseProcess {
  Log log = LogFactory.getLog(this.getClass());

  public CharlesCityInvoiceProcess(String client) {
    super(client);
  }
  ...
  public void getWordInvoice(InvoiceInputBean bean, Writer writer) throws NoDataException, BaseException {
    try {
      ...
      criteria.addCriterion("facilityId", SearchCriterion.EQUALS, "Charles City");
      ...
      File xslFile = null;
      xslFile = new File(library.getString("word.verasunccinvoice.xsl"));
      ...
      BaseException be = new BaseException("Error creating word invoice for Verasun cc:" + e.getMessage());
      be.setRootCause(e);
      throw be;
    }
  }
