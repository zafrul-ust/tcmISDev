...
import com.tcmis.internal.invoice.factory.InvoiceViewBoeingOffsiteBeanFactory;

/***********************************************************
 * Process for creating Boeing Offsite invoice.
 ***********************************************************/

public class BoeingOffsiteInvoiceProcess
    extends BaseProcess {

  public BoeingOffsiteInvoiceProcess(String client) {
    super(client);
  }
  ...
  public void getWordInvoice(InvoiceInputBean bean, Writer writer) throws
      ...
      InvoiceViewBoeingOffsiteBeanFactory factory = new
          InvoiceViewBoeingOffsiteBeanFactory(
          dbManager);
      Collection c = factory.select(new BigDecimal("" + bean.getInvoicePeriod()));
      if (c == null || c.size() == 0) {
      ...
      File xslFile = new File(library.getString("word.boeingoffsiteinvoice.xsl"));
