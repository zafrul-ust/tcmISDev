...
public class LindenInvoiceProcess
    extends BaseProcess {
  Log log = LogFactory.getLog(this.getClass());

  public LindenInvoiceProcess(String client) {
    super(client);
  }
  ...
  public void getWordInvoice(InvoiceInputBean bean, Writer writer) throws NoDataException, BaseException {
    try {
      ...
      criteria.addCriterion("facilityId", SearchCriterion.EQUALS, "Linden");
      ...
      File xslFile = null;
      xslFile = new File(library.getString("word.verasunlindeninvoice.xsl"));
      ...
      BaseException be = new BaseException("Error creating word invoice for Verasun Linden:" + e.getMessage());
      be.setRootCause(e);
      throw be;
    }
  }
