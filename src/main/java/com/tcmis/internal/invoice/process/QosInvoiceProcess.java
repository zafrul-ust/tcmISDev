...
/***********************************************************
 * Process for creating Quality On Site invoice.
 ***********************************************************/

public class QosInvoiceProcess
    extends BaseProcess {

  public QosInvoiceProcess(String client) {
    super(client);
  }
  ...
  public void getWordInvoice(InvoiceInputBean bean, Writer writer) 
      ...
      Collection c = factory.selectQos(new BigDecimal("" + bean.getInvoicePeriod()));
      ...
      File xslFile = new File(library.getString("word.qosinvoice.xsl"));
