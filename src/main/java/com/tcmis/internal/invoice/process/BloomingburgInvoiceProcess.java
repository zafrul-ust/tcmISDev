...
import com.tcmis.internal.invoice.factory.InvoiceFormatVerasunViewBeanFactory;
import com.tcmis.internal.invoice.factory.InvoiceBeanFactory;

/***********************************************************
 * Process for creating CC invoice.
 ***********************************************************/

public class BloomingburgInvoiceProcess
    extends BaseProcess {
  Log log = LogFactory.getLog(this.getClass());

  public BloomingburgInvoiceProcess(String client) {
    super(client);
  }
  ...
  public void getWordInvoice(InvoiceInputBean bean, Writer writer) throws NoDataException, BaseException {
    try {
      ...
      InvoiceFormatVerasunViewBeanFactory factory = new
          InvoiceFormatVerasunViewBeanFactory(dbManager);
      SearchCriteria criteria = new SearchCriteria();
      criteria.addCriterion("facilityId", SearchCriterion.EQUALS, "Bloomingburg");
      ...
      Collection c = factory.select(criteria, new SortCriteria());
      if (c == null || c.size() == 0) {
      ...
      File xslFile = null;
      xslFile = new File(library.getString("word.verasunbloomingburginvoice.xsl"));
      ...
      BaseException be = new BaseException("Error creating word invoice for Verasun Bloomingburg:" + e.getMessage());
      be.setRootCause(e);
      throw be;
    }
  }
