...
import com.tcmis.internal.invoice.factory.InvoiceFormatViewMoraineBeanFactory;
...
public class MoraineInvoiceProcess
    extends BaseProcess {
  Log log = LogFactory.getLog(this.getClass());

  public MoraineInvoiceProcess(String client) {
    super(client);
  }
  ...
  public void getWordInvoice(InvoiceInputBean bean, Writer writer) throws NoDataException, BaseException {
    try {
      ...
      InvoiceFormatViewMoraineBeanFactory factory = new
          InvoiceFormatViewMoraineBeanFactory(dbManager);
      ...
      File xslFile = null;
      xslFile = new File(library.getString("word.moraineinvoice.xsl"));
