...
public class HartleyInvoiceProcess
    extends BaseProcess {
  Log log = LogFactory.getLog(this.getClass());

  public HartleyInvoiceProcess(String client) {
    super(client);
  }
  ...
  public void getWordInvoice(InvoiceInputBean bean, Writer writer) throws NoDataException, BaseException {
    try {
      ...
      criteria.addCriterion("facilityId", SearchCriterion.EQUALS, "Hartley");
      ...
      File xslFile = null;
      xslFile = new File(library.getString("word.verasunhartleyinvoice.xsl"));
      ...
      BaseException be = new BaseException("Error creating word invoice for Verasun Hartley:" + e.getMessage());
      be.setRootCause(e);
      throw be;
    }
  }
