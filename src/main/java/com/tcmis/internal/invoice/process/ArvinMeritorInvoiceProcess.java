 ...
 ***********************************************************/
public class ArvinMeritorInvoiceProcess
    extends BaseProcess {
  Log log = LogFactory.getLog(this.getClass());

  public ArvinMeritorInvoiceProcess(String client) {
    super(client);
  }
  ...
  public void getWordInvoice(InvoiceInputBean bean, Writer writer) throws
      ...
      InvoiceViewArvinMeritorBeanFactory factory = new
          InvoiceViewArvinMeritorBeanFactory(
          dbManager);
      ...
      File xslFile = new File(library.getString("word.arvinmeritorinvoice.xsl"));
