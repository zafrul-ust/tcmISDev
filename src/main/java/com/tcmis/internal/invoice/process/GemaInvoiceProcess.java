 ...
 ***********************************************************/
public class GemaInvoiceProcess
    extends BaseProcess {
  Log log = LogFactory.getLog(this.getClass());

  public GemaInvoiceProcess(String client) {
    super(client);
  }
  ...
  public void getWordInvoice(InvoiceInputBean bean, Writer writer) throws
      ...
      criteria.addCriterion("companyId", SearchCriterion.EQUALS, "GEMA");
      criteria.addCriterion("invoiceGroup", SearchCriterion.EQUALS, "GEMA-SF");
      ...
      File xslFile = new File(library.getString("word.gemasfinvoice.xsl"));
