...
public class WelcomeInvoiceProcess
    extends BaseProcess {
  Log log = LogFactory.getLog(this.getClass());

  public WelcomeInvoiceProcess(String client) {
    super(client);
  }
  ...
  public void getWordInvoice(InvoiceInputBean bean, Writer writer) throws NoDataException, BaseException {
    try {
      ...
      criteria.addCriterion("facilityId", SearchCriterion.EQUALS, "Welcome");
      ...
      File xslFile = null;
      xslFile = new File(library.getString("word.verasunwelcomeinvoice.xsl"));
      ...
      BaseException be = new BaseException("Error creating word invoice for Verasun Welcome:" + e.getMessage());
      be.setRootCause(e);
      throw be;
    }
  }
