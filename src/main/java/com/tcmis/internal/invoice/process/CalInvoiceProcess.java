...
public class CalInvoiceProcess
    extends BaseProcess {

  public CalInvoiceProcess(String client) {
    super(client);
  }
  ...
  public void getWordInvoice(InvoiceInputBean bean, Writer writer) throws
      ...
      com.tcmis.internal.invoice.factory.InvoiceViewCalBeanFactory factory = new
          com.tcmis.internal.invoice.factory.InvoiceViewCalBeanFactory(
          dbManager);
      ...
      File xslFile = new File(library.getString("word.calinvoice.xsl"));
