...
public class AuroraInvoiceProcess
    extends BaseProcess {
  Log log = LogFactory.getLog(this.getClass());

  public AuroraInvoiceProcess(String client) {
    super(client);
  }
  ...
  public void getWordInvoice(InvoiceInputBean bean, Writer writer) throws NoDataException, BaseException {
    try {
      ...
      criteria.addCriterion("facilityId", SearchCriterion.EQUALS, "Aurora");
      ...
      File xslFile = null;
      xslFile = new File(library.getString("word.verasunaurorainvoice.xsl"));
