...
/******************************************************************************
 * CLASSNAME: CabinetItemMrCreateViewBeanFactory <br>
 * 
 * @version: 1.0, Mar 6, 2008 <br>
 *****************************************************************************/

public class CabinetItemMrCreateViewBeanFactory extends CabinetMaterialRequestFactory {
    ...
    //table name
	public String TABLE = "CABINET_ITEM_MR_CREATE_VIEW";

	//constructor
	public CabinetItemMrCreateViewBeanFactory(DbManager dbManager) {
		super(dbManager);
	}
	...
	public int getType(String attributeName) {
		return super.getType(attributeName, CabinetItemMrCreateViewBean.class);
	}
	...
	public Collection select(SearchCriteria criteria, SortCriteria sortCriteria, Connection conn) throws BaseException {
		...
		Collection cabinetItemMrCreateViewBeanColl = new Vector();
		...
		while (dataIter.hasNext()) {
			...
			CabinetItemMrCreateViewBean cabinetItemMrCreateViewBean = new CabinetItemMrCreateViewBean();
			load(dataSetRow, cabinetItemMrCreateViewBean);
			cabinetItemMrCreateViewBeanColl.add(cabinetItemMrCreateViewBean);
		}

		return cabinetItemMrCreateViewBeanColl;
	}
}