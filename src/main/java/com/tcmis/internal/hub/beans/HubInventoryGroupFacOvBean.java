...
/******************************************************************************
 * CLASSNAME: HubInventoryGroupFacOvBean <br>
 * @version: 1.0, Oct 3, 2006 <br>
 *****************************************************************************/

public class HubInventoryGroupFacOvBean
  ...
  private String sqlType = "HUB_INVENTORY_GROUP_FAC_OBJ";

  //constructor
  public HubInventoryGroupFacOvBean() {
  }
  ...
  public void setInventoryGroupCollectionArray(Array
                                               inventoryGroupCollectionArray) {
    List list = null;
    try {
