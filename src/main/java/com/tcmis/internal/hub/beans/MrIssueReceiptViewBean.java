...
public class MrIssueReceiptViewBean extends BaseDataBean {
	...
	//mr_issue_receipt_view. quantity - available quantity without accounting for approved authorized return
	...
	private BigDecimal quantityReturnedDisplay;
	private BigDecimal approvedQuantity;
	private BigDecimal availableQuantity;
	private BigDecimal requestApprovedQuantity;
	...
	public BigDecimal getQuantityReturnedDisplay() {
		return quantityReturnedDisplay;
	}

	public void setQuantityReturnedDisplay(BigDecimal quantityReturnedDisplay) {
		this.quantityReturnedDisplay = quantityReturnedDisplay;
	}
	...
	public BigDecimal getRequestApprovedQuantity() {
		return requestApprovedQuantity;
	}

	public void setRequestApprovedQuantity(BigDecimal requestApprovedQuantity) {
		this.requestApprovedQuantity = requestApprovedQuantity;
	}
}