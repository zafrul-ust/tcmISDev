package com.tcmis.internal.airgas.action;
...
import com.tcmis.internal.airgas.beans.*;
import com.tcmis.internal.airgas.process.PageAirgasProcess;
...
public class PageStockQueryAction
...
*/
	...
	if (form == null) 	return (mapping.findForward("success"));
	 ...
	 if ( "testAirgasService".equals(action) ) {
		 ...
		 request.setAttribute("itemWeightExampleViewBeanColl",  process.StockQuery(inputBean));
