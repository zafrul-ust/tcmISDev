 ...
 * @version 1.0
     ******************************************************************************/
public class ProcessMsdsLocationAction
  ...
  public ActionForward executeAction(ActionMapping mapping,
    ...
    if (!this.isLoggedIn(request)) {
      request.setAttribute("requestedPage", "showsearchmsds");
...
*/
        ...
        else if ( ( ( (DynaBean) form).get("submitAdd") != null &&
                   ( (String) ( (DynaBean) form).get("submitAdd")).length() > 0)) {
          process.addMsdsLocation(bean);
          request.setAttribute("currentMsdsLoadViewBeanCollection",
                               process.getSearchResult(bean));
        }
        else if ( ( (DynaBean) form).get("submitDelete") != null &&
                 ( (String) ( (DynaBean) form).get("submitDelete")).length() >
                 0) {
          //delete
          log.debug("deleting");
